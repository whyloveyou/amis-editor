...
import { BasePlugin, registerEditorPlugin, tipedLabel, defaultValue, getSchemaTpl, diff } from 'amis-editor-core';
                    ...
                    body: getSchemaTpl('collapseGroup', [
                        {
                            ...
                            body: [
                                ...
                                {
                                    children: (React.createElement("div", { className: "mb-3" },
                                        React.createElement(Button, { level: "info", size: "sm", className: "m-b-sm", block: true, onClick: _this.editDetail.bind(_this, context.id) }, "\u914D\u7F6E\u4E0B\u62C9\u6309\u94AE\u96C6\u5408")))
                                },
                                getSchemaTpl('label', {
                                    label: '按钮文案'
                                }),

...
import { BasePlugin, tipedLabel, defaultValue, getSchemaTpl, registerEditorPlugin, translateSchema } from 'amis-editor-core';
                    ...
                    body: getSchemaTpl('collapseGroup', [
                        {
                            ...
                            body: [
                                ...
                                getSchemaTpl('combo-container', {
                                    ...
                                    draggable: true,
                                    editable: false,
                                    pipeIn: function (value, data) { return translateSchema(value); },
                                    items: [
                                        {
                                            type: 'tpl',
                                            inline: false,

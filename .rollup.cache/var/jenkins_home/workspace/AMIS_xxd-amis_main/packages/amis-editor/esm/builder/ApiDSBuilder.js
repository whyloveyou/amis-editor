...
import { getSchemaTpl, tipedLabel, generateNodeId, JSONPipeOut } from 'amis-editor-core';
...
var ApiDSBuilder = /** @class */ (function (_super) {
    ...
    ApiDSBuilder.prototype.match = function (schema, key) {
         ...
         *  */
        if (isObject(apiSchema) &&
            (apiSchema.jsonql != null || apiSchema.strategy != null)) {
            return false;
        }
        var maybeApiUrl = typeof apiSchema === 'string'
            ? apiSchema
            : isObject(apiSchema)
                ? (apiSchema === null || apiSchema === void 0 ? void 0 : apiSchema.url) || ''
                : '';
        if (typeof maybeApiUrl === 'string' &&
    ...
    ApiDSBuilder.prototype.makeSourceSettingForm = function (options) {
        ...
        return __spreadArray([
            ...
            feat === 'Edit' && (renderer === 'form' || sourceKey === 'initApi')
                ? getSchemaTpl('apiControl', __assign(__assign({}, baseApiSchemaConfig), { name: 'initApi', label: tipedLabel('初始化接口', "\u63A5\u53E3\u54CD\u5E94\u4F53\u8981\u6C42\uFF1A<br/>\n              <pre>".concat(JSON.stringify({ status: 0, msg: '', data: {} }, null, 2), "</pre>")) }))
                : null
        ], __read((feat === 'List' && renderer === 'crud' && !inScaffold
            ? [
                getSchemaTpl('apiControl', __assign(__assign({}, baseApiSchemaConfig), { name: 'quickSaveApi', label: tipedLabel('快速保存', '快速编辑后用来批量保存的 API') })),
                getSchemaTpl('apiControl', __assign(__assign({}, baseApiSchemaConfig), { name: 'quickSaveItemApi', label: tipedLabel('快速保存单条', '即时保存时使用的 API') }))
            ]
        ...
        var result = [
            {
                ...
                renderer: renderer,
                feat: feat,
                fieldKeys: this.features.map(function (f) { return _this.getFieldsKey({ feat: f }); }),
                config: {
    ...
    ApiDSBuilder.prototype.buildBaseButtonSchema = function (options, schemaPatch) {
        ...
        var schema = __assign(__assign({ type: 'button', label: (_a = labelMap[feat]) !== null && _a !== void 0 ? _a : '按钮' }, buttonSchema), { behavior: feat, onEvent: {
                click: {
                    actions: [
                        {
                            actionType: 'dialog',
                            dialog: __assign({ body: __assign(__assign({}, formSchema), { onEvent: {
                                        submitSucc: {
                                            actions: [
                                                {
                                                    actionType: 'search',
    ...
    ApiDSBuilder.prototype.buildFormOperators = function (options, componentId) {
        ...
        var schema = sortBy(operators !== null && operators !== void 0 ? operators : Object.values(FormOperatorMap), [
            'order'
        ]).map(function (item) {
            return __assign({ type: 'button', label: item.label, onEvent: {
                    click: {
                        actions: [
                            {
    ...
    ApiDSBuilder.prototype.buildBaseFormSchema = function (options, schemaPatch, componentId) {
        ...
        if (!feat) {
            return __assign(__assign({}, schemaPatch), (componentId ? { id: componentId } : {}));
        }
        ...
        var schema = __assign({ id: id, type: 'form', title: '表单', mode: 'horizontal', dsType: this.key, feat: feat, body: fields.map(function (f) {
                var _a;
                var type = f.inputType
                    ? (_a = displayType2inputType(f.inputType)) !== null && _a !== void 0 ? _a : 'input-text'
                    : 'input-text';
                return __assign(__assign(__assign({}, pick(f, ['name', 'label'])), { type: type }), _this.appendSchema2InputControl(type));
        ...
        return __assign(__assign(__assign({}, schema), schemaPatch), { id: id });
    };
    ApiDSBuilder.prototype.buildInsertSchema = function (options, componentId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                title = '新增数据';
                formSchema = this.buildBaseFormSchema(__assign(__assign({}, options), { feat: DSFeatureEnum.Insert }), {
                    id: formId,
                    title: title,
                    api: insertApi,
                    actions: formActions
                });
                return [2 /*return*/, __assign({}, this.buildBaseButtonSchema(__assign(__assign({}, options), { feat: DSFeatureEnum.Insert }), {
                        buttonSchema: {
                            level: 'primary',
                            className: 'm-r-xs'
                        },
    ...
    ApiDSBuilder.prototype.buildViewSchema = function (options, componentId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                title = '查看数据';
                formSchema = this.buildBaseFormSchema(__assign(__assign({}, options), { feat: DSFeatureEnum.View }), {
                    title: title,
                    initApi: viewApi,
                    actions: formActions
                });
                if (renderer === 'crud') {
                    buttonSchema = __assign({}, this.buildBaseButtonSchema(__assign(__assign({}, options), { feat: DSFeatureEnum.View }), {
                        buttonSchema: {
                            level: 'link'
                        },
                        dialogSchema: {
    ...
    ApiDSBuilder.prototype.buildEditSchema = function (options, componentId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                title = '编辑数据';
                formSchema = this.buildBaseFormSchema(__assign(__assign({}, options), { feat: DSFeatureEnum.Edit }), {
                    id: formId,
                    title: title,
                    initApi: initApi,
                    api: editApi,
                ...
                return [2 /*return*/, __assign({}, this.buildBaseButtonSchema(__assign(__assign({}, options), { feat: DSFeatureEnum.Edit }), {
                        buttonSchema: {
                            level: 'link'
                        },
                        dialogSchema: {
    ...
    ApiDSBuilder.prototype.buildBulkEditSchema = function (options, componentId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                title = '批量编辑';
                formSchema = this.buildBaseFormSchema(__assign(__assign({}, options), { feat: DSFeatureEnum.BulkEdit }), {
                    id: formId,
                    title: title,
                    api: bulkEditApi,
                    actions: formActions
                });
                return [2 /*return*/, __assign({}, this.buildBaseButtonSchema(__assign(__assign({}, options), { feat: DSFeatureEnum.BulkEdit }), {
                        buttonSchema: {
                            className: 'm-r-xs',
                    ...
                    case 0:
                        ...
                        simpleQueryFields = ((_a = schema === null || schema === void 0 ? void 0 : schema.columns) !== null && _a !== void 0 ? _a : [])
                            ...
                            var inputType = item.type
                                ? (_a = displayType2inputType(item.type)) !== null && _a !== void 0 ? _a : 'input-text'
                                : 'input-text';
                            return {
                        ...
                        return [4 /*yield*/, this.buildCRUDFilterSchema(__assign(__assign({}, options), { scaffoldConfig: {
                                    dsType: this.key,
            ...
            return __generator(this, function (_a) {
                ...
                formSchema = {
                    ...
                    body: fields.map(function (f) {
                        ...
                        return __assign(__assign(__assign({}, pick(f, ['name', 'label'])), { type: type, size: 'full', required: false, behavior: 'SimpleQuery' }), _this.appendSchema2InputControl(type));
                    }),
                    actions: [
                        { type: 'reset', label: '重置' },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        opColumn = _a.sent();
                        return [4 /*yield*/, Promise.all(fields.map(function (f) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    ApiDSBuilder.prototype.buildToolbarContainer = function (align, body, behaviors) {
        ...
        return __assign(__assign({ type: 'container', align: align }, (behaviors ? { behavior: behaviors } : {})), { body: Array.isArray(body) ? body : [body], wrapperBody: false, style: __assign({ flexGrow: 1, flex: '1 1 auto', position: 'static', display: 'flex', flexBasis: 'auto', flexDirection: 'row', flexWrap: 'nowrap', alignItems: 'stretch' }, (align
                ? {
        ...
        return [
            {
                ...
                items: [
                    this.buildToolbarContainer('left', left, position === 'header'
                        ...
                        : undefined),
                    this.buildToolbarContainer('right', right, position === 'header' ? [DSFeatureEnum.FuzzyQuery] : undefined)
                ].filter(Boolean)
            }
        ];
    };
    ...
    ApiDSBuilder.prototype.guessFormScaffoldConfig = function (options) {
        ...
        var config = __assign(__assign(__assign(__assign({ feat: feat, dsType: dsType }, (fieldKey ? (_a = {}, _a[fieldKey] = fields, _a) : {})), (apiKey ? (_b = {}, _b[apiKey] = JSONPipeOut(schema === null || schema === void 0 ? void 0 : schema.api), _b) : {})), (feat === 'Edit' || schema.initApi != null
            ? { initApi: JSONPipeOut(schema === null || schema === void 0 ? void 0 : schema.initApi) }
            : {})), { operators: operators.length < 1
                ? [FormOperatorMap['cancel'], FormOperatorMap['submit']]
                : operators, __pristineSchema: omit(JSONPipeOut(schema), __spreadArray([], __read(Object.values(DSFeature).map(function (item) { return "".concat(item.value, "Fields"); })), false)) });
        return config;
    };
    ApiDSBuilder.prototype.guessCRUDScaffoldConfig = function (options) {
        ...
        var collectFormFields = function (body) {
            return body.map(function (item) {
                var _a;
                return (__assign(__assign({}, pick(item, ['name', 'label'])), { inputType: (_a = item.type) !== null && _a !== void 0 ? _a : 'input-text', displayType: 'tpl' }));
            });
        };
            ...
            if (key === 'behavior') {
                if (value === 'BulkDelete') {
                    ...
                    simpleQueryFields = ((_e = host === null || host === void 0 ? void 0 : host.body) !== null && _e !== void 0 ? _e : []).map(function (item) {
                        var _a;
                        return (__assign(__assign({}, pick(item, ['name', 'label'])), { inputType: (_a = item.type) !== null && _a !== void 0 ? _a : 'input-text', isplayType: 'tpl' }));
                    });
                }
            }
            return [key, value];
        ...
        var config = {
            ...
            __pristineSchema: omit(JSONPipeOut(schema), __spreadArray([], __read(Object.values(DSFeature).map(function (item) { return "".concat(item.value, "Fields"); })), false))
        };
        return config;
    };
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        id = generateNodeId();
                        _c = [__assign(__assign(__assign(__assign({ id: id, type: 'crud2', mode: 'table2', dsType: this.key, syncLocation: true }, (enableMultiple ? { selectable: true, multiple: true } : {})), { primaryField: primaryField, loadType: 'pagination', api: listApi }), (enableBulkEdit ? { quickSaveApi: bulkEditApi } : {})), (enableEdit ? { quickSaveItemApi: editApi } : {}))];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        ...
                        _c.label = 6;
                    case 6:
                        baseSchema = __assign(__assign(__assign({}, formSchema), (feat === 'Edit' ? { initApi: initApi } : {})), { dsType: this.key });
                        if (__pristineSchema && isObject(__pristineSchema)) {
                            return [2 /*return*/, __assign(__assign(__assign({}, __pristineSchema), baseSchema), { id: id })];
                        }

...
function BaseOptionControl(Cmpt) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.render = function () {
            ...
            var cmptProps = __assign(__assign({}, this.props), { data: __assign({ api: api, labelField: labelField, valueField: valueField }, (_a = this.props) === null || _a === void 0 ? void 0 : _a.data) });
            return (React.createElement("div", { className: cx('ae-OptionControl', className) },
                this.renderHeader(),
                source === 'custom' ? React.createElement(Cmpt, __assign({}, cmptProps)) : null,
...
var TransferTableOption = /** @class */ (function (_super) {
                                ...
                                body: [
                                    {
                                        ...
                                        addButtonText: '新增',
                                        value: options,
                                        items: __spreadArray(__spreadArray([], __read(columns.map(function (item) { var _a; return renderInput(item.name, (_a = item.label) !== null && _a !== void 0 ? _a : '', false); })), false), [
    ...
    TransferTableOption.prototype.render = function () {
        return (React.createElement("div", { className: "ae-OptionControl-footer" },
...
export default TransferTableOption;
...
var TransferTableControlRenderer = /** @class */ (function (_super) {
    ...
    TransferTableControlRenderer = __decorate([
        FormItem({
...
export { TransferTableControlRenderer };

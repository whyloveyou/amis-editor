...
import { autobind, render as renderAmis } from 'amis-core';
...
var TextareaFormulaControl = /** @class */ (function (_super) {
    ...
    TextareaFormulaControl.prototype.handleEditorMounted = function (cm, editor) {
        ...
        this.editorPlugin = new FormulaPlugin(editor, {
            getProps: function () { return (__assign(__assign({}, _this.props), { variables: variables })); },
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        return [3 /*break*/, 4];
                    case 4: return [4 /*yield*/, getVariables(this)];
                    case 5:
    ...
    TextareaFormulaControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('ae-TextareaFormulaControl', {
                'is-fullscreen': this.state.isFullscreen
            }, className), ref: this.wrapRef },
            React.createElement("div", { className: cx('ae-TextareaResultBox'), style: resultBoxStyle },
                React.createElement(CodeMirrorEditor, { className: "ae-TextareaResultBox-editor", value: this.props.value, onChange: this.handleOnChange, editorFactory: this.editorFactory, editorDidMount: this.handleEditorMounted, onBlur: this.editorAutoMark }),
                !this.props.value && (React.createElement("div", { className: "ae-TextareaResultBox-placeholder" }, placeholder)),
                React.createElement("ul", { className: "ae-TextareaResultBox-footer" },
                    React.createElement("li", { className: "ae-TextareaResultBox-footer-fullscreen" },
                        React.createElement("a", { className: cx('Modal-fullscreen'), "data-tooltip": isFullscreen ? '退出全屏' : '全屏', "data-position": "top", onClick: this.handleFullscreenModeChange },
                            React.createElement(Icon, { icon: isFullscreen ? 'compress-alt' : 'expand-alt', className: "icon" }))),
                    React.createElement("li", { className: cx('ae-TextareaResultBox-footer-fxIcon', {
                            'is-loading': loading
                        }) }, loading ? (React.createElement(Spinner, { show: true, icon: "reload", size: "sm" })) : (React.createElement("a", { "data-tooltip": "\u8868\u8FBE\u5F0F", "data-position": "top", onClick: this.handleFormulaClick },
                        React.createElement(Icon, { icon: "input-add-fx", className: "icon" })))),
                    Array.isArray(additionalMenus) &&
                        ...
                        (additionalMenus === null || additionalMenus === void 0 ? void 0 : additionalMenus.map(function (item, i) {
                            return (React.createElement("li", { key: i }, item.icon ? (React.createElement("a", { "data-tooltip": item.label, "data-position": "top", onClick: function (e) { return _this.handleAddtionalMenuClick(e, item); } }, renderAmis({
                                type: 'icon',
                                icon: item.icon,
                                vendor: '',
                                className: item.className
                            }))) : (React.createElement("a", { onClick: function (e) { return _this.handleAddtionalMenuClick(e, item); } }, item.label))));
                        })))),
            !!onOverallClick ? (React.createElement("div", { className: cx('ae-TextareaResultBox-overlay'), onClick: onOverallClick })) : null,
            React.createElement(TooltipWrapper, { container: function () { return findDOMNode(_this); }, trigger: "hover", placement: "top", style: { fontSize: '12px' }, tooltip: {
                    tooltipTheme: 'dark',
                    children: function () { return renderFormulaValue(highlightValue); }
                } },
                React.createElement("div", { className: "ae-TplFormulaControl-tooltip", style: tooltipStyle, ref: this.tooltipRef, onClick: function (e) { return _this.handleFormulaClick(e, 'update'); } })),
            formulaPickerOpen ? (React.createElement(FormulaPickerCmp, __assign({}, this.props, { value: formulaPickerValue, initable: true, variables: variables, header: header, variableMode: rest.variableMode, evalMode: true, onClose: this.closeFormulaPicker, onConfirm: this.handleConfirm }))) : null));
    };
...
var TextareaFormulaControlRenderer = /** @class */ (function (_super) {
    ...
    TextareaFormulaControlRenderer = __decorate([
        FormItem({
...
export default TextareaFormulaControlRenderer;

...
var TableViewEditor = /** @class */ (function (_super) {
    ...
    TableViewEditor.prototype.markSelectingCell = function () {
        ...
        var _this = this;
        // 首先，查找最小和最大的行和列
        var _c = this.findFirstAndLastCell(), minRow = _c.minRow, minCol = _c.minCol, maxRow = _c.maxRow, maxCol = _c.maxCol;
        try {
    ...
    TableViewEditor.prototype.render = function () {
        var _this = this;
        var _a = this.props, children = _a.children, schema = _a.schema;
        ...
        return (React.createElement("div", { className: "ae-TableViewEditor", ref: this.tableViewWrapperRef, style: schema === null || schema === void 0 ? void 0 : schema.style },
            children,

...
var SwitchMore = /** @class */ (function (_super) {
        ...
        if (bulk) {
            ...
            // 取消选中后，将所有字段重置
                ...
                var values = clearChildValuesOnOff
                    ? fromPairs(this.getFormItemNames().map(function (i) { return [i, undefined]; }))
                    : {};
    ...
    SwitchMore.prototype.renderForm = function () {
        ...
        return __assign({ type: 'form', wrapWithPanel: false, panelClassName: 'border-none shadow-none mb-0', actionsClassName: 'border-none mt-2.5', wrapperComponent: 'div', mode: 'horizontal', horizontal: {
                justify: true,
                left: 4

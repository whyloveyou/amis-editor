...
import { DSFeature, DSFeatureEnum } from '../../builder';
...
var CRUDToolbarControl = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        headerToolbarSchema = cloneDeep(ctx.headerToolbar);
                        if (confirmed) {
                            marked = deepRemove(headerToolbarSchema, function (item) { return item.behavior === option.value; });
                            if (marked) {
    ...
    CRUDToolbarControl.prototype.renderHeader = function () {
        ...
        return (React.createElement("header", { className: cx('ae-CRUDConfigControl-header') },
            React.createElement("span", { className: cx('Form-label') }, "\u5DE5\u5177\u680F"),
    ...
    CRUDToolbarControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('ae-CRUDConfigControl') }, loading ? (React.createElement(Spinner, { show: true, tip: "\u64CD\u4F5C\u751F\u6210\u4E2D", tipPlacement: "bottom", size: "sm", className: cx('flex') })) : (React.createElement(React.Fragment, null,
            this.renderHeader(),
            React.createElement("ul", { className: cx('ae-CRUDConfigControl-list') }, Array.isArray(options) && options.length > 0 ? (options.map(function (item, index) {
...
var CRUDToolbarControlRenderer = /** @class */ (function (_super) {
    ...
    CRUDToolbarControlRenderer = __decorate([
        FormItem({
...
export { CRUDToolbarControlRenderer };

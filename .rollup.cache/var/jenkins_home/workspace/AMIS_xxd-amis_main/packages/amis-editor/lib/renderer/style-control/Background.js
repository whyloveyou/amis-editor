...
var Background = function (props) {
    ...
    function handleChange(key, keyValue) {
        ...
        if (key === 'backgroundColor') {
            result = __assign(__assign({}, omit(value, [
                'backgroundImage',
                'backgroundPosition',
                'backgroundSize',
                'backgroundRepeat',
            ...
            result = __assign(__assign({}, value), { backgroundImage: backgroundImage });
        }
        else {
    ...
    return (React.createElement("div", { className: "ae-Background" },
        React.createElement("div", { className: "ae-Background_tabs" },
            ...
            React.createElement("div", { className: "ae-Background_tabs-content" },
                currentItem === 'pure' && (React.createElement("div", { className: "ae-Background_setting" }, render('backgroundColor', {
                    type: 'input-color',
                    label: '背景色',
                    format: 'rgba',
                    mode: 'normal',
                ...
                currentItem === 'gradient' && (React.createElement("div", { className: "ae-Background_setting" },
                    React.createElement("div", { className: "ae-Background_setting-item" },
                        React.createElement("div", { className: "ae-Background_setting-item_color" }, render('prev', {
                            type: 'input-color',
                            label: '开始颜色',
                            clearable: false,
                            placeholder: '起始色',
                        ...
                        React.createElement("div", { className: "ae-Background_setting-item_color" }, render('next', {
                            type: 'input-color',
                            label: '结束颜色',
                            clearable: false,
                            placeholder: '结束色',
                    ...
                    React.createElement("div", { className: "ae-Background_setting-item" }, render('gradient', {
                        type: 'input-number',
                        label: '渐变角度',
                        mode: 'row',
                        step: 10,

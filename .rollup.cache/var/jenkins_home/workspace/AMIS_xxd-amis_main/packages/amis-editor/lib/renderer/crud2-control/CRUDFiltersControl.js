...
import { FormItem, Button, Icon, toast, Switch, Spinner, Tag, autobind } from 'amis';
...
var CRUDFiltersControl = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 7];
                    case 3:
                        if (!(feat === DSFeatureEnum.AdvancedQuery &&
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 7];
                    case 5:
                        if (!(feat === DSFeatureEnum.FuzzyQuery &&
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        config = _h.sent();
                        filterSchema = cloneDeep((CRUDSchema === null || CRUDSchema === void 0 ? void 0 : CRUDSchema.filter)
                            ? Array.isArray(CRUDSchema.filter)
                    ...
                    case 2:
                        ...
                        newFilterSchema = traverseSchemaDeep(filterSchema, function (key, value, host) {
                            ...
                            if (key === 'behavior' && Array.isArray(value)) {
                                return [
                                    key,
                                    uniq(__spreadArray(__spreadArray([], __read(value), false), [DSFeatureEnum.SimpleQuery], false).filter(Boolean))
                                ];
                            }
                            /** 更新内容区 */
                            if (key === 'body' &&
                    ...
                    case 3:
                        newFilterSchema = traverseSchemaDeep(filterSchema, function (key, value, host) {
                            ...
                            if (key === 'behavior' && Array.isArray(value)) {
                                return [
                                    key,
                                    value.filter(function (i) { return i !== DSFeatureEnum.SimpleQuery; })
                                ];
                            }
                            /** 更新内容区 */
                            if (key === 'body' &&
                                ...
                                return [
                                    key,
                                    value.filter(function (item) { return (item === null || item === void 0 ? void 0 : item.behavior) !== DSFeatureEnum.SimpleQuery; })
                                ];
                            }
                            return [key, value];
                        });
                    ...
                    case 7:
                        ...
                        CRUDNode.updateSchema(__assign(__assign({}, CRUDSchema), { filter: isArrayFilter ? newFilterSchema : filter }));
                        _h.label = 8;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        CRUDNode = store.getNodeById(nodeId);
                        CRUDSchema = CRUDNode === null || CRUDNode === void 0 ? void 0 : CRUDNode.schema;
                        filterSchema = cloneDeep(Array.isArray(CRUDSchema.filter)
                    ...
                    case 1:
                        ...
                        newFilterSchema = traverseSchemaDeep(filterSchema, function (key, value, host) {
                            ...
                            if (key === 'behavior' && Array.isArray(value)) {
                                return [
                                    key,
                                    uniq(__spreadArray(__spreadArray([], __read(value), false), [DSFeatureEnum.AdvancedQuery], false).filter(Boolean))
                                ];
                            }
                            /** 更新内容区 */
                            if (key === 'body' &&
                    ...
                    case 2:
                        newFilterSchema = traverseSchemaDeep(filterSchema, function (key, value, host) {
                            ...
                            if (key === 'behavior' && Array.isArray(value)) {
                                return [
                                    key,
                                    value.filter(function (i) { return i !== DSFeatureEnum.AdvancedQuery; })
                                ];
                            }
                            /** 更新内容区 */
                            if (key === 'body' &&
                                ...
                                return [
                                    ...
                                    value.filter(function (item) {
                                        return (item === null || item === void 0 ? void 0 : item.behavior) !== DSFeatureEnum.AdvancedQuery &&
            ...
            return __generator(this, function (_p) {
                switch (_p.label) {
                        ...
                        if (!enable) {
                            if (headerToolbar) {
                                deepRemove(headerToolbar, function (schema) {
                                    return (schema.behavior === DSFeatureEnum.FuzzyQuery &&
                                        schema.type === 'search-box');
                                }, true);
                                CRUDNode.updateSchema(__assign(__assign({}, CRUDSchema), { headerToolbar: headerToolbar }));
                            }
                            return [2 /*return*/];
                        }
                    ...
                    case 8:
                        ...
                        CRUDNode.updateSchema(__assign(__assign({}, CRUDSchema), { headerToolbar: newHeaderToolbar }));
                        _p.label = 9;
    ...
    CRUDFiltersControl.prototype.renderOption = function (item, index) {
        ...
        return (React.createElement("li", { key: index, className: cx('ae-CRUDConfigControl-list-item') },
            ...
            React.createElement("div", { className: cx('ae-CRUDConfigControl-list-item-actions') },
                ((_b = item === null || item === void 0 ? void 0 : item.context) === null || _b === void 0 ? void 0 : _b.isCascadingField) ? (React.createElement(Tag, { label: (_c = item === null || item === void 0 ? void 0 : item.context) === null || _c === void 0 ? void 0 : _c.modelLabel, displayMode: "normal", className: cx('ae-CRUDConfigControl-list-item-tag', 'ae-CRUDConfigControl-list-item-tag--cascading') })) : null,
                feat === 'SimpleQuery' ? (React.createElement(Button, { level: "link", size: "sm", tooltip: {
                        content: '去编辑',
                        tooltipTheme: 'dark',
                        style: { fontSize: '12px' }
                    }, onClick: function () { return _this.handleEdit(item); } },
                    React.createElement(Icon, { icon: "column-setting", className: cx('icon') }))) : null)));
    };
    CRUDFiltersControl.prototype.renderHeader = function () {
        ...
        return (React.createElement("header", { className: cx('ae-CRUDConfigControl-header', 'mb-2') },
            React.createElement("span", { className: cx('Form-label') }, label),
            React.createElement("div", { className: cx('ae-CRUDConfigControl-header-actions') },
                React.createElement(Switch, { className: cx('ae-CRUDConfigControl-header-actions-switch'), key: "switch", size: "sm", classPrefix: ns, value: checked, onChange: this.handleToggle }),
                React.createElement("div", { className: cx('ae-CRUDConfigControl-header-actions-divider') }),
                React.createElement(Button, { level: "link", size: "sm", tooltip: {
                        content: '去编辑目标组件',
                        tooltipTheme: 'dark',
                        style: { fontSize: '12px' }
                    }, onClick: function () { return _this.handleEdit(); } },
                    React.createElement(Icon, { icon: "share-link", className: cx('icon'), style: { width: '16px', height: '16px' } })))));
    };
    CRUDFiltersControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('ae-CRUDConfigControl') },
            this.renderHeader(),
            React.createElement("ul", { className: cx('ae-CRUDConfigControl-list') }, loading ? (React.createElement(Spinner, { show: true, tip: "\u5B57\u6BB5\u52A0\u8F7D\u4E2D", tipPlacement: "bottom", size: "sm", className: cx('flex') })) : Array.isArray(options) && options.length > 0 ? (options.map(function (item, index) {
                return _this.renderOption(item, index);
            })) : (React.createElement("p", { className: cx("ae-CRUDConfigControl-placeholder") }, "\u6682\u65E0\u5B57\u6BB5")))));
    };
    __decorate([
        autobind,
...
var CRUDFiltersControlRenderer = /** @class */ (function (_super) {
    ...
    CRUDFiltersControlRenderer = __decorate([
        FormItem({
...
export { CRUDFiltersControlRenderer };

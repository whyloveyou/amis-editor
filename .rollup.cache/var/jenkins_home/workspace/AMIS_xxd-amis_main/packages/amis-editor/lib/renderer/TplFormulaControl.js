...
var TplFormulaControl = /** @class */ (function (_super) {
    ...
    TplFormulaControl.prototype.checkOpenFormulaPicker = function (value) {
        ...
        if (/\$|\{|\}$/.test(inputText)) {
            if (/\$\{\}/.test(inputText)) {
                ...
                preInputLocation = __assign(__assign({ start: left }, preInputLocation), { end: end });
            }
        }
        else {
            preInputLocation = null;
    ...
    TplFormulaControl.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, header = _a.header, label = _a.label, placeholder = _a.placeholder, customFormulaPicker = _a.customFormulaPicker, clearable = _a.clearable, rest = __rest(_a, ["className", "header", "label", "placeholder", "customFormulaPicker", "clearable"]);
        ...
        return (React.createElement("div", { className: cx('ae-TplFormulaControl', className, {
                clearable: clearable
            }), ref: this.wrapRef },
            React.createElement("div", { className: cx('ae-TplResultBox') },
                React.createElement(CodeMirrorEditor, { className: "ae-TplResultBox-editor", value: this.props.value, onChange: this.handleOnChange, editorFactory: this.editorFactory, editorDidMount: this.handleEditorMounted, onBlur: this.editorAutoMark }),
                !this.props.value && (React.createElement("div", { className: "ae-TplFormulaControl-placeholder" }, placeholder)),
                clearable && this.props.value && (React.createElement(Icon, { icon: "input-clear", className: "input-clear-icon", iconContent: "InputText-clear", onClick: this.handleClear }))),
            React.createElement(Button, { className: "ae-TplFormulaControl-button", size: "sm", tooltip: {
                    enterable: false,
                    content: '点击配置表达式',
                    tooltipTheme: 'dark',
                    placement: 'left',
                ...
                React.createElement(Icon, { icon: "input-add-fx", className: cx('ae-TplFormulaControl-icon', 'icon') })),
            React.createElement(TooltipWrapper, { trigger: "hover", placement: "top", style: { fontSize: '12px' }, tooltip: {
                    tooltipTheme: 'dark',
            ...
            formulaPickerOpen ? (React.createElement(FormulaPickerCmp, __assign({}, this.props, { value: formulaPickerValue, initable: true, header: header, variables: variables, variableMode: rest.variableMode, evalMode: true, onClose: this.closeFormulaPicker, onConfirm: this.handleConfirm }))) : null));
    };
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [MouseEvent, String, Array]),
...
var TplFormulaControlRenderer = /** @class */ (function (_super) {
    ...
    TplFormulaControlRenderer = __decorate([
        FormItem({
...
export default TplFormulaControlRenderer;

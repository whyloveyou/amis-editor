...
setSchemaTpl('layout:position', function (config) {
    var configSchema = {
        type: 'select',
        label: (config === null || config === void 0 ? void 0 : config.label) || tipedLabel('定位模式', '指定当前容器元素的定位类型'),
...
setSchemaTpl('layout:inset', function (config) {
    ...
    var configSchema = {
        ...
        label: (config === null || config === void 0 ? void 0 : config.label) ||
            tipedLabel('布局位置', '指定当前容器元素的定位位置，用于配置 top、right、bottom、left。'),
...
setSchemaTpl('layout:z-index', function (config) {
    ...
    var configSchema = {
        type: 'input-number',
        label: (config === null || config === void 0 ? void 0 : config.label) ||
            tipedLabel('显示层级', '指定元素的堆叠顺序，层级高的元素总是会处于较低层级元素的上面。'),
...
setSchemaTpl('layout:display', function (config) {
    ...
    var configSchema = {
        ...
        label: (config === null || config === void 0 ? void 0 : config.label) ||
            tipedLabel('显示类型', '默认为块级，可设置为弹性布局模式（flex布局容器）'),
...
setSchemaTpl('layout:flexDirection', function (config) {
    var configSchema = {
        type: 'select',
        label: (config === null || config === void 0 ? void 0 : config.label) ||
            tipedLabel('排列方向', '设置成水平排列方向，则从左到右放置子项；设置成垂直排列方向，则从上到下放置子项'),
...
setSchemaTpl('layout:flex-basis', function (config) {
    ...
    return {
        type: 'input-number',
        label: tipedLabel((config === null || config === void 0 ? void 0 : config.label) || '默认宽度', '在分配多余空间之前，其默认占据的主轴空间（main size）'),
...
setSchemaTpl('layout:flex-grow', function (config) {
    return {
        ...
        step: 1,
        label: (config === null || config === void 0 ? void 0 : config.label) ||
            tipedLabel('弹性比例', '定义项目的放大比例，如果设置为0，即使父容器存在剩余空间，也不放大。'),
...
setSchemaTpl('layout:originPosition', function (config) {
    ...
    var configSchema = {
        type: 'select',
        label: (config === null || config === void 0 ? void 0 : config.label) ||
            tipedLabel('参考位置', '可设置为左上角、右上角、右下角、左下角，默认为右下角'),
...
setSchemaTpl('layout:sticky', {
    type: 'switch',
    label: tipedLabel('滚动吸附', '开启滚动吸附后，当滚动至父容器上下边沿时会自动开启吸附模式。'),
    name: 'stickyStatus',
    inputClassName: 'inline-flex justify-between',
    onChange: function (value, oldValue, model, form) {
        if (value) {

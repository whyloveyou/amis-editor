...
var InputRangeValue = function (props) {
    ...
    /** 转化成对象格式 */
    var pipeInValue = useCallback(function (value) {
        var _a, _b, _c;
        if (!value) {
            return _a = {}, _a[minField] = undefined, _a[maxField] = undefined, _a;
        }
        if (typeof value === 'string') {
            var _d = __read(value.split(delimiter), 2), lhs = _d[0], rhs = _d[1];
    ...
    var handleSubmit = useCallback(function (value, action) {
        var _a;
    ...
    return (React.createElement(React.Fragment, null, render('input-range-value-control', {
        type: 'form',
        wrapWithPanel: false,
...
var InputRangeValueRenderer = /** @class */ (function (_super) {
    __extends(InputRangeValueRenderer, _super);
    function InputRangeValueRenderer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    InputRangeValueRenderer.prototype.render = function () {
        return React.createElement(InputRangeValue, __assign({}, this.props));
    };
    InputRangeValueRenderer = __decorate([
        FormItem({ type: 'ae-input-range-value' })
    ], InputRangeValueRenderer);
    return InputRangeValueRenderer;
}(React.Component));
export default InputRangeValueRenderer;

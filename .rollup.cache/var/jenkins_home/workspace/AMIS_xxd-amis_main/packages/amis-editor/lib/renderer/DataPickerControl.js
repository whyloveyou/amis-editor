...
var DataPickerControl = /** @class */ (function (_super) {
    ...
    DataPickerControl.prototype.render = function () {
        ...
        return (React.createElement(FormulaPicker, __assign({}, this.props, { onPickerOpen: this.handlePickerOpen, evalMode: false, onConfirm: this.handleConfirm, value: value, onChange: function () { }, header: '' }), function (_a) {

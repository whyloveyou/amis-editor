...
amisEditorCore.setSchemaTpl('formItemMode', function (config) {
  ...
  return {
    ...
    name: 'mode',
    type: 'select',
    pipeIn: amisEditorCore.defaultValue((_a = config === null || config === void 0 ? void 0 : config.defaultValue) !== null && _a !== void 0 ? _a : ''),
    options: [{
...
amisEditorCore.setSchemaTpl('expressionFormulaControl', function (schema) {
  if (schema === void 0) {
    schema = {};
  }
  return tslib.__assign({
...
amisEditorCore.setSchemaTpl('textareaFormulaControl', function (schema) {
  if (schema === void 0) {
    schema = {};
  }
  return tslib.__assign({
...
amisEditorCore.setSchemaTpl('tplFormulaControl', function (schema) {
  if (schema === void 0) {
    schema = {};
  }
  return tslib.__assign({
...
amisEditorCore.setSchemaTpl('DataPickerControl', function (schema) {
  if (schema === void 0) {
    schema = {};
  }
  return tslib.__assign({
...
amisEditorCore.setSchemaTpl('formItemSize', {
  ...
  options: [{
    ...
    label: i18nRuntime.i18n("4a12e9b9fc5443e5e9999b5a7c56c19a"),
    value: 'full'
  }]
});
...
/** 文件上传按钮名称 btnLabel */
amisEditorCore.setSchemaTpl('btnLabel', {
  type: 'input-text',
  name: 'btnLabel',
  label: i18nRuntime.i18n("cf6e87cb9edfa398ccfc3db377e34ca4"),
  value: i18nRuntime.i18n("481e034e6026969aae4ce7ce7c8a7b6f")
});
...
amisEditorCore.setSchemaTpl('startPlaceholder', {
  type: 'input-text',
  name: 'startPlaceholder',
  label: i18nRuntime.i18n("2f92fc7bf6ef3dd57c514d0797fe2f1e"),
  pipeIn: amisEditorCore.defaultValue(i18nRuntime.i18n("592c59589144ddc68d05d528da17dcdc"))
});
amisEditorCore.setSchemaTpl('endPlaceholder', {
  type: 'input-text',
  name: 'endPlaceholder',
  label: i18nRuntime.i18n("a04c4894d83323d187f65cc357fa646e"),
  pipeIn: amisEditorCore.defaultValue(i18nRuntime.i18n("f782779e8b5d709462c8e71e0d9019f2"))
});
...
amisEditorCore.setSchemaTpl('valueFormula', function (config) {
  ...
  return {
    ...
    body: [amisEditorCore.getSchemaTpl('formulaControl', tslib.__assign({
      ...
      DateTimeType: DateTimeType !== null && DateTimeType !== void 0 ? DateTimeType : FormulaControl.FormulaDateType.NotDate
    }, rest))]
  };
});
...
amisEditorCore.setSchemaTpl('optionsMenuTpl', function (config) {
  var manager = config.manager,
    rest = tslib.__rest(config, ["manager"]);
  // 设置 options 中变量集合
  function getOptionVars(that) {
    ...
    if (schema.labelField) {
      children.push({
        label: i18nRuntime.i18n("7e9c83e86beb612377a94e6e8d1fc644"),
    ...
    if (schema.options) {
      ...
      children.push.apply(children, tslib.__spreadArray([], tslib.__read(otherItem), false));
    }
    var variablesArr = [{
      label: i18nRuntime.i18n("fb7ea2b05ca7328ee16a562d90c2eb96"),
      children: children
    }];
    return variablesArr;
  }
  return amisEditorCore.getSchemaTpl('textareaFormulaControl', tslib.__assign({
    mode: 'normal',
    label: amisEditorCore.tipedLabel(i18nRuntime.i18n("1ca87f0171481e27d94e81b477150b7d"), i18nRuntime.i18n("d6ecb32a380c91887a9346653c2427e9")),
    name: 'menuTpl',
 ...
 * 数据源绑定
 */
amisEditorCore.setSchemaTpl('sourceBindControl', function (schema) {
  if (schema === void 0) {
    schema = {};
  }
  return tslib.__assign({
    ...
    placeholder: i18nRuntime.i18n("052f7eec7ca35a6b4d72d169ee1de494"),
    requiredDataPropsVariables: true
  }, schema);
});
amisEditorCore.setSchemaTpl('menuTpl', function () {
  return amisEditorCore.getSchemaTpl('textareaFormulaControl', {
    mode: 'normal',
    label: amisEditorCore.tipedLabel(i18nRuntime.i18n("59cf15fe6b8d659c9bd2f86143534a06"), i18nRuntime.i18n("d6ecb32a380c91887a9346653c2427e9")),
    name: 'menuTpl'
  });
});
...
amisEditorCore.setSchemaTpl('onlyClassNameTab', function (label) {
  if (label === void 0) {
...
amisEditorCore.setSchemaTpl('combo-container', function (config) {
  ...
  if (amisEditorCore.isObject(config)) {
    ...
    return tslib.__assign(tslib.__assign(tslib.__assign({}, config), itemsWrapperClassName ? {
...
amisEditorCore.setSchemaTpl('static', {
  type: 'ae-StatusControl',
...
amisEditorCore.setSchemaTpl('nav-badge', {
  label: i18nRuntime.i18n("b8c467fce096a649583c0bc9d9281a5c"),
  name: 'badge',
  type: 'ae-nav-badge'
});
amisEditorCore.setSchemaTpl('nav-default-active', {
...
amisEditorCore.setSchemaTpl('data', {
  type: 'input-kv',
  name: 'data',
  label: i18nRuntime.i18n("c70638412c6cffd150117ae403dea939")
});
...
amisEditorCore.setSchemaTpl('iconLink', function (schema) {
  var name = schema.name,
    ...
    label = schema.label;
  return amisEditorCore.getSchemaTpl('icon', {
    name: name,
    visibleOn: visibleOn,
    label: label !== null && label !== void 0 ? label : i18nRuntime.i18n("5ef69f62dc668c1a3e68b51c50a2530a"),
    placeholder: i18nRuntime.i18n("b7dee01f2d085d90c47bcb8b490d9055"),
    clearable: true,
    description: ''
  });
});
amisEditorCore.setSchemaTpl('virtualThreshold', {
  name: 'virtualThreshold',
  type: 'input-number',
  min: 1,
  step: 1,
  precision: 0,
  label: amisEditorCore.tipedLabel(i18nRuntime.i18n("03bfb834c8a5fef58d885e448a4e13b4"), i18nRuntime.i18n("50437e080edc71ab624c93d419472919")),
  pipeOut: function (value) {
    return value || undefined;
  }
});
amisEditorCore.setSchemaTpl('virtualItemHeight', {
  name: 'itemHeight',
  type: 'input-number',
  min: 1,
  step: 1,
  precision: 0,
  label: amisEditorCore.tipedLabel(i18nRuntime.i18n("02b9880e1d2df8a07e90e9878080c739"), i18nRuntime.i18n("a3f66655c3d2bcfecc6afba0e4424460")),
  pipeOut: function (value) {
    return value || undefined;
  }
});
amisEditorCore.setSchemaTpl('pageTitle', {
  label: i18nRuntime.i18n("8d6b5924f187048cfa28d6c21fa6d2d6"),
  name: 'title',
  type: 'input-text'
});
amisEditorCore.setSchemaTpl('pageSubTitle', {
  label: i18nRuntime.i18n("72cf373be86a38b29f6d2f15900b0da1"),
  name: 'subTitle',
  type: 'textarea'
});
amisEditorCore.setSchemaTpl('textareaDefaultValue', function () {
  return amisEditorCore.getSchemaTpl('textareaFormulaControl', {
...
amisEditorCore.setSchemaTpl('prefix', {
  type: 'input-text',
  name: 'prefix',
  label: amisEditorCore.tipedLabel(i18nRuntime.i18n("4c9bb42608b11278a5d9a2471b74eb40"), i18nRuntime.i18n("925d31bb30d63576600299475a910c33"))
});
amisEditorCore.setSchemaTpl('suffix', {
  type: 'input-text',
  name: 'suffix',
  label: amisEditorCore.tipedLabel(i18nRuntime.i18n("242d641eab57223af01fb29940a096ed"), i18nRuntime.i18n("42677544e2cbee28f7e7df216e685543"))
});
amisEditorCore.setSchemaTpl('unit', {
  type: 'input-text',
  name: 'unit',
  label: i18nRuntime.i18n("f2996845b6bf0a07fe26f74f35e42ebe"),
  value: ''
});
amisEditorCore.setSchemaTpl('optionsTip', {
  type: 'input-text',
  name: 'optionsTip',
  label: i18nRuntime.i18n("9888468550779b1777260b8fafe6abc2"),
  value: i18nRuntime.i18n("a2cbb42e488dffe644bdb87c26afbc07")
});
amisEditorCore.setSchemaTpl('tableCellRemark', {
  name: 'remark',
  label: i18nRuntime.i18n("02d9819ddaaaeb1b7b22b12608c7e5ca"),
  type: 'input-text',
  description: i18nRuntime.i18n("45882ddedb42c1a38462949750bc8a84")
});
amisEditorCore.setSchemaTpl('tableCellPlaceholder', {
  name: 'placeholder',
  type: 'input-text',
  label: i18nRuntime.i18n("4c1cff4d8c05daa6ed9352a241ee628c"),
  value: '-',
  description: i18nRuntime.i18n("ff88d5db9d61f14bce6e3397fd4652a5")
});
amisEditorCore.setSchemaTpl('title', {
  type: 'input-text',
  name: 'title',
  label: i18nRuntime.i18n("32c65d8d7431e76029678ec7bb73a5ab")
});
amisEditorCore.setSchemaTpl('caption', {
  type: 'input-text',
  name: 'caption',
  label: i18nRuntime.i18n("32c65d8d7431e76029678ec7bb73a5ab")
});
amisEditorCore.setSchemaTpl('imageCaption', {
  type: 'input-text',
  name: 'imageCaption',
  label: i18nRuntime.i18n("098c3d959911b48b4d912cb85ccc4942")
});
amisEditorCore.setSchemaTpl('inputBody', {
  type: 'input-text',
  name: 'body',
...
amisEditorCore.setSchemaTpl('stepSubTitle', {
  type: 'input-text',
  name: 'subTitle',
  label: false,
  placeholder: i18nRuntime.i18n("72cf373be86a38b29f6d2f15900b0da1")
});
amisEditorCore.setSchemaTpl('stepDescription', {
  type: 'input-text',
  name: 'description',
  label: false,
  placeholder: i18nRuntime.i18n("3bdd08adab6ea90b9164b20a0e4151ac")
});
amisEditorCore.setSchemaTpl('taskNameLabel', {
  type: 'input-text',
  name: 'taskNameLabel',
...
amisEditorCore.setSchemaTpl('operationLabel', {
  type: 'input-text',
  name: 'operationLabel',
...
amisEditorCore.setSchemaTpl('statusLabel', {
  type: 'input-text',
  name: 'statusLabel',
...
amisEditorCore.setSchemaTpl('remarkLabel', {
  type: 'input-text',
  name: 'remarkLabel',
...
amisEditorCore.setSchemaTpl('inputArrayItem', {
  type: 'input-text',
  placeholder: i18nRuntime.i18n("d7ec2d3fea4756bc1642e0f10c180cf5")
});
amisEditorCore.setSchemaTpl('actionPrevLabel', {
  type: 'input-text',
...
amisEditorCore.setSchemaTpl('actionNextLabel', {
  type: 'input-text',
...
amisEditorCore.setSchemaTpl('actionNextSaveLabel', {
  type: 'input-text',
...
amisEditorCore.setSchemaTpl('actionFinishLabel', {
  type: 'input-text',
...
amisEditorCore.setSchemaTpl('imgCaption', {
  type: 'textarea',
  name: 'caption',
  label: i18nRuntime.i18n("098c3d959911b48b4d912cb85ccc4942")
});
amisEditorCore.setSchemaTpl('taskRemark', {
  type: 'textarea',
  name: 'remark',
  label: i18nRuntime.i18n("1d35dcbf191e36dcc6c15f71277d72ed")
});
amisEditorCore.setSchemaTpl('tooltip', {
  type: 'textarea',
  name: 'tooltip',
  label: i18nRuntime.i18n("6f2b01db04cbf7e460b5c6f4e37a5e76")
});
amisEditorCore.setSchemaTpl('anchorTitle', {
  type: 'input-text',
  name: 'title',
  required: true,
  placeholder: i18nRuntime.i18n("8cfd149e7d73ebae6a797d21728292ff")
});
amisEditorCore.setSchemaTpl('avatarText', {
...
amisEditorCore.setSchemaTpl('cardTitle', {
  name: 'header.title',
  type: 'input-text',
  label: i18nRuntime.i18n("32c65d8d7431e76029678ec7bb73a5ab"),
  description: i18nRuntime.i18n("00a1f644f34b9ee43adf82cb3449158c")
});
amisEditorCore.setSchemaTpl('cardSubTitle', {
  name: 'header.subTitle',
  type: 'input-text',
  label: i18nRuntime.i18n("72cf373be86a38b29f6d2f15900b0da1"),
  description: i18nRuntime.i18n("00a1f644f34b9ee43adf82cb3449158c")
});
amisEditorCore.setSchemaTpl('cardsPlaceholder', {
  name: 'placeholder',
  value: i18nRuntime.i18n("21efd88b67a39834582ad99aabb9dc60"),
  type: 'input-text',
  label: i18nRuntime.i18n("35ba83e053cef95e55dfffde279822b5")
});
amisEditorCore.setSchemaTpl('cardDesc', {
  name: 'header.desc',
  type: 'textarea',
  label: i18nRuntime.i18n("3bdd08adab6ea90b9164b20a0e4151ac"),
  description: i18nRuntime.i18n("00a1f644f34b9ee43adf82cb3449158c")
});
amisEditorCore.setSchemaTpl('imageTitle', {
  type: 'input-text',
  label: i18nRuntime.i18n("c6c7456d446d62a906c2809b6ba19ce1"),
  name: 'title',
  visibleOn: 'this.type == "image"'
});
amisEditorCore.setSchemaTpl('imageDesc', {
  type: 'textarea',
  label: i18nRuntime.i18n("098c3d959911b48b4d912cb85ccc4942"),
  name: 'description',
  visibleOn: 'this.type == "image"'
});
amisEditorCore.setSchemaTpl('fetchSuccess', {
  label: i18nRuntime.i18n("fb24383a41f23196349548b5d0cb98ce"),
  type: 'input-text',
  name: 'fetchSuccess'
});
amisEditorCore.setSchemaTpl('fetchFailed', {
  label: i18nRuntime.i18n("62e3e15c8fb9038f2780329bc26e8bab"),
  type: 'input-text',
  name: 'fetchFailed'
});
amisEditorCore.setSchemaTpl('saveOrderSuccess', {
  label: i18nRuntime.i18n("c62a1b7f314be10aead10475e7543f6a"),
  type: 'input-text',
  name: 'saveOrderSuccess'
});
amisEditorCore.setSchemaTpl('saveOrderFailed', {
  label: i18nRuntime.i18n("c8035507b7a576d43e9f227c91c7a7b5"),
  type: 'input-text',
  name: 'saveOrderFailed'
});
amisEditorCore.setSchemaTpl('quickSaveSuccess', {
  label: i18nRuntime.i18n("7cb0932b806559be232d2a69453224e7"),
  type: 'input-text',
  name: 'quickSaveSuccess'
});
amisEditorCore.setSchemaTpl('quickSaveFailed', {
  label: i18nRuntime.i18n("fd79a193a487b8c9d5a302d0d88c1c2c"),
  type: 'input-text',
  name: 'quickSaveFailed'
});
amisEditorCore.setSchemaTpl('saveSuccess', {
  label: i18nRuntime.i18n("b66ef8966dad62d377bc5310d8b88e7f"),
  name: 'saveSuccess',
  type: 'input-text'
});
amisEditorCore.setSchemaTpl('saveFailed', {
  label: i18nRuntime.i18n("cf538bbe1fb431f9e2668da4d84cfadf"),
  name: 'saveFailed',
  type: 'input-text'
});
amisEditorCore.setSchemaTpl('validateFailed', {
  label: i18nRuntime.i18n("6509e435d66db2a105b2444b1d3d0db1"),
  name: 'validateFailed',
  type: 'input-text'
});
amisEditorCore.setSchemaTpl('tablePlaceholder', {
  name: 'placeholder',
  pipeIn: amisEditorCore.defaultValue(i18nRuntime.i18n("21efd88b67a39834582ad99aabb9dc60")),
  type: 'input-text',
  label: i18nRuntime.i18n("35ba83e053cef95e55dfffde279822b5")
});
amisEditorCore.setSchemaTpl('collapseOpenHeader', {
  name: 'collapseHeader',
  label: amisEditorCore.tipedLabel(i18nRuntime.i18n("81d2b9f20fb2083c75a5b052b84e897a"), i18nRuntime.i18n("7349194c139069b32889101768aa7428")),
  type: 'input-text'
});
amisEditorCore.setSchemaTpl('matrixColumnLabel', {
  type: 'input-text',
  name: 'label',
  placeholder: i18nRuntime.i18n("39886861ea5d8b526e0ac5ecc78d110c")
});
amisEditorCore.setSchemaTpl('matrixRowLabel', {
  type: 'input-text',
  name: 'label',
  placeholder: i18nRuntime.i18n("854af3c2cd9c275ac70fc5121ea4fb2e")
});
amisEditorCore.setSchemaTpl('matrixRowTitle', {
  name: 'rowLabel',
  label: i18nRuntime.i18n("34ad26bd1fb448c7f2384252d856c02b"),
  type: 'input-text'
});
amisEditorCore.setSchemaTpl('submitText', {
  name: 'submitText',
  label: i18nRuntime.i18n("60ad7d0d170b973ab9cdb0b23e636704"),
  type: 'input-text'
});
amisEditorCore.setSchemaTpl('tpl:btnLabel', {
  type: 'tpl',
  tpl: '<span class="label label-success">${label}</span>',
  columnClassName: 'p-t-xs'
});
amisEditorCore.setSchemaTpl('switchOption', {
  type: 'input-text',
  name: 'option',
  label: i18nRuntime.i18n("f411d0f1f925d9b48d8c1d451bd809b1")
});
amisEditorCore.setSchemaTpl('addOnLabel', {
  name: 'label',
  label: i18nRuntime.i18n("ca746b1ff10193a3ce20878dec04a733"),
  type: 'input-text'
});
amisEditorCore.setSchemaTpl('onText', {
  name: 'onText',
  type: 'input-text',
  label: i18nRuntime.i18n("c580bacf343343f04a1b551e46d02c4f")
});
amisEditorCore.setSchemaTpl('offText', {
  name: 'offText',
  type: 'input-text',
  label: i18nRuntime.i18n("9ff352ae39cdaeaa4fc54f83575eedc9")
});
amisEditorCore.setSchemaTpl('propertyTitle', {
  label: i18nRuntime.i18n("32c65d8d7431e76029678ec7bb73a5ab"),
  type: 'input-text',
  name: 'title'
});
amisEditorCore.setSchemaTpl('propertyLabel', {
  type: 'input-text',
  mode: 'inline',
  size: 'sm',
  label: i18nRuntime.i18n("ae41a992ccceb36f83024f72531186ec"),
  name: 'label'
});
amisEditorCore.setSchemaTpl('propertyContent', {
  type: 'input-text',
  mode: 'inline',
  size: 'sm',
  label: i18nRuntime.i18n("52dff5b153bb5eaca33a008458ce0209"),
  name: 'content'
});
amisEditorCore.setSchemaTpl('draggableTip', {
  type: 'input-text',
  name: 'draggableTip',
  label: amisEditorCore.tipedLabel(i18nRuntime.i18n("9b14c9051067bef2dd9a15683201dd18"), i18nRuntime.i18n("f41a714bc8b26dc27a93a07c44e329a8"))
});
amisEditorCore.setSchemaTpl('deleteConfirmText', {
  label: amisEditorCore.tipedLabel(i18nRuntime.i18n("0c15a924dc3bedefb79c958972bef2b9"), i18nRuntime.i18n("178bf4dd4b8d56370e2fc8275f9dc9e4")),
  name: 'deleteConfirmText',
  type: 'input-text',
  pipeIn: amisEditorCore.defaultValue(i18nRuntime.i18n("cb8f7758eb03574f9b8402659c0f02b2"))
});
amisEditorCore.setSchemaTpl('optionsLabel', {
  type: 'input-text',
  name: 'label',
  placeholder: i18nRuntime.i18n("d7ec2d3fea4756bc1642e0f10c180cf5"),
  required: true
});
amisEditorCore.setSchemaTpl('anchorNavTitle', {
  name: 'title',
  label: i18nRuntime.i18n("32c65d8d7431e76029678ec7bb73a5ab"),
  type: 'input-text',
  required: true

...
// 定位模式
amisEditorCore.setSchemaTpl('layout:position', function (config) {
  var configSchema = {
    type: 'select',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("b19b454fe603e03e98ad9772615c7c32"), i18nRuntime.i18n("8444f01399c0003fbb68eeff1310566c")),
    ...
    options: [{
      label: i18nRuntime.i18n("aae5ccb98564e19c48f19c740c3c10b7"),
      value: 'static'
    }, {
      label: i18nRuntime.i18n("5d721446605f21bddb3b8e2ab2a3841c"),
      value: 'relative'
    }, {
      label: i18nRuntime.i18n("b55b525d56fd0d4d3dcb9291e59e3433"),
      value: 'fixed'
    }, {
      label: i18nRuntime.i18n("25ece43050dda20ad4d8dd058dd590d1"),
      value: 'absolute'
    }]
  };
  if ((config === null || config === void 0 ? void 0 : config.mode) === 'vertical') {
    ...
    return {
      ...
      mode: 'vertical',
      visibleOn: config === null || config === void 0 ? void 0 : config.visibleOn,
      body: [tslib.__assign({}, configSchema)]
    };
  } else {
    // 默认左右展示
    return configSchema;
...
// inset 配置:
amisEditorCore.setSchemaTpl('layout:inset', function (config) {
  var _a;
  var configSchema = {
    type: 'inset-box-model',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("86a6b5a0a45bba5b6187cc2277e3375e"), i18nRuntime.i18n("6e72759ed1cbf9f9e8523197dd93888f")),
    ...
    pipeIn: function (value) {
      ...
      if (isNumber__default["default"](curValue)) {
        curValue = curValue.toString();
      }
      if (!isString__default["default"](curValue)) {
        curValue = '0';
      }
...
// z-index 配置:
amisEditorCore.setSchemaTpl('layout:z-index', function (config) {
  var _a;
  var configSchema = {
    type: 'input-number',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("8e903bee4578f72bbecf9eb62d7b875c"), i18nRuntime.i18n("6f649980c839dffca1506f20d534fe3d")),
...
amisEditorCore.setSchemaTpl('layout:display', function (config) {
  var configOptions = compact__default["default"]([{
    ...
    label: i18nRuntime.i18n("26b10072a4e0c8c9a3a1142db3d7b3b4"),
...
// 主轴排列方向
amisEditorCore.setSchemaTpl('layout:justifyContent', function (config) {
  var defaultOptions = [{
    ...
    label: i18nRuntime.i18n("d5a3cb1cc31a0469b011abdbd3e947f7"),
    value: 'space-around'
  }, {
    label: i18nRuntime.i18n("85530444a72a840ee657e2df99970136"),
    value: 'space-between'
  }, {
    label: i18nRuntime.i18n("9aad08fbd356fb4279f0efa81b3d016e"),
    value: 'space-evenly'
  }, {
    label: i18nRuntime.i18n("ae558cbf4c35d381b6542f517f2e8dff"),
    value: 'stretch'
  }];
  var configSchema = {
    type: 'select',
...
// 交叉轴排列方向
amisEditorCore.setSchemaTpl('layout:alignItems', function (config) {
  var defaultOptions = [{
    label: i18nRuntime.i18n("4ba6c2256050d805ae5cd1e0e84737cf"),
    value: 'flex-start'
  }, {
...
// 排列方向
amisEditorCore.setSchemaTpl('layout:flexDirection', function (config) {
  var configSchema = {
    type: 'select',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("78d32d2bd35c0262fe77b517c5a4fb62"), i18nRuntime.i18n("3fa460b81736c0360f6f7571801935b1")),
    ...
    options: [{
      ...
      label: i18nRuntime.i18n("fa228d6bec96d052de0ad369407f5241"),
      value: 'row-reverse'
    }, {
      label: i18nRuntime.i18n("75ac842f8e77305846f1d776f97dfaf8"),
      value: 'column'
    }, {
      label: i18nRuntime.i18n("2df3bc66ab3fcb0de1caf11831eff595"),
...
// 如何换行
amisEditorCore.setSchemaTpl('layout:flex-wrap', function (config) {
  return {
    type: 'select',
    label: (config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("98b2fea2d8f3ceb81e9ce32d66383f05"),
    ...
    pipeOut: config === null || config === void 0 ? void 0 : config.pipeOut,
    options: [{
      label: i18nRuntime.i18n("3b6e8d54b7b2ae890d5357b7eaaeaaf2"),
      value: 'nowrap'
    }, {
      label: i18nRuntime.i18n("452dba7c65211630f8066b070fdf157f"),
      value: 'wrap'
    }, {
      label: i18nRuntime.i18n("d4054144c4341872496e3550fdb1b826"),
      value: 'wrap-reverse'
    }]
  };
});
// 弹性模式
amisEditorCore.setSchemaTpl('layout:flex', function (config) {
  return {
    type: 'button-group-select',
    size: 'xs',
    name: (config === null || config === void 0 ? void 0 : config.name) || 'style.flex',
    options: [{
      label: i18nRuntime.i18n("091885db07e43ff7cbe60c3b664b0b50"),
      value: '1 1 auto'
    }, {
      label: i18nRuntime.i18n("1ef8fd21130d17cb7c1613eaed6ca1e4"),
      value: '0 0 150px'
    }, {
      label: i18nRuntime.i18n("363165ccee78341a65f1d42174e8b08f"),
      value: '0 0 auto'
    }],
    label: (config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("eb44269adb6ba70569cd62ea88cb2750"),
...
// flex-basis设置
amisEditorCore.setSchemaTpl('layout:flex-basis', function (config) {
  var _a;
  return {
    type: 'input-number',
    label: amisEditorCore.tipedLabel((config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("cf8852316501c22ea19c4e432c59e7d7"), i18nRuntime.i18n("abbd790f85282349e2004df9fd494e31")),
...
// flex-grow 弹性比例
amisEditorCore.setSchemaTpl('layout:flex-grow', function (config) {
  return {
    type: 'input-range',
    max: 12,
    step: 1,
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("9e7c8d1554f6449121a83f951cf21ca1"), i18nRuntime.i18n("eb7366583485f478e3d8c2b105ea51ff")),
...
amisEditorCore.setSchemaTpl('layout:isFixedWidth', function (config) {
  var _a;
  return {
    type: 'button-group-select',
    label: (config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("a170a375b264f7fe0c02a7ca8c268784"),
    size: 'xs',
...
// 宽度设置
amisEditorCore.setSchemaTpl('layout:width', function (config) {
  var _a;
  return {
    type: 'input-number',
    label: (config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("c28479019e24e0e4745f4948e9e97ee7"),
...
// 宽度设置(不关联固定宽度配置项)
amisEditorCore.setSchemaTpl('layout:width:v2', function (config) {
  var _a;
  return {
    type: 'input-number',
    label: (config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("c28479019e24e0e4745f4948e9e97ee7"),
...
// 最大宽度设置
amisEditorCore.setSchemaTpl('layout:max-width', function (config) {
  var _a;
  return {
    type: 'input-number',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("99b57d8c9244ff9a695fcd519b4e2e57"), i18nRuntime.i18n("d1b91a1a24f0d4935c2dd13e6a22b6d4")),
...
// 最小宽度设置
amisEditorCore.setSchemaTpl('layout:min-width', function (config) {
  var _a;
  return {
    type: 'input-number',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("a2b62974f4d7564bb68b570116f25a10"), i18nRuntime.i18n("ede82efb4a69c35743185c6c73ab771e")),
...
// x轴（水平轴）滚动模式
amisEditorCore.setSchemaTpl('layout:overflow-x', function (config) {
  return {
    type: 'select',
    ...
    pipeOut: config === null || config === void 0 ? void 0 : config.pipeOut,
    options: [{
      label: i18nRuntime.i18n("cbc7af1d6422e88f4b87ade748e0f07d"),
      value: 'visible'
    }, {
      label: i18nRuntime.i18n("b48a90c77b5e792260d830c2d68c527e"),
      value: 'hidden'
    }, {
      label: i18nRuntime.i18n("ddea62517e2bd1007712689746ebfe00"),
      value: 'scroll'
    }, {
      label: i18nRuntime.i18n("55becc96b40692cc9cf898b331d16976"),
      value: 'auto'
    }]
  };
});
// 是否固定高度: isFixedHeight 配置:
amisEditorCore.setSchemaTpl('layout:isFixedHeight', function (config) {
  var _a;
  return {
    type: 'button-group-select',
    label: (config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("f02f876ee64cc016d97fa4dc498d4857"),
    size: 'xs',
...
// 高度设置
amisEditorCore.setSchemaTpl('layout:height', function (config) {
  var _a;
  return {
    type: 'input-number',
    label: (config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("c1df04eec5fa0857bc0df2d68d8e953c"),
...
// 最大高度设置
amisEditorCore.setSchemaTpl('layout:max-height', function (config) {
  var _a;
  return {
    type: 'input-number',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("fc2bc4193eea63128961d09497e07dc8"), i18nRuntime.i18n("6f420734edfaff00a8210a4c762a9207")),
...
// 最小高度设置
amisEditorCore.setSchemaTpl('layout:min-height', function (config) {
  var _a;
  return {
    type: 'input-number',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("2bd921d0ea7a73b77ee0fcddb1afcc84"), i18nRuntime.i18n("0611733b53e0098e6fd880bd44b2806f")),
...
// y轴（交叉轴）滚动模式
amisEditorCore.setSchemaTpl('layout:overflow-y', function (config) {
  return {
    type: 'select',
...
// 居中显示
amisEditorCore.setSchemaTpl('layout:margin-center', function (config) {
  var _a;
  return {
    type: 'button-group-select',
    size: 'xs',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("d5bc35360607472de4525358af126de4"), i18nRuntime.i18n("052f93928af33d4d7035e7c8e8a73f17")),
    ...
    options: [{
      label: i18nRuntime.i18n("a738a8594bd2b71002d09277b84d86dd"),
      value: 'auto auto auto 0px'
    }, {
      label: i18nRuntime.i18n("0bbc2ea4e1d1f23feb576de5dca1ce3b"),
      value: '0px auto'
    }, {
      label: i18nRuntime.i18n("fc0f19e9e47e352d36d36cf6eb653210"),
...
amisEditorCore.setSchemaTpl('layout:originPosition', function (config) {
  var _a;
  var configSchema = {
    type: 'select',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel(i18nRuntime.i18n("7d1313925f158b747c094a7f2480e535"), i18nRuntime.i18n("41a7494315a528f0f9618646f7e0dddf")),
    ...
    pipeOut: config === null || config === void 0 ? void 0 : config.pipeOut,
    options: [{
      label: i18nRuntime.i18n("df68a5dc8f8847179b7afdf943f80796"),
      value: 'left-top'
    }, {
      label: i18nRuntime.i18n("e717b4ae480e7c073fd5a44647a7f0da"),
      value: 'right-top'
    }, {
      label: i18nRuntime.i18n("845c61ac8f51c6702dd22e5657c07e8d"),
      value: 'right-bottom'
    }, {
      label: i18nRuntime.i18n("2a97dfb2d236c87c41fd588f006111dc"),
      value: 'left-bottom'
    }],
    onChange: function (value, oldValue, model, form) {
...
// 吸附位置配置项
amisEditorCore.setSchemaTpl('layout:sorption', {
  type: 'button-group-select',
  label: i18nRuntime.i18n("7d30297d4e1f310c73b27be88c748026"),
  size: 'xs',
  name: 'sorptionPosition',
  options: [{
    label: i18nRuntime.i18n("2ea76e2ffc1b92911d6f7decfa993360"),
    value: 'top'
  }, {
    label: i18nRuntime.i18n("8cfc818a76662085cb64752d6d592fbe"),
    value: 'bottom'
  }],
  onChange: function (value, oldValue, model, form) {
    if (value === 'top') {
...
// 滚动吸附配置项
amisEditorCore.setSchemaTpl('layout:sticky', {
  type: 'switch',
  label: amisEditorCore.tipedLabel(i18nRuntime.i18n("e2f6535e21570a0703c7c65f41b30eaa"), i18nRuntime.i18n("1c5ea0ffb2b15713cb22c41a02576924")),
  name: 'stickyStatus',
  inputClassName: 'inline-flex justify-between',
  onChange: function (value, oldValue, model, form) {
    if (value) {
...
// 滚动吸附位置配置项
amisEditorCore.setSchemaTpl('layout:stickyPosition', {
  type: 'button-group-select',
  size: 'xs',
  label: amisEditorCore.tipedLabel(i18nRuntime.i18n("7d30297d4e1f310c73b27be88c748026"), i18nRuntime.i18n("5f9be0002394f0b58952969d5952e24c")),
  name: 'stickyPosition',
...
// 默认内边距配置项
amisEditorCore.setSchemaTpl('layout:padding', function (config) {
  return {
    label: (config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("c17fef27ea1d970fc66f4c4c3d442129"),
    type: 'button-group-select',
    name: (config === null || config === void 0 ? void 0 : config.name) || 'size',
    size: 'xs',
    mode: (config === null || config === void 0 ? void 0 : config.mode) || 'horizontal',
    visibleOn: config === null || config === void 0 ? void 0 : config.visibleOn,
    pipeIn: (config === null || config === void 0 ? void 0 : config.pipeIn) || amisEditorCore.defaultValue(''),
    pipeOut: config === null || config === void 0 ? void 0 : config.pipeOut,
    options: [{
...
// 内部水平对齐方式
amisEditorCore.setSchemaTpl('layout:textAlign', function (config) {
  return {
    label: (config === null || config === void 0 ? void 0 : config.label) || i18nRuntime.i18n("d5bc35360607472de4525358af126de4"),
    type: 'button-group-select',
...
// flex相关配置项（整合版）
amisEditorCore.setSchemaTpl('layout:flex-setting', function (config) {
  var _a;
  return {
...
// 子配置项包裹容器
amisEditorCore.setSchemaTpl('layout:wrapper-contanier', function (config) {
  return {
    type: 'container',

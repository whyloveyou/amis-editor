...
var TableViewEditor = /** @class */function (_super) {
  ...
  TableViewEditor.prototype.handleCellMouseDown = function (e) {
    ...
    this.selectedCell = (_a = {}, _a[tdId] = amisEditorCore.JSONGetById(this.props.schema, tdId), _a);
  };
  // 用于单元格合并的移动
  TableViewEditor.prototype.handleCellMouseMove = function (e) {
    if (this.isSelectionCell) {
      ...
      if (!(tdId in this.selectedCell)) {
        this.selectedCell[tdId] = amisEditorCore.JSONGetById(this.props.schema, tdId);
  ...
  TableViewEditor.prototype.findFirstAndLastCell = function () {
    ...
    if (!tds.length) {
      console.warn(i18nRuntime.i18n("9efb0ce5a4510ef29345b6edb3e58bc2"));
    }
    ...
    var lastCell = null;
    try {
      for (var tds_1 = tslib.__values(tds), tds_1_1 = tds_1.next(); !tds_1_1.done; tds_1_1 = tds_1.next()) {
  ...
  TableViewEditor.prototype.markSelectingCell = function () {
    ...
    try {
      ...
      for (var _d = tslib.__values(this.props.schema.trs), _e = _d.next(); !_e.done; _e = _d.next()) {
        var tr = _e.value;
        try {
          for (var _f = (e_3 = void 0, tslib.__values(tr.tds)), _g = _f.next(); !_g.done; _g = _f.next()) {
            var td = _g.value;
            var internalTd = td;
  ...
  TableViewEditor.prototype.handleMergeCell = function () {
    var _a = this.findFirstAndLastCell(),
      ...
      maxCol = _a.maxCol;
    if (!firstCell) {
      console.warn(i18nRuntime.i18n("3ce57bd19e37d2b27145dc6fcfff3520"));
      return;
    }
    ...
    if (dom) {
      ...
      for (var trIndex = 0; trIndex < trs.length; trIndex++) {
        ...
        if (rowLines[trIndex]) {
          ...
          console.warn(i18nRuntime.i18n("f7d205072a2ceb63b4f48a8b6f32fd25"));
        }
      }
      ...
      for (var tdIndex = 0; tdIndex < tds.length; tdIndex++) {
        ...
        if (colLines[tdIndex]) {
          ...
          console.warn(i18nRuntime.i18n("852228c640b1daefe6b0853390e66791"));
        }
      }
    }
  };
  ...
  TableViewEditor.prototype.handleRowMouseUp = function (e) {
    ...
    if (!value || !rowElement) {
      console.warn(i18nRuntime.i18n("26526c3354307798dfa84f17decf5140"), draggingId);
    } else {
      var height = rowElement.getBoundingClientRect().height;
      var targetHeight = height + moveY;
      store.changeValueById(draggingId, tslib.__assign(tslib.__assign({}, value), {
        height: targetHeight
      }));
      if (ROW_HEIGHT - targetHeight > 20) {
        amis.toast.warning(i18nRuntime.i18n("38d2ccdde0ae0c2329defd3c75c59d8b"));
      }
    }
  };
  // 垂直线的拖拽
  ...
  TableViewEditor.prototype.renderMergeIcon = function () {
    if (this.state.displayMergeCell) {
      ...
      }, i18nRuntime.i18n("d59379f4227af3b2c60214e2f4f903ba"));
    }
    return null;
  };
  ...
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "removeListenTdSelection", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "listenTdSelection", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleCellMouseDown", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleCellMouseMove", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleCellMouseUp", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleCellMouseClick", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleMergeCell", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleRowMouseDown", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleRowMouseMove", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleRowMouseUp", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleColMouseDown", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleColMouseMove", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleColMouseUp", null);
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent]), tslib.__metadata("design:returntype", void 0)], TableViewEditor.prototype, "handleLineClick", null);

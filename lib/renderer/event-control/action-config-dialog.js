...
var actionConfigPanel = require('./action-config-panel.js');
...
var ActionDialog = /** @class */function (_super) {
  tslib.__extends(ActionDialog, _super);
    ...
    var getSearchList = function (result, array, keywords) {
      array.forEach(function (node) {
        if (node.children) {
          ...
          result.push(tslib.__assign({}, node));
        }
      });
    };
  ...
  ActionDialog.prototype.getInputTreeSchema = function (isSearch, actionTree, getComponents) {
    var inputTreeSchema = {
      ...
      placeholder: i18nRuntime.i18n("db1cac8e2f6206e8f179b1ff47a676df"),
      onChange: function (value, oldVal, data, form) {
        ...
        Object.keys(form.data).forEach(function (key) {
          if (!compActionSelect.BASE_ACTION_PROPS.includes(key)) {
        ...
        var actionNode = helper.findActionNode(actionTree, value);
        form.setValues(tslib.__assign(tslib.__assign(tslib.__assign(tslib.__assign({}, removeKeys), {
    ...
    if (isSearch) {
      return tslib.__assign(tslib.__assign({}, inputTreeSchema), {
  ...
  ActionDialog.prototype.render = function () {
    ...
    return render('inner', {
      type: 'dialog',
      title: i18nRuntime.i18n("e9908cdf79e965f6907ce9f291cdfcf8"),
      ...
      body: [{
        ...
        submitText: i18nRuntime.i18n("be5fbbe34ce9979bfb6576d9eddc5612"),
        autoFocus: true,
        data: {
          __keywords: '',
          __resultActionTree: []
        ...
        body: [{
          ...
          columns: [{
            body: [{
              type: 'tpl',
              tpl: i18nRuntime.i18n("d1d9049139d870edd490215530d90458"),
              ...
              placeholder: i18nRuntime.i18n("9eac7e07ca0a3181766e5ecc70d20727"),
              clearable: true,
              onChange: function (value, oldVal, data, form) {
                if (value) {
            ...
            body: [{
              type: 'tpl',
              tpl: i18nRuntime.i18n("0174bdde9517fa331bf7d716a553e023"),
              className: 'action-panel-title',
              ...
              type: 'tpl',
              tpl: i18nRuntime.i18n("0aeca07a02601a8e701a46d1a8b5ce43"),
              className: 'action-panel-title',
              visibleOn: 'data.actionType',
              inline: false
            }, {
              ...
              body: [{
                asFormItem: true,
                component: actionConfigPanel["default"],
                pluginActions: pluginActions,
                commonActions: commonActions
              }, {
                type: 'tpl',
                tpl: i18nRuntime.i18n("e370757f933a8ecd87bf0255c3ce45d0"),
                inline: false,
                className: 'action-panel-title',
                visibleOn: 'data.actionType'
              }, {
                ...
                name: 'ignoreError',
                visibleOn: 'data.actionType',
                label: amisEditorCore.tipedLabel(i18nRuntime.i18n("0e7bb2c7879f0a34c02f547820b0b0b3"), i18nRuntime.i18n("5d9fe78268b03e8aa41ac316ef610d9a")),
                mode: 'horizontal',
                ...
                options: [{
                  label: i18nRuntime.i18n("c0d5d68f5f1cc399311e92905ed2fa80"),
                  value: '1'
                }, {
                  label: i18nRuntime.i18n("a165be161ac250720f6f25820dd2a5b3"),
                  value: '2'
                }, {
                  label: i18nRuntime.i18n("9cdfce42ef0fa346511538131e51328f"),
                  value: '3'
                }],
                description: i18nRuntime.i18n("17817a4d2da41f4261f4155ada59e395")
              }, amisEditorCore.getSchemaTpl('expressionFormulaControl', {
                name: 'stopPropagation',
                label: amisEditorCore.tipedLabel(i18nRuntime.i18n("8c2bb89f516205027b9ed6609fb17726"), i18nRuntime.i18n("46a3c6ab94da0b16a707bdd3b74c9e09")),
                evalMode: true,
                variables: '${variables}',
                mode: 'horizontal',
                size: 'lg',
                ...
                name: 'expression',
                label: i18nRuntime.i18n("da1ed600ce65be863766444e60c2da05"),
                evalMode: true,
                variables: '${variables}',
                mode: 'horizontal',
                size: 'lg',
                placeholder: i18nRuntime.i18n("13b2de1073f76444c49d2c6a21e46e26"),
                visibleOn: 'data.actionType'
              })]
            }],

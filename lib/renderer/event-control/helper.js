    ...
    children: [{
      ...
      actions: [{
        ...
        descDetail: function (info) {
          return React__default["default"].createElement("div", null, i18nRuntime.i18n("4d775d4cd79e2ed6a2fc66fd1e7139c8"), React__default["default"].createElement("span", {
            className: "variable-left variable-right"
          }, (info === null || info === void 0 ? void 0 : info.rendererLabel) || info.componentId || '-'), i18nRuntime.i18n("bb79667f37035e9562ec6bcffd6cf8ef"));
        }
      }, {
        actionType: 'hidden',
        descDetail: function (info) {
        ...
        descDetail: function (info) {
          return React__default["default"].createElement("div", null, i18nRuntime.i18n("bb79667f37035e9562ec6bcffd6cf8ef"), React__default["default"].createElement("span", {
            className: "variable-left variable-right"
          }, (info === null || info === void 0 ? void 0 : info.rendererLabel) || info.componentId || '-'), i18nRuntime.i18n("7f019b96ffb7d72ec8d6ce8d76e5362f"));
        }
      }],
      supportComponents: '*',
      schema: tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(renderCmptSelect(i18nRuntime.i18n("6afde638796d237377b0755506d08ded"), true)), false), [renderCmptIdInput(), {
        type: 'radios',
      ...
      actions: [{
        ...
        descDetail: function (info) {
          ...
          }, (info === null || info === void 0 ? void 0 : info.rendererLabel) || info.componentId), i18nRuntime.i18n("0e35b091e18032508758899735664df7"));
        }
      }, {
        ...
        descDetail: function (info) {
          return React__default["default"].createElement("div", null, React__default["default"].createElement("span", {
            className: "variable-right"
          }, (info === null || info === void 0 ? void 0 : info.rendererLabel) || info.componentId), i18nRuntime.i18n("34d361256526b04909e064c29d9a9b76"));
        }
      }],
      supportComponents: tslib.__spreadArray(['form'], tslib.__read(SUPPORT_STATIC_FORMITEM_CMPTS), false),
      schema: tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(renderCmptSelect(i18nRuntime.i18n("d80bc0fcbfb250480320b683e48b1467"), true)), false), [renderCmptIdInput(), {
        type: 'radios',
      ...
      schema: [{
        ...
        body: tslib.__spreadArray([], tslib.__read(renderCmptSelect(i18nRuntime.i18n("6afde638796d237377b0755506d08ded"), true, function (value, oldVal, data, form) {
        ...
        // 找到组件并设置相关的属性
        var schema = amisEditorCore.JSONGetById(manager.store.schema, value, 'id');
        if (schema) {
      ...
      descDetail: function (info) {
        ...
        return React__default["default"].createElement("div", null, typeof ((_a = info === null || info === void 0 ? void 0 : info.args) === null || _a === void 0 ? void 0 : _a.path) === 'string' && !(info === null || info === void 0 ? void 0 : info.componentId) ? React__default["default"].createElement(React__default["default"].Fragment, null, i18nRuntime.i18n("c85c8d61a67014c4b5d44f25e49e87fc"), React__default["default"].createElement("span", {
          ...
          className: "variable-left variable-right"
        }, (info === null || info === void 0 ? void 0 : info.rendererLabel) || info.componentId || '-'), i18nRuntime.i18n("df24d894cd3331f53964bc75f5c192e2")));
      },
      supportComponents: 'byComponent',
      schema: [{
      ...
      // 组件变量
      {
        ...
        body: [{
          ...
          size: 'sm',
          visibleOn: 'data.componentId === "customCmptId"',
          body: tslib.__spreadArray([], tslib.__read(renderCmptActionSelect(i18nRuntime.i18n("6afde638796d237377b0755506d08ded"), true, function (value, oldVal, data, form) {
      ...
      descDetail: function (info) {
        return React__default["default"].createElement("div", null, i18nRuntime.i18n("939d5345ad4345dbaabe14798f6ac0f1"), React__default["default"].createElement("span", {
          className: "variable-left variable-right"
        }, (info === null || info === void 0 ? void 0 : info.rendererLabel) || info.componentId || '-'), i18nRuntime.i18n("b91ebe714155c83b6d3bc02b675a31e9"));
      },
      ...
      supportComponents: 'form',
      schema: tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(renderCmptSelect(i18nRuntime.i18n("6afde638796d237377b0755506d08ded"), true)), false), [renderCmptIdInput()], false)
    }, {
  ...
  return tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(renderCmptSelect(componentLabel || i18nRuntime.i18n("d80bc0fcbfb250480320b683e48b1467"), true, function (value, oldVal, data, form) {
      ...
      return tslib.__generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            dataSchema = new amisCore.DataSchema(contextSchema || []);
    ...
    onChange: function (value, oldVal, data, form) {
      return tslib.__awaiter(void 0, void 0, void 0, function () {
        var schema;
        return tslib.__generator(this, function (_a) {
          schema = amisEditorCore.JSONGetById(manager.store.schema, value, 'id');
          if (schema) {
            form.setValues({
        ...
        return tslib.__generator(this, function (_w) {
          ...
          if (['ajax', 'download'].includes(action.actionType)) {
            ...
            if (typeof (action === null || action === void 0 ? void 0 : action.api) === 'string') {
              config.api = amisCore.normalizeApi(action === null || action === void 0 ? void 0 : action.api);
            }
            delete config.args;
          }
          ...
          if (['setValue', 'static', 'nonstatic', 'show', 'visibility', 'hidden', 'enabled', 'disabled', 'usability', 'reload', 'submit', 'clear', 'reset', 'validate'].includes(action.actionType)) {
            node = amisCore.findTree(allComponents !== null && allComponents !== void 0 ? allComponents : [], function (item) {
            ...
            if (['setValue'].includes(action.actionType)) {
              schema = amisEditorCore.JSONGetById(manager.store.schema, config.__cmptId, 'id');
              if (schema) {
...
exports.renderCmptIdInput = renderCmptIdInput;

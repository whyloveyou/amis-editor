...
var FieldSetting = /** @class */function (_super) {
  tslib.__extends(FieldSetting, _super);
  function FieldSetting(props) {
    var _this = this;
    var _a, _b;
    _this = _super.call(this, props) || this;
    _this.formRef = React__default["default"].createRef();
    _this.tableRef = React__default["default"].createRef();
    _this.scaffold = {
      label: '',
      name: '',
      displayType: 'tpl',
    ...
    _this.debounceGenerateFields = debounce__default["default"](function (e) {
  ...
  FieldSetting.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
    ...
    if (((prevValue === null || prevValue === void 0 ? void 0 : prevValue.length) !== (value === null || value === void 0 ? void 0 : value.length) || !isEqual__default["default"](prevValue, value)) && !isEqual__default["default"](value, prevState === null || prevState === void 0 ? void 0 : prevState.fields)) {
      this.setState({
        loading: true,
  ...
  FieldSetting.prototype.handleTableChange = function (items) {
    ...
    this.handleFieldsChange(items.map(function (row) {
      ...
      return tslib.__assign(tslib.__assign({}, pick__default["default"](tslib.__assign(tslib.__assign({}, item), row), ['label', 'name', 'displayType', 'inputType'])), {
        checked: true
      });
    }));
  };
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib.__generator(this, function (_j) {
        switch (_j.label) {
          ...
          case 3:
            error_1 = _j.sent();
            amisUi.toast.warning((_a = error_1.message) !== null && _a !== void 0 ? _a : i18nRuntime.i18n("91aa2166ee4811414381c8d94e6567e6"));
            return [3 /*break*/, 4];
          case 4:
            return [3 /*break*/, 9];
          case 5:
          ...
          case 7:
            result = _j.sent();
            if (!result.ok) {
              amisUi.toast.warning((_d = (_c = result.defaultMsg) !== null && _c !== void 0 ? _c : result.msg) !== null && _d !== void 0 ? _d : i18nRuntime.i18n("91aa2166ee4811414381c8d94e6567e6"));
              this.setState({
                loading: false
              });
              return [2 /*return*/];
          ...
          case 8:
            error_2 = _j.sent();
            amisUi.toast.warning((_g = error_2.message) !== null && _g !== void 0 ? _g : i18nRuntime.i18n("91aa2166ee4811414381c8d94e6567e6"));
            return [3 /*break*/, 9];
          case 9:
    ...
    if (renderer === 'form') {
      ...
      if (isFirstStep) {
        ...
        if (scaffoldStepManipulated) {
          ...
          onBulkChange === null || onBulkChange === void 0 ? void 0 : onBulkChange(tslib.__assign(tslib.__assign({}, updatedData_1), {
            listFields: fields
          }), submitOnChange);
        }
      } else {
  ...
  FieldSetting.prototype.renderFooter = function () {
    ...
    var isApiValid = amisCore.isValidApi((_a = amisCore.normalizeApi(fieldApi)) === null || _a === void 0 ? void 0 : _a.url);
    var showAutoGenBtn = renderer === 'form' && feat === 'Edit' || renderer === 'crud' && feat === 'List' && (ctx === null || ctx === void 0 ? void 0 : ctx.__step) === 0;
    return showAutoGenBtn ? React__default["default"].createElement("div", {
      ...
      disabledTip: {
        content: loading ? i18nRuntime.i18n("acb3aec4d12f6ca06a1e45302030cdb1") : renderer === 'form' ? i18nRuntime.i18n("cdfd25057876424324682b5bdde38a3d") : i18nRuntime.i18n("a9fea442707e26dee478b34a2f2ce263"),
        tooltipTheme: 'dark'
      },
      onClick: this.debounceGenerateFields
    }, React__default["default"].createElement("span", null, i18nRuntime.i18n("4cc6a76c146c0360a41ceaf5e212c891")))) : null;
  };
  FieldSetting.prototype.render = function () {
    ...
    var isFirstStep = this.isFirstStep();
    var fields = this.state.fields.concat();
    return React__default["default"].createElement(React__default["default"].Fragment, null, render('field-setting', {
      type: 'input-table',
      name: name,
      label: false,
      ...
      addable: true,
      addBtnLabel: i18nRuntime.i18n("66ab5e9f24c8f46012a25c89919fb191"),
      addBtnIcon: false,
      editable: true,
      editBtnLabel: i18nRuntime.i18n("95b351c86267f3aedf89520959bce689"),
      editBtnIcon: false,
      removable: true,
      deleteBtnLabel: i18nRuntime.i18n("2f4aaddde33c9b93c36fd2503f3d122b"),
      deleteBtnIcon: false,
      confirmBtnLabel: i18nRuntime.i18n("e83a256e4f5bb4ff8b3d804b5473217a"),
      cancelBtnLabel: i18nRuntime.i18n("625fb26b4b3340f7872b411f401e754c"),
      needConfirm: true,
      ...
      footerAddBtn: {
        level: 'link',
        label: i18nRuntime.i18n("4484fa04e7b71db4c8293e5bcb53eca4")
      },
      scaffold: this.scaffold,
      columns: [{
        type: 'input-text',
        name: 'name',
        label: i18nRuntime.i18n("e996419dedc2f1ffd96e7a0e808127d0"),
        placeholder: i18nRuntime.i18n("e996419dedc2f1ffd96e7a0e808127d0")
      }, {
        type: 'input-text',
        name: 'label',
        label: i18nRuntime.i18n("32c65d8d7431e76029678ec7bb73a5ab"),
        placeholder: i18nRuntime.i18n("eea3ebc33e69694e0c12d4ab2e07a553")
      }, showInputType && !(renderer === 'crud' && feat === 'List' && !isFirstStep) ? {
        type: 'select',
        name: 'inputType',
        label: i18nRuntime.i18n("b3e55578af5dd473bab62641bb2f5f8e"),
        options: [{
          label: i18nRuntime.i18n("0766a6467bed7f2840871a5f0638669d"),
          value: 'input-text',
          ...
          label: i18nRuntime.i18n("9597dcaf432ceba92a160d61cb1ef65f"),
          value: 'input-number'
        }, {
          ...
          label: i18nRuntime.i18n("006ded9fa277cf030592021f595a07d5"),
          value: 'select'
        }, {
          ...
          label: i18nRuntime.i18n("13c250c68608118463871ce7cd8b292c"),
          value: 'input-table'
        }, {
          ...
          label: i18nRuntime.i18n("6bfb9bb2218ff32b6139e98bc93707c0"),
          value: 'input-image'
        }, {
          label: i18nRuntime.i18n("24b6d4c0892a8f3ee2a982e3ab0afe38"),
  ...
  FieldSetting.validator = function (items, isInternal) {
    ...
    var error = false;
    try {
      for (var _b = tslib.__values(fields.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
  ...
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Array]), tslib.__metadata("design:returntype", void 0)], FieldSetting.prototype, "handleTableChange", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], FieldSetting.prototype, "handleSubmit", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", Promise)], FieldSetting.prototype, "handleGenerateFields", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Array]), tslib.__metadata("design:returntype", void 0)], FieldSetting.prototype, "handleFieldsChange", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], FieldSetting.prototype, "renderFooter", null);
  return FieldSetting;
}(React__default["default"].Component);
/** @class */(function (_super) {
  tslib.__extends(FieldSettingRenderer, _super);
  function FieldSettingRenderer() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  FieldSettingRenderer = tslib.__decorate([amisCore.FormItem({

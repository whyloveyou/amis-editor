...
var plugin = require('./textarea-formula/plugin.js');
...
var TplFormulaControl = /** @class */function (_super) {
  tslib.__extends(TplFormulaControl, _super);
  ...
  TplFormulaControl.prototype.checkOpenFormulaPicker = function (value) {
    ...
    if (/\$|\{|\}$/.test(inputText)) {
      if (/\$\{\}/.test(inputText)) {
        ...
        preInputLocation = tslib.__assign(tslib.__assign({
          start: left
        }, preInputLocation), {
          end: end
        });
  ...
  TplFormulaControl.prototype.render = function () {
    ...
    var _a = this.props,
      ...
      rest = tslib.__rest(_a, ["className", "header", "label", "placeholder", "customFormulaPicker", "clearable"]);
    var _b = this.state,
    ...
    return React__default["default"].createElement("div", {
      className: cx__default["default"]('ae-TplFormulaControl', className, {
        clearable: clearable
      }),
      ref: this.wrapRef
    }, React__default["default"].createElement("div", {
      className: cx__default["default"]('ae-TplResultBox')
    ...
    }, placeholder), clearable && this.props.value && React__default["default"].createElement(amis.Icon, {
      icon: "input-clear",
      ...
      icon: "input-add-fx",
      className: cx__default["default"]('ae-TplFormulaControl-icon', 'icon')
  ...
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [MouseEvent, String, Array]), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "onExpressionMouseEnter", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "hiddenToolTip", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "handleKeyDown", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "closeFormulaPicker", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "handleConfirm", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "handleOnChange", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "handleClear", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", Promise)], TplFormulaControl.prototype, "beforeFormulaEditorOpen", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, String]), tslib.__metadata("design:returntype", Promise)], TplFormulaControl.prototype, "handleFormulaClick", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [HTMLElement, Object]), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "editorFactory", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object]), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "handleEditorMounted", null);
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], TplFormulaControl.prototype, "editorAutoMark", null);
  return TplFormulaControl;
}(React__default["default"].Component);
/** @class */(function (_super) {
  tslib.__extends(TplFormulaControlRenderer, _super);
  function TplFormulaControlRenderer() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  TplFormulaControlRenderer = tslib.__decorate([amis.FormItem({

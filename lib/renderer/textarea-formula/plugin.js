 ...
 * @file 扩展 codemirror
 */
function editorFactory(dom, cm, value, config) {
    return cm(dom, tslib.__assign({ value: value || '', autofocus: false, lineWrapping: true }, config));
}
...
var FormulaPlugin = /** @class */ (function () {
    function FormulaPlugin(editor, config) {
        var _a, _b;
        this.editor = editor;
        this.config = tslib.__assign(tslib.__assign({}, defaultPluginConfig), config);
    ...
    FormulaPlugin.prototype.markExpression = function (from, to, expression, className) {
        ...
        var highlightValue = amisUi.FormulaEditor.highlightValue(expression, variables) || {
            html: expression
        };

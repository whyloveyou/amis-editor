...
var OptionControl = /** @class */function (_super) {
  ...
  OptionControl.prototype.componentWillReceiveProps = function (nextProps) {
    var options = get__default["default"](nextProps, 'data.options') ? this.transformOptions(nextProps) : [];
  ...
  OptionControl.prototype.onChange = function () {
    ...
    if (source === 'custom') {
      ...
      data.options = options.map(function (item) {
        return tslib.__assign(tslib.__assign(tslib.__assign({}, (item === null || item === void 0 ? void 0 : item.badge) ? {
          badge: item.badge
        } : {}), {
          label: item.label,
  ...
  OptionControl.prototype.handleHiddenValueChange = function (index, value) {
    ...
    var _a = options[index];
      _a.hiddenOn;
      var option = tslib.__rest(_a, ["hiddenOn"]);
    options.splice(index, 1, tslib.__assign(tslib.__assign({}, option), !value ? {} : {
      hiddenOn: value
    }));
    this.setState({
      options: options
  ...
  OptionControl.prototype.handleBatchAdd = function (values, action) {
    ...
    var newOptions = uniqBy__default["default"](tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(options), false), tslib.__read(addedOptions), false), 'value');
    this.setState({
      options: newOptions
    }, function () {
      return _this.onChange();
  ...
  OptionControl.prototype.renderOption = function (props) {
    ...
    var editDom = editing ? React__default["default"].createElement("div", {
      ...
      body: [{
        ...
        type: i18nEnabled ? 'input-text-i18n' : 'input-text',
        placeholder: i18nRuntime.i18n("7f05bea37729325a6cc84eb26bb9f8c8"),
      ...
      data: amisCore.createObject(ctx, {
        option: props
      })
    })) : null;
    var operationBtn = [{
    ...
    var tooltip = disabled ? i18nRuntime.i18n("bc3f5a690d8c3a47d27ef8a1b127bafc") : i18nRuntime.i18n("0560b060c438e9326f92718ccbc3f95b");
    return React__default["default"].createElement("li", {
      ...
      value: label,
      placeholder: i18nRuntime.i18n("5d26b8a41e805204c9dcd5ea7e23b150"),
      clearable: false,
  ...
  OptionControl.prototype.render = function () {
    ...
    return React__default["default"].createElement("div", {
      ...
      ref: this.targetRef
    }, i18nRuntime.i18n("e8755fb1e985a5d26df0fce1f0b7b0f8")), render('inner', this.buildBatchAddSchema()))) : null, source === 'api' || source === 'apicenter' ? this.renderApiPanel() : null, source === 'variable' ? render('variable', {
      type: 'control',
      label: false,
      className: 'ae-ExtendMore',
  ...
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Number, String]), tslib.__metadata("design:returntype", void 0)], OptionControl.prototype, "handleHiddenValueChange", null);
  ...
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Array, Object]), tslib.__metadata("design:returntype", void 0)], OptionControl.prototype, "handleBatchAdd", null);

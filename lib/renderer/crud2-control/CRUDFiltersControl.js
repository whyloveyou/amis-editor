...
var CRUDFiltersControl = /** @class */function (_super) {
  tslib.__extends(CRUDFiltersControl, _super);
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib.__generator(this, function (_l) {
        switch (_l.label) {
          ...
          case 1:
            _l.trys.push([1, 8,, 9]);
            if (!(feat === constants.DSFeatureEnum.SimpleQuery && builder.filterByFeat(feat))) return [3 /*break*/, 3];
            return [4 /*yield*/, (_c = builder.getCRUDSimpleQueryFields) === null || _c === void 0 ? void 0 : _c.call(builder, tslib.__assign({}, baseOpitons))];
          case 2:
            ...
            return [3 /*break*/, 7];
          case 3:
            if (!(feat === constants.DSFeatureEnum.AdvancedQuery && builder.filterByFeat(feat))) return [3 /*break*/, 5];
            return [4 /*yield*/, (_e = builder === null || builder === void 0 ? void 0 : builder.getCRUDAdvancedQueryFields) === null || _e === void 0 ? void 0 : _e.call(builder, tslib.__assign({}, baseOpitons))];
          case 4:
            ...
            CBSchema = ((_g = filterSchema === null || filterSchema === void 0 ? void 0 : filterSchema.body) !== null && _g !== void 0 ? _g : []).find(function (item) {
              return item.type === 'condition-builder' && (item.behavior === constants.DSFeatureEnum.AdvancedQuery || item.name === '__filter');
            });
            ...
            return [3 /*break*/, 7];
          case 5:
            if (!(feat === constants.DSFeatureEnum.FuzzyQuery && builder.filterByFeat(feat))) return [3 /*break*/, 7];
            return [4 /*yield*/, (_h = builder === null || builder === void 0 ? void 0 : builder.getCRUDFuzzyQueryFields) === null || _h === void 0 ? void 0 : _h.call(builder, tslib.__assign({}, baseOpitons))];
          case 6:
            fields = (_j = _l.sent()) !== null && _j !== void 0 ? _j : [];
            utils.traverseSchemaDeep(CRUDSchema, function (key, value, host) {
              if (key === 'behavior' && value === constants.DSFeatureEnum.FuzzyQuery && host.type === 'search-box') {
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib.__generator(this, function (_h) {
        switch (_h.label) {
          ...
          case 1:
            _h.sent();
            filterSchema = cloneDeep__default["default"]((CRUDSchema === null || CRUDSchema === void 0 ? void 0 : CRUDSchema.filter) ? Array.isArray(CRUDSchema.filter) ? CRUDSchema.filter.find(function (item) {
          ...
          case 2:
            ...
            newFilterSchema = utils.traverseSchemaDeep(filterSchema, function (key, value, host) {
              /** 更新标识符 */
              if (key === 'behavior' && Array.isArray(value)) {
                return [key, uniq__default["default"](tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(value), false), [constants.DSFeatureEnum.SimpleQuery], false).filter(Boolean))];
              }
              /** 更新内容区 */
              if (key === 'body' && Array.isArray(value) && (host === null || host === void 0 ? void 0 : host.type) === 'form') {
                return [key, tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(value), false), tslib.__read(simpleQuerySchema_1), false).filter(Boolean)];
              }
              return [key, value];
            });
            ...
            newFilterSchema = utils.traverseSchemaDeep(filterSchema, function (key, value, host) {
              ...
              if (key === 'behavior' && Array.isArray(value)) {
                return [key, value.filter(function (i) {
                  return i !== constants.DSFeatureEnum.SimpleQuery;
                })];
              }
              /** 更新内容区 */
              if (key === 'body' && Array.isArray(value) && (host === null || host === void 0 ? void 0 : host.type) === 'form') {
                return [key, value.filter(function (item) {
                  return (item === null || item === void 0 ? void 0 : item.behavior) !== constants.DSFeatureEnum.SimpleQuery;
                })];
              }
              return [key, value];
            });
          ...
          case 6:
            ...
            return [4 /*yield*/, builder.buildCRUDFilterSchema({
              ...
              inScaffold: false,
              schema: CRUDSchema,
              feats: [constants.DSFeatureEnum.SimpleQuery],
              scaffoldConfig: {
          ...
          case 7:
            filter = _h.sent();
            newFilterSchema = cloneDeep__default["default"](CRUDNode === null || CRUDNode === void 0 ? void 0 : CRUDNode.schema.filter);
            isArrayFilter = Array.isArray(newFilterSchema);
            if (isArrayFilter) {
              newFilterSchema.push(filter);
            }
            CRUDNode.updateSchema(tslib.__assign(tslib.__assign({}, CRUDSchema), {
      ...
      return tslib.__generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            CRUDNode = store.getNodeById(nodeId);
            CRUDSchema = CRUDNode === null || CRUDNode === void 0 ? void 0 : CRUDNode.schema;
            filterSchema = cloneDeep__default["default"](Array.isArray(CRUDSchema.filter) ? CRUDNode === null || CRUDNode === void 0 ? void 0 : CRUDNode.schema.filter.find(function (item) {
              return item.behavior && Array.isArray(item.behavior);
          ...
          case 1:
            ...
            newFilterSchema = utils.traverseSchemaDeep(filterSchema, function (key, value, host) {
              /** 更新标识符 */
              if (key === 'behavior' && Array.isArray(value)) {
                return [key, uniq__default["default"](tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(value), false), [constants.DSFeatureEnum.AdvancedQuery], false).filter(Boolean))];
              }
              /** 更新内容区 */
              if (key === 'body' && Array.isArray(value) && (host === null || host === void 0 ? void 0 : host.type) === 'form') {
                return [key, tslib.__spreadArray([advancedQuerySchema_1], tslib.__read(value), false)];
              }
              return [key, value];
            });
            targetNode = manager.store.getNodeById(filterSchema.$$id);
          ...
          case 2:
            newFilterSchema = utils.traverseSchemaDeep(filterSchema, function (key, value, host) {
              ...
              if (key === 'behavior' && Array.isArray(value)) {
                return [key, value.filter(function (i) {
                  return i !== constants.DSFeatureEnum.AdvancedQuery;
                })];
              }
              /** 更新内容区 */
              if (key === 'body' && Array.isArray(value) && (host === null || host === void 0 ? void 0 : host.type) === 'form') {
                return [key, value.filter(function (item) {
                  return (item === null || item === void 0 ? void 0 : item.behavior) !== constants.DSFeatureEnum.AdvancedQuery && item.type !== 'condition-builder';
                })];
              }
              return [key, value];
            });
          ...
          case 4:
            ...
            return [4 /*yield*/, builder.buildCRUDFilterSchema({
              ...
              inScaffold: false,
              schema: CRUDSchema,
              feats: [constants.DSFeatureEnum.AdvancedQuery],
              buildSettings: {
                useDefaultFields: true
              }
            })];
      ...
      return tslib.__generator(this, function (_p) {
        switch (_p.label) {
          case 0:
            ...
            headerToolbar = cloneDeep__default["default"](CRUDSchema.headerToolbar);
            /** 关闭功能且存在定位容器 */
            if (!enable) {
              if (headerToolbar) {
                utils$1.deepRemove(headerToolbar, function (schema) {
                  return schema.behavior === constants.DSFeatureEnum.FuzzyQuery && schema.type === 'search-box';
                }, true);
                CRUDNode.updateSchema(tslib.__assign(tslib.__assign({}, CRUDSchema), {
          ...
          case 1:
            _l.apply(_k, [tslib.__assign.apply(void 0, _m.concat([(_o.headerToolbar = _p.sent(), _o)]))]);
            return [2 /*return*/];
          case 2:
            utils.traverseSchemaDeep(CRUDSchema, function (key, value, host) {
          ...
          case 3:
            ...
            newFuzzyParent = cloneDeep__default["default"](fuzzyQueryParent);
            newFuzzyParent.body = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(newFuzzyParent.body), false), [fuzzyQuerySchema], false);
          ...
          case 5:
            ...
            newFlexContainer = cloneDeep__default["default"](headerToolbar[0]);
          ...
          case 6:
            ...
            return [3 /*break*/, 9];
          case 7:
            newHeaderToolbar = cloneDeep__default["default"](headerToolbar);
  ...
  CRUDFiltersControl.prototype.handleEdit = function (item) {
    ...
    if (!targetNodeId) {
      amis.toast.warning(i18nRuntime.i18n("e11e888f47bc6cd5816a1147be05e792"));
      return;
    }
  ...
  CRUDFiltersControl.prototype.renderOption = function (item, index) {
    ...
    }, React__default["default"].createElement("span", null, item.label))), React__default["default"].createElement("div", {
      className: cx('ae-CRUDConfigControl-list-item-actions')
    }, ((_b = item === null || item === void 0 ? void 0 : item.context) === null || _b === void 0 ? void 0 : _b.isCascadingField) ? React__default["default"].createElement(amis.Tag, {
    ...
    }) : null, feat === 'SimpleQuery' ? React__default["default"].createElement(amis.Button, {
      level: "link",
      size: "sm",
      tooltip: {
        content: i18nRuntime.i18n("eee03351367bb1907dcc3140ffa3e3b8"),
        tooltipTheme: 'dark',
        style: {
          fontSize: '12px'
        }
  ...
  CRUDFiltersControl.prototype.renderHeader = function () {
    ...
    return React__default["default"].createElement("header", {
    ...
    }, React__default["default"].createElement(amis.Switch, {
      ...
      size: "sm",
      tooltip: {
        content: i18nRuntime.i18n("e6413abdc2fd3ccbbf15327e4004b1b2"),
        tooltipTheme: 'dark',
        style: {
          fontSize: '12px'
        }
  ...
  CRUDFiltersControl.prototype.render = function () {
    ...
    }, this.renderHeader(), React__default["default"].createElement("ul", {
      className: cx('ae-CRUDConfigControl-list')
    }, loading ? React__default["default"].createElement(amis.Spinner, {
      show: true,
      tip: i18nRuntime.i18n("4c2dc6491d29ef77f421daa19541c8ab"),
      tipPlacement: "bottom",
      size: "sm",
      className: cx('flex')
    ...
    }, i18nRuntime.i18n("fcebd5cda006253365b4453596290f48"))));
  };
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", Promise)], CRUDFiltersControl.prototype, "initOptions", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Boolean]), tslib.__metadata("design:returntype", Promise)], CRUDFiltersControl.prototype, "updateAdvancedQuery", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Boolean]), tslib.__metadata("design:returntype", Promise)], CRUDFiltersControl.prototype, "updateFuzzyQuery", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Boolean]), tslib.__metadata("design:returntype", Promise)], CRUDFiltersControl.prototype, "handleToggle", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], CRUDFiltersControl.prototype, "handleEdit", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Number]), tslib.__metadata("design:returntype", void 0)], CRUDFiltersControl.prototype, "renderOption", null);
  return CRUDFiltersControl;
}(React__default["default"].Component);
/** @class */(function (_super) {
  tslib.__extends(CRUDFiltersControlRenderer, _super);
  function CRUDFiltersControlRenderer() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  CRUDFiltersControlRenderer = tslib.__decorate([amis.FormItem({

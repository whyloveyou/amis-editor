...
var utils = require('../../plugin/CRUD2/utils.js');
...
var CRUDToolbarControl = /** @class */function (_super) {
  tslib.__extends(CRUDToolbarControl, _super);
  function CRUDToolbarControl(props) {
    var _this = _super.call(this, props) || this;
    /** 可供使用的功能集合 */
    _this.collection = [constants.DSFeatureEnum.Insert, constants.DSFeatureEnum.BulkEdit, constants.DSFeatureEnum.BulkDelete];
    _this.state = {
      options: [],
      loading: false
    };
  ...
  CRUDToolbarControl.prototype.getActions = function (props) {
    ...
    var actions = amisCore.findTreeAll(node.children, function (item) {
      return [constants.DSFeatureEnum.Insert, constants.DSFeatureEnum.BulkEdit, constants.DSFeatureEnum.BulkDelete, 'custom'].includes(item.schema.behavior);
    });
    return actions;
  };
  ...
  CRUDToolbarControl.prototype.getOptionLabel = function (schema, behavior) {
    return behavior === 'custom' ? schema.label : constants.DSFeature[behavior].label;
  };
  CRUDToolbarControl.prototype.handleEdit = function (item) {
    var manager = this.props.manager;
    if (!item.nodeId) {
      amis.toast.warning("\u672A\u627E\u5230\u5DE5\u5177\u680F\u4E2D\u5BF9\u5E94\u64CD\u4F5C\u300C".concat(item.label, "\u300D"));
      return;
    }
        ...
        switch (_f.label) {
          ...
          case 5:
            return [4 /*yield*/, builder.buildCRUDBulkDeleteSchema({
              feat: constants.DSFeatureEnum.BulkDelete,
              renderer: 'crud',
              inScaffold: false,
              schema: ctx,
              scaffoldConfig: {
          ...
          case 8:
            ...
            headerToolbarSchema = cloneDeep__default["default"](ctx.headerToolbar);
            actionSchema = amisEditorCore.JSONPipeIn(tslib.__assign({}, scaffold));
            options.push({
      ...
      return tslib.__generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            headerToolbarSchema = cloneDeep__default["default"](ctx.headerToolbar);
            if (confirmed) {
              marked = utils.deepRemove(headerToolbarSchema, function (item) {
  ...
  CRUDToolbarControl.prototype.renderHeader = function () {
    ...
    return React__default["default"].createElement("header", {
    ...
    }, i18nRuntime.i18n("012f602372cd2dbd639cd966c63e1f90")), render('crud-toolbar-control-dropdown', {
      ...
      icon: 'column-add',
      label: i18nRuntime.i18n("84a2f40385427bbf2edc79e3368e4e0f"),
      className: cx('ae-CRUDConfigControl-dropdown'),
      disabledTip: {
        content: i18nRuntime.i18n("dc858fed3c66a1194d5f9aec81faee3d"),
        tooltipTheme: 'dark'
      },
      buttons: actions.map(function (item) {
        return {
          type: 'button',
          label: constants.DSFeature[item].label,
        ...
        type: 'button',
        label: i18nRuntime.i18n("fb3304d27d85c79d89ce6cac22a174b8"),
        disabled: false,
        onClick: function () {
  ...
  CRUDToolbarControl.prototype.render = function () {
    ...
    return React__default["default"].createElement("div", {
      ...
      show: true,
      tip: i18nRuntime.i18n("e40c411876b4a57e24fbc6b4b4fd5027"),
      tipPlacement: "bottom",
      size: "sm",
      className: cx('flex')
    }) : React__default["default"].createElement(React__default["default"].Fragment, null, this.renderHeader(), React__default["default"].createElement("ul", {
    ...
    }, i18nRuntime.i18n("21efd88b67a39834582ad99aabb9dc60")))));
  };
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], CRUDToolbarControl.prototype, "handleEdit", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [String]), tslib.__metadata("design:returntype", Promise)], CRUDToolbarControl.prototype, "handleAddAction", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Number]), tslib.__metadata("design:returntype", Promise)], CRUDToolbarControl.prototype, "handleDelete", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Number]), tslib.__metadata("design:returntype", void 0)], CRUDToolbarControl.prototype, "renderOption", null);
  return CRUDToolbarControl;
}(React__default["default"].Component);
/** @class */(function (_super) {
  tslib.__extends(CRUDToolbarControlRenderer, _super);
  function CRUDToolbarControlRenderer() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  CRUDToolbarControlRenderer = tslib.__decorate([amis.FormItem({

...
var AddColumnModal = require('./AddColumnModal.js');
...
var CRUDColumnControl = /** @class */function (_super) {
  tslib.__extends(CRUDColumnControl, _super);
  ...
  CRUDColumnControl.prototype.initDragging = function () {
    ...
    this.sortable = new Sortable__default["default"](dom.querySelector(".".concat(cx('ae-CRUDConfigControl-list'))), {
  ...
  CRUDColumnControl.prototype.handleEdit = function (item) {
    ...
    if (!~idx) {
      amis.toast.warning("\u672A\u627E\u5230\u5BF9\u5E94\u5217\u300C".concat(item.label, "\u300D"));
      return;
    }
  ...
  CRUDColumnControl.prototype.handleAddColumn = function (type) {
    ...
    switch (type) {
      case 'field':
        this.setState({
          showAddModal: true,
          addModalData: {
            colTypeLabel: i18nRuntime.i18n("8eebb8ae809cf1ceaa23cd2fa2c73898"),
            colType: type
          }
        });
        break;
      case 'empty':
        scaffold = {
          title: i18nRuntime.i18n("f9e759ac21d528e7d1e84b5feae4560a"),
          name: 'empty'
        };
        break;
      case 'container':
        scaffold = {
          title: i18nRuntime.i18n("22c799040acdb2601b437ed5449de076"),
          name: 'container',
          type: 'container',
          style: {
            position: 'static',
      ...
      case 'operation':
        this.setState({
          showAddModal: true,
          addModalData: {
            colTypeLabel: i18nRuntime.i18n("39ccc34fa3ee9be12d8bae7e6fecbac2"),
            colType: type
          }
        });
        break;
    ...
    var columnSchema = amisEditorCore.JSONPipeIn(tslib.__assign({}, scaffold));
    options.push({
  ...
  CRUDColumnControl.prototype.renderOption = function (item, index) {
    ...
    }, item.hidden || !((_b = item === null || item === void 0 ? void 0 : item.context) === null || _b === void 0 ? void 0 : _b.isCascadingField) ? null : React__default["default"].createElement(amis.Tag, {
  ...
  CRUDColumnControl.prototype.renderHeader = function () {
    ...
    return React__default["default"].createElement("header", {
    ...
    }, i18nRuntime.i18n("dc7558211f2990370954c2e7ca498ee9")), render('column-control-dropdown', {
      ...
      icon: 'column-add',
      label: i18nRuntime.i18n("49198f84cea6c212cd5d463037827cd5"),
      ...
      buttons: [{
        ...
        type: 'button',
        label: i18nRuntime.i18n("f9e759ac21d528e7d1e84b5feae4560a"),
        onClick: function () {
          return _this.handleAddColumn('empty');
        }
      }, {
        type: 'button',
        label: i18nRuntime.i18n("7202bba23492811d2964234485a909e5"),
        onClick: function () {
  ...
  CRUDColumnControl.prototype.render = function () {
    ...
    return React__default["default"].createElement("div", {
      ...
      size: "sm",
      className: cx('flex')
    }) : Array.isArray(options) && options.length > 0 ? React__default["default"].createElement(React__default["default"].Fragment, null, this.renderHeader(), React__default["default"].createElement("ul", {
    ...
    }, i18nRuntime.i18n("21efd88b67a39834582ad99aabb9dc60"))), showAddModal ? React__default["default"].createElement(AddColumnModal["default"], {
  ...
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], CRUDColumnControl.prototype, "dragRef", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], CRUDColumnControl.prototype, "handleSort", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], CRUDColumnControl.prototype, "handleEdit", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [String]), tslib.__metadata("design:returntype", void 0)], CRUDColumnControl.prototype, "handleAddColumn", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", void 0)], CRUDColumnControl.prototype, "handleAddModalConfirm", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], CRUDColumnControl.prototype, "handleAddModalClose", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Number]), tslib.__metadata("design:returntype", Promise)], CRUDColumnControl.prototype, "handleDelete", null);
  tslib.__decorate([amis.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Number]), tslib.__metadata("design:returntype", void 0)], CRUDColumnControl.prototype, "renderOption", null);
  return CRUDColumnControl;
}(React__default["default"].Component);
/** @class */(function (_super) {
  tslib.__extends(CRUDColumnControlRenderer, _super);
  function CRUDColumnControlRenderer() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  CRUDColumnControlRenderer = tslib.__decorate([amis.FormItem({

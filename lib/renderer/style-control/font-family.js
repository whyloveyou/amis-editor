 ...
 */
var fontFamilyList = [{
  label: i18nRuntime.i18n("65786fea9d354015d3a2724086f7f3d6"),
  value: ''
}, {
...
fontFamilyList.reduce(function (memo, current) {
  var _a;
  return tslib.__assign(tslib.__assign({}, memo), (_a = {}, _a[current.label] = current.value, _a));
}, {});
fontFamilyList.reduce(function (memo, current) {
  var _a;
  return tslib.__assign(tslib.__assign({}, memo), (_a = {}, _a[current.value] = current.label, _a));
}, {});

...
function InsetBoxModel(_a) {
    ...
    function handleChange(styleName) {
        return function (e) {
            ...
            if (!inputValue) {
                onChange(tslib.__assign(tslib.__assign({}, value), (_a = {}, _a[styleName] = '', _a)));
                return;
            }
            // 数字类型或带有合法单位的字符串都支持
...
mobxReact.observer(InsetBoxModel);
/** @class */ ((function (_super) {
    ...
    BoxModelRenderer.prototype.render = function () {
        return React__default["default"].createElement(InsetBoxModel, tslib.__assign({}, this.props));
    };
    BoxModelRenderer = tslib.__decorate([
        amis.FormItem({ type: 'inset-box-model' })
    ], BoxModelRenderer);

...
var BadgeControl = /** @class */function (_super) {
  ...
  BadgeControl.prototype.renderBody = function () {
    ...
    return render('badge-form', {
      ...
      submitOnChange: true,
      body: [{
        label: i18nRuntime.i18n("a7999d1390b7dc775e4287511c395d6c"),
        name: 'mode',
        ...
        label: amisEditorCore.tipedLabel(i18nRuntime.i18n("29e13ada94b145a1359291d5e1564655"), i18nRuntime.i18n("31175366279c15232e27b6736ccb2fd4")),
        name: 'overflowCount',
        type: 'input-number',
        size: 'sm',
        ...
        options: [{
          ...
          label: i18nRuntime.i18n("1c9bc9dab33944e953412f8b22cb024a"),
          value: 'bottom-right'
        }],
  ...
  BadgeControl.prototype.render = function () {
    ...
    }, render('', amisEditorCore.getSchemaTpl('switch', {
      label: amisEditorCore.tipedLabel(i18nRuntime.i18n("b8c467fce096a649583c0bc9d9281a5c"), i18nRuntime.i18n("b3c1b71ed42c7f2fe55f3c64346f1ae6")),
      name: 'checked',
      mode: 'horizontal',
      value: checked,

...
var TableColumnWidthControl = /** @class */function (_super) {
  tslib.__extends(TableColumnWidthControl, _super);
  function TableColumnWidthControl(props) {
    var _this = _super.call(this, props) || this;
    _this.options = [{
      label: i18nRuntime.i18n("07c60b53a84fd7751095864a5310cc7d"),
      value: 'adaptive'
    }, {
      label: i18nRuntime.i18n("81522afdfef2e4121c9240d00583f531"),
      value: 'percentage'
    }, {
  ...
  TableColumnWidthControl.prototype.renderBody = function () {
    ...
    if (activeOption.value === 'fixed') {
      return render('columnWidthControl-fixed', amisEditorCore.getSchemaTpl('withUnit', {
        label: i18nRuntime.i18n("9a8aed590bb7fcdd9198daca349b055a"),
        name: 'interval',
        control: {
          type: 'input-number',
          min: 0,
    ...
    return render('columnWidthControl-fixed', {
      ...
      max: 100,
      step: 1,
      label: i18nRuntime.i18n("e0dbf4a939e6c84610d28b8a9b1803c1"),
      value: amisCore.toNumber(value),
      onChange: function (val) {
  ...
  TableColumnWidthControl.prototype.render = function () {
    return React__default["default"].createElement("div", {
      className: cx__default["default"]('ae-columnWidthControl')
    }, this.renderHeader(), this.renderBody());
  };
  return TableColumnWidthControl;
}(React__default["default"].Component);
/** @class */(function (_super) {
  tslib.__extends(TableColumnWidthControlRender, _super);
  function TableColumnWidthControlRender() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  TableColumnWidthControlRender = tslib.__decorate([amis.FormItem({

...
var DialogPlugin = /** @class */function (_super) {
  ...
  function DialogPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("6cff4b6d794cc17f5d24dbe0d21e5732");
        ...
        return amisEditorCore.getSchemaTpl('tabs', [{
          ...
          body: amisEditorCore.getSchemaTpl('collapseGroup', [{
            ...
            body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
              ...
              label: i18nRuntime.i18n("e406488d1b9545168eb1896e35139bf2"),
              type: 'input-text',
              name: 'confirmText'
            }, amisEditorCore.getSchemaTpl('layout:originPosition', {
              value: 'left-top'
            }), {
              label: i18nRuntime.i18n("d919d62d7e5ec5cb63ad47e5dc347a7e"),
              type: 'input-text',
              name: 'cancelText'
          ...
          body: amisEditorCore.getSchemaTpl('collapseGroup', [{
            ...
            body: [{
              ...
              label: i18nRuntime.i18n("b12df8decf62700970e08b9b2ebce1f8"),
              name: 'confirmBtnLevel'
            }), amisEditorCore.getSchemaTpl('buttonLevel', {
              label: i18nRuntime.i18n("7f29931020c2d8ce97b8043a933db151"),
              name: 'cancelBtnLevel'
            })]
          }])
        }]);
  ...
  DialogPlugin.prototype.patchSchema = function (schema, info, props) {
    ...
    return tslib.__assign(tslib.__assign({}, schema), {
      actions: [{
        ...
        type: 'button',
        actionType: 'confirm',
        label: i18nRuntime.i18n("38cf16f2204ffab8a6e0187070558721"),
        primary: true
...
var InlineModal = /** @class */function (_super) {
  ...
  InlineModal.prototype.render = function () {
    ...
    var Container = type === 'drawer' ? amisUi.Drawer : amisUi.Modal;
    if (dialogType === 'confirm') {
      children = children.filter(function (item) {
        return (item === null || item === void 0 ? void 0 : item.key) !== 'actions';
      });
      return React__default["default"].createElement(amisUi.Modal, tslib.__assign({}, this.props, {
      ...
      }, cancelText || i18nRuntime.i18n("625fb26b4b3340f7872b411f401e754c")), React__default["default"].createElement(amisUi.Button, {
        className: "ae-InlineModal-footer-btn",
        level: confirmBtnLevel
      }, confirmText || i18nRuntime.i18n("e83a256e4f5bb4ff8b3d804b5473217a")))));
    }
    return React__default["default"].createElement(Container, tslib.__assign({}, this.props, {
      container: editorDialogMountNode
    }), children);
  };
  return InlineModal;

...
var TablePlugin = /** @class */function (_super) {
  tslib.__extends(TablePlugin, _super);
  function TablePlugin(manager) {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("642d94fa418e15a3997bcf7488315e4d");
    ...
    _this.actions = [{
      ...
      actionType: 'initDrag',
      actionLabel: i18nRuntime.i18n("b94bd878cae4ddc567b00a2dc4f21d74"),
      description: i18nRuntime.i18n("5dc3017c21ae2e31ab127dbde8ec80e9")
    }];
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [{
          ...
          }, isCRUDBody ? null : amisEditorCore.getSchemaTpl('sourceBindControl', {
            label: i18nRuntime.i18n("c11322c9cc43ce3c004cf03f5ac0acd0")
          }), {
            name: 'combineNum',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("25915fb58615ba9a5e145efa252fec30"), i18nRuntime.i18n("80174cabf025dfe269aee5390b813708")),
            type: 'input-number',
            labelAlign: 'left',
            horizontal: {
              left: 5,
            ...
            placeholder: i18nRuntime.i18n("d7d0936858fcdf4ffdb2899451ec74fc")
          }, {
            type: 'ae-switch-more',
            mode: 'normal',
            formType: 'extend',
            ...
            form: {
              body: [{
                ...
                }, i18nRuntime.i18n("e6aa1b827415217c524ae9d9b665cca5"))
              }]
            }
          }, {
            type: 'ae-switch-more',
            ...
            form: {
              body: [{
                ...
                }, i18nRuntime.i18n("a2ecfd5a0db9c855f59eea75083678e6"))
              }]
            }
          }
          // {
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [{
            ...
            name: 'affixHeader',
            label: i18nRuntime.i18n("e8bb313fb86cf474c0e264794bc85896"),
            pipeIn: amisEditorCore.defaultValue(true)
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'footable',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("5006fdc5659989e42c3855c17c57f878"), i18nRuntime.i18n("9db359f376a1a588ef7dcbef53cc114a")),
            ...
            label: i18nRuntime.i18n("df74194830e695efbfce16c0c64223cf"),
            pipeIn: amisEditorCore.defaultValue('none'),
            options: [{
              label: i18nRuntime.i18n("94be543c4fd399f0839211464c8583ce"),
              value: 'first'
            }, {
              label: i18nRuntime.i18n("9a7b52fc8659f1786907fe93efa85bf7"),
              value: 'all'
            }, {
              label: i18nRuntime.i18n("b07deca9076bd3354b1b2709d58d725a"),
              value: 'none'
            }]
          }, {
            name: 'placeholder',
            ...
            type: 'input-text',
            label: i18nRuntime.i18n("76b3250fb1e8593fac075b64029300fa"),
            placeholder: i18nRuntime.i18n("1fe38acb67e766f7767d9f8e88bfe990")
          }]
        }, {
          ...
          body: [amisEditorCore.getSchemaTpl('className', {
            ...
            label: i18nRuntime.i18n("9e25d776a57c610940bcc1c19847b97d")
          }), amisEditorCore.getSchemaTpl('className', {
            name: 'footerClassName',
            label: i18nRuntime.i18n("2ec1b0bb189b486945e79c167a4a024d")
          }), amisEditorCore.getSchemaTpl('className', {
          ...
          case 6:
            ...
            if (node.schema.source) {
              ...
              while (scope) {
                ...
                if (rowMembers) {
                  itemsSchema = tslib.__assign(tslib.__assign({}, itemsSchema), {
                    properties: tslib.__assign(tslib.__assign({}, itemsSchema.properties), (_f = (_e = (_d = rowMembers.properties) === null || _d === void 0 ? void 0 : _d[source_1]) === null || _e === void 0 ? void 0 : _e.items) === null || _f === void 0 ? void 0 : _f.properties)
                  });
                }
            ...
            return [2 /*return*/, {
              ...
              properties: {
                ...
                selectedItems: {
                  type: 'array',
                  title: i18nRuntime.i18n("41c5c859a80b635c23b3b4d1d8b44efb"),
                  items: itemsSchema
                },
                unSelectedItems: {
                  type: 'array',
                  title: i18nRuntime.i18n("f87912f19be48f36e4e261e585764d6e"),
                  items: itemsSchema
                }
              }
            }];
  ...
  TablePlugin.prototype.editHeaderDetail = function (id) {
    ...
    node && value && this.manager.openSubEditor({
      ...
      value: util.schemaToArray((_a = value.header) !== null && _a !== void 0 ? _a : defaultHeader),
      slot: {
        type: 'container',
        body: '$$'
      },
      onChange: function (newValue) {
        newValue = tslib.__assign(tslib.__assign({}, value), {
          header: util.schemaArrayFormat(newValue)
        });
  ...
  TablePlugin.prototype.editFooterDetail = function (id) {
    ...
    node && value && this.manager.openSubEditor({
      ...
      value: util.schemaToArray((_a = value.footer) !== null && _a !== void 0 ? _a : defaultFooter),
      slot: {
        type: 'container',
        body: '$$'
      },
      onChange: function (newValue) {
        newValue = tslib.__assign(tslib.__assign({}, value), {
          footer: util.schemaArrayFormat(newValue)
        });
        manager.panelChangeValue(newValue, amisEditorCore.diff(value, newValue));
      }
    });
  ...
  TablePlugin.prototype.componentRef = function (node, ref) {
    ...
    if (ref) {
      ...
      this.unWatchWidthChange[node.id] = mobx.reaction(function () {
...
amisEditorCore.registerEditorPlugin(TablePlugin);

...
amisFormula.registerFilter('appTranslate', function (input) {
  return amisEditorCore.translateSchema(input);
});
var AnchorNavPlugin = /** @class */function (_super) {
  tslib.__extends(AnchorNavPlugin, _super);
  function AnchorNavPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("bede211909a1022b13e9728ed162b77e");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("f6da8aa86fa3e399da95dab399a67985");
    ...
    _this.scaffold = {
      type: 'anchor-nav',
      links: [{
        title: i18nRuntime.i18n("5879dec0aea52871e0ae6969893a315b"),
        href: '1',
        body: [{
          type: 'tpl',
          tpl: i18nRuntime.i18n("ce08bc4247c040bac13155befc7c1638"),
          wrapperComponent: '',
          inline: false
        }]
      }, {
        title: i18nRuntime.i18n("d89a42cb938819f67172ea64037c19fe"),
        href: '2',
        body: [{
          type: 'tpl',
          tpl: i18nRuntime.i18n("96f05e63c6f606925636d6810167e7ea"),
          wrapperComponent: '',
          inline: false
        }]
      }, {
        title: i18nRuntime.i18n("31327b9041b825a0b455b3ff9ddd3909"),
        href: '3',
        body: [{
          type: 'tpl',
          tpl: i18nRuntime.i18n("68284dd430993f495a6f2254ae5480ae"),
          wrapperComponent: '',
          inline: false
        }]
      }]
    ...
    _this.panelTitle = i18nRuntime.i18n("bede211909a1022b13e9728ed162b77e");
    ...
    _this.panelBody = [amisEditorCore.getSchemaTpl('tabs', [{
      ...
      body: amisEditorCore.getSchemaTpl('collapseGroup', [{
        ...
        body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
          ...
          type: 'combo',
          name: 'links',
          label: i18nRuntime.i18n("9ad515106f02f3909974b75d22625b0d"),
          mode: 'normal',
          multiple: true,
          draggable: true,
          minLength: 1,
          addButtonText: i18nRuntime.i18n("40c6e9ed3d9949a326f5a216d936324d"),
          deleteBtn: {
            icon: 'fa fa-trash'
          },
          items: [amisEditorCore.getSchemaTpl('anchorTitle')],
          scaffold: {
            title: i18nRuntime.i18n("6be15e9949e4be7fc485e1eaae472942"),
            href: '',
            body: [{
              type: 'tpl',
              tpl: i18nRuntime.i18n("c624c875ea37f790665d0cae8959d4e2"),
              wrapperComponent: '',
              inline: false
            }]
          },
          ...
          pipeOut: function (value) {
            ...
            value.forEach(function (item) {
              if (!item.href) {
                ...
                item.href = key;
                item.title = i18nRuntime.i18n("6be15e9949e4be7fc485e1eaae472942").concat(key);
                item.body[0].tpl = i18nRuntime.i18n("c624c875ea37f790665d0cae8959d4e2").concat(key);
              }
            });
            return value;
          }
          ...
          name: 'active',
          type: 'select',
          label: i18nRuntime.i18n("39f4fbc5b5ba681f7e8c4d4a4ddb3e2f"),
      ...
      body: amisEditorCore.getSchemaTpl('collapseGroup', [{
        ...
        body: [{
          ...
          name: 'direction',
          label: i18nRuntime.i18n("9959b2ad2d4f75f7a6be46872642df6d"),
          value: 'vertical',
          options: [{
        ...
        schema: [amisEditorCore.getSchemaTpl('className', {
          name: 'linkClassName',
          label: i18nRuntime.i18n("056f2d7df6e6b64625c3a2d27ce07b05")
        }), amisEditorCore.getSchemaTpl('className', {
          name: 'sectionClassName',
          label: i18nRuntime.i18n("696754a8b2b23e30b11187303d1238f5")
        })]
      })])
    }])];
    ...
    _this.vRendererConfig = {
      ...
      panelTitle: i18nRuntime.i18n("33be689a0f0de129ce37f7a96052002e"),
      panelJustify: true,
      panelBody: [amisEditorCore.getSchemaTpl('tabs', [{
        title: i18nRuntime.i18n("24d67862f87f439db7ca957aecb77cce"),
        body: [amisEditorCore.getSchemaTpl('collapseGroup', [{
          title: i18nRuntime.i18n("4092ed98e9035652d4c9ca9441701ed7"),
          body: [amisEditorCore.getSchemaTpl('anchorNavTitle')]
        }])]
      }, {
        title: i18nRuntime.i18n("afcde2611bdd13c1e65b4fb6a2f13425"),
        body: [amisEditorCore.getSchemaTpl('collapseGroup', [{
      ...
      render: function () {
        ...
        if (!this.renderSection && this.props.$$editor && dom) {
          ...
          return amisEditorCore.mapReactElement(dom, function (item) {
            var _a, _b;
            if (item.type === amisUi.AnchorNavSection && item.props.$$id) {
              var id_1 = item.props.$$id;
              var index = findIndex__default["default"](links_1, function (link) {
                return link.$$id === id_1;
              });

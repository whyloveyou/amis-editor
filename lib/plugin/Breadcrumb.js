...
var BreadcrumbPlugin = /** @class */function (_super) {
  tslib.__extends(BreadcrumbPlugin, _super);
  function BreadcrumbPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("169b227aff15b834b64205d0fdcb0f33");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-list';
    _this.pluginIcon = 'breadcrumb-plugin';
    _this.description = i18nRuntime.i18n("3576258acd7269da9f44859a2edec1aa");
    _this.docLink = '/amis/zh-CN/components/breadcrumb';
    _this.tags = [i18nRuntime.i18n("0d98c74797e49d00bcc4c17c9d557a2b")];
    _this.scaffold = {
      type: 'breadcrumb',
      items: [{
        label: i18nRuntime.i18n("db1c89e0f6e62f9642018cbb531bbd4f"),
        href: '/',
        icon: 'fa fa-home'
      }, {
        label: i18nRuntime.i18n("2e8bf3c87641fba59c2a9cb6636d7e88")
      }, {
        label: i18nRuntime.i18n("12d358955755488ff3790bbd6d75673a")
      }]
    };
    _this.previewSchema = tslib.__assign({}, _this.scaffold);
    _this.panelTitle = i18nRuntime.i18n("169b227aff15b834b64205d0fdcb0f33");
    _this.panelBody = [amisEditorCore.getSchemaTpl('tabs', [{
      ...
      body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
        ...
        label: i18nRuntime.i18n("a38100f22f59f7cd89e36139faa6fd4d"),
        name: 'source'
      }), {
        label: i18nRuntime.i18n("169b227aff15b834b64205d0fdcb0f33"),
        name: 'items',
        type: 'combo',
        multiple: true,
        multiLine: true,
        ...
        items: [{
          ...
          type: 'input-text',
          name: 'href',
          placeholder: i18nRuntime.i18n("bfe68d5844f8e54602760e18f45954f7")
      ...
      body: [amisEditorCore.getSchemaTpl('className'), amisEditorCore.getSchemaTpl('className', {
        name: 'itemClassName',
        label: i18nRuntime.i18n("ba7f916a39c0beb545388ea3b7f6b3b7")
      }),, amisEditorCore.getSchemaTpl('className', {
        name: 'separatorClassName',
        label: i18nRuntime.i18n("e3acc9857c852dae27e064ace5e5688e")
      })]
    }, {

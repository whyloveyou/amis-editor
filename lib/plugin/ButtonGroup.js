...
var ButtonGroupPlugin = /** @class */function (_super) {
  tslib.__extends(ButtonGroupPlugin, _super);
  function ButtonGroupPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("c8caf94205105bac5833ab31cc2129d7");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("66ae9ce23b0b2e243aff087d906a2489");
    ...
    _this.panelTitle = i18nRuntime.i18n("c8caf94205105bac5833ab31cc2129d7");
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            name: 'vertical',
            label: i18nRuntime.i18n("de26e1294acedb55155a418630d57924"),
            options: [{
            ...
            name: 'tiled',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("8eb18b36f5a27fa8e6d32bc66546ce05"), i18nRuntime.i18n("2e28645c67c5742e473888a27aab7bd6")),
            pipeIn: amisEditorCore.defaultValue(false)
    ...
    _this.regions = [{
      key: 'buttons',
      label: i18nRuntime.i18n("40f3bc0a4f4d0f4230fc7fa6f4fcec92"),
      renderMethod: 'render',

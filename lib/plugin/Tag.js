...
var TagPlugin = /** @class */function (_super) {
  ...
  function TagPlugin() {
    ...
    _this.events = [{
        ...
        properties: {
          ...
          data: {
            ...
            properties: {
              label: {
                type: 'object',
                title: i18nRuntime.i18n("341fe804cc8b65dc17a31c7a25a90444")
              }
            }
          }
        }
      ...
      eventName: 'close',
      eventLabel: i18nRuntime.i18n("d04f139ee0fb6fac19ccaec0f7b323df"),
      description: i18nRuntime.i18n("fe7967a547915be9ae4083ed50c3b94a"),
      dataSchema: [{
        type: 'object',
        properties: {
          context: {
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('valueFormula', {
            name: 'label',
            label: i18nRuntime.i18n("5cbd7ad8a3ecf059b62219c17fa58cae"),
            rendererSchema: {
              type: 'input-text'
            }
          }), {

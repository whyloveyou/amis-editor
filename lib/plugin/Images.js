...
var ImagesPlugin = /** @class */function (_super) {
  tslib.__extends(ImagesPlugin, _super);
  function ImagesPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("e040fc4bf539dd1cf6ebca6b4bff857a");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("93f46deec83b8f9005233a1467498d52");
    ...
    _this.previewSchema = tslib.__assign(tslib.__assign({}, _this.scaffold), {
      ...
      thumbMode: 'cover',
      value: [{
        title: i18nRuntime.i18n("2382c315a6ba396be1932dd8dafaff52"),
        image: amisEditorCore.mockValue({
          type: 'image'
        }),
        src: amisEditorCore.mockValue({
          type: 'image'
        })
      }, {
        title: i18nRuntime.i18n("ce6e2814f207c9333f10785606c57df3"),
        image: amisEditorCore.mockValue({
          type: 'image'
        }),
        src: amisEditorCore.mockValue({
    ...
    _this.panelTitle = i18nRuntime.i18n("e040fc4bf539dd1cf6ebca6b4bff857a");
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: (isUnderField ? [] : [{
          ...
          }, amisEditorCore.getSchemaTpl('sourceBindControl', {
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("45a4922d3f42d0b137c6845c4c77031f"), i18nRuntime.i18n("47fd366b711a0567646854f541449f8b")),
            ...
            minLength: 1,
            label: i18nRuntime.i18n("81a2b634d7ddcffc21b787613673943c"),
            multiple: true,
            multiLine: true,
            addable: true,
            removable: true,
            ...
            name: 'enlargeAble',
            label: i18nRuntime.i18n("26122d95c72204c83ebdc37cd16a96f9")
          })]).concat([amisEditorCore.getSchemaTpl('imageUrl', {
            name: 'defaultImage',
...
amisEditorCore.registerEditorPlugin(ImagesPlugin);

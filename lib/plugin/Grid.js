...
var GridPlugin = /** @class */function (_super) {
  tslib.__extends(GridPlugin, _super);
  function GridPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("2820712cac089483cf2b4a0c939fc780");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("9e17d57a0ba39254a75c0265aa3063ca");
    ...
    */
    ...
    _this.previewSchema = {
      ...
      columns: [{
        body: [{
          type: 'tpl',
          tpl: i18nRuntime.i18n("e63907bf0db529e84866d1ae737bfc0d"),
          inline: false,
          wrapperComponent: '',
          className: 'bg-light wrapper'
        }]
    ...
    _this.panelTitle = i18nRuntime.i18n("9e17d57a0ba39254a75c0265aa3063ca");
    ...
    _this.vRendererConfig = {
      regions: {
        body: {
          ...
          placeholder: i18nRuntime.i18n("e63907bf0db529e84866d1ae737bfc0d"),
          wrapperResolve: function (dom) {
            return dom;
          }
        }
      },
      panelTitle: i18nRuntime.i18n("e63907bf0db529e84866d1ae737bfc0d"),
  ...
  GridPlugin.prototype.panelBodyCreator = function (context) {
    ...
    return [amisEditorCore.getSchemaTpl('tabs', [{
      ...
      title: i18nRuntime.i18n("afcde2611bdd13c1e65b4fb6a2f13425"),
      body: [amisEditorCore.getSchemaTpl('collapseGroup', tslib.__spreadArray([amisEditorCore.getSchemaTpl('subFormItemMode'), amisEditorCore.getSchemaTpl('subFormHorizontalMode'), amisEditorCore.getSchemaTpl('subFormHorizontal')], tslib.__read(amisEditorCore.getSchemaTpl('theme:common', {
        exclude: ['layout']
      })), false))]
    }])];
  };
  ...
  GridPlugin.prototype.buildEditorContextMenu = function (context, menus) {
    ...
    if (context.node.isVitualRenderer) {
      menus.push('|');
      menus.push({
        label: i18nRuntime.i18n("9cc03fc4b3e87e8410e10357a219b44e"),
        onSelect: function () {
          return _this.insertColumnBefore(context);
        }
      });
      menus.push({
        label: i18nRuntime.i18n("6b12fc99e2a46aed982d46b93ac191a0"),
        onSelect: function () {
          return _this.insertColumnAfter(context);
        }
      });

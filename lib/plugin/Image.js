    ...
    _this.panelBodyCreator = function (context) {
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          }), amisEditorCore.getSchemaTpl('backgroundImageUrl', {
            name: 'editorSetting.mock.src',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("1fd65acd90f99791d70ca70e046c9f05"), i18nRuntime.i18n("5789be67da4a1dc0fd9600bd626776a1"))
          }), {
            type: 'ae-switch-more',
            mode: 'normal',
            name: 'enlargeAble',
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          //   label: '显示图片尺寸'
          // }),
          amisEditorCore.getSchemaTpl('layout:display', {
            flexHide: true,
            value: 'inline-block',
          ...
          }, amisEditorCore.getSchemaTpl('theme:size', {
          ...
          body: [amisEditorCore.getSchemaTpl('theme:font', {
            label: i18nRuntime.i18n("eded9ed93a453c3f790126e30b776a22"),

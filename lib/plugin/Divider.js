      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            mode: 'horizontal',
            type: 'input-number',
            label: i18nRuntime.i18n("40d39c3bc7bebced7d63eace0191a0a8"),
            name: 'rotate',
            value: 0,
            min: -360,
            max: 360
            ...
            mode: 'horizontal',
            label: i18nRuntime.i18n("bade10099f8447210ce7b97fa106b527"),
          ...
          body: [{
            ...
            label: amisEditorCore.tipedLabel('距离', '标题和最近左、右边框之间的距离，默认值5%'),

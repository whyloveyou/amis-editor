...
var ResetPlugin = /** @class */function (_super) {
  tslib.__extends(ResetPlugin, _super);
  function ResetPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("4b9c3271dc2f299dc3aeffb369187513");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-eraser';
    _this.description = i18nRuntime.i18n("d5e6d5c44426a82e18e31eadf7f1e09b");

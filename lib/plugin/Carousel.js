...
var CarouselPlugin = /** @class */function (_super) {
  tslib.__extends(CarouselPlugin, _super);
  function CarouselPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("0c0180cb06a322199a67f10d4ec41cd5");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("1007c97dbf952e032ce13be3cb811f23");
    ...
    _this.scaffold = {
      type: 'carousel',
      options: [{
        image: amisEditorCore.mockValue({
          type: 'image'
        })
      }, {
    ...
    _this.panelTitle = i18nRuntime.i18n("0c0180cb06a322199a67f10d4ec41cd5");
      ...
      return [amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
          ...
          options: [{
            ...
            label: i18nRuntime.i18n("e760ec18028fc075c5705bf184589e70"),
            value: 2
          }]
        }, {
          ...
          name: 'name',
          type: 'input-text',
          description: i18nRuntime.i18n("793a763e73f1f742e3a16ddc2ed95ccb"),
          ...
          label: i18nRuntime.i18n("b9994cc749b4cfbbac0a9b140addd242"),
          mode: 'vertical',
          multiple: true,
          multiLine: true,
          addable: true,
          ...
          conditions: [{
            ...
            items: [amisEditorCore.getSchemaTpl('imageUrl', {
              name: 'content'
            }), amisEditorCore.getSchemaTpl('imageTitle'), amisEditorCore.getSchemaTpl('className', {
              label: i18nRuntime.i18n("ab8a46ccf46acbf82d020d11468291b1"),
              name: 'titleClassName',
              visibleOn: 'this.type == "image"'
            }), amisEditorCore.getSchemaTpl('imageDesc'), amisEditorCore.getSchemaTpl('className', {
              label: i18nRuntime.i18n("c6fc4066471664a8602c636cfe1cc766"),
            ...
            label: 'HTML',
            test: 'this.type === "html"',
            items: [amisEditorCore.getSchemaTpl('richText', {
              label: i18nRuntime.i18n("2d711b09bd0db0ad240cc83b30dd8014"),
              name: 'content'
            })],
            scaffold: {
              type: 'html',
              content: i18nRuntime.i18n("cfb6f6e4c92a61ed0e0717abc8d0eec7")
            }
          }],
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('switch', {
            name: 'auto',
            label: i18nRuntime.i18n("97cc997910b99083bd23c6ac39294ff3"),
            ...
            name: 'interval',
            label: i18nRuntime.i18n("9dd651411c1cb25e19249bb4ea8878c3"),
            valueType: 'number',
            pipeIn: amisEditorCore.defaultValue(5000)
          }), {
            name: 'duration',
            type: 'input-number',
            label: i18nRuntime.i18n("46bc66b19c2b589ebd24d1c583325080"),
            min: 100,
            step: 10,
            size: 'sm',
            pipeIn: amisEditorCore.defaultValue(500)
          }, {
            name: 'animation',
            label: i18nRuntime.i18n("5bc37c57ee54d407f441b222f02391db"),
            type: 'button-group-select',
            pipeIn: amisEditorCore.defaultValue('fade'),
            options: [{
              label: 'fade',
              value: 'fade'
            }, {
            ...
            name: 'controlsTheme',
            label: i18nRuntime.i18n("8a0d716ded7baa7ee356ff39c3cf0bec"),
            type: 'button-group-select',
            ...
            name: 'controls',
            label: i18nRuntime.i18n("f7471313dce32bc3669d338764a0d036"),
            type: 'button-group-select',
            pipeIn: amisEditorCore.defaultValue('dots,arrows'),
            multiple: true,
            options: [{
              label: i18nRuntime.i18n("1c0fe943329339003e9e3c1b12a27fe3"),
              value: 'dots'
            }, {
              label: i18nRuntime.i18n("e030190fd1c10b0c967f48e789fa86b1"),
              value: 'arrows'
            }]
          }, amisEditorCore.getSchemaTpl('switch', {
            name: 'alwaysShowArrow',
            label: i18nRuntime.i18n("9cb33a16b57ef10b79ae76a66379d66f"),
            ...
            mode: 'normal',
            name: 'multiple',
            label: i18nRuntime.i18n("f4f965513462fcc9fe6fe896a9c249d8"),
            formType: 'extend',
            form: {
              body: [{
                name: 'multiple.count',
                label: i18nRuntime.i18n("0bf60b32f9db93b87e08763b1c815469"),
                type: 'input-number',
                min: 2,
                step: 1
              }]
          ...
          title: i18nRuntime.i18n("0c0180cb06a322199a67f10d4ec41cd5")
        }), {
          title: i18nRuntime.i18n("0d98c74797e49d00bcc4c17c9d557a2b"),
          body: [{
            name: 'themeCss.baseControlClassName.--image-images-prev-icon',
            label: i18nRuntime.i18n("d63b707be8a6feb914a3f6899c38770f"),
            type: 'icon-select',
            returnSvg: true
          }, {
            name: 'themeCss.baseControlClassName.--image-images-next-icon',
            label: i18nRuntime.i18n("911f1640e858c362bfb3ba9a55e8269a"),
            type: 'icon-select',
            returnSvg: true
          }, amisEditorCore.getSchemaTpl('theme:select', {
            label: i18nRuntime.i18n("8a0b967b90e89dd8e7311065c1de720a"),

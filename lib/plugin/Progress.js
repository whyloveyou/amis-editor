...
var ProgressPlugin = /** @class */function (_super) {
  tslib.__extends(ProgressPlugin, _super);
  function ProgressPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("83077805e05ac6bedad69b47fca4462b");
    _this.searchKeywords = i18nRuntime.i18n("c77048def6e8a2d6c556a3fcc9c66730");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("b1aefb18d4bf96dc283a26d67abc41a8");
    ...
    _this.panelTitle = i18nRuntime.i18n("c7bff79d059a0b7ff9b02441959d8be2");
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            pipeIn: amisEditorCore.defaultValue('line'),
            tiled: true,
            options: [{
              label: i18nRuntime.i18n("ce179eca04fab0d584506b0d19736836"),
              value: 'line'
            }, {
              label: i18nRuntime.i18n("2db0fcd5342b479688fd999a0108ef5a"),
              value: 'circle'
            }, {
              label: i18nRuntime.i18n("3fa8b34a2744f62fe93dd599a275af39"),
              value: 'dashboard'
            }],
          ...
          }), amisEditorCore.getSchemaTpl('menuTpl', {
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("31c29c46536a5007522032d2a42db56a"), i18nRuntime.i18n("a6a41d1bfb5896210eb527d183a07958")),
            name: 'valueTpl',
            variables: [{
              label: i18nRuntime.i18n("2e01f5f5889e33d003bec7857cd38445"),
              children: [{
                label: i18nRuntime.i18n("1ca3fa86d8faa46cc75792bcf90d7fff"),
                value: 'value',
                tag: 'number'
              }]
            }],
            ...
            value: '-',
            placeholder: i18nRuntime.i18n("b0932e5bb7f7d95e3636d82d1a039854"),
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("940b12c19fcf7aced0cdd164edc9acbc"), i18nRuntime.i18n("9cf66e7783e4c9b1d74bcd411edb6950"))
          })]
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [{
            ...
            type: 'input-number',
            name: 'strokeWidth',
            label: i18nRuntime.i18n("2f0faae87508471abce4384b60900e15"),
            value: 6,
            min: 0,
            max: 100
          }, {
            ...
            label: i18nRuntime.i18n("bd9b3f7e564c9eeaedd72f1bcbb7fc9f"),
            value: 75,
            min: 0,
            max: 295
          }, {
            label: i18nRuntime.i18n("31a088147dc0006e4775d066980fa688"),
            name: 'gapPosition',
            type: 'button-group-select',
            visibleOn: 'data.mode === "dashboard"',
            value: amisEditorCore.defaultValue('bottom'),
            tiled: true,
            options: [{
            ...
            name: 'animate',
            label: i18nRuntime.i18n("77a7419dd4fad70c3f3e4b075b2c3fcb"),
            ...
            visibleOn: 'data.mode === "line"',
            options: [{
              label: i18nRuntime.i18n("a04564aaca658461333b00cbcd071518"),
              value: 'purity'
            }, {
              label: i18nRuntime.i18n("0a9fc7083e2768107fc178ff36f29ba0"),
              value: 'stripe'
            }],
            ...
            mode: 'normal',
            multiple: true,
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("6b36c6f7ec834692ec6c8e3816349fdd"), i18nRuntime.i18n("087e631da111edc6db508289a7b5a95b")),
            items: [{
              placeholder: 'color',
              type: 'input-color',
              name: 'color'

...
var CustomPlugin = /** @class */function (_super) {
  tslib.__extends(CustomPlugin, _super);
  function CustomPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("b82231f254baf9a28bf752683d31b169");
    _this.isBaseComponent = true;
    _this.disabledRendererPlugin = true; // 待完善，暂时隐藏
    _this.description = i18nRuntime.i18n("e5b5798a8bab7dc8a578431991731040");
    _this.docLink = '/amis/zh-CN/components/custom';
    _this.tags = [i18nRuntime.i18n("997c7a5d34f6fc628893f509d0df32e0"), i18nRuntime.i18n("22c799040acdb2601b437ed5449de076")];
    _this.icon = 'fa fa-gears';
    _this.scaffold = {
      type: 'custom',
      html: i18nRuntime.i18n("73ac822ddf4685dbfec661dec41a96b7"),
      onMount: "this.renderChild('body', props.body, document.getElementById('customBox'));",
      body: [{
        type: 'tpl',
        wrapperComponent: '',
        tpl: i18nRuntime.i18n("5323ab3e5c12066101244f0577c30e22")
      }]
    };
    ...
    _this.panelBody = [amisEditorCore.getSchemaTpl('layout:originPosition', {
      ...
      title: i18nRuntime.i18n("0b13dc6251002bf556263fb3e4675b11"),
      body: [{
        label: i18nRuntime.i18n("0b13dc6251002bf556263fb3e4675b11"),
        name: 'html',
        type: 'editor',
      ...
      body: [{
        ...
        allowFullscreen: true,
        size: 'xxl',
        label: i18nRuntime.i18n("d6b917c76b92aa9b92b6bebdcab993f3"),
        options: {
          lineNumbers: 'off',
          glyphMargin: false,
      ...
      body: [{
        ...
        allowFullscreen: true,
        size: 'xxl',
        label: i18nRuntime.i18n("e64739dd24bb0bfcb6f6e1ee2cce5413")
      }]
    }), amisEditorCore.getSchemaTpl('fieldSet', {
      title: 'onUnmount',
      body: [{
        ...
        allowFullscreen: true,
        size: 'xxl',
        label: i18nRuntime.i18n("0601b7aa5b53cbc3616e24719bcd2aaa")
      }]
    })];
    return _this;
  }
  ...
  CustomPlugin.prototype.getRendererInfo = function (context) {
    ...
    if (schema.$$id && plugin.name && plugin.rendererName && plugin.rendererName === renderer.name) {
      ...
      if (!regions && schema && schema.body && isArray__default["default"](schema.body)) {
        regions = [{
          key: 'body',
          label: i18nRuntime.i18n("749f710d280419b1da031c9bc79b3b07")
        }];
      }
      return {
        name: plugin.name,

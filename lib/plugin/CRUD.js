...
var CRUDPlugin = /** @class */function (_super) {
  ...
  function CRUDPlugin() {
        ...
        properties: {
          data: {
            ...
            properties: {
              selectedItems: {
                type: 'array',
                title: i18nRuntime.i18n("6142a89066ca7dd6a1ce9493462c5aca")
              },
              unSelectedItems: {
                type: 'array',
                title: i18nRuntime.i18n("21bd0846bd8aa2296c597a1c1ff8e1a7")
              }
            }
          }
        }
    ...
    _this.actions = [{
      ...
      actionType: 'setValue',
      description: i18nRuntime.i18n("f97f8b90f09fb7df39c5c9ae3554b4c7")
    }];
    _this.btnSchemas = {
      create: {
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
          ...
          items: [amisEditorCore.getSchemaTpl('tpl:btnLabel'), {
            ...
            children: function (_a) {
              ...
              return React__default["default"].createElement("button", {
                ...
                "data-tooltip": i18nRuntime.i18n("8347a927c09a4ec2fe473b0a93f667d0"),
        ...
        body: [{
          ...
          name: 'autoFillHeight',
          label: i18nRuntime.i18n("0449dab523020003eee89a0751e1c003")
        }), amisEditorCore.getSchemaTpl('switch', {
                ...
                switch (_e.label) {
                  ...
                  case 1:
                    ...
                    if (Array.isArray(items)) {
                      ...
                      amis.toast.warning(i18nRuntime.i18n("522cddc343d72db3db80cf3d71f99210"));
                    }
                    return [2 /*return*/];
                }
              });
  ...
  CRUDPlugin.prototype.renderEditableComponents = function (props) {
    ...
    if (Array.isArray(bulkActions) && bulkActions.length) {
      ...
      }, i18nRuntime.i18n("7f7c624a843b0d539a4ea59a696702f9")), React__default["default"].createElement("div", {
    ...
    if (Array.isArray(itemActions) && itemActions.length) {
      doms.push(React__default["default"].createElement("div", {
        ...
        className: "ae-EditableRender-title"
      }, i18nRuntime.i18n("f13a0697d58d975d14eb3f3c72c2cbf2")), React__default["default"].createElement("div", {
        className: "ae-EditableRender-body"
    ...
    }, i18nRuntime.i18n("5db6b2160b9169b9d89de247d14ab740")), doms);
  };
            ...
            if (child.type === 'table') {
              ...
              childSchame = {
                ...
                properties: {
                  ...
                  count: {
                    type: 'number',
                    title: i18nRuntime.i18n("31769d6063c5ab0cfee842b395916fd4")
                  },
                  page: {
                    type: 'number',
  ...
  CRUDPlugin.prototype.rendererBeforeDispatchEvent = function (node, e, data) {
    if (e === 'fetchInited') {
      ...
      var jsonschema = tslib.__assign({
        ...
        type: 'object'
      }, amisEditorCore.jsonToJsonSchema(data.responseData, function (type, key) {
        if (type === 'array' && key === 'items') {
          return i18nRuntime.i18n("77fdd35933c099cdcb64b71f3fbe7a6c");
        }
        if (type === 'number' && key === 'count') {
          return i18nRuntime.i18n("31769d6063c5ab0cfee842b395916fd4");
        }
        return key;
      }));

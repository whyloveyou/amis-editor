...
var RangeControlPlugin = /** @class */function (_super) {
  tslib.__extends(RangeControlPlugin, _super);
  function RangeControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("6036c91d6b0b6d1a2468684e597d9f70");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-sliders';
    _this.pluginIcon = 'input-range-plugin';
    _this.description = i18nRuntime.i18n("4c65f10eacbfaf580236b5cbe2de68de");
    _this.docLink = '/amis/zh-CN/components/form/input-range';
    _this.tags = [i18nRuntime.i18n("55b45c73ae417c4dead67905b1550e85")];
    _this.scaffold = {
      type: 'input-range',
      label: i18nRuntime.i18n("6036c91d6b0b6d1a2468684e597d9f70"),
      name: 'range'
    };
    _this.previewSchema = {
      type: 'form',
    ...
    _this.events = [{
      ...
      description: i18nRuntime.i18n("0a6a4aee139530801791c556e7177a7f"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
            ...
            properties: {
              value: {
                type: 'number',
                title: i18nRuntime.i18n("bc0689a4c353e9c95c5b7fc5aa49b59f")
              }
            }
          }
        }
      ...
      description: i18nRuntime.i18n("f34b1a3e26aadb6f60c546dbe9c62232"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
      ...
      description: i18nRuntime.i18n("7c9ec5db3bf23f367c1a905d356aab5c"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
    ...
    _this.actions = [{
      ...
      description: i18nRuntime.i18n("1659f1112dd649ec55390fe7c8e3b1d0")
    }, {
      actionType: 'reset',
    ...
    _this.panelTitle = i18nRuntime.i18n("6036c91d6b0b6d1a2468684e597d9f70");
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            label: i18nRuntime.i18n("753a8c54d3944e252be1af928b8e7afd"),
            name: 'multiple'
          }), {
            type: 'container',
            className: 'ae-sub-content',
            visibleOn: 'data.multiple',
            body: [amisEditorCore.getSchemaTpl('joinValues', {
          ...
          }, amisEditorCore.getSchemaTpl('unit'),
          // tooltipVisible 为true时，会一直显示，为undefined时，才会鼠标移入显示
          amisEditorCore.getSchemaTpl('switch', {
            name: 'tooltipVisible',
            label: i18nRuntime.i18n("e48d95a94e49b81b12a0113a5c253d8f"),
            value: undefined,
            pipeOut: function (value) {
            ...
            body: [{
              ...
              label: i18nRuntime.i18n("a465db53b8c98f42caa15ca5662f9c90"),
              value: 'auto',
              options: [{
            ...
            name: 'showInput',
            label: i18nRuntime.i18n("1d1a0bd85740653320d80f0d6e0918e7"),
            value: false
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'clearable',
            label: i18nRuntime.i18n("d22aa5f57ff8679ee7b7d473ef31417d"),
            value: false,
            visibleOn: '!!data.showInput'
          }), amisEditorCore.getSchemaTpl('autoFillApi')]
        }, {
          title: i18nRuntime.i18n("15628d1d85aee23c229c528a70419414"),
          body: [{
    ...
    if ((_a = node.schema) === null || _a === void 0 ? void 0 : _a.multiple) {
      return {
        ...
        properties: {
          max: {
            type: 'number',
            title: i18nRuntime.i18n("5da893141114a59da868052b3a17a79a")
          },
          min: {
            type: 'number',
            title: i18nRuntime.i18n("c322edb884724d04842fc35f4d29a24e")
          }
        },
...
amisEditorCore.registerEditorPlugin(RangeControlPlugin);

...
var ImageControlPlugin = /** @class */function (_super) {
  tslib.__extends(ImageControlPlugin, _super);
  function ImageControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("6bfb9bb2218ff32b6139e98bc93707c0");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("0a7f8e17f8487c3715a154bea698778e");
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            name: 'accept',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("7c5e7ad8954effd97cb78dcb0e8f99d9"), i18nRuntime.i18n("f816b3decb401dcd0c22db7f104beccc"))
          }, {
            type: 'input-text',
            name: 'frameImage',
            label: i18nRuntime.i18n("99e6b6011bacaabc18aeac70390252a3")
            ...
            mode: 'row',
            name: 'receiver',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("1e4dc4d5f4a3a95ddc349147d4d8cd39"), i18nRuntime.i18n("d24bada35447c81d7d7ddec13c44b576")),
          ...
          amisEditorCore.getSchemaTpl('multiple', {
            patch: {
              value: false,
              visibleOn: '!data.crop',
              label: amisEditorCore.tipedLabel(i18nRuntime.i18n("e3be7b8a459a08fec8f378a0660b642b"), i18nRuntime.i18n("d4633ba7a30303a59891d051a7715cc9"))
            },
            body: [{
              name: 'maxLength',
            ...
            label: i18nRuntime.i18n("037805d2f16cfe69e3145c9f436c06ef"),
            value: false
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'autoUpload',
          ...
          amisEditorCore.getSchemaTpl('switch', {
            ...
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("4838f2f4ecafd0a3a4fcfe82521acdd9"), i18nRuntime.i18n("3d948d24bc4c29689c5a1d4bcb9f2b98")),
            ...
            body: [{
              ...
              type: 'input-text',
              label: i18nRuntime.i18n("e09f3466f78e62c1494fb36816950501"),
              pipeOut: amisEditorCore.valuePipeOut
            }, amisEditorCore.getSchemaTpl('switch', {
              name: 'crop.rotatable',
              label: i18nRuntime.i18n("c7fa7f54ece94ae684aee1ee2088a5ae"),
              pipeOut: amisEditorCore.valuePipeOut
            }), amisEditorCore.getSchemaTpl('switch', {
              name: 'crop.scalable',
              label: i18nRuntime.i18n("bd698e3f47ede4e59aafb28a291b77e7"),
              pipeOut: amisEditorCore.valuePipeOut
            }), {
              name: 'crop.viewMode',
              type: 'select',
              label: i18nRuntime.i18n("f785a357a820555445acd6f7051b1048"),
              value: 1,
              options: [{
                label: i18nRuntime.i18n("bc436447f54b10a9ac3f0ee3e1b863dc"),
                value: 0
              }, {
                label: i18nRuntime.i18n("7ccc0313ac4c40b364f482341ecc3bb8"),
                value: 1
              }],
              pipeOut: amisEditorCore.valuePipeOut
            }]
            ...
            name: 'limit',
            label: i18nRuntime.i18n("4db4c540f05524c38e9431173736517b"),
            pipeIn: function (value) {
              return !!value;
            }
          }), {
            ...
            body: [{
              ...
              type: 'input-number',
              suffix: 'B',
              label: amisEditorCore.tipedLabel(i18nRuntime.i18n("0a9dced8856958fbd05508d1218f8090"), i18nRuntime.i18n("13446481eaf0a047d8fddf159d981a7c"))
            }, {
              type: 'input-number',
              name: 'limit.width',
              label: amisEditorCore.tipedLabel(i18nRuntime.i18n("c28479019e24e0e4745f4948e9e97ee7"), i18nRuntime.i18n("17a689143f0c7003123bb3c947d35273"))
            }, {
              type: 'input-number',
              name: 'limit.height',
              label: amisEditorCore.tipedLabel(i18nRuntime.i18n("c1df04eec5fa0857bc0df2d68d8e953c"), i18nRuntime.i18n("2aa41edf8cfa79e7e5fcf38c9742b495"))
            }, {
              type: 'input-number',
              name: 'limit.maxWidth',
              ...
              label: i18nRuntime.i18n("fc2bc4193eea63128961d09497e07dc8")
            }, {
              type: 'input-number',
              name: 'limit.minWidth',
              ...
              label: i18nRuntime.i18n("2bd921d0ea7a73b77ee0fcddb1afcc84")
            }, {
              type: 'input-number',
              name: 'limit.aspectRatio',
              label: i18nRuntime.i18n("b7623c7e17098d5950694437aa7584ad")
            }, {
              type: 'input-text',
              name: 'limit.aspectRatioLabel',
              label: amisEditorCore.tipedLabel(i18nRuntime.i18n("1765a2daba3ba8c5af95e66fa83545d4"), i18nRuntime.i18n("a7b7da38fcb8e246e910e178c5fe4ebc"))
            }]
          }]
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [amisEditorCore.getSchemaTpl('style:formItem', {
          ...
          body: tslib.__spreadArray(tslib.__spreadArray(tslib.__spreadArray(tslib.__spreadArray([{
            type: 'select',
            name: 'editorState',
          ...
          }], tslib.__read(inputStateFunc("${editorState == 'default' || !editorState}", 'default')), false), tslib.__read(inputStateFunc("${editorState == 'hover'}", 'hover')), false), tslib.__read(inputStateFunc("${editorState == 'active'}", 'active')), false), [amisEditorCore.getSchemaTpl('theme:radius', {
...
amisEditorCore.registerEditorPlugin(ImageControlPlugin);

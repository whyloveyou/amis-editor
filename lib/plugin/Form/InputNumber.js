...
var NumberControlPlugin = /** @class */function (_super) {
  tslib.__extends(NumberControlPlugin, _super);
  function NumberControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("1e65b8181e9a40e76b86e2c261cafbe0");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-sort-numeric-asc';
    _this.pluginIcon = 'input-number-plugin';
    _this.description = i18nRuntime.i18n("c45782c425bfc31824af8129bd6e0282");
    ...
    _this.panelTitle = i18nRuntime.i18n("1e65b8181e9a40e76b86e2c261cafbe0");
    _this.panelJustify = true;
    // 事件定义
    _this.events = [{
      eventName: 'change',
      eventLabel: i18nRuntime.i18n("755955372bcc0c7ebf161a656bc389b3"),
      description: i18nRuntime.i18n("b2a5322c8dbc0d8343315cafbd39b7ce"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
            ...
            properties: {
              value: {
                type: 'number',
                title: i18nRuntime.i18n("6d829f061ed82a688f2669c54dd83301")
              }
            }
          }
        }
      ...
      description: i18nRuntime.i18n("5f914e36c49db618d06981df7b3c4d81"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
      ...
      description: i18nRuntime.i18n("efdd0d8923130f281b54506eef2121cf"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
    ...
    _this.actions = [{
      ...
      description: i18nRuntime.i18n("0849471829a565a8af6b70a46346e574")
    }, {
      actionType: 'reset',
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            type: 'switch',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("32f13c9db34f638c2c5cf2bf19326ebf"), i18nRuntime.i18n("8572d14f815d840bd9e940cd8ee4e380")),
            name: 'keyboard',
            value: true,
            inputClassName: 'is-inline'
          }, amisEditorCore.getSchemaTpl('kilobitSeparator'), amisEditorCore.getSchemaTpl('valueFormula', {
            ...
            type: 'input-number',
            name: 'step',
            label: i18nRuntime.i18n("d26404c10871481ab6bbb4837a34ae95"),
            min: 0,
            value: 1
          }, {
            type: 'input-number',
            name: 'precision',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("e284e64008fd8b066da04bca335d032a"), i18nRuntime.i18n("b317cbf67c94f986fc44cf4cbc2280c6")),
            min: 1,
            max: 100
          }, amisEditorCore.getSchemaTpl('prefix'), amisEditorCore.getSchemaTpl('suffix'), amisEditorCore.getSchemaTpl('combo-container', {
            type: 'combo',
            label: i18nRuntime.i18n("7915dcc78c28ed3cda8fc949a86e4806"),
            mode: 'normal',
            name: 'unitOptions',
            items: [{
              placeholder: 'label',
        ...
        body: [amisEditorCore.getSchemaTpl('collapseGroup', [amisEditorCore.getSchemaTpl('style:formItem', {
          ...
          schema: [{
            label: i18nRuntime.i18n("8c80ed1f85135cc9153d0b7406ac5b38"),
            name: 'displayMode',
            type: 'select',
            pipeIn: amisEditorCore.defaultValue('base'),
            options: [{
              label: i18nRuntime.i18n("0a8c852e27763a18ce5b72a87ba8b5ba"),
              value: 'base'
            }, {
              label: i18nRuntime.i18n("de93563a076f72b3e919870c9dad9935"),
              value: 'enhance'
            }]
          }]
        }), amisEditorCore.getSchemaTpl('theme:form-label'), amisEditorCore.getSchemaTpl('theme:form-description'), {
          title: i18nRuntime.i18n("bade9c4e0b8a75a251c1a2760571d3c3"),
          body: tslib.__spreadArray([], tslib.__read(helper.inputStateTpl('themeCss.inputControlClassName', 'inputNumber.base.base')), false)
        }, amisEditorCore.getSchemaTpl('theme:cssCode', {
          themeClass: [{
            name: i18nRuntime.i18n("53069052573de671c6e5108de745b036"),
            value: '',
...
amisEditorCore.registerEditorPlugin(NumberControlPlugin);

...
var TextControlPlugin = /** @class */function (_super) {
  tslib.__extends(TextControlPlugin, _super);
  function TextControlPlugin() {
    ...
    _this.order = -600;
    // 添加源对应组件中文名称 & type字段
    _this.searchKeywords = i18nRuntime.i18n("379b5486e7860a9f38f37dddabbb094c");
    // 组件名称
    _this.name = i18nRuntime.i18n("5ac57ce6df8c2a19668b7429aebd9f33");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-terminal';
    _this.pluginIcon = 'input-text-plugin';
    _this.description = i18nRuntime.i18n("f222f5413d3854897741e0ec4b0d2c7b");
    ...
    _this.panelTitle = i18nRuntime.i18n("5ac57ce6df8c2a19668b7429aebd9f33");
    _this.events = [
    // {
    //   eventName: 'click',
    //   eventLabel: '点击',
    ...
    // },
    {
      ...
      description: i18nRuntime.i18n("277daf93adca7889605057f566b584bf"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
      ...
      description: i18nRuntime.i18n("40fa260f07ed5a14f9516c0c37fbfd4e"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            required: true
          }), amisEditorCore.getSchemaTpl('label'), amisEditorCore.getSchemaTpl('inputType', {
            ...
            onChange: function (value, oldValue, model, form) {
              ...
              form.changeValue('validations', tslib.__assign({}, validations));
              form.changeValue('validationErrors', tslib.__assign({}, validationErrors));
            }
          }), amisEditorCore.getSchemaTpl('tplFormulaControl', {
            name: 'value',
            label: i18nRuntime.i18n("225f3ed00750ae78ad1e6ea42c8f5087")
          }), amisEditorCore.getSchemaTpl('clearable'), amisEditorCore.getSchemaTpl('showCounter', {
            ...
            name: 'addOn',
            label: amisEditorCore.tipedLabel('AddOn', i18nRuntime.i18n("9306b956ca5950203ee49a2680cac63d")),
            type: 'ae-switch-more',
            mode: 'normal',
            formType: 'extend',
            title: 'AddOn',
            ...
            form: {
              body: [{
                ...
                pipeIn: amisEditorCore.defaultValue('button'),
                options: [{
                  label: i18nRuntime.i18n("97d07614380da93d257f9fbf81aa56fb"),
                  value: 'text'
                }, {
              ...
              }), amisEditorCore.getSchemaTpl('addOnLabel'), amisEditorCore.getSchemaTpl('icon')]
            }
          ...
          body: [amisEditorCore.getSchemaTpl('optionControlV2'), amisEditorCore.getSchemaTpl('multiple', {
            visibleOn: "".concat(isText, " || ").concat(isUrl)
          }), {
            type: 'ae-Switch-More',
            mode: 'normal',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("d548d3e938088d5d469a28c20e939750"), i18nRuntime.i18n("424cd425082360322678a5c8d6910b80")),
            visibleOn: isText,
            formType: 'extend',
            defaultData: {
              autoComplete: {
          ...
          tag: function (data) {
            switch (data.type) {
              case 'input-password':
                return validator.ValidatorTag.Password;
              case 'input-email':
                return validator.ValidatorTag.Email;
              case 'input-url':
                return validator.ValidatorTag.URL;
              default:
                return validator.ValidatorTag.Text;
            }
          }
        })
        // {
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [amisEditorCore.getSchemaTpl('style:formItem', {
          ...
          title: i18nRuntime.i18n("f7e3d7e3146bb53b5e6f09f7c90dea3a"),
          body: tslib.__spreadArray([], tslib.__read(helper.inputStateTpl('themeCss.inputControlClassName', 'input.base.default')), false)
        }, {
          title: i18nRuntime.i18n("a39a2916d17f2b9ba11853066b4225f3"),
          ...
          themeClass: [{
            name: i18nRuntime.i18n("9b6425cd2d496c9cb5a6c6b8ff125d1b"),
            value: '',
...
amisEditorCore.registerEditorPlugin(TextControlPlugin);

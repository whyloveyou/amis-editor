...
var RichTextControlPlugin = /** @class */function (_super) {
  tslib.__extends(RichTextControlPlugin, _super);
  function RichTextControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("24b6d4c0892a8f3ee2a982e3ab0afe38");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-newspaper-o';
    _this.pluginIcon = 'input-rich-text-plugin';
    _this.description = i18nRuntime.i18n("42c036311993897680ef37f11e4e20a8");
    ...
    _this.panelTitle = i18nRuntime.i18n("e2591e971f4c28db7c80a5f546084a1d");
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          // tinymce
          {
            type: 'select',
            multiple: true,
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("236b0cdd2e18418fd17d3cdfcace239e"), i18nRuntime.i18n("defe851634125bb16e762f26dbb6555f")),
            name: 'options.plugins',
            visibleOn: 'data.vendor === "tinymce"',
            value: tslib.__spreadArray([], tslib.__read(tinymceOptions), false).join(','),
            searchable: true,
            maxTagCount: 5,
            overflowTagPopover: {
              title: i18nRuntime.i18n("236b0cdd2e18418fd17d3cdfcace239e"),
              offset: [0, 5]
            },
            ...
            label: i18nRuntime.i18n("df025e01cbbae804f7d720e6b932e8e8"),
            value: true,
          ...
          // froala
          {
            ...
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("b74c3bbb8ec4f18896cd3b5a20ee9e2c"), i18nRuntime.i18n("e08c3505f9779bf919628166a77d0d77")),
            value: tslib.__spreadArray([], tslib.__read(froalaOptions), false),
            joinValues: false,
            extractValue: true,
            options: tslib.__spreadArray([], tslib.__read(froalaOptions), false),
            ...
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("04f91b84d48285162d3e29205a194143"), i18nRuntime.i18n("9ac0e46a361565f0b8be2228bef4b679")),
            joinValues: false,
            extractValue: true,
            options: tslib.__spreadArray([], tslib.__read(froalaOptions), false),
            pipeOut: froalaOptionsPipeOut
            ...
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("70d3894aaed305d2fc67f91122d77759"), i18nRuntime.i18n("a3133ac3b34da77e612bcb1763adae1e")),
            joinValues: false,
            extractValue: true,
            options: tslib.__spreadArray([], tslib.__read(froalaOptions), false),
            pipeOut: froalaOptionsPipeOut
          }, amisEditorCore.getSchemaTpl('switch', {
            label: i18nRuntime.i18n("194ab42ad1ca7fca9a6ef84fadf99490"),
            value: true,
            name: 'options.quickInsertEnabled',
            visibleOn: 'data.vendor === "froala"'
          }), amisEditorCore.getSchemaTpl('switch', {
            label: i18nRuntime.i18n("94621f44f98c996e49d5b214aebefffc"),
            value: true,
          ...
          amisEditorCore.getSchemaTpl('apiControl', {
            ...
            labelClassName: 'none',
            name: 'receiver',
            label: i18nRuntime.i18n("b720ed498f054a2539d496d0da68f85b"),
            ...
            labelClassName: 'none',
            name: 'videoReceiver',
            label: i18nRuntime.i18n("376496a8918c57220159951e24d3b72d"),
            visibleOn: 'data.vendor === "froala"'
          }), amisEditorCore.getSchemaTpl('labelRemark'), amisEditorCore.getSchemaTpl('remark'), amisEditorCore.getSchemaTpl('placeholder', {
            visibleOn: 'data.vendor !== "tinymce"'
        ...
        body: [amisEditorCore.getSchemaTpl('collapseGroup', [{
          title: i18nRuntime.i18n("555a9859e2c34b015438bdfb59a57c5b"),
          body: [{
            type: 'input-number',
...
amisEditorCore.registerEditorPlugin(RichTextControlPlugin);

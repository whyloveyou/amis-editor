...
var InputQuarterPlugin = /** @class */function (_super) {
  tslib.__extends(InputQuarterPlugin, _super);
  function InputQuarterPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("a483bccf85587055ab31314ad1d2f82a");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-calendar';
    _this.pluginIcon = 'input-quarter-plugin';
    _this.description = i18nRuntime.i18n("549a2a421951fc8c304c6223f346e024");
...
amisEditorCore.registerEditorPlugin(InputQuarterPlugin);

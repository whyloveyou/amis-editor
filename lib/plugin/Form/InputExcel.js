...
var ExcelControlPlugin = /** @class */function (_super) {
  tslib.__extends(ExcelControlPlugin, _super);
  function ExcelControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("899339c1133a6100a1b223680d26692c");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-eyedropper';
    _this.pluginIcon = 'input-excel-plugin';
    _this.description = i18nRuntime.i18n("b0e4a21f29af38986eebbbf867eee31b");
    ...
    _this.events = [{
      ...
      description: i18nRuntime.i18n("7caadb59b5892d107a909816b6571c66"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
            ...
            properties: {
              value: {
                type: 'string',
                title: i18nRuntime.i18n("de3ad0cd57153f799f7538dd1e4fd441")
              }
            }
          }
        }
      ...
      return BaseControl.formItemControl({
        common: {
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            label: i18nRuntime.i18n("d9435aa8028acfc660276c4e0af5536a"),
            name: 'parseMode',
            type: 'select',
            options: [{
              label: i18nRuntime.i18n("b14494137c805dc66bdc9ed88d7fd2de"),
              value: 'object'
            }, {
              label: i18nRuntime.i18n("0e67d4b0e351b00f4bea9840aa6b99d7"),
              value: 'array'
            }]
          }, amisEditorCore.getSchemaTpl('switch', {
            name: 'allSheets',
            label: i18nRuntime.i18n("fe5c59cbac3d45314ec6397d9f75789a")
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'plainText',
            label: i18nRuntime.i18n("50b10b178196378f4359ce11bbc31372"),
            pipeIn: amisEditorCore.defaultValue(true)
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'includeEmpty',
            label: i18nRuntime.i18n("1647e4bfb548f2e8468d10b4b3bfbe21"),

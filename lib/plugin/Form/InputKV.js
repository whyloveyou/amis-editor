...
var KVControlPlugin = /** @class */function (_super) {
  tslib.__extends(KVControlPlugin, _super);
  function KVControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("ed55564c631322fa3042c77286d6562c");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-eyedropper';
    _this.pluginIcon = 'input-kv-plugin';
    _this.description = i18nRuntime.i18n("746dd83e6891ccc9a19804c23c2c4443");
    ...
    _this.panelTitle = i18nRuntime.i18n("ed55564c631322fa3042c77286d6562c");
    _this.panelBody = [amisEditorCore.getSchemaTpl('layout:originPosition', {
      value: 'left-top'
    }), {
      type: 'input-text',
      name: 'valueType',
      label: i18nRuntime.i18n("654ad5670efdd25f1417958a7026a355"),
      pipeIn: amisEditorCore.defaultValue('input-text')
    }, {
      type: 'input-text',
      name: 'keyPlaceholder',
      label: i18nRuntime.i18n("9648d874d516a87965066342394e86e6")
    }, {
      type: 'input-text',
      name: 'valuePlaceholder',
      label: i18nRuntime.i18n("4dae7425b21494a318cd4a69ce24608f")
    }, {
      type: 'switch',
      name: 'draggable',
...
amisEditorCore.registerEditorPlugin(KVControlPlugin);

exports.KVControlPlugin = KVControlPlugin;

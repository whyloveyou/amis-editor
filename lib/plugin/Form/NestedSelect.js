...
var NestedSelectControlPlugin = /** @class */function (_super) {
  tslib.__extends(NestedSelectControlPlugin, _super);
  function NestedSelectControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("24d9de25721d1fb0ecf89ef81c43d877");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-indent';
    _this.pluginIcon = 'nested-select-plugin';
    _this.description = i18nRuntime.i18n("c65c9862813c7a66c0df52e301e0e1d1");
    ...
    _this.scaffold = {
      ...
      options: [{
        ...
        value: 'B',
        children: [{
          label: i18nRuntime.i18n("03cd388fe29a4fc116c0021e496a113a"),
          value: 'b1'
        }, {
          label: i18nRuntime.i18n("fb00d1c1a65d3739c03a0b2715168327"),
          value: 'b2'
        }]
      }, {
        ...
        value: 'C',
        children: [{
          label: i18nRuntime.i18n("353ae08afdb3d0a3587e9b27ca239c33"),
          value: 'c1'
        }, {
          label: i18nRuntime.i18n("bea7ad76f0f321124ff614a099cb9a85"),
          value: 'c2'
        }]
      }]
    };
    ...
    _this.panelTitle = i18nRuntime.i18n("24d9de25721d1fb0ecf89ef81c43d877");
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            required: true
          }), amisEditorCore.getSchemaTpl('label'), amisEditorCore.getSchemaTpl('clearable'), {
            type: 'ae-Switch-More',
            name: 'searchable',
          ...
          }, amisEditorCore.getSchemaTpl('onlyLeaf'), [{
            type: 'switch',
            ...
            body: [{
              type: 'switch',
              label: amisEditorCore.tipedLabel(i18nRuntime.i18n("6a7f7d89c8f1f3e6aab0962ff920b145"), i18nRuntime.i18n("c23eb92d1f249452c3ff3ee13738b47a")),
              horizontal: {
                left: 6,
                justify: true
              },
            ...
            }, amisEditorCore.getSchemaTpl('joinValues'), amisEditorCore.getSchemaTpl('delimiter', {
          ...
          }), amisEditorCore.getSchemaTpl('hideNodePathLabel'), amisEditorCore.getSchemaTpl('labelRemark'), amisEditorCore.getSchemaTpl('remark'), amisEditorCore.getSchemaTpl('placeholder'), amisEditorCore.getSchemaTpl('description'), amisEditorCore.getSchemaTpl('autoFillApi')]
        }, {
          title: i18nRuntime.i18n("ea15ae2b7fba76c83eec6d0986d15197"),
          body: [amisEditorCore.getSchemaTpl('treeOptionControl'), amisEditorCore.getSchemaTpl('loadingConfig', {
          ...
          tag: function (data) {
            return validator.ValidatorTag.MultiSelect;
          }
        })])
      }, {
...
amisEditorCore.registerEditorPlugin(NestedSelectControlPlugin);

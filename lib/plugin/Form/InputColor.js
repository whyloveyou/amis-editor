...
function convertColor(value, format) {
  ...
  function convert(v) {
    var color = tinyColor__default["default"](v);
    if (!color.isValid()) {
      return '';
    }
    if (format !== 'rgba') {
...
var ColorControlPlugin = /** @class */function (_super) {
  tslib.__extends(ColorControlPlugin, _super);
  function ColorControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("d1b5ad85ada6350ea1a1432b813700be");
    ...
    _this.panelTitle = i18nRuntime.i18n("d1b5ad85ada6350ea1a1432b813700be");
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          }, tslib.__spreadArray([], tslib.__read(formatOptions.map(function (_a) {
            var value = _a.value;
          ...
          //   format: '${format}'
          // },
          amisEditorCore.getSchemaTpl('clearable'), amisEditorCore.getSchemaTpl('labelRemark'), amisEditorCore.getSchemaTpl('remark'), amisEditorCore.getSchemaTpl('placeholder'), amisEditorCore.getSchemaTpl('description'), amisEditorCore.getSchemaTpl('autoFillApi')]
        }, {
          title: i18nRuntime.i18n("a47b08f4c83158a058c06e176cff501a"),
          body: tslib.__spreadArray([amisEditorCore.getSchemaTpl('switch', {
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("1b25b3b1b5076f0c2e6bd12d73c56f79"), i18nRuntime.i18n("9b161db0e2e749c1106c702c8097d380")),
            ...
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("05a64e0df1490a5db391e7a43eced6e0"), i18nRuntime.i18n("6cbabc9a4cc07c1e26bb131c02833f8d")),
            name: 'presetColors',
            onText: i18nRuntime.i18n("f1d4ff50f3828f9b73412e7d94e6dd6e"),
            offText: i18nRuntime.i18n("18c63459a2c069022c7790430f761214"),
            pipeIn: function (value) {
          ...
          })], tslib.__read(formatOptions.map(function (_a) {
            var value = _a.value;
  ...
  ColorControlPlugin.prototype.getConditionalColorComb = function (format) {
    var visibleOnNoFormat = format === 'hex' ? ' || !this.format' : '';
    return amisEditorCore.getSchemaTpl('combo-container', {
      type: 'combo',
      mode: 'normal',
      name: 'presetColors',
      items: [{

...
var FormPlugin = /** @class */function (_super) {
  tslib.__extends(FormPlugin, _super);
  function FormPlugin(manager) {
    ...
    _this.regions = [{
      ...
      label: i18nRuntime.i18n("e2b67a7f51c977887d2b3c2de2727509"),
      key: 'actions',
    ...
    _this.events = [{
      ...
      dataSchema: [{
        ...
        properties: {
          data: {
            type: 'object',
            title: i18nRuntime.i18n("0d83078816aa273f2941c9b55ec82bf3"),
            description: i18nRuntime.i18n("1b5cf3e354142cc1cdd6f56b6afaba49")
          }
        }
      }]
    }, {
      ...
      eventLabel: i18nRuntime.i18n("1b43b43e692a5b6b2f6ec1417791a550"),
      description: i18nRuntime.i18n("0de773dedbe5875ca4529e7d0ce9d2bf"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
    ...
    _this.Features = [{
      ...
      value: constants.DSFeatureEnum.Insert
    }, {
    ...
    _this.panelBodyCreator = function (context) {
      ...
      var generateDSControls = function () {
        ...
        /** 数据源配置 */
        var dsSettings = flatten__default["default"](_this.Features.map(function (feat) {
      ...
      return [amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [isCRUDFilter || isModelForm ? null : {
          ...
          body: [{
            ...
            name: 'autoFocus',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("cbef9ad64297efd7657d5b67b2112751"), i18nRuntime.i18n("ded8caee55c05aa0f1a4e6a197c480bd"))
          }), {
            type: 'ae-switch-more',
            mode: 'normal',
            name: 'persistData',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("cd8b367599d0c748e74029da8c10d295"), i18nRuntime.i18n("8a0544ca2f7ddaf8768ab599858315a6")),
            hiddenOnDefault: true,
            formType: 'extend',
            form: {
              body: [amisEditorCore.getSchemaTpl('switch', {
                name: 'clearPersistDataAfterSubmit',
                label: amisEditorCore.tipedLabel(i18nRuntime.i18n("09a94b2400f7f05fbf2fc37a20b097d0"), i18nRuntime.i18n("bc01ee1a28f980c298679610fe4d2d66")),
            ...
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("69445b3c5ddb606c7d51fd941e4aae10"), i18nRuntime.i18n("86f056f1cd4e25d5bd2bebddc971032b")),
          ...
          title: i18nRuntime.i18n("5cd08fe4cd86fffe7cd23d934d4d3b32"),
          body: [tslib.__assign({
            name: 'submitText',
            type: 'input-text',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("60ad7d0d170b973ab9cdb0b23e636704"), i18nRuntime.i18n("e59e1cb3f366d6e7012fe64748355b0a")),
          ...
          }, justifyLayout(4)), amisEditorCore.getSchemaTpl('switch', {
            name: 'submitOnChange',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("171f7b825707ddd79175fed3f8def6cd"), i18nRuntime.i18n("6ccb7091c39a5229f7e77eff4dd44a0e"))
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'resetAfterSubmit',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("d3458f4ee2c2203bb51f9d138dfd0c05"), i18nRuntime.i18n("e89bb79f0a0cb4fa4693c4a5ace130f4"))
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'preventEnterSubmit',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("59c1b37b7ff983385a2521541cbcccf8"), i18nRuntime.i18n("794020840d754ea7fb58ea3bf4394e1a"))
          }),
          // isCRUDFilter
          //   ? null
          //   : getSchemaTpl('switch', {
          ...
          isInDialog ? amisEditorCore.getSchemaTpl('switch', {
            label: i18nRuntime.i18n("87a6f142d80987db2e31569e403619f7"),
          ...
          title: i18nRuntime.i18n("2e799a2e68a3303201d89752ae201a88"),
          body: [{
            name: 'rules',
            label: false,
            type: 'combo',
            ...
            placeholder: '',
            addBtn: {
              label: i18nRuntime.i18n("442781667396d6eff51113f482d89e54"),
              block: true,
              icon: 'fa fa-plus',
              className: cx__default["default"]('ae-Button--enhance')
            },
            items: [tslib.__assign({
              type: 'ae-formulaControl',
              name: 'rule',
              label: i18nRuntime.i18n("8101a0aec7eba32e633e3cc29f4b7ede")
            }, justifyLayout(4)), tslib.__assign({
              name: 'message',
          ...
          body: [amisEditorCore.getSchemaTpl('disabled'), amisEditorCore.getSchemaTpl('visible'), amisEditorCore.getSchemaTpl('static')]
        }, {
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('formItemMode', {
            isForm: true,
            /** Form组件默认为normal模式 */
            defaultValue: 'normal'
          }), amisEditorCore.getSchemaTpl('horizontal'), {
            name: 'labelAlign',
            label: i18nRuntime.i18n("86ed196f63524be7775e5a01b0152793"),
            type: 'button-group-select',
            size: 'sm',
            visibleOn: "${mode === 'horizontal'}",
            pipeIn: amisEditorCore.defaultValue('right', false),
            options: [{
            ...
            precision: 0,
            resetValue: '',
            unitOptions: [i18nRuntime.i18n("cb2f68c9c24e85d21e6b090b6e5657d8")],
          ...
          body: [amisEditorCore.getSchemaTpl('switch', {
            name: 'wrapWithPanel',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("6bde56d911167d0f47aae6bab762cd70"), i18nRuntime.i18n("1cb01363e2463443bc8105f544ce2736")),
            pipeIn: amisEditorCore.defaultValue(true)
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'affixFooter',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("019078f52f120a70fc23d94ccd364200"), i18nRuntime.i18n("f9e5a5377c1f56f1d09ae2bc58bd2d5b")),
            visibleOn: isWrapped
          })]
        }, /** */
  ...
  Object.defineProperty(FormPlugin.prototype, "scaffoldForm", {
    ...
    get: function () {
      ...
      return {
        title: i18nRuntime.i18n("4f2ef285e13e20f551f7111f535cde11"),
        mode: {
          mode: 'horizontal',
          horizontal: {
            leftFixed: 'sm'
        ...
        this.dsManager.getDSSelectorSchema({
        ...
        })], tslib.__read(flatten__default["default"](features.map(function (feat) {
          ...
          joinValues: false,
          extractValue: false,
          options: [constants.FormOperatorMap['reset'], constants.FormOperatorMap['submit'], constants.FormOperatorMap['cancel']]
        }], false),
        ...
        validate: function (data, form) {
          ...
          var featValue = builder === null || builder === void 0 ? void 0 : builder.getFeatValueByKey(feat !== null && feat !== void 0 ? feat : constants.DSFeatureEnum.Insert);
          var fieldsKey = "".concat(featValue, "Fields");
          var errors = {};
          if ((data === null || data === void 0 ? void 0 : data.dsType) === constants.ModelDSBuilderKey) {
            return errors;
          }
          // if (!form.data[apiKey]) {
          ...
          // }
          var fieldErrors = FieldSetting.FieldSetting.validator(form.data[fieldsKey]);
          if (fieldErrors) {
  ...
  Object.defineProperty(FormPlugin.prototype, "dynamicControls", {
    ...
    set: function (controls) {
      if (!controls || !amisCore.isObject(controls)) {
        throw new Error(i18nRuntime.i18n("b4f035fa6f9faaa78707b72c352c6a8b"));
      }
        ...
        if (rendererInfo.isFormItem || rendererInfo.type && specialRenderer.includes(rendererInfo.type) || ((_a = target.sameIdChild) === null || _a === void 0 ? void 0 : _a.info.renderer.isFormItem)) {
          ...
          if (builder && scopeNode.schema.api) {
            return [2 /*return*/, builder.getAvailableContextFields({
              ...
              sourceKey: 'api',
              feat: (_m = (_l = scopeNode.schema) === null || _l === void 0 ? void 0 : _l.feat) !== null && _m !== void 0 ? _m : constants.DSFeatureEnum.Insert
            }, target)];
          }
        }
        return [2 /*return*/];

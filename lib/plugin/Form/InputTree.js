...
var TreeControlPlugin = /** @class */function (_super) {
  ...
  function TreeControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("479728c411bac59bc44d5ab8dc3cb4f0");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-list-alt';
    _this.pluginIcon = 'input-tree-plugin';
    _this.description = i18nRuntime.i18n("912beb37a3785e50d6483852be41111f");
    _this.searchKeywords = i18nRuntime.i18n("0b52d7d00ed28e41f4845fec1622d056");
    ...
    _this.scaffold = {
      ...
      options: [{
        ...
        value: 'A',
        children: [{
          label: i18nRuntime.i18n("57a6105deead3fec79028cce7bfa2004"),
          value: 'C'
        }, {
          label: i18nRuntime.i18n("9bc04a190ce0a5ba1ed473cb628b5ed4"),
          value: 'D'
        }]
      }, {
    ...
    _this.previewSchema = {
      ...
      body: [tslib.__assign(tslib.__assign({}, _this.scaffold), {
        label: i18nRuntime.i18n("ea687c59ff7d980afc55427853af864a"),
        mode: 'normal'
      })]
    };
    ...
    _this.actions = [{
      actionType: 'expand',
      actionLabel: i18nRuntime.i18n("e2edde5adbdf33f6dce59a299cbf5fad"),
      description: i18nRuntime.i18n("38747bcbc3c47924098076ee87e59933"),
      innerArgs: ['openLevel'],
      descDetail: function (info) {
        ...
        }, info === null || info === void 0 ? void 0 : info.__rendererLabel), i18nRuntime.i18n("a148ea1749eaf611df5cc95b533751ec"), React__default["default"].createElement("span", {
      ...
      schema: helper.getArgsWrapper(amisEditorCore.getSchemaTpl('formulaControl', {
        name: 'openLevel',
        label: i18nRuntime.i18n("01356df4561f9da87d2876ec9c0dacfe"),
        variables: '${variables}',
        size: 'lg',
        mode: 'horizontal'
      }))
      ...
      actionType: 'collapse',
      actionLabel: i18nRuntime.i18n("def9e98b60e3bfc493bcd7693e702096"),
      description: i18nRuntime.i18n("3ebb9059b6abc8f80a212b5795270ec2")
    }, {
      actionType: 'clear',
      actionLabel: i18nRuntime.i18n("288f0c404c4e546aa3683ff5054e85e2"),
      description: i18nRuntime.i18n("d81f0b9079d5a38bbedffeacaad8b905")
    }, {
      actionType: 'reset',
      actionLabel: i18nRuntime.i18n("4b9c3271dc2f299dc3aeffb369187513"),
      description: i18nRuntime.i18n("ce5e449208bb568eaf722bab9a20380e")
    }, {
      actionType: 'reload',
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            pipeIn: amisEditorCore.defaultValue('input-tree'),
          ...
          }, amisEditorCore.getSchemaTpl('clearable', {
            mode: 'horizontal',
            horizontal: {
              justify: true,
              left: 8
            ...
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("4c3ed2fc7331db687fc0e8ffb8f672a7"), i18nRuntime.i18n("0ae8c01434dc2a38a90561fcbf5d79b5")),
            name: 'cascade',
            hiddenOn: '!data.multiple || !data.autoCheckChildren'
          }), amisEditorCore.getSchemaTpl('switch', {
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("22c023bf51970a461cc164e711f3d3ff"), i18nRuntime.i18n("6e19e48a52986659ae5ba1bfe612ba8a")),
            name: 'withChildren',
            hiddenOn: '!data.multiple || !data.autoCheckChildren && data.cascade'
          }), amisEditorCore.getSchemaTpl('switch', {
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("cccb3595f8ff536e27d94ec91a49bfdf"), i18nRuntime.i18n("49ccf100ac35e1cc3d40b7222cdcd1a7")),
            name: 'onlyChildren',
            hiddenOn: '!data.multiple || !data.autoCheckChildren'
          ...
          body: [amisEditorCore.getSchemaTpl('treeOptionControl', {
          ...
          body: [amisEditorCore.getSchemaTpl('valueFormula', {
            name: 'highlightTxt',
            label: i18nRuntime.i18n("2b3073b1ba5f9deab7818d8be02de3a1"),
            type: 'input-text',
            ...
            form: {
              body: [{
                type: 'input-text',
                label: i18nRuntime.i18n("9cb417cfac37e6d65dedbc35ee9e916e"),
                value: '/',
                name: 'pathSeparator'
              }]
            }
            ...
            mode: 'normal',
            name: 'hideRoot',
            label: i18nRuntime.i18n("d6840c02c4d9cd5f4f5fd4d9f3e6b916"),
            value: true,
            trueValue: false,
            falseValue: true,
            formType: 'extend',
            form: {
              body: [{
                ...
                label: i18nRuntime.i18n("e2c310a329c2cf62a0764fc912f2f583"),
                value: i18nRuntime.i18n("c48d9f48ce8a798772f17d1f47560529"),
                name: 'rootLabel'
              }]
            },
            visibleOn: 'data.type === "input-tree"'
          }, amisEditorCore.getSchemaTpl('switch', {
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("0aa73cfbe5a84cd34a212de5bab2058d"), i18nRuntime.i18n("4dabfefd787102b8159b5c4a221aa048")),
            name: 'hideNodePathLabel',
            visibleOn: 'data.type==="tree-select"'
          }), amisEditorCore.getSchemaTpl('switch', {
            label: i18nRuntime.i18n("8c9a3a8cd5de83121c03c83f909a7534"),
            name: 'showIcon',
            value: true
          }), amisEditorCore.getSchemaTpl('switch', {
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("ae7d563d3190ddbafdda8093fc28fc5f"), i18nRuntime.i18n("4444d03faa51f8550a8a4547fb471ab7")),
            name: 'showRadio',
            hiddenOn: 'data.multiple'
          }), amisEditorCore.getSchemaTpl('switch', {
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("0f993a54d2c67716220632577d3b5b51"), i18nRuntime.i18n("846da282ebfa6dfe61deb1d58145158c")),
            name: 'showOutline'
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'withChildren',
            label: i18nRuntime.i18n("b39c6fb1cdf629d3f3032d6c7d4694a8"),
            visibleOn: 'data.cascade !== true && data.multiple',
            disabledOn: 'data.onlyChildren'
          }), amisEditorCore.getSchemaTpl('switch', {
            name: 'onlyChildren',
            label: i18nRuntime.i18n("1fa482fed3042cac9f96c6f43c13f84a"),
            visibleOn: 'data.cascade !== true && data.multiple',
            ...
            mode: 'normal',
            name: 'initiallyOpen',
            label: amisEditorCore.tipedLabel(i18nRuntime.i18n("d7eae84550f9b9bc0c78a94e4072ad0d"), i18nRuntime.i18n("346f7e0c7ef27b6a83f3c9f8f406d737")),
            value: true,
            trueValue: false,
            falseValue: true,
            formType: 'extend',
          ...
          tag: validator.ValidatorTag.Tree
        })])
      }, {
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [amisEditorCore.getSchemaTpl('style:formItem', {
          ...
          schema: [amisEditorCore.getSchemaTpl('className', {
            label: i18nRuntime.i18n("24c5febd312d27b5e80354cf03e241f0"),
...
amisEditorCore.registerEditorPlugin(TreeControlPlugin);

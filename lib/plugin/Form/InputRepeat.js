...
var RepeatControlPlugin = /** @class */function (_super) {
  tslib.__extends(RepeatControlPlugin, _super);
  function RepeatControlPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("d38056d1c6aa9456f4b6b2c20aab06a2");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-repeat';
    _this.pluginIcon = 'input-repeat-plugin';
    _this.description = i18nRuntime.i18n("b3389af540d99fe9e51fb2995dbd6dff");
    _this.docLink = '/amis/zh-CN/components/form/input-repeat';
    _this.tags = [i18nRuntime.i18n("55b45c73ae417c4dead67905b1550e85")];
    _this.scaffold = {
      type: 'input-repeat',
      label: i18nRuntime.i18n("2d842318fbd931286be387aaf5b2a7c3"),
      name: 'repeat'
    };
    _this.previewSchema = {
      type: 'form',
...
amisEditorCore.registerEditorPlugin(RepeatControlPlugin);

...
var ItemPlugin = /** @class */function (_super) {
  tslib.__extends(ItemPlugin, _super);
  function ItemPlugin() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
    // panelTitle = '表单项通配';
    _this.panelTitle = i18nRuntime.i18n("55b45c73ae417c4dead67905b1550e85");
    _this.order = -990;
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return [amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
          value: 'left-top'
        }), ignoreName ? null : amisEditorCore.getSchemaTpl('formItemName', {
          required: notRequiredName ? false : true
        }), renderer.renderLabel !== false ? amisEditorCore.getSchemaTpl('label') : null, hasReadOnly ? amisEditorCore.getSchemaTpl('switch', {
          name: 'readOnly',
          label: i18nRuntime.i18n("973b69af999dbdf4fa124df8c928ca6e")
        }) : null, amisEditorCore.getSchemaTpl('disabled'), ignoreValidator ? null : amisEditorCore.getSchemaTpl('required'), amisEditorCore.getSchemaTpl('description'), amisEditorCore.getSchemaTpl('placeholder'), amisEditorCore.getSchemaTpl('remark', {
          mode: 'row'
        }), renderer.renderLabel !== false ? amisEditorCore.getSchemaTpl('labelRemark', {
          mode: 'row'
        }) : null]
      }, {
        title: i18nRuntime.i18n("afcde2611bdd13c1e65b4fb6a2f13425"),
        body: tslib.__spreadArray([amisEditorCore.getSchemaTpl('formItemMode'), amisEditorCore.getSchemaTpl('horizontalMode'), amisEditorCore.getSchemaTpl('horizontal', {
          label: '',
          visibleOn: 'data.mode == "horizontal" && data.label !== false && data.horizontal'
        }), renderer.sizeMutable !== false ? amisEditorCore.getSchemaTpl('formItemSize', {
          options: [{
        ...
        }) : null, amisEditorCore.getSchemaTpl('formItemInline'), amisEditorCore.getSchemaTpl('className'), amisEditorCore.getSchemaTpl('className', {
        ...
        body: [amisEditorCore.getSchemaTpl('visible'), supportStatic ? amisEditorCore.getSchemaTpl('static') : null, amisEditorCore.getSchemaTpl('switch', {
          name: 'clearValueOnHidden',
          label: i18nRuntime.i18n("7abf78a41095c6d21a1cc89b4a876233")
        })]
      }, ignoreValidator ? null : {
        title: i18nRuntime.i18n("cd8992b644e6c18367861a4d913fd116"),
        body: [
        // getSchemaTplByName('ref'),
        amisEditorCore.getSchemaTpl('validations'), amisEditorCore.getSchemaTpl('validationErrors'), amisEditorCore.getSchemaTpl('validateOnChange'), amisEditorCore.getSchemaTpl('submitOnChange'), amisEditorCore.getSchemaTpl('api', {
          name: 'validateApi',
          label: i18nRuntime.i18n("1040279cf7b8dbdb842f597c30095f62"),
          description: i18nRuntime.i18n("133886b10fd9721e6cf91b76f2df5b6e")
        })]
      }])];
    };
    return _this;
  ...
  ItemPlugin.prototype.afterUpdate = function (event) {
    ...
    if (context.info.renderer.isFormItem && ((_a = context.diff) === null || _a === void 0 ? void 0 : _a.some(function (change) {
      ...
      var change = find__default["default"](context.diff, function (change) {
        var _a;
        return ((_a = change.path) === null || _a === void 0 ? void 0 : _a.join('.')) === 'value';
      });
  ...
  ItemPlugin.prototype.beforeReplace = function (event) {
    var context = event.context;
    if (context.info.renderer.isFormItem && context.data && context.subRenderer && !~context.subRenderer.tags.indexOf(i18nRuntime.i18n("55b45c73ae417c4dead67905b1550e85")) && ~context.subRenderer.tags.indexOf(i18nRuntime.i18n("027446c2f9070b0f5b16a18208bf5fc7"))) {
  ...
  ItemPlugin.prototype.buildEditorContextMenu = function (_a, menus) {
    ...
    menus.unshift({
      label: i18nRuntime.i18n("b95c6e14a4d8f6a6c6d99d583916f327"),
      icon: 'merge-icon',
      onSelect: function () {
        ...
        var group = [tslib.__assign({}, first.schema)];
        ...
        arr.forEach(function (elem) {
          ...
          schema = amisEditorCore.JSONDelete(schema, elem.id);
        });
        var curNewGroup = amisEditorCore.JSONPipeIn({
          type: 'group',
          body: group
        });
        schema = amisEditorCore.JSONUpdate(schema, first.id, curNewGroup, true);

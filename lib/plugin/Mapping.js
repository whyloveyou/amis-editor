...
var MappingPlugin = /** @class */function (_super) {
  tslib.__extends(MappingPlugin, _super);
  function MappingPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("9da188491dd34c4382a5b9f006194e41");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("ddeeaa33ae62ead1a77a859fb79b78d7");
    ...
    _this.scaffold = {
      ...
      value: 1,
      map: {
        1: i18nRuntime.i18n("0218cbc88086353118fea07e364334d4"),
        2: i18nRuntime.i18n("8167b3dd560a83cdc757d1022ff111e2"),
        3: i18nRuntime.i18n("8fa28f95c03faa7cc87e487a89a35a72"),
        4: i18nRuntime.i18n("d246bdddaf59436cb2160837f7bef634"),
        '*': i18nRuntime.i18n("2ab01e418dca1500dcb133d50656deea")
      },
      itemSchema: {
        type: 'tag',
        label: '${item}'
    ...
    _this.panelTitle = i18nRuntime.i18n("9da188491dd34c4382a5b9f006194e41");
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return [amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          } : null, amisEditorCore.getSchemaTpl('mapSourceControl'), {
            type: 'ae-switch-more',
            mode: 'normal',
  ...
  MappingPlugin.prototype.buildEditorToolbar = function (_a, toolbars) {
    ...
    if (info.renderer.name === 'mapping') {
      toolbars.push({
        icon: 'fa fa-expand',
        order: 100,
        tooltip: i18nRuntime.i18n("25e4c39320150bca74b4c05c7740e365"),
  ...
  MappingPlugin.prototype.editDetail = function (id) {
    ...
    node && value && this.manager.openSubEditor({
      ...
      value: util.schemaToArray((_b = value.itemSchema) !== null && _b !== void 0 ? _b : defaultItemSchema),
      slot: {
        type: 'container',
        body: '$$'
      },
      onChange: function (newValue) {
        newValue = tslib.__assign(tslib.__assign({}, value), {
          itemSchema: util.schemaArrayFormat(newValue)
        });
        manager.panelChangeValue(newValue, amisEditorCore.diff(value, newValue));
      },
      data: (_a = {}, _a[value.labelField || 'label'] = i18nRuntime.i18n("6cb01692eea2fa7066d20fe2b6ccaea3"), _a[value.valueField || 'value'] = i18nRuntime.i18n("6cb01692eea2fa7066d20fe2b6ccaea3"), _a.item = i18nRuntime.i18n("6cb01692eea2fa7066d20fe2b6ccaea3"), _a)
    });
  };
...
amisEditorCore.registerEditorPlugin(MappingPlugin);

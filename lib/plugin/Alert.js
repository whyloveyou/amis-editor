...
var AlertPlugin = /** @class */function (_super) {
  tslib.__extends(AlertPlugin, _super);
  function AlertPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("02d9819ddaaaeb1b7b22b12608c7e5ca");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("4be3194e93cdd2899d06b499c184195b");
    ...
    _this.scaffold = {
      ...
      body: {
        type: 'tpl',
        tpl: i18nRuntime.i18n("6f2b01db04cbf7e460b5c6f4e37a5e76"),
        wrapperComponent: '',
        inline: false
      },
      level: 'info'
    ...
    _this.regions = [{
      ...
      placeholder: i18nRuntime.i18n("6f2b01db04cbf7e460b5c6f4e37a5e76")
    }];
    _this.notRenderFormZone = true;
    _this.panelTitle = i18nRuntime.i18n("02d9819ddaaaeb1b7b22b12608c7e5ca");
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            label: i18nRuntime.i18n("cbda486dbec5bdacb593294e240c5e63"),

...
var WebComponentDemo = /** @class */function (_super) {
  tslib.__extends(WebComponentDemo, _super);
...
var WebComponentPlugin = /** @class */function (_super) {
  tslib.__extends(WebComponentPlugin, _super);
  function WebComponentPlugin() {
    ...
    _this.description = i18nRuntime.i18n("1fa035e78c5408c9079c20637acdb2bb");
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: [amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            mode: 'normal',
            name: 'props',
            label: i18nRuntime.i18n("24d67862f87f439db7ca957aecb77cce")
          })]
        }])]
      }]);
    };
...
amisEditorCore.registerEditorPlugin(WebComponentPlugin);

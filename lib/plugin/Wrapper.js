...
var WrapperPlugin = /** @class */function (_super) {
  tslib.__extends(WrapperPlugin, _super);
  function WrapperPlugin() {
    ...
    // 组件名称
    _this.name = i18nRuntime.i18n("8df7c8a1f9f579f0ddc35bb4ee50f166");
    _this.isBaseComponent = true;
    _this.description = i18nRuntime.i18n("de5e232d10e2fa6218259289d4de4835");
    ...
    _this.panelTitle = i18nRuntime.i18n("8df7c8a1f9f579f0ddc35bb4ee50f166");
      ...
      return [amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: [amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: tslib.__spreadArray(tslib.__spreadArray([amisEditorCore.getSchemaTpl('layout:position', {
            ...
            mode: 'vertical'
          }), amisEditorCore.getSchemaTpl('layout:display'), amisEditorCore.getSchemaTpl('layout:flex-setting', {
            ...
            visibleOn: 'data.style && (data.style.display === "flex" || data.style.display === "inline-flex")'
          })], tslib.__read(isFlexItem ? [amisEditorCore.getSchemaTpl('layout:flex', {
          ...
          }), !isFlexItem ? amisEditorCore.getSchemaTpl('layout:margin-center') : null, !isFlexItem ? amisEditorCore.getSchemaTpl('layout:textAlign', {
          ...
          body: [amisEditorCore.getSchemaTpl('layout:padding')]
        }, amisEditorCore.getSchemaTpl('status')])]
      }, {
        title: i18nRuntime.i18n("afcde2611bdd13c1e65b4fb6a2f13425"),
        className: 'p-none',
        body: amisEditorCore.getSchemaTpl('collapseGroup', tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(amisEditorCore.getSchemaTpl('style:common', ['layout'])), false), [{
          title: i18nRuntime.i18n("4434b33a8731a73613ba5fa1eb984efb"),
          body: [amisEditorCore.getSchemaTpl('className', {
            description: i18nRuntime.i18n("5db7ca044a5179bf05428b283ac0452c"),
            pipeIn: amisEditorCore.defaultValue('bg-white')
          })]
        }], false))
      }])];
    };
...
amisEditorCore.registerEditorPlugin(WrapperPlugin);

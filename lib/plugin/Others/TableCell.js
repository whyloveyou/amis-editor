...
var TableCellPlugin = /** @class */function (_super) {
  tslib.__extends(TableCellPlugin, _super);
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return [amisEditorCore.getSchemaTpl('tabs', [{
        ...
        amisEditorCore.getSchemaTpl('label', {
          label: i18nRuntime.i18n("bcee820bc20342a4d388a35ed32a35fe")
        }), amisEditorCore.getSchemaTpl('formItemName', {
          label: i18nRuntime.i18n("41a344642681efaaa418c228ba7fb45c")
        }), amisEditorCore.getSchemaTpl('tableCellRemark'), amisEditorCore.getSchemaTpl('tableCellPlaceholder'), amisEditorCore.getSchemaTpl('switch', {
          name: 'sortable',
          label: i18nRuntime.i18n("233662283039ded8c29f070d1a807029"),
          description: i18nRuntime.i18n("348097cc50579e489f0bcb5433637d3a")
        })]
      }, {
        title: i18nRuntime.i18n("dfac151de712ab0b3618072c8a7f0a0f"),
        body: [{
          name: 'groupName',
          label: i18nRuntime.i18n("9db64f772c11c614ee00bb3cc066f46f"),
          type: i18nEnabled ? 'input-text-i18n' : 'input-text',
          description: i18nRuntime.i18n("9791b05a4df9d72f1a01b81fa695fbc6")
        }, amisEditorCore.getSchemaTpl('switch', {
          name: 'quickEdit',
          label: i18nRuntime.i18n("19c4f5e98ad302574202de30dddbaf66"),
          ...
          value: 'popOver',
          label: i18nRuntime.i18n("abd733d00ec656e7b0cfd88deedf102f"),
          size: 'xs',
          mode: 'inline',
          className: 'w-full',
          options: [{
          ...
          label: i18nRuntime.i18n("15c3796e07e33afc7252df751f610c5d"),
          visibleOn: 'data.quickEdit',
          description: i18nRuntime.i18n("2d2eb2ac28f074d1caef0d332d61cfb0"),
          ...
          name: 'popOver',
          label: i18nRuntime.i18n("ba5a0a1ff2c438ae7719ca48b0ce3af7"),
          pipeIn: function (value) {
            return !!value;
          }
        }), {
          name: 'popOver.mode',
          label: i18nRuntime.i18n("d689e3c38fdb32c98fb27f8f35a26552"),
          type: 'select',
          ...
          options: [{
            ...
            label: i18nRuntime.i18n("33e6c41fed95c25e3b426d596d504579"),
            value: 'drawer'
          }]
        }, {
          ...
          name: 'copyable',
          label: i18nRuntime.i18n("6e78b595d6a296938201a3c80660bf35"),
          pipeIn: function (value) {
            return !!value;
          }
        }), {
        ...
        body: [{
          ...
          name: 'toggled',
          label: i18nRuntime.i18n("0a5ac2f5c327e28c58d51db967a0e603"),
          pipeIn: amisEditorCore.defaultValue(true)
        }), {
          name: 'breakpoint',
          type: 'button-group-select',
          label: i18nRuntime.i18n("a3bd2104e3df81df713de636b907462c"),
          visibleOn: 'data.tableFootableEnabled',
          size: 'xs',
          multiple: true,
          options: [{
            label: i18nRuntime.i18n("986a5f50e946674bb91c9408fc974497"),
            value: '*'
          }, {
            label: i18nRuntime.i18n("a165f0fe5fb904049f6b6961105e433f"),
            value: 'xs'
          }, {
            label: i18nRuntime.i18n("03ee8b948c9b34daca9584811bcca17d"),
            value: 'sm'
          }, {
            label: i18nRuntime.i18n("82d9f1f96084674e2b0101ecc04d5d58"),
            value: 'md'
          }, {
            label: i18nRuntime.i18n("f4166de371b5dfb87efce228b17a3fbb"),
            value: 'lg'
          }],
          pipeIn: function (value) {
          ...
          name: 'className',
          label: i18nRuntime.i18n("f8cffd4d3fcdca390a3a3de24d209bb6"),
          pipeIn: function (value) {
          ...
          name: 'width',
          type: 'input-number',
          label: i18nRuntime.i18n("bdd9d38d7e2929024089363dc8f48b7a"),
          description: i18nRuntime.i18n("b198805e7a6b35830ba813f51db2fdc4")
        }]
      }])];
    };
    return _this;
  ...
  TableCellPlugin.prototype.getRendererInfo = function (_a) {
    ...
    if (renderer.name === 'table-cell') {
      return {
        name: schema.label ? "<".concat(schema.label, ">\u5217") : i18nRuntime.i18n("044892c0c637f2d9e78e78956b1ded01"),
...
amisEditorCore.registerEditorPlugin(TableCellPlugin);

exports.TableCellPlugin = TableCellPlugin;

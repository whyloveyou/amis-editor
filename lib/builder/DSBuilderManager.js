...
var DSBuilderManager = /** @class */function () {
  function DSBuilderManager(manager) {
    ...
    DSBuilder.builderFactory.forEach(function (Builder, key) {
  ...
  DSBuilderManager.prototype.getBuilderBySchema = function (schema, sourceKey) {
    ...
    var builder;
    try {
      for (var _b = tslib.__values(Array.from(this.builders.entries())), _c = _b.next(); !_c.done; _c = _b.next()) {
  ...
  DSBuilderManager.prototype.getDefaultBuilderKey = function () {
    ...
    var _d = tslib.__read((_c = (_a = collections.find(function (_a) {
      ...
      })) === null || _b === void 0 ? void 0 : _b[0]) !== null && _c !== void 0 ? _c : [], 2),
      defaultKey = _d[0];
      _d[1];
    return defaultKey;
  };
  ...
  DSBuilderManager.prototype.getAvailableBuilders = function () {
    return Array.from(this.builders.entries()).filter(function (_a) {
      var _b;
      var _c = tslib.__read(_a, 2);
        _c[0];
        var builder = _c[1];
  ...
  DSBuilderManager.prototype.getDSSelectorSchema = function (patch, config) {
    ...
    var _b = config || {},
      schema = _b.schema,
      sourceKey = _b.sourceKey,
      getDefautlValue = _b.getDefautlValue;
    var builders = this.getAvailableBuilders();
    var defaultValue = schema === null || schema === void 0 ? void 0 : schema.dsType;
    var options = [];
    try {
      for (var builders_1 = tslib.__values(builders), builders_1_1 = builders_1.next(); !builders_1_1.done; builders_1_1 = builders_1.next()) {
        var _c = tslib.__read(builders_1_1.value, 2),
          key = _c[0],
          builder = _c[1];
        if (schema && !defaultValue) {
          if (getDefautlValue && typeof getDefautlValue === 'function' && getDefautlValue(key, builder)) {
            defaultValue = key;
    ...
    return tslib.__assign(tslib.__assign({
      type: 'radios',
      label: i18nRuntime.i18n("a094e5b7699ea4b61094cc4120170423"),
      name: 'dsType',
  ...
  DSBuilderManager.prototype.buildCollectionFromBuilders = function (callback) {
    var builders = this.getAvailableBuilders();
    var collection = builders.map(function (_a, index) {
      var _b = tslib.__read(_a, 2),
        key = _b[0],
        builder = _b[1];

...
})(exports.DSBehavior || (exports.DSBehavior = {}));
/** 数据粒度 */
exports.DSGrain = void 0;
(function (DSGrain) {
  /** 实体 */
  ...
  /** 单条数据 */
  DSGrain["piece"] = "piece";
})(exports.DSGrain || (exports.DSGrain = {}));
/** 数据源所使用的功能场景 */
var DSFeature = {
  List: {
    value: 'list',
...
})(exports.DSFeatureEnum || (exports.DSFeatureEnum = {}));
...
exports.ApiCenterDSBuilderKey = ApiCenterDSBuilderKey;
exports.ApiDSBuilderKey = ApiDSBuilderKey;
exports.DSFeature = DSFeature;

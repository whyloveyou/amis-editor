...
i18nRuntime.extendLocale('zh-CN', {
    ...
    '38d2ccdde0ae0c2329defd3c75c59d8b': '由于内边距限制，太小的高度设置会不生效，可以调小默认内边距',
    'd59379f4227af3b2c60214e2f4f903ba': '合并单元格',
    '02d9819ddaaaeb1b7b22b12608c7e5ca': '提示',
    '4be3194e93cdd2899d06b499c184195b': '用来做文字特殊提示，分为四类：提示类、成功类、警告类和危险类。可结合 <code>visibleOn</code> 用来做错误信息提示。',
    ...
    'f6da8aa86fa3e399da95dab399a67985': '锚点导航，在多行内容展示时，可以将内容用锚点导航分组的形式展示，点击导航菜单可以定位到对应内容区域。',
    ...
    '37b12f2666b9e4e37f33eb5e83533d5e': '<p>当前为字段内容节点配置，选择上层还有更多的配置。</p>',
    'f8f176147db276063e7ec15f076e39e0': '音频地址',
    '91d3cd46d6b6919749e56056d5acc9bc': '支持获取变量如：<code>\\${audioSrc}</code>',
    ...
    'ad751bba0aed43a673c40b652a239fc3': '选择倍速后，还需要在常规选择栏中配置倍速',
    ...
    'f1b4c635cdb39c91461f181d27d06f8c': '文字居中，文字过多时保持与边框最小的距离',
    ...
    '89de611b2d759a1802542b5d3a06829f': '用来展示一个按钮，你可以配置不同的展示样式，配置不同的点击行为。',
    ...
    'ed2f135144b4e138cb29419c1f245f4b': '点击后先询问用户，由手动确认后再执行动作，避免误触。可用<code>\\${xxx}</code>取值。',
    '0d0c6ff7b65e62eba3ddd523e2976389': '确认内容',
    '7e9646e2db5ce66dc2b4b922ece483ba': '气泡提示',
    '5daaffe964aee9d884e0a681b2818a17': '正常提示',
    '2fd82aa9dd7fedea2c16b7dfe93b6d0e': '正常状态下的提示内容，不填则不弹出提示。可用<code>\\${xxx}</code>取值。',
    'fb37b983a93aabdcdbbd59ae48c519fb': '禁用提示',
    'f4f168a3fec79443d2ca8fd1955edee8': '禁用状态下的提示内容，不填则弹出正常提示。可用<code>\\${xxx}</code>取值。',
    ...
    '66ae9ce23b0b2e243aff087d906a2489': '用来展示多个按钮，视觉上会作为一个整体呈现。',
    ...
    '2e28645c67c5742e473888a27aab7bd6': '使按钮组宽度占满父容器，各按钮宽度自适应',
    ...
    '433e2e80ec74563daf4368e59b525e34': '可以用来放置多个按钮或者按钮组，按钮之间会存在一定的间隔',
    '6651fec0511e3593d3438a113dff23d6': '可排序、可移除、如要编辑请在预览区选中编辑',
    'd7213304d1a8a02a73a2f4010839e061': '增删改查',
    '7a9f1ec32752de8b69ef21138970f64d': '用来实现对数据的增删改查，支持三种模式展示：table、cards和list. 负责数据的拉取，分页，单条操作，批量操作，排序，快速编辑等等功能。集成查询条件。',
    ...
    '3266535dc49863d976b9960adad29fef': 'API返回格式不正确，请点击接口地址右侧示例的问号查看示例',
    ...
    '46e6edaeb9968e7f7ab549d4f2f82d6d': '通过此可以管理批量操作按钮，只有设置了批量操作按钮才会出现选择框，可在外观中配置批量操作按钮位置。',
    '8347a927c09a4ec2fe473b0a93f667d0': '修改',
    'f13a0697d58d975d14eb3f3c72c2cbf2': '单条操作',
    '3674ea51498e7118732e5e1c53d4bc80': '设置后，当鼠标悬停行数据上，会出现该操作按钮，同时顶部操作栏也会显示该按钮，勾选成员时与批量按钮智能切换。',
    '4916771d080ddf6d0551de4d6d2f42a4': '悬停隐藏',
    '569343b4fe5e48131b78611c11eadbeb': '同步地址栏',
    '6dbee29a8c54eef9d042ef3280999ad9': '开启后会把查询条件数据和分页信息同步到地址栏中，页面中出现多个时，建议只保留一个同步地址栏，否则会相互影响。',
    '2171d1b07d045e796cba4a05bcf7d13f': '默认参数',
    '01e7eb2256821085a14708d6ddf36814': '可以用来设置默认参数，比如 <code>perPage:20</code>',
    '58ed0a7a5a91996dbb4c7d6dc7679364': '保留条目选择',
    '36ac0011faae6f88ee0ec3e642328327': '默认分页、搜索后，用户选择条目会被清空，开启此选项后会保留用户选择，可以实现跨页面批量操作。',
    '2a0b47ba76e886070c3bd6abeae3d1c0': '单条描述模板',
    '6ab3e5b6c5d5d2cf621e911226495433': '开启【保留条目选择】后会把所有已选择条目列出来，此选项可以用来定制条目展示文案。',
    '987b04af242bb2dafaf32d890ab952ff': '指定主键',
    'a270e70be12fb13a24ca3e4ac70fa838': '默认<code>id</code>，用于批量操作获取行级数据',
    ...
    '559fa334442f0f75b0343bbf38b7ff05': '开启后，数据只会在初始的时候拉取，后续分页、排序不再请求接口，都由前端直接完成。',
    ...
    '32e3a79e80dcf7f7304e8092dd7acc6f': '定时刷新一旦设置会一直刷新，除非给出表达式，条件满足后则不刷新了。',
    ...
    '8343f619879fa79bc8ef1a35b2fc3e78': '当 column 中设置了快速编辑后将使用此接口批量保存数据。',
    'd891e79d4a8718a7dbd47ac68aaaa5cb': '快速保存单条接口',
    '38db6e045e214ffcd03ede695002271c': '当 column 中设置了快速编辑且设置了立即保存，将使用此接口保存数据。',
    '522110866c19dace2ce38336617405c2': '默认消息提示',
    '3b69c2e540c05e9ca530ed30cf224472': '覆盖默认消息提示，但如果 api 返回 msg 则会优先使用这个 msg',
    ...
    '62569fcb0fc8314daea97989bba3877c': '不填写，默认读取接口返回的 items 或者 rows 属性，如果是别的，请在此设置，如： <code>\\${xxxx}</code>',
    ...
    'dd8d217677e4c5df28b7f46aa99b22a8': '设置用来确定位置的字段名，设置后新的顺序将被赋值到该字段中。',
    'e04e8f570e2fb43a533b224f3c48523d': '切换每页数',
    '0fc1de8f71a7470213fc68f981abdbc2': '配置单条可选中的表达式',
    '7d5fefd589000879088063dceb4b2552': '请使用 js 表达式，不设置的话每条都可选中。',
    ...
    '60011314ed92794f3d4f3e874c359279': '默认切换页面、搜索后，用户选择项会被清空，开启此功能后会保留用户选择，可以实现跨页面批量操作。',
    ...
    'd2e20bb1e977f9571a9e2d1b39a7ff10': '数据一次性加载到浏览器，而非每次请求后端用户所请求的当页数据，不建议开启，对性能影响较大',
    ...
    'a0c35361a003527d123cb581f5c68f4b': '围绕卡片列表的数据增删改查. 负责数据的拉取，分页，单条操作，批量操作，排序，快速编辑等等功能，集成查询条件。',
    '9caecd931b956381e0763d05aa42835c': '字段',
    '860827796ce2fa94e9ee39e53f011ec0': '围绕列表的数据增删改查. 负责数据的拉取，分页，单条操作，批量操作，排序，快速编辑等等功能，集成查询条件。',
    ...
    'aeca6900b9e45f7f235eb9d443f0dd61': '不再显示选择框，可以通过自定义选中态外观实现选中样式',
    '1d4103a96a70de2cb69dd597d679fefe': '选中态',
    '85c17b016309a3f867a1803049b3bcd8': '功能类似于表格，但是用一个个小卡片来展示数据。当前组件需要配置数据源，不自带数据拉取，请优先使用 「CRUD」 组件。',
    ...
    '1007c97dbf952e032ce13be3cb811f23': '用来渲染轮播图，可以配置每一页的内容（不只是图片），可以配置过渡动画。',
    '0a2907a421b8f980986117e4f3044f92': '关联字段',
    'e760ec18028fc075c5705bf184589e70': '静态设置',
    'd314558953b3c76adb7e131aaec8bd86': '字段名',
    '793a763e73f1f742e3a16ddc2ed95ccb': '设置字段名，关联当前数据作用域中的数据。',
    ...
    '10e14f791d73c7c0f4113787f36f1626': '用来渲染图表，基于 echarts 图表库，理论上 echarts 所有图表类型都支持。',
    '67b6bec14c39be3f2602271e2fe3bcde': '更新数据',
    '0310aa5a05fe07147d8b7ef20616f659': '触发组件数据更新',
    '3d6abfdea70af544603da70f93ed3d24': '接口拉取',
    '03677b68a73eb59e5faf281f49f3c130': '接口可以返回配置，或者数据，建议返回数据可映射到 Echarts 配置中',
    ...
    '3d3fa75d8b345b22a5fbd14a65a0af71': '支持数据映射，可将接口返回的数据填充进来',
    ...
    'f1f13cb0ca4720a727cbfba4c82e5890': '默认为追加模式，新的配置会跟旧的配置合并，如果勾选将直接完全覆盖。',
    ...
    '452b62e9b7e650fa163300da2893654a': '折叠器，可以将内容区展开或隐藏，保持页面的整洁',
    ...
    '0d571a7ab19e098820e8cea4d5a80f7d': '折叠面板，当信息量较大且分类较多时，可使用折叠面板进行分类收纳。',
    ...
    'a955021cdf0249de1f3818f83cf248b7': '用来展示表格的自定义显示列按钮，你可以配置不同的展示样式。',
    ...
    'ded228f9173b241dd8df2a4811ea0e98': '一个简单的容器，可以将多个渲染器放置在一起。',
    ...
    '2bc6d101e5701a70f2fb9e0b67581594': '主要用来关联字段名做日期展示，支持各种格式如：X（时间戳），YYYY-MM-DD HH:mm:ss。',
    ...
    'bc43ae8e61f1ad4be2b0a9e70501e490': '用来展示一个分割线，可用来做视觉上的隔离。',
    ...
    '74bafe23b0be1a14aa218b396cb33bd0': '下拉按钮，更多的按钮通过点击后展示开来。',
    ...
    'f34111ff3694a6c6de6e31bef8ebadcb': '功能渲染器，可以基于现有变量循环输出渲染器。',
    '874268022baac239b06c40600d3ce080': '<%= data.index + 1 %>. 内容：<%= data.item %>',
    '69bdc66bb88ac5b63053e2bb7db41801': '循环',
    'b7c16dedc4291d333fba7628ec9eb073': '如果所在容器有下发 value 则不需要配置，如果没有请配置变量名，支持多层级如：a.b，表示关联a对象下的b属性。目标变量可以是数组，也可以是对象。',
    '4726ff4e62d3fcfa4b090aaefc393229': '暂无内容',
    '5d5f9d49fcb2109f94a43590ef796ca7': '当没有关联变量，或者目标变量不是数组或者对象时显示此占位信息',
    ...
    '29513434492e5d19a9660e0a918befd1': '用来展示多个按钮，视觉上会作为一个整体呈现，同时可以作为表单项选项选择器来用。',
    ...
    '8db57ba01ffb9bf29c1656de5f0208f5': '将值重置为resetValue，若没有配置resetValue，则清空',
    ...
    'fd179c2844536ce198290441c38c814e': '<span class=label label-default><% if (data.type === button-group) { %> 按钮组 <% } else { %><%= data.label %><% if (data.icon) { %><i class=<%= data.icon %>/><% }%><% } %></span>',
    'b6872877e1eb5ddedd904c170db26024': '链式下拉框',
    'fdf1664c0790d25f236bd596aef1acef': '通过<code>source</code>拉取选项，只要有返回结果，就可以无限级别增加',
    ...
    '6d1383a2806f0516aac2c115f96799eb': '通过<code>options</code>配置多个勾选框，也可以通过<code>source</code>拉取选项',
    ...
    '08346c5bb99d8e3bfa406995b8c4f067': '代码编辑器，采用 monaco-editor 支持：{{@1}}等等',
    ...
    '4db731c7d73988e40a01b4bf1a7f00d7': '多个表单项的组合，可配置是否增加和删除初始设定的模板',
    ...
    'ba2bd765f6c2e2b717139c5453884e14': '当设置 tabsMode 为 true 时，切换选项卡时触发',
    ...
    '28a59fee1a4714493a8d6cec05c1417b': '默认数组内的数据结构为对象，如果只有一个表单项，可以配置将值打平，那么数组内放置的就是那个表单项的值',
    ...
    '91396e9bc25c9e8b63907fe22408e2bb': '可通过拖动每行中的【交换】按钮进行顺序调整',
    ...
    '93dc24d4ad01981d5994ba7f8ffaf345': '如果数据比较多，比较卡顿时，可开启此配置项',
    '98d52b737d6bc171b6d5bad9a42f6e23': '严格模式',
    'cb5ca128b6c78a90f26673e21b0b3f28': '如果你希望环境变量的值实时透传到 Combo 中，请关闭此选项。',
    'bc91f4844843d6c8ec1acb78a1f1aba4': '配置同步字段',
    '07bf6c08bb5f0bdb32dbfecc7d3fe290': '如果 Combo 层级比较深，底层的获取外层的数据可能不同步。但是给 combo 配置这个属性就能同步下来。',
    '3f2176cdae8a4ed6a4c4eaff002a3b24': '允许为空',
    'ead7156521ca11acb7ca7bdf4c9c87f6': '如果子表单项里面配置验证器，且又是单条模式。可以允许用户选择清空（不填）。',
    '7ab968b8219f6c348478da255ebcbcb9': '各列 CSS 配置',
    '6e87bfe16db746db13966f0d7552b052': '条件组件',
    'ab7f2096d3ea8aa85f453b204bfbc493': '用于设置复杂组合条件，支持添加条件，添加分组，设置组合方式，拖拽排序等功能。',
    'ae5e21c7b57aaaff2071b757f35dbb3e': '适合让用户自己拼查询条件，然后后端根据数据生成 query where',
    ...
    '7b4fe9415d80d3694d2f630411ac7e9c': '左右两边的代码做对比，支持的语言包括：{{@1}}等等',
    ...
    '10b3d542748da2043f79395bfa2ab35f': '可用于新建、编辑或者展示数据，配置初始化接口可从远端加载数据，配置提交接口可将数据发送远端。另外也可以将数据提交给其他组件，与其他组件通信。',
    ...
    'ded8caee55c05aa0f1a4e6a197c480bd': '设置后将让表单的第一个可输入的表单项获得焦点',
    'c8801f299681b3080968effcb13a57fe': '禁用回车提交表单',
    '4fe8162504ae5fb955c30863d88834fa': '设置后无法通过键盘 “回车” 按键进行表单提交',
    '6232c762a93aeb3c89cc759c06802610': '提交完后重置表单',
    '7d61784cd115d333f01a3c0c46408a1c': '即表单提交完后，让所有表单项的值还原成初始值',
    ...
    '4133d2c3613ece9792c90d185ec32306': '可以通过设置此属性，把当前表单的值提交给目标组件，而不是自己来通过接口保存，请填写目标组件的 <code>name</code> 属性，多个组件请用逗号隔开。当 <code>target</code> 为 <code>window</code> 时，则把表单数据附属到地址栏。',
    '7653297de32f34fdec0dd0653aebf358': '跳转',
    '6d00e21637c382cbd4d949b7735a2e41': '当设置此值后，表单提交完后跳转到目标地址。',
    '672b63d7523095b949f5fad233fa0cde': '是否开启本地缓存',
    '8a0544ca2f7ddaf8768ab599858315a6': '开启后，表单的数据会缓存在浏览器中，切换页面或关闭弹框不会清空当前表单内的数据',
    'ce2457fe99197e0fe81b6fb08e3eaf0e': '提交成功后清空本地缓存',
    'bc01ee1a28f980c298679610fe4d2d66': '开启本地缓存并开启本配置项后，表单提交成功后，会自动清除浏览器中当前表单的缓存数据',
    ...
    '6df230c8f18709575777172f0a9a588c': '异步方式主要用来解决请求超时问题，启用异步方式后，程序会在请求完后，定时轮询请求额外的接口用来咨询操作是否完成。所以接口可以快速的返回，而不需要等待流程真正完成。',
    'daf3aec137ac74941adb1b1d3e3dd1d3': '异步检测接口',
    '0705e4aba9f22ae70d906e2201a4a68d': '设置此属性后，表单提交发送保存接口后，还会继续轮训请求该接口，直到返回 finished 属性为 true 才 结束',
    'b4bc91701b86fe8543d649e97daea602': '初始化接口',
    '258c437ef67e5ef12f3a766ff1802f85': '用来初始化表单数据',
    'e8c46074d8432532cac25eba56bca354': '采用异步方式？',
    'd2af24c0f76cf325f1c8fa939576c379': '设置此属性后，表单请求 initApi 后，还会继续轮训请求该接口，直到返回 finished 属性为 true 才 结束',
    'ab94e2c30b3cf0fd11eea477f70dcbaf': '初始化失败',
    'b64292a1903bd969d0e3a558c334f5bf': '默认消息信息',
    '8a5e590f69e1ae52d86396410ceeee5a': '可以不设置，接口返回的 msg 字段，优先级更高',
    ...
    '1cb01363e2463443bc8105f544ce2736': '关闭后，表单只会展示表单项，标题和操作栏将不会显示。',
    ...
    '000cf7353ce03857c671e89c91b35464': '通过公式计算指定的变量值，并将其结果作用到指定的变量中',
    '9da7578f9329ccaee1bbdf6a766744fd': '计算公式',
    '77562ec3db28683ec71612a11e6b39ef': '公式计算结果会作用到此字段名对应的变量中。',
    'c80c42a0be1b39ed899b1f5560875cf8': '支持 JS 表达式，如： <code>data.var_a + 2</code>，即当表单项 <code>var_a</code> 变化的时候，会自动给当前表单项设置为 <code>var_a + 2</code> 的值。若设置为字符串，则需要加引号',
    '89a8549c2ed7fc23a683599731d92b22': '作用条件',
    '3df193f5d4f652a4bac331a69761041b': '是否初始应用',
    '86cebf86c66c6a4e6731b840c3967ab0': '是否初始化的时候运行公式结果，并设置到目标变量上。',
    'aaff9b44fa3c84058d6bec9888b7b39f': '是否自动应用',
    '677568b4f6505bdd63387137bfcbf35a': '是否自动计算公式结果，有变化时自动设置到目标变量上。<br />关闭后，通过按钮也能触发运算。',
    ...
    '6e43f86d0b2973c34078bc7c7bc02eb0': 'Array 数组输入框，可自定义成员输入形式。其实是 Combo 的 flat 值打平的一种用法，可直接用 combo 代替。',
    ...
    '5a9e72d006165ae3dacdbd96f931f70e': '支持<code>hex、hls、rgb、rgba</code>格式，默认为<code>hex</code>格式',
    ...
    '9b161db0e2e749c1106c702c8097d380': '开启时，禁止手动输入颜色，只能从备选颜色中选择',
    ...
    '4be42a8a2cbb9088b4d051cfd824d68c': '支持 <code>now、+1day、-2weeks、+1hours、+2years</code>这种相对值用法，同时支持变量如<code>\\${start_date}</code>',
    'be28cd64f978dd70c1cd345ebe751bca': '日期框、input-datetime、日期时间框、input-time、时间框、input-month、月份框、input-quarter、季度框、input-year、年框',
    '52ea2070560eb55083b64f5ba748697d': '年月日选择，支持相对值设定，如<code>+2days</code>两天后',
    ...
    '182503224cfaf1f63c566f13da56a2a4': '请参考 <a href=https://momentjs.com/ target=_blank>moment</a> 中的格式用法。',
    'bf8f46b5c3b309f666965a74d57ac093': '支持 <code>now、+1day、-2weeks、+1hours、+2years</code>等这种相对值用法',
    ...
    '28de3d73d839b616bd617b3636669780': '日期范围框、input-datetime-range、日期时间范围、input-time-range、时间范围、input-month-range、月份范围、input-quarter-range、季度范围、input-year-range、年范围',
    '9024ff398faf8340b92bf0208431973b': '日期范围选择，可通过<code>minDate</code>、<code>maxDate</code>设定最小、最大日期',
    ...
    '7f4466c0a16a1808b5ee398ce55997ab': '日期时间范围选择，可通过<code>minDate</code>、<code>maxDate</code>设定最小、最大日期',
    ...
    'ec1f230a0181d79b37967a455b1f3515': '可上传多个文件，可配置是否自动上传以及大文件分片上传',
    '8dccb3d6633a85edb21fa52599211654': '上传文件值变化时触发（上传失败同样会触发）',
    ...
    '5548252bd28fc1d217d13a9e5771ecb0': '用来做分块前的准备工作，一个文件只会调用一次。如果出错了，后续的分块上传就会中断。',
    'd7832abe5b9ce8e41537b4964fd7cf70': '分块上传接口',
    '14008d63c109cc0d0c4ba305671800d2': '用来接收每个分块上传，大文件会根据 chunkSize 分割成多块，然后每块上传都会调用这个接口。',
    '70c935fa7ae03aeb1ff87b878e16841f': '上传完成接口',
    'c88aaeddb5aa95c7627d84df33929e3f': '等所有分块上传完后，将上传文件收集到的 `eTag` 信息合并一起，再次请求后端完成文件上传。',
    '1e4dc4d5f4a3a95ddc349147d4d8cd39': '文件接收器',
    '258d9e27231b06769dd584a3365545ba': '默认不填写将上传到 bos，可以在系统配置中设置为自己的 bos 地址。',
    '28b988ce6ae6dd62d24bcb8a52119179': '文件类型',
    'f0a37d6f810c73a2f936f33035d99056': '请填入文件的后缀，多个类型用<code>,</code>隔开',
    '58892b7a6a785706712761d5aebb4639': '模板链接',
    'af4b910df15b00ba7fb5163558389cfe': '适用于excel上传等有上传格式要求的场景，为用户提供一个模板下载入口',
    ...
    '0a7f8e17f8487c3715a154bea698778e': '可以对图片实现裁剪，限制图片的宽高以及大小，支持自动上传及上传多张图片',
    '7c5e7ad8954effd97cb78dcb0e8f99d9': '图片类型',
    'f816b3decb401dcd0c22db7f104beccc': '请填入图片的后缀或 <code>MimeType</code>，多个类型用<code>,</code>隔开',
    ...
    'a7b7da38fcb8e246e910e178c5fe4ebc': '当宽高比没有满足条件时，此描述将作为提示信息显示',
    ...
    '5b4ad7ffa6eee985e72e002bf18ac09a': '月份范围选择，可通过<code>minDate</code>、<code>maxDate</code>设定最小、最大日期',
    ...
    '33bf23fcb86101a9994b7e4bfdc2b062': '请输入数字或使用 <code>\\${xxx}</code> 来获取变量，否则该配置不生效',
    ...
    'f34b1a3e26aadb6f60c546dbe9c62232': '当设置 showInput 为 true 时，输入框获取焦点时触发',
    '404625f170839b2a24d7ab65304c2fe7': '滑块当前值',
    '7c9ec5db3bf23f367c1a905d356aab5c': '当设置 showInput 为 true 时，输入框失去焦点时触发',
    ...
    '1a920d9999206a9fa5f588c7405fe081': 'SubForm, 配置一个子<code>form</code>作为当前的表单项',
    '18c113b99afa964ee988f30e81baf12b': '名称字段名',
    '4d930a9c13fca9d74e1a77496abfaa58': '当值中存在这个字段，则按钮名称将使用此字段的值来展示。',
    ...
    '0fbb26a646da61d2123319b4d0144ba4': '可以用来展现数据的,可以用来展示数组类型的数据，比如 <code>multiple</code> 的子 <code>form</code>',
    ...
    '1b4996b29c7b4d5fb45ca701e6438d14': '配置<code>options</code>可以实现选择选项',
    ...
    '6f6fa31a91b516b28ebee7a86a9b13e2': '设置选项后，输入时会下拉这些选项供用户参考。',
    '379b5486e7860a9f38f37dddabbb094c': '文本框、邮箱框、input-email、URL框、input-url、密码框、input-password',
    'f222f5413d3854897741e0ec4b0d2c7b': '文本输入框，支持普通文本、密码、URL、邮箱等多种内容输入',
    '9306b956ca5950203ee49a2680cac63d': '输入框左侧或右侧的附加挂件',
    'd548d3e938088d5d469a28c20e939750': '自动补全',
    '424cd425082360322678a5c8d6910b80': '根据输入内容，调用接口提供选项。当前输入值可用${term}变量',
    '7e9c83e86beb612377a94e6e8d1fc644': '显示字段',
    '26ff46d82166741297ce666b2792af85': '选项文本对应的数据字段，多字段合并请通过模板配置',
    ...
    'c166d8f9804ecef74b3b74190599a7b8': '时间范围选择，可通过<code>minDate</code>、<code>maxDate</code>设定最小、最大日期',
    '479728c411bac59bc44d5ab8dc3cb4f0': '树选择框',
    '15ac5d800c0163b4b806622739478e9b': '树型结构来选择，可通过<code>options</code>来配置选项，也可通过<code>source</code>拉取选项',
    ...
    '6e19e48a52986659ae5ba1bfe612ba8a': '选中父节点时，值里面将包含父子节点的值，否则只会保留父节点的值',
    'cccb3595f8ff536e27d94ec91a49bfdf': '值只含子节点',
    '49ccf100ac35e1cc3d40b7222cdcd1a7': 'ui 行为级联选中子节点，子节点可反选，值只包含子节点的值',
    ...
    '346f7e0c7ef27b6a83f3c9f8f406d737': '默认展开所有节点层级，开启后可自定义展开层级数',
    ...
    '32a750b4fd61f1cfe37cac7147f05b3c': '年份范围选择，可通过<code>minDate</code>、<code>maxDate</code>设定最小、最大日期',
    ...
    '5e391af52da238f13c78b471a7cc54f3': '单选或者多选，支持<code>source</code>拉取选项，选项可配置图片，也可以自定义<code>HTML</code>配置',
    ...
    '183aae5eec1ff547833dc338aaeffc9a': '可配置行单选，列单选，以及全部选项只能单选或者全部选项多选',
    ...
    '10d1cfb7219a5445ef1e70aa16e4451d': '适用于选项中含有子项，可通过<code>source</code>拉取选项，支持多选',
    ...
    'c23eb92d1f249452c3ff3ee13738b47a': '开启后选中父级，不会全选子级选项，并且父级作为值返回',
    '8fcbfdc1a9403f6339d81911473806da': '列表选取',
    '819776e8d96b1438eca3594f47bdb1c6': '通过<code>pickerSchema</code>配置可供选取的数据源进行选择需要的数据，支持多选',
    ...
    '5a7af8d3e471d98339c84b07a844547b': '通过<code>options</code>配置选项，可通过<code>source</code>拉取选项',
    ...
    '8a0c1f35cff334fc105b6d52b195369d': '支持多选，输入提示，可使用<code>source</code>获取选项',
    ...
    '2b23767de575e27fc9e4e0949e885f81': '标签的最大展示数量，超出数量后以收纳浮层的方式展示，默认全展示',
    '406af2b98e6210cd42d7f824cb6dfd16': '选项值检查',
    'fa8d03e8b5458c1a1d742736bc26e25b': '开启后，当选项值未匹配到当前options中的选项时，选项文本飘红',
    '33e7b7433fdbeafa1ef71105ee28c061': '静态展示框',
    'c99e0a675933de39693b7e80d5b70405': '纯用来展示数据，可用来展示<code>json、date、image、progress</code>等数据',
    ...
    '2d2eb2ac28f074d1caef0d332d61cfb0': '开启后修改即提交，而不是标记修改批量提交。',
    'eccba4475f3144e417e55fd96e831e09': '立即保存接口',
    'c8e5c062d5ad38e54413abd9c7cfb2f4': '是否单独给立即保存配置接口，如果不配置，则默认使用quickSaveItemApi。',
    ...
    'b3a17ee1af382c467d857d33089fc0c7': '左侧选项渲染模板，支持JSX，变量使用\\${xx}',
    'd5dbf5285b2dbe07b481fbd5d4536c60': '右侧结果面板',
    'b720b2abd62161c3c99625c8160df987': '跟随左侧',
    'acef03eee638dc4239ee60f627f33d85': '查询功能目前只支持根据名称或值来模糊匹配查询',
    'e3ed623b79100791f156d3586751c652': '支持排序',
    'd4865602e26e9c985814380beae99b6d': '结果选项渲染模板，支持JSX，变量使用\\${xx}',
    ...
    '4dabfefd787102b8159b5c4a221aa048': '隐藏选择框中已选中节点的祖先节点的文本信息',
    ...
    '69a519f6b7fd6d0bebba72e7572ea1d6': '用来实现左右排版布局，默认平均分配，可以通过 columnClassName 配置某列的宽度。',
    ...
    'd34cc10492e80595a901a292d0c16bb8': '可以添加宽度类样式调整宽度，默认宽度为平均分配。',
    ...
    '51ad722113289f70b6d77c78ddf0c64a': '默认宽度为父容器宽度，值单位默认为 px，也支持百分比等单位 ，如：100%',
    'c78d9b9ab9db5951eb5526e8a46677d9': '默认高度为父容器高度，值单位默认为 px，也支持百分比等单位 ，如：100%',
    '9ef4425332e5f8bcad86de483b4faedf': 'IFrame 页面（{{@1}}）',
    '67997ccf7ea846c3c2d278b01ed9600b': '图片展示',
    '6dcf991e992a0b765df0933411fe9bb2': '可以用来展示一张图片，支持静态设置图片地址，也可以配置 <code>name</code> 与变量关联。',
    'e18aa5e376437da71083a29c4cddaf46': '缩率图',
    'fb43d5ffa21f3c4055c29fad350f27e4': '原图',
    '582570bef8c57c5af7658c4a4eea45ff': '缩略图地址',
    '1193e1aab7bea094279ae7b4288ba848': '如果已绑定字段名，可以不用设置，支持用变量。',
    ...
    '2d4247be13246794180897b40fcdbcb1': '比如：\\${listVar}，用来关联作用域中的已有数据。',
    ...
    '78ce29fdc55e6d0980b591a264c537a8': '支持取变量，如果已绑定字段名，可以不用设置',
    ...
    'e35dbea2b0c097d7fb76173da0e0bba1': 'HTML &lt;a&gt; 元素的target属性，该属性指定在何处显示链接的资源',
    '9f556fb46ecef854282d17e631578b1c': '展示一个列表，可以自定标题、副标题，内容及按钮组部分。当前组件需要配置数据源，不自带数据拉取，请优先使用 「CRUD」 组件。',
    ...
    'ddeeaa33ae62ead1a77a859fb79b78d7': '对现有值做映射展示，比如原始值是：1、2、3...，需要展示成：下线、上线、过期等等。',
    '8b139ce9fa196b602bb1ee3bd25b25df': '映射表',
    'a9de5901385d644363cd056482be7517': '<p>当值命中左侧 Key 时，展示右侧内容，当没有命中时，默认实现 Key 为 <code>*</code>的内容</div>(请确保key值唯一)',
    ...
    '9fc8c79aac0302a60ebc0777183cd181': '如果菜单地址希望可以动态设置，请在此填入接口地址',
    ...
    '06b13b11740f7663af325bf5426930ba': '点击后会弹出此内容，等用户确认后才进行相应的操作。',
    'fa9a0a79f29fef72e3060ea1af93c305': '刷新目标组件',
    '437d629f00e62cf99b3ad288f84ade46': '当前动作完成后，指定目标组件刷新。支持传递数据如：<code>xxx?a=\\${a}&b=\\${b}</code>，多个目标请用英文逗号隔开。',
    'b01f08bf5b9f8e3ef9d49e31d89bf770': '指定响应组件',
    'f667748a8e9717498da714d4e5087af2': '指定动作执行者，默认为当前组件所在的功能性性组件，如果指定则转交给目标组件来处理。',
    ...
    '45882ddedb42c1a38462949750bc8a84': '显示一个提示图标，鼠标放上去会提示该内容。',
    ...
    'd6fdfa4f989be6586a7a29ea85522f24': '开启下拉刷新后，下拉释放后触发（仅用于移动端）',
    ...
    '4143d7418de740e8bc26ef4b27c63534': '用来获取初始数据的 api, 返回的数据可以整个 page 级别使用',
    ...
    '7cfb5e222a5954e891fba6e3802c7ea6': '分页组件，可以对列表进行分页展示，提高页面性能',
    ...
    'b1aefb18d4bf96dc283a26d67abc41a8': '用来展示进度。可配置各个进度段用不同的颜色展示。',
    ...
    '57eda9139c0b3bc0605ed4cf303ffbd2': '支持使用 <code>\\${xxx}</code> 来获取变量',
    ...
    '9cc50da6bb17ea7ecf44c254c9b37619': '功能性容器，可以用来加载数据或者加载渲染器配置。加载到的数据在容器可以使用。',
    ...
    '54f876a529283de5668426b2dc8adb15': '设置 service 默认提示信息，当 service 没有返回 msg 信息时有用，如果 service 返回携带了 msg 值，则还是以 service 返回为主',
    ...
    '82a3047196be368be13dcdd2373520ff': '用图标更具关联字段来展示状态，比如 1 展示 √、0 展示 x。这块可以自定义配置',
    ...
    '74f0f6730053049f4c9beca2ab00c193': '用来提交表单，要求表单验证，如果在弹窗中会自动关闭弹窗。',
    '7b755ba413eac50423859395c68e6280': '表格V2',
    'ea2b32f5d78d2305b9b7bc21e056a009': '用来展示表格数据，可以配置列信息，然后关联数据便能完成展示。支持嵌套、超级表头、列固定、表头固顶、合并单元格等等。当前组件需要配置数据源，不自带数据拉取，请优先使用 「CRUD」 组件。',
    ...
    '88a364068f684dc77aca5b6c006ef576': '当列内容过多，超出宽度时，可使用横向滚动方式查看数据。',
    ...
    '80174cabf025dfe269aee5390b813708': '设置从左到右多少列内启用自动合并单元格，根据字段值是否相同来决定是否合并。',
    ...
    '9db359f376a1a588ef7dcbef53cc114a': '如果列太多显示会很臃肿，可以考虑把部分列放在当前行的底部展示',
    ...
    '1fe38acb67e766f7767d9f8e88bfe990': "支持模板语法，如 <%= data.id % 2 ? 'bg-success' : '' %>",
    ...
    'ac83dbca40c9d2151b5f7d81795535cc': '开启后可以根据当前列排序，接口类型将增加排序参数。',
    ...
    'f1f4c88f30744f2365b65f1790c71da8': '错误的组件合并对象，面板过老无法处理，除非增加新面板',
    ...
    'a8b1273cb2d53ad858906ff9744a9891': '选项卡，可以将内容分组用选项卡的形式展示，降低用户使用成本。',
    ...
    'b744b72fd649d904e561358fc26c455f': '鼠标移动到选项卡标题时弹出提示，适用于标题超长时进行完整提示',
    '6e7fe62a865cb9ae90e52f85f4c6b8a0': '默认选项卡',
    'a8986713e2b83c9ecafe5b107c09b68e': '默认显示某个选项卡，选项卡配置hash时使用hash，否则使用索引值，支持获取变量，如：<code>tab\\${id}</code>、<code>\\${id}</code>',
    'acb839aac679bb34be9b4b49806b74a8': '可用<code>\\${xxx}</code>取值，根据该数据来动态重复渲染所配置的选项卡',
    '5b9af1bc3012bb3c8e07b983b423ec17': '激活时渲染内容',
    '4bcecc15d16e8c851dc3d155b8f30929': '只有激活选项卡时才进行内容渲染，提升渲染性能',
    '12c6a62683d63e404d71a31c9cb5209c': '隐藏后销毁内容',
    '5b52bcb62a2e1dab99ef841b05395b6d': '激活其他选项卡时销毁当前内容，使其再次激活时内容可以重新渲染，适用于数据容器需要每次渲染实时获取数据的场景',
    ...
    'ee51f2d49fa12c730d2a0efef0d67e44': '当选项卡选中后才渲染其内容区，可提高渲染性能。',
    '024f24defb08c5c9d463a2668cbb9802': '隐藏即销毁',
    '370bb4d6806c88a7df2ac17ca2a7b6a6': '关闭选项卡则销毁其内容去，配置「激活时才渲染」选项可实现每次选中均重新加载的效果。',
    ...
    '093bcd735847b8464d683464165adbb8': '可以不设置，如果检测接口返回这些信息的话。',
    ...
    '33813749a95477897085e2435acc16b6': '类似容器，可以将多个渲染器放置在一起，当用户鼠标悬停或者点击容器时，显示文字提示浮层',
    ...
    '65862c97143c6c5479e0c623093a25d6': '用来展示文字或者段落，支持模板语法可用来关联动态数据。',
    '38accbc34901ee6fd7bd7cd9f92f0a2a': '这是模板内容当前时间<%- new Date() %>',
    '590e147e49735ebbfc51ae2175c36eb0': '请编辑内容',
    '47ae015d04dda362d066e4f9ac09d647': '内联模式默认采用 <code>span</code> 标签包裹内容、非内联将默认采用 <code>div</code> 标签作为容器。',
    '7fcf42edf5817042904f4a122ff77582': '视频',
    '1d5bbe0ab0d90a223c162fb375997a98': '视频控件，可以用来播放各种视频文件，包括 flv 和 hls 格式。',
    'f50bc38cf567e68250a8d15edfd8eb27': '视频地址',
    '733dda7842619a437b2486f6f71b0c10': '可以写静态值，也可以用变量取比如：<code>\\${videoSrc}</code>',
    'fb103fc64a0caeec24c707b9e7b50870': '视频封面图片地址',
    '828f83110677bab8ef940f79f77b9049': '可以写静态值，也可以用变量取比如：<code>\\${videoPoster}</code>',
    '351cb1f8ffbcc9d2d4c1f35505e15864': '静音',
    'c7638cec349cb86eaeaeb983909fae0e': '直播流',
    '82f5f7bf3fb529360947cbb3b988037f': '如果是直播流，请勾选，否则有可能不能正常播放。',
    ...
    '1fc7d723b3a82ce32bfbbfa0a1761969': '比如填写：<code>\\${videoFrames}</code>会在当前作用域中查找 videoFrames 变量，如果是对象，将生成视频截图列表，点击后可跳转到对应的帧。',
    ...
    'c8c0339a6f9e105cfef45b76b788b635': '表单向导，可以将复杂的多个表单项拆分成多个步骤，一步一步指引用户完成填写。',
    ...
    '1fd41e410930ac58e748f7704c3a05f3': '如果接口返回了 <code>step</code> 变量，且数值是数字类型，比如 <code>3</code>，提交完后回跳到第 3 步',
    '938b484df1447d8f01f96e45125eb031': '是否可被点开',
    '20022725ac2c53869f7af6646ca4ba29': '用表达式来决定，当前步骤是否可被点开。额外可用变量：currentStep 表示当前步骤。',
    'd4b8306441c00f01d4f044b3802c4266': '起始默认值',
    '37c0c041a0ad487d23c9f42c29f6d5e1': '从第几步开始。可支持模版，但是只有在组件创建时渲染模版并设置当前步数，在之后组件被刷新时，当前step不会根据startStep改变',
    '076bd7c0adfc4f5d2abde6b309d9f53b': '用来初始化向导数据，当接口中返回 <code>step</code> 字段时，可以控制默认跳转到第几步，注意数值一定得是数字类型。当返回 <code>submiting</code> 并且当前步骤中存在异步保存接口时，可以让 wizard 初始进入异步提交状态。',
    'dbb19fea1965f7ef88cf1d1e0450c0f4': '用来保存表单数据, 最后一步点击完成触发，<code>如果最后一步中已经设置保存接口，则此处设置无效。</code>',
    ...
    'de5e232d10e2fa6218259289d4de4835': '类似于容器，唯一的区别在于会默认会有一层内边距。',
    ...
    'e06a14abe7ef66a8ead143db4ae9786e': '当发送内容中存在文件时会自动使用 form-data 格式。',
    ...
    '68caa6082eda1745aa3f6b6d12efe423': '当接口为二进制文件下载时请勾选，否则会文件乱码。',
    '91831507074270c0da8a31ad9ff87495': '数据替换',
    '42be3061671b38468cc6ac84f6a0dd77': '默认数据为追加方式，开启后完全替换当前数据',
    '81fe75a5216d4f612f1809c122f5145a': '定时刷新间隔，单位 ms',
    '83f16354dd1532422dc8b3581d096e7b': '定时刷新停止',
    '620f826a77f079c5683a9d3c59461ea1': '定时刷新一旦设置会一直刷新，除非给出表达式，条件满足后则停止刷新',
    '90260d55567cfd97ec2f085963a60bcf': 'HTTP配置',
    '9ae7a582479116d4cb41e828fbd59798': '发送数据映射',
    '0fcbf036057c6dd88b7b809daa0c5eb7': '当没开启数据映射时，发送 API 的时候会发送尽可能多的数据，如果你想自己控制发送的数据，或者需要额外的数据处理，请开启此选项',
    '7dd590a9d9e783e980d318bd52891905': '返回结果映射',
    '7e295b6ff39ec7356e06c4534bfc4fb3': '如果需要对返回结果做额外的数据处理，请开启此选项',
    '417125a06b1d2bfff025e83a4e067bf0': '发送适配器',
    '62efcb25e5b21da47c09780119da3458': '函数签名：(api) => api， 数据在 api.data 中，修改后返回 api 对象。',
    '6eb8944029108ad3b6bb3572a648fafa': '接收适配器',
    'e83cbec70e17988749c4a02a3b73f55c': '函数签名: (payload, response, api) => payload',
    'be47bd270e7756d4233e59bbe4cd5b96': '请求头',
    'f80cc88446cc10da4838556666f6b9f1': '可以配置<code>headers</code>对象，添加自定义请求头',
    '9d191f6126f21da8222755c14f49707b': '设置 ajax 默认提示信息，当 ajax 没有返回 msg 信息时有用，如果 ajax 返回携带了 msg 值，则还是以 ajax 返回为主',
    'c5e1f01e3d98b4db536765ae0d5b91a9': '点击选择',
    '4e7c006f535b13b9737ac310bc34193a': '初始加载',
    '3c743b8b2d662421117a2fb1c445425d': '当配置初始化接口后，组件初始就会拉取接口数据，可以通过以下配置修改',
    ...
    '4abbdba4b6b06ce00702a255bd89c92c': '勾选后，服务请求将以静默模式发送，即不会弹出成功或报错提示。',
    'e3b49b5bbbdea05598525e91dbdfa638': '存储结果',
    '4dca05af026848011eedee1b53efa61c': '请输入存储请求结果的变量名称',
    '4da82260041107e5780bcbb3a14ef791': '如需执行多次发送请求，可以修改此变量名用于区分不同请求返回的结果',
    ...
    'be4b778e7f5aa6aa5a811d7db4e1a8b3': '如果开启发送数据，会先发送配置数据到目标组件，然后重新请求数据。',
    ...
    '9bef5e571702130c5710af4ee2c27455': "/* 自定义JS使用说明：\n  * 1.动作执行函数doAction，可以执行所有类型的动作\n  * 2.通过上下文对象context可以获取当前组件实例，例如context.props可以获取该组件相关属性\n  * 3.事件对象event，在doAction之后执行event.stopPropagation();可以阻止后续动作执行\n*/\nconst myMsg = '我是自定义JS';\ndoAction({\n  actionType: 'toast',\n  args: {\n    msg: myMsg\n  }\n});\n",
    ...
    '9654916723a8d1d82f5ab9d2911edf93': '温馨提示：添加下方事件动作后，下方事件动作将先于旧版动作执行，建议统一迁移至事件动作机制，帮助您实现更灵活的交互设计',
    ...
    '6e889f0cc8c1d8f705edfd5d0bbdaaa0': '当接口为二进制文件下载时请勾选，并设置 Content-Disposition',
    '508a38f518821a0f6bb2d15269b31ece': '默认数据都是追加方式，开启这个后是完全替换',
    '5c131eb3bc61f6b0a26e20449ad7ce56': '自定义适配器',
    'f514cabe63553a850063834c9d44a5ee': '可以通过接口获取动态选项，一次拉取全部。',
    '47d0a7caaa2baee8d38612a1c57421ef': '是否初始加载',
    '866a60d7fbdfeba6ae42c7e9c7b03059': '当配置初始化接口后，组件初始就会拉取接口数据，可以通过以下配置修改。',
    ...
    'dc5dbe7a1b1ff5cae22ffbb636bc6380': '当输入框获得焦点的时候显示，用来提示用户输入内容。',
    'ff255db9b108589abd5c649e2a02e3f1': '控件提示',
    '9e783b34207fe24bc488136faba65442': '在输入控件旁展示提示，注意控件宽度需设置，否则提示触发图标将自动换行',
    ...
    '6c1e18fd4cb57288a9f43603d5167292': '需要联动时才需要，其他组件可以通过这个名字跟当前组件联动',
    'ae344073ea6ca9ce742899cdf6d3e106': '请输入字母或者数字',
    '1a1ff1e1149a0cd1b39c0b231a334d04': '可以指定操作完成后刷新目标组件，请填写目标组件的 <code>name</code> 属性，多个组件请用<code>,</code>隔开，如果目标组件为表单项，请先填写表单的名字，再用<code>.</code>连接表单项的名字如：<code>xxForm.xxControl</code>。另外如果刷新目标对象设置为 <code>window</code>，则会刷新整个页面。',
    '4fe2f10c6d5bedac03f40a4362e4f69b': '请输入组件name',
    '3bce1a6217990c8dc087d254f1fe754a': '自动填充',
    'f01553e415ca33cc89d0bca84023f4b5': '将当前已选中的选项的某个字段的值，自动填充到表单中某个表单项中，支持数据映射',
    ...
    'ce641d8297471a5d65c46cdfb023097c': '当前表单项隐藏时，表单提交数据中会删除该表单项的值',
    '3e719b87b9ee71d4613caefbf2fd1074': 'UTC转换',
    'd52e57147787797ae0153d43bf8be298': '开启后，提交数据和展示数据将进行UTC转换；存在跨地域用户的应用建议开启',
    ...
    'aa0ff71cb10c3e54d68874dc2b17acaf': '一共 12 等份，这里可以设置左侧宽度占比 n/12。',
    '1f08c91da33fc5f0616e8a85c0456a18': '静态数据暂不支持多级，请切换到代码模式，或者采用 source 接口获取。',
    ...
    'd7d810ec89408c206a220f62edde737f': '开启后将选中项的 value 封装为数组，关闭后则将整个选项数据封装为数组。',
    ...
    '923a91fdc2c777f8443c85278060195a': '格式不正确, 请输入符合规则为 `$1` 的内容。',
    'd87b1a3d180a1cc56bbd174d2860ca4c': '请输入更多的内容，至少输入 $1 个字符。',
    '9b8d6abb2f03fbcbdb0e4d2b1970a751': '请控制内容长度, 请不要输入 $1 个字符以上',
    ...
    'c323e3527a805cfdd264700fdf013daf': '请控制内容长度, 请不要输入 \\$1 个字符以上',
    ...
    'd01886eeef1de19f2e99617017f4def8': '格式不正确, 请输入符合规则为 \\$1 的内容。',
    'f10b676db977ae808af8d96b327be7f3': '有哪些辅助类 CSS 类名？请前往 <a href="https://baidu.gitee.io/amis/zh-CN/style/index" target="_blank">样式说明</a>，除此之外你可以添加自定义类名，然后在系统配置中添加自定义样式。',
    '73ac822ddf4685dbfec661dec41a96b7': '<div>\n<h2>hello, world!</h2>\n<div id="customBox">自定义容器区域</div>\n</div>',
    'e9b91e9101059dc2e234d9847dd7b003': '弹窗数据',
    '94397b87ac63fe238c779120fadab024': '位置为 "左" 或 "右" 时生效。 默认宽度为"尺寸"字段配置的宽度，值单位默认为 px，也支持百分比等单位 ，如：100%',
    'a6d91e801974dfa735a4ae0e098c522a': '位置为 "上" 或 "下" 时生效。 默认宽度为"尺寸"字段配置的高度，值单位默认为 px，也支持百分比等单位 ，如：100%',
    '197af5d5971778e3b80deb25182d63e3': '<span class="label label-default">子节点${index | plus}</span>',
    '7341e991c8e8cfec68d31ffe0e06e429': '比如: this.type === "text"',
    '8add6799ceff24eb041c5a6a92bb1694': '支持如：<code>\\${xxx}</code>或者<code>data.xxx == "a"</code> 表达式来配置作用条件，当满足该作用条件时，会将计算结果设置到目标变量上。',
    'e02d111d524de97e8622121f7ce845cf': '提交数据前将根据设定格式化数据，请参考 <a href="https://momentjs.com/" target="_blank">moment</a> 中的格式用法。',
    'fcb9b16d5d056bfbf6b6cba9dcf61efa': '请参考 <a href="https://momentjs.com/" target="_blank">moment</a> 中的格式用法。',
    'fde1ab2f504097f3f717acbb653b4f09': '${formType ? asBase64 ? "小文件时可以使用，默认给 Form 提交的是文件下载地址，设置后给 Form 提交文件内容的 base64 格式字符串。" : "File 控件不接管文件上传，直接由表单的保存接口完成。和 Base64 选项二选一。" : ""}',
    ...
    'd85a80d177db696b29b7338af1501055': '使用空格分开配置，使用<code>|</code>可将配置栏分组，<a target="_blank" href="https://www.froala.com/wysiwyg-editor/docs/options">参考文档</a>',
    '8cfcd52cebdc2555b202f4b03de93662': '使用空格分开配置，<a target="_blank" href="https://www.tiny.cloud/docs/general-configuration-guide/basic-setup/">参考文档</a>',
    '5831c1f77c5acefa6dfe9c64d06ca78a': '配置"canAccessSuperData": true 同时配置 "strictMode": false 开启此特性，初始会自动映射父级数据域的同名变量。需要注意的是，这里只会初始会映射，一旦修改过就是当前行数据为主了。也就是说，表单项类型的，只会起到初始值的作用',
    '24c5febd312d27b5e80354cf03e241f0': '外层容器',
    'a269e7de6c7735290733eb3e574c2129': '请从<a href="http://lbsyun.baidu.com/" target="_blank">百度地图开放平台</a>获取',
    '0861915dbac25ccb573b3bb72ffeebd7': '支持使用 <code>\\${xxx}</code> 来获取变量，或者用 lodash.template 语法来写模板逻辑。<a target="_blank" href="/amis/zh-CN/docs/concepts/template">详情</a>',
    '844318bd1d58ba0bf7dabbb771174b12': '<span class="label label-info">一</span>',
    '2fccd71275cdf5d6c0c677ef79dd84a0': '<span class="label label-success">二</span>',
    '198a96c4cfc64d5feba81b3f931f8289': '<span class="label label-danger">三</span>',
    '626a0f2fdf13bcadf11581006ab9eba3': '<span class="label label-warning">四</span>',
    'ce3fd44456123f571e9d083b98da9fcb': '<span class="label label-primary">五</span>',
    'f8fc21a9fd40881e8fd3d7f15919465c': '如果当前字段有值，请不要设置，否则覆盖。支持使用 <code>\\${xxx}</code> 来获取变量，或者用 lodash.template 语法来写模板逻辑。<a target="_blank" href="/amis/zh-CN/docs/concepts/template">详情</a>',
    '2c8a99d35cb5704994cabcc61a4c3a4a': '查看详情<a target="_blank" href="http://www.baidu.com">日志</a>。',
    'bf9e242338d2c26b182aa6b9c015d84c': '如：this.type == "123"',
    '5414824fb8efdb7d59beae4bf95fdefd': '<p>当没开启数据映射时，发送数据自动切成白名单模式，配置啥发送啥，请绑定数据。如：<code>{"a": "\\${a}", "b": 2}</code></p><p>如果希望在默认的基础上定制，请先添加一个 Key 为 `&` Value 为 `\\$$` 作为第一行。</p><div>当值为 <code>__undefined</code>时，表示删除对应的字段，可以结合<code>{"&": "\\$$"}</code>来达到黑名单效果。</div>',
    'c130bd5b55edefdaf8923269e9a52439': '每个选项单列一行，将所有值不重复的项加为新的选项;<br/>每行可通过空格来分别设置label和value,例："张三 zhangsan"',
    '1bf14fd24efe68f62bbff0538dee238a': '每个选项单列一行，将所有值不重复的项加为新的选项;<br/>每行可通过空格来分别设置time和title,例："2022-06-23 期末补考"',
    '0e9525b2bb1493c567c114dd61b69095': '温馨提示：',
    '7080fa6e0ca1d7e24f6f8cac05077a3a': '有哪些辅助类 CSS 类名？请前往 <a href="https://baidu.github.io/amis/docs/concepts/style" target="_blank">样式说明</a>，除此之外你可以添加自定义类名，然后在系统配置中添加自定义样式。',
    'f19464cd1d7c55610b84b4972eaf506f': '<div> 当开启数据映射时，弹框中的数据只会包含设置的部分，请绑定数据。如：{"a": "${a}", "b": 2}。</div>',
    '784cf5219012b5f16f2985b7f1fd52f5': '<div>当值为 __undefined时，表示删除对应的字段，可以结合{"&": "$$"}来达到黑名单效果。</div>',
    'af9f27383daeec508815a33753247f42': '${data["&"] ? "已开启定制参数功能，可点击关闭该功能。" : "如果需要在默认数据的基础上定制参数，请配置开启参数定制再定义key和value。"}',
    ...
    '5e568c42a5ecb74db2dc3d8531079dd6': '<a target="_blank" href="https://www.tiny.cloud/docs/general-configuration-guide/basic-setup/">参考文档</a>',
    ...
    'f6e5fc909971d2e5f6ffe23edae93584': '如果数据比较多，比较卡顿时，可开启此配置项。',
    '31dae237cbd03ae0d2dcf7ad2fd4fb76': '初始化接口请求成功后返回的数据',
    '850c62f7b1ebfb4b89182ecd51202a7d': '表单提交成功后触发，如果事件源是按钮，且按钮的类型为“提交”，那么即便当前表单没有配置“保存接口”也将触发提交成功事件',
    ...
    '3f3f4c71c1b736e7f01cf910a553ff43': '选择“是”时，会将源组件所在数据域变量同步到目标组件的数据域。<br/>如果目标组件是增删改查组件，且增删改查组件的数据拉取接口是get请求，则源组件所在数据域变量将追加到目标组件的初始化请求query中。',
    '2aecb19ca1655d66fc80fc27a783cc9e': '追加方式',
    'b67b01a3b9170f1daf78082cfd0df793': '选择“合并”时，会将数据合并到目标组件的数据域。<br/>选择“覆盖”时，数据会直接覆盖目标组件的数据域。',
    'bd81577a6fd4956e676cec499bb70d00': '合并',
    'e09fea40f7e4abd4b2a495b315940688': '覆盖',
    '9a5500b6013ec1ebf61bdf0e18452348': '数据默认为源组件所在数据域，可以选择“自定义”来定制所需数据',
    'f30bcdccf71b19e858c37d8881d2b206': '源组件所在数据域',
    'fa644cb20c66f7530d8a376d4fa6a36e': '组件数据',
    '7d9260bd45b2e85a09398f218c25f220': '更新目标组件的数据域或目标表单项的数据值',
    ...
    'b62ce3df3c0d5772006c525b60d5eeab': '数据默认为源组件所在数据域，开启“自定义”可以定制所需数据',
    '0f9803bd27434940d4017007c105a861': '当选择“是”，且目标组件是增删改查组件时，数据接口请求时将带上这些数据，其他类型的目标组件只有在数据接口是post请求时才会带上这些数据。',
    '81e1ff0bb8917a9df99d737982ee24b7': 'SubForm, 配置一个子 form 作为当前的表单项',
    'a5c2dba5ccf62851b24cfa12d4958ce2': '可以用来展现数据的,可以用来展示数组类型的数据，比如 multiple  的子 form',
    '74104c62ed33836f0bc74297539dd7c9': '配置 options 可以实现选择选项',
    'b5ade3d97d5b11bc784786111e011571': '树型结构来选择，可通过 options 来配置选项，也可通过 source 拉取选项',
    '2c05e451a6f2b2fe1cf55f7afb8c8423': '单选或者多选，支持 source 拉取选项，选项可配置图片，也可以自定义 HTML 配置',
    'c65c9862813c7a66c0df52e301e0e1d1': '适用于选项中含有子项，可通过 source 拉取选项，支持多选',
    '8f650b58c8421edecfb380d6f60ef40e': '通过 pickerSchema 配置可供选取的数据源进行选择需要的数据，支持多选',
    'b7a4abc1e4e975c9df5bb9d9cf4823ba': '通过 options 配置选项，可通过 source 拉取选项',
    'f2fc416c7d95a93a8da621f760be8417': '支持多选，输入提示，可使用 source 获取选项',
    'b4482a3d9523f48e83a816fa85911185': '纯用来展示数据，可用来展示 json、date、image、progress 等数据',
    ...
    '03097563d201ad3a29c79165226764e5': '布局容器 是基于 CSS Flex 实现的布局效果，它比 Grid 和 HBox 对子节点位置的可控性更强，比用 CSS 类的方式更易用',
    ...
    '6e72759ed1cbf9f9e8523197dd93888f': '指定当前容器元素的定位位置，用于配置 top、right、bottom、left。',
    '6896da744f8ae9633263d55af0fceae1': '层级',
    '6f649980c839dffca1506f20d534fe3d': '指定元素的堆叠顺序，层级高的元素总是会处于较低层级元素的上面。',
    'a8489cf57d7f44e889aff79434776f47': '默认为块级，可设置为弹性布局模式（flex布局容器）',
    ...
    '3fa460b81736c0360f6f7571801935b1': '设置成水平排列方向，则从左到右放置子项；设置成垂直排列方向，则从上到下放置子项',
    ...
    '9cc69c8469b23b77519065d3df381113': '定义在分配多余空间之前，项目占据的主轴空间（main size）',
    '0ad8b3b736ae5b9e23cf16ac13e1e283': '占比设置',
    'fa6bb048a2f73975a40789b30c5b8a06': '定义项目的放大比例，默认为0，即如果存在剩余空间，也不放大。',
    ...
    '41a7494315a528f0f9618646f7e0dddf': '可设置为左上角、右上角、右下角、左下角，默认为右下角',
    '845c61ac8f51c6702dd22e5657c07e8d': '右下角(默认)',
    '2794fe303cf8ad4395fe93271fae7925': '布局容器主要用于设计复杂布局的容器组件，基于 CSS Flex 实现的布局效果，比 Grid 和 HBox 对子节点位置的可控性更强，比用 CSS 类的方式更简单易用',
    'abbd790f85282349e2004df9fd494e31': '在分配多余空间之前，其默认占据的主轴空间（main size）',
    ...
    '230d65546ea0d299907943403608233c': '常见布局：经典布局（基于 CSS Flex 实现的布局容器）。',
    '9bbb7cfaeb34a2b5c095ac253355f028': '悬浮容器',
    'a3e91631c1a3a43e09526ea7f6b8595c': '常见布局：悬浮容器（基于 CSS Flex 实现的布局容器）。',
    'd423930b823fc45f08c18922b19e4e9e': '吸底容器',
    'b8b4eb373d8ba6f98271b681fba2511d': '常见布局：吸底容器（基于 CSS Flex 实现的布局容器）。',
    'faaa6444a709917ff33e0d58948504dc': '吸顶容器',
    '1facf0bd0f56c66759857345e7434443': '常见布局：吸顶容器（基于 CSS Flex 实现的布局容器）。',
    'f416a3a2566dda04bc0ef67027e6f460': 'x轴滚动容器',
    'e3d9ad8453925764f2918dbfd6ff824e': '常见布局：x轴滚动容器（基于 CSS Flex 实现的布局容器）。',
    '053e0cbf18c8fe59b928d52fcd556b88': 'y轴滚动容器',
    'c9f089cefc06c217c6dddfe2fc772ea3': '常见布局：y轴滚动容器（基于 CSS Flex 实现的布局容器）。',
    ...
    '542e06175ff4f7407c467bbde90de56a': '如果需要对返回结果中的data做额外的数据处理，请开启此选项',
    '7c583ecdf795ce4f1f40d7960ead9344': '默认提示文案',
    '70941a02776496ec446f21f98ebf754e': '请求成功',
    'f50bf418323ee425eca7208c09a4577e': '请求失败',
    'f3dc08e3617d1e19cf8135be4412a80b': '点击后先询问用户，由手动确认后再执行动作，避免误触。可从数据域变量中取值。',
    'faa29265819714253843e23437b9193e': '正常状态下的提示内容，不填则不弹出提示。可从数据域变量中取值。',
    'f855f46ce6146aa17a9ed423da16bfa2': '禁用状态下的提示内容，不填则弹出正常提示。可从数据域变量中取值。',
    '037becbe8bff2f8838d141cc7b6b2df7': '支持例如: <code>now、+3days、-2weeks、+1hour、+2years</code> 等（minute|min|hour|day|week|month|year|weekday|second|millisecond）这种相对值用法',
    '8f7ae284d0039fe05b9f57fd5ae3ede9': '请选择静态值',
    '98229308e2e9484583fde4ae363a979f': '表达式或相对值',
    '6b3c2a07db1bb3c229bbc5df48068792': '支持例如: <code>now、+3days、-2weeks、+1hour、+2years</code> 等（minute|hour|day|week|month|year|weekday|second|millisecond）这种相对值用法',
    'dcc94ea1715bd502c709c5d5092e9c82': '支持例如: <code>3days、2weeks、1hour、2years</code> 等（minute|hour|day|week|month|year|weekday|second|millisecond）这种相对值用法',
    '13ce82d026daa5a30e50105bd2a204a6': '请输入相对值',
    '31c29c46536a5007522032d2a42db56a': '数值模板',
    'a6a41d1bfb5896210eb527d183a07958': '值渲染模板，支持JSX、数据域变量使用, 默认 ${value}%',
    ...
    'd6ecb32a380c91887a9346653c2427e9': '自定义选项渲染模板，支持JSX、数据域变量使用',
    ...
    '50437e080edc71ab624c93d419472919': '当选项数量超过阈值后，会开启虚拟列表以优化性能',
    ...
    'eb7366583485f478e3d8c2b105ea51ff': '定义项目的放大比例，如果设置为0，即使父容器存在剩余空间，也不放大。',
    '5d3d48de1ba22368eacdc1c69fb044ce': '组件内层 CSS 类名',
    '72c32b47c5e4dcd58ddabdb8fde761a0': '悬浮容器: 基于 CSS Flex 实现的特殊布局容器。',
    'a03384e93b62e3110aa92c9e345111ba': '吸底容器: 基于 CSS Flex 实现的布局容器。',
    'f564e3e66dd2aca0e080cb6484c95a5e': '吸顶容器: 基于 CSS Flex 实现的布局容器。',
    'db805d4e361ac2d3fc6047eaea1a7c69': '自由容器',
    '9ccbfde404798593fa6fdeac9dbef200': '自由容器: 其直接子元素支持拖拽调整位置。',
    'f20ca09e513399510ce34ba2cb05b7d9': 'x轴滚动容器: 基于 CSS Flex 实现的布局容器。',
    '47ef0cec2c3436377a42390e10de4567': 'y轴滚动容器: 基于 CSS Flex 实现的布局容器。',
    '8c2bb89f516205027b9ed6609fb17726': '阻断条件',
    '46a3c6ab94da0b16a707bdd3b74c9e09': '满足条件时，将会阻断当前事件的后续动作的执行',
    '6e6d4269d0dc3324d551062350a2ae9f': '静默请求',
    '56e13c39822a814ab39b0d5a0867d7dc': '开启后，服务请求将以静默模式发送，即不会弹出成功或报错提示。',
    '7f019b96ffb7d72ec8d6ce8d76e5362f': '表达式已配置',
    '699829ed5bab67dfb360764c3bbaed4e': '{{@1}}-事件配置',
    '5ba999eb762f60324033b735e55d989c': '事件防重',
    '7fe94616be0e8fb5ef5ab40a7397f0aa': '开启事件防重后，防重时间内多次触发事件只会执行最后一次',
    ...
    '1c5ea0ffb2b15713cb22c41a02576924': '开启滚动吸附后，当滚动至父容器上下边沿时会自动开启吸附模式。',
    ...
    'c6a65a86cd2bd74a6f72df0a7b81d3cb': '配置该事件后将不会触发表单提交时默认的校验、提交到api或者target等行为，所有行为需要自己配置',
    ...
    '052f93928af33d4d7035e7c8e8a73f17': '通过 margin 数值来设置对齐方式，其中 margin: 0 auto 用于设置居中对齐',
    ...
    '30d4e9f1c60f2d5851f77463476d568b': '如需要拓展自定义的新增功能，可通过配置组件-新增项来拓展',
    ...
    '912beb37a3785e50d6483852be41111f': '树型结构选择，支持 [内嵌模式] 与 [浮层模式] 的外观切换',
    ...
    'ba1a077af717cb3c4788849c2342200b': '单独给立即保存配置接口，如果不配置，则默认使用quickSaveItemApi。',
    'cf8774ca07f11ecb14b3b59c3891e9cc': '<p>当前组件已停止维护，建议您使用<a href="https://baidu.gitee.io/amis/zh-CN/components/form/formitem#%E9%85%8D%E7%BD%AE%E9%9D%99%E6%80%81%E5%B1%95%E7%A4%BA" target="_blank">静态展示</a>新特性实现表单项的静态展示。</p>',
    '26122d95c72204c83ebdc37cd16a96f9': '图片放大功能',
    'a19769d02b8de60a1e3b46c3ef96f122': '放大功能和打开外部链接功能是冲突的，若要点击时打开外部链接请先关闭此功能',
    'd196eb8f65e84003b7ca64d5dd8fc737': '占位图',
    'd98b3f3d11e6dce8eac1a041247fbc50': '图片列表',
    '8e1fee898434093aad55f5888497f970': '<p>当前为字段内容节点配置，选择上层还有更多配置</p>',
    '86aafaa75b388deb4a4cbdab2293c099': '头部',
    'e6aa1b827415217c524ae9d9b665cca5': '配置头部',
    'a2ecfd5a0db9c855f59eea75083678e6': '配置底部',
    'fa0b9c20503ee00554e8c86d4a4461b6': '返回日志信息的服务，后端需要通过流的方式返回结果。\n                  可参考<a target="_blank" href="https://baidu.github.io/amis/zh-CN/components/log#%E5%90%8E%E7%AB%AF%E5%AE%9E%E7%8E%B0%E5%8F%82%E8%80%83">示例</a>',
    '1d3d7de6b84f4d5d4a4e126e145af132': '文本编码',
    'd55bbcd785be46c3182dcd7663c3c041': '返回内容的字符编码，例如 UTF-8、ISO-8859-2、KOI8-R、GBK等等。默认UTF-8',
    ...
    '2135be5a60fc3c6fe864e159e289af51': '映射表是数组对象，且对象有多个key时，用来匹配值的字段, 默认为value',
    '6a1ca1c113a9b5bee58ea009e40f5954': '匹配字段，默认为value',
    'dc7becbad712786c9e4766636047e509': '映射表是数组对象时，用作显示的字段，显示多字段请使用自定义显示模板，默认为label',
    '1140acc9ac4b803b733f70445e7d495a': '显示字段，默认为label',
    '55497c5de8558f1a164e437205cd510b': '<p>当值命中左侧 Key 时，展示右侧内容<br />当没有命中时，默认展示 Key 为 <code>*</code>的内容</div><br />(请确保key值唯一)',
    ...
    'defe851634125bb16e762f26dbb6555f': '查看 https://www.tiny.cloud/docs/general-configuration-guide/basic-setup/ 文档',
    'df025e01cbbae804f7d720e6b932e8e8': '显示菜单栏',
    'b74c3bbb8ec4f18896cd3b5a20ee9e2c': '工具栏-大屏',
    'e08c3505f9779bf919628166a77d0d77': '屏幕宽度≥1200px，参考文档：https://froala.com/wysiwyg-editor/docs/options/',
    '04f91b84d48285162d3e29205a194143': '工具栏-中屏',
    '9ac0e46a361565f0b8be2228bef4b679': '屏幕宽度≥992px，如果不配置就和大屏设置的工具栏一致，参考文档：https://froala.com/wysiwyg-editor/docs/options/',
    '70d3894aaed305d2fc67f91122d77759': '工具栏-小屏',
    'a3133ac3b34da77e612bcb1763adae1e': '屏幕宽度≥768px，如果不配置就和大屏设置的工具栏一致，参考文档：https://froala.com/wysiwyg-editor/docs/options/',
    ...
    '555a9859e2c34b015438bdfb59a57c5b': '${vendor === "tinymce" ? "编辑器" : "编辑区域"}',
    ...
    '383c125a11b0dd070b04194b9e2e78fb': '在新增或编辑单行数据时生效。开启时，输入完内容后需要点击表格右侧的“保存”按钮后才能提交到数据域。未开启时，输入完内容后就能提交数据域。',
    ...
    'aa8b2a821e8e32196a720eaaa41b64d3': '为了性能，默认其他表单项项值变化不会让当前表格更新，有时候为了同步获取其他表单项字段，需要开启这个。',
    '2aa56a9b94ee3fde76a15711c94fdabc': '是否可以访问父级数据，也就是表单中的同级数据，通常需要跟 “严格模式”属性搭配使用。',
    ...
    '391299a1c1722a777991a182a44bccbf': '默认支持如下几种状态，无需配置即可使用。自定义状态会和默认状态合并。',
    ...
    '3d4d83f05a12364e2522fcfb265d8ce8': '开启时，新增、编辑需要点击表格右侧的“保存”按钮才能变更组件数据。未开启时，新增、编辑、删除操作直接改变组件数据。',
    ...
    '8dd27bbe64ec245ce449caab5cf7f12b': '默认为内联模式，开启后子菜单不在父级下方展开，会悬浮在菜单的侧边展示',
    '154a7ec36c43427f73705ae834967703': '子菜单悬浮展示',
    '9dcb6b749d6682f1ac51b2dcdefd3208': '点击菜单，只展开当前父级菜单，收起其他展开的菜单',
    ...
    'cac013d011fe1ac71c3b9f0bd0594d65': '配置后将隐藏超过该层级的菜单项，如最大显示两级，菜单项的三级及以下将被隐藏',
    '7419d6bab78d959d5c3b7a38f9888258': '菜单项',
    '1a9aaf05889002e65708c4950012a652': '对，你刚刚点击了',
    '243e91d5fbc5a03a5c54da6d8e662e4f': '页面渲染器，页面的顶级入口。包含多个区域，您可以选择在不同的区域里面放置不同的渲染器。',
    'a7999d1390b7dc775e4287511c395d6c': '角标类型',
    '31175366279c15232e27b6736ccb2fd4': '仅在文本内容为数字下生效',
    '58f966670529f4753fb3c5a0647606be': '大小',
    'b3c1b71ed42c7f2fe55f3c64346f1ae6': '此处配置角标样式，需同时在菜单项中配置角标内容后角标生效',
    '515e8b11c3c24c6c3b03c6c76b1da496': '默认选中菜单',
    '4f80ea1e761598ba9fe393e7c745468d': '优先根据当前浏览器地址栏URL进行匹配，未命中时将选中您配置的菜单项',
    ...
    '22b47452f52254ce07507287d137d167': '<div> 当开启数据映射时，弹框中的数据只会包含设置的部分，请绑定数据。如：{"a": "\\${a}", "b": 2}。</div>',
    '68419387f5bb8487a848b818d78424ae': '<div>当值为 __undefined时，表示删除对应的字段，可以结合{"&": "\\$$"}来达到黑名单效果。</div>',
    'cb65841ea7dec5ae0af20b3f5e52abfc': '原始数据打平',
    '6922790f45faf064e063069816e4d2ec': '开启后，会将所有原始数据打平设置到 data 中，并在此基础上定制',
    '9791b05a4df9d72f1a01b81fa695fbc6': '当多列的分组名称设置一致时，表格会在显示表头的上层显示超级表头，<a href="https://baidu.github.io/amis/zh-CN/components/table#%E8%B6%85%E7%BA%A7%E8%A1%A8%E5%A4%B4" target="_blank">示例</a>',
    ...
    'f1ee660e12ef0b76c10cccc3d923e605': 'AK不能为空，请访问http://lbsyun.baidu.com/获取密钥(AK)',
    '4d01bb9f50eb1480e0e9995a2a003181': '请从<a href="http://lbsyun.baidu.com/" target="_blank" class="text-sm">百度地图开放平台</a>获取',
    'f1f7a5f821ca0ee4caaa9324eda48d91': '静态表单项',
    '4602761ee85e2e6e5360cd13fe642a08': '<p>当前组件已停止维护，建议您使用<a href="/amis/zh-CN/components/form/formitem#%E9%85%8D%E7%BD%AE%E9%9D%99%E6%80%81%E5%B1%95%E7%A4%BA" target="_blank">静态展示</a>新特性实现表单项的静态展示。</p>',
    '6ca92e3386f9e392584367df5054c27c': '用来展示一个图标，你可以配置不同的图标样式。',
    '47fd366b711a0567646854f541449f8b': '比如：\\${listVar}，用来关联作用域中的已有数据',
    ...
    '83fe6a5db780fcfa68f3336c7d86f25b': '用于展示一个简单搜索框，通常需要搭配其他组件使用。比如 page 配置 initApi 后，可以用来实现简单数据过滤查找，name keywords 会作为参数传递给 page 的 initApi。',
    ...
    '6d8e3115be41a8a5690d6fefa637dac7': '接口返回数据需要符合以下格式, status、msg、data 为必要字段',
    '09212e946a4d9b0f775700c46ef0dcd5': '返回 0 表示当前接口正确返回，否则按错误请求处理',
    '7391774e57425e5d8e83de64100b5f2e': '返回接口处理信息，主要用于表单提交或请求失败时的 toast 显示',
    ...
    '9bf078fb5589f2c09031f1f2b5a8d2b1': '设置此属性后，表单提交发送保存接口后，还会继续轮询请求该接口，直到返回 finished 属性为 true 才 结束',
    'f63ba7e3c9d8de0b8b4f769055a36d2e': '设置此属性后，表单请求 initApi 后，还会继续轮询请求该接口，直到返回 finished 属性为 true 才 结束',
    '58477471b3bb8ad53fe9ab18a244868b': '添加行',
    '6070fdf451b08e4302a7dab560771222': '点击左下角添加按钮 或 某一行右侧操作栏添加按钮时触发',
    'c9f63503ee66082fc00c3e6eac57a95f': '列表记录',
    '7b25d5ff93da66fe95b5409731bb9838': '新增行记录索引',
    '5e3640e4bc8efbe00a7b7c6ba169560c': '确认添加',
    '008ae858112dcc7739985045e4326f3a': '开启”确认模式“，点击添加按钮，填入数据后点击“保存”按钮后触发',
    '1fb1cbe49c3e72c2b5f4e0151a4cb5d9': '新增行记录',
    '3fdaeadf0e8a3154ae62784f04138c28': '添加成功',
    'bd4ef227fe8aae88ae6aa97236c0e9bb': '开启”确认模式“并且配置”新增接口“，点击“保存”后成功添加时触发',
    '6452a05591d7402a8bcd9fadc950c449': '添加失败',
    'bd7c39d10dbf6985d2be2d9a4fdcccf7': '开启”确认模式“并且配置”新增接口“，点击“保存”后调用接口失败时触发',
    ...
    '562f54a2fec7a68f85ff192a68cf69f2': '开启”确认模式“，点击“编辑”按钮，填入数据后点击“保存”按钮后触发',
    '3bb47b67994cb374e601fab35f63bc8e': '编辑成功',
    'b394745a8a77179da0000293638e8a56': '开启”确认模式“并且配置”编辑接口“，点击“保存”后成功编辑时触发',
    '9304e8f4c324b5882b550caa971b64b8': '编辑失败',
    'b9d277c3ffab7d4b955ad10308c7ae0a': '开启”确认模式“并且配置”编辑接口“，点击“保存”后调用接口失败时触发',
    ...
    '1b5cf3e354142cc1cdd6f56b6afaba49': '当前表单数据，可以通过.字段名读取对应的值',
    ...
    'bd749c7a75af1236325d8d669e9bc5fc': '组件初始化时激活的选项卡，优先级高于激活的选项卡，不可响应上下文数据，选项卡配置hash时使用hash，否则使用索引值，支持获取变量，如：<code>tab\\${id}</code>、<code>\\${id}</code>',
    '8b4de52c23ad472b9ece9e30d8750c48': '初始默认激活的选项卡',
    '7806807651c37e4467f9d2fc1c18eb2a': '激活的选项卡',
    '8a59e0a5705fea1751d77a97b7bf5d8d': '默认显示某个选项卡，可响应上下文数据，选项卡配置hash时使用hash，否则使用索引值，支持获取变量，如：<code>tab\\${id}</code>、<code>\\${id}</code>',
    '27e0d57c4412bcb89e6aaeeb1e5935fe': '默认激活的选项卡',
    'e83caa4c6ef82543603609c916cd804d': '可基于 JavaScript 语言直接录入发送适配器的函数体，在该函数体内，您可以对 <span style="color: #108CEE">api</span> 进行处理或者返回新的内容，最后需要 <span style="color: #108CEE">return</span> <span style="color: #108CEE">api</span>。<br><br/>\n    函数体内可访问的变量如下：<br/>\n    &nbsp;1. <span style="color: #108CEE">api</span>：接口的schema配置对象<br/>\n    &nbsp;2. <span style="color: #108CEE">api.data</span>：请求数据<br/>\n    &nbsp;3. <span style="color: #108CEE">api.query</span>：请求查询参数<br/>\n    &nbsp;4. <span style="color: #108CEE">api.headers</span>：请求头<br/>\n    &nbsp;5. <span style="color: #108CEE">api.url</span>：请求地址<br/>',
    ...
    '7658a7c761a4296d5526426d29ee7c68': '用来保存数据, 表单提交后将数据传入此接口。<br/>\n        接口响应体要求(如果data中有数据，该数据将被合并到表单上下文中)：<br/>\n        <pre>{{@1}}\n}, null, 2)}</pre>',
    'e7173f5a0462ffb0eb9dfc02e44155f8': '接口响应体要求：<br/>\n        <pre>{{@1}},\n  page: 0,\n  total: 0\n}, null, 2)}</pre>',
    '319ec20dfe05d268928076e0cbb8e45a': '接口响应体要求：<br/>\n              <pre>{{@1}}\n}, null, 2)}</pre>',
    '419b0a74c438b81124992616dd0a36f3': '快速编辑后用来批量保存的 API',
    '152e8c553fe6fbc51df7c72a45917107': '即时保存时使用的 API',
    '91aa2166ee4811414381c8d94e6567e6': 'API返回格式不正确，请查看接口响应格式要求',
    ...
    '16ea2200bfba281fdf5e6870498790cc': '[amis-editor][CRUD2Plugin] dynamicControls的值必须是一个对象',
    ...
    '67584675004a48be903e9f61c733cb35': '在开启前端分页时，表头过滤后是否重新请求初始化 API',
    '8cc3589c442c478dde8ceb60aeb29e03': '翻页后回到顶部',
    '9cb14f1355b3a312ebd62ebff5e1e06b': '无限加载时，根据此项设置其每页加载数量，留空即不限制',
    'f300691f823aacea572e63bb7fb7ce8a': '点击编辑分页组件',
    'd81ad681a447abae7cba38779ffc0c9e': '未找到分页组件',
    '86b17bba54b65c6a62895357095f63a3': '接口轮询',
    '983a8ab6a97da0a0dec7b5c751cf02b1': '开启初始化接口轮询，开启后会按照设定的时间间隔轮询调用接口',
    '4cbec5cb54ba399ea81381a75f5f1f93': '轮询间隔',
    '3a5d9512f474ff7c2a017a13e7f8a9af': '停止条件',
    'fd649ca959662306b734f03438869bf0': '定时刷新停止表达式，条件满足后则停止定时刷新，否则会持续轮询调用初始化接口。',
    '0516133b87f03f859e23bf014d71ab57': '模态窗口期间停止',
    '52dce697d35795d7835e483d69f72419': '当页面中存在弹窗时停止接口轮询，避免中断操作',
    ...
    'cc6a173a3601403f2d96cae2180539b3': '用来实现对数据的增删改查，用来展示表格数据，可以配置列信息，然后关联数据便能完成展示。支持嵌套、超级表头、列固定、表头固顶、合并单元格等等。',
    ...
    'eabda74dd2ac5b4e6eab9229e0e63f79': '接口可以返回echart图表完整配置，或者图表数据，建议返回图表数据映射到 Echarts 配置中',
    '59688d1a484179aef8edc0ccbabb9fc1': '跟踪表达式',
    '3fd81a573ea309b203ab019c1aa95a2c': '如果这个表达式的值有变化时会更新图表，当 config 中用了数据映射时有用',
    'd0d852432ce09f627e6ae471b3f86b0a': '数据映射（dataFilter）',
    '06e89ed3cb501da6d57e35bc28a37089': '如果后端没有直接返回 Echart 配置，可以自己写一段函数来包装',
    'f25c9fd2852b85502157decbedd19082': '原始数据',
    '2695f318db820c2bfe4c886fed3697f0': 'echarts 对象',
    'b76e25de5689ea51af0688d0ea6d7b39': '如果配置了数据接口，接口返回的数据通过此变量传入',
    '45bc998df29cf75725df6141098d5cec': 'debugger; // 可以浏览器中断点调试\\n\\n// 查看原始数据\\nconsole.log(config)\\n\\n// 返回新的结果 \\nreturn {}',
    'e8f96ea47cb322f4f1a4c938c7b155ac': '默认为追加模式，新的配置会跟旧的配置合并，如果勾选将直接完全覆盖',
    'e732f4c0d8075670b6c75cc52bd1f7d5': '图表下钻',
    '00958a92c5804d56047c18fc206382e1': '宽高设置',
    'b3e991d11b9f0ee04f55627c62d4fcba': '默认高度为300px，值单位默认为 px，也支持百分比等单位 ，如：100%',
    ...
    'b4f035fa6f9faaa78707b72c352c6a8b': '[amis-editor][FormPlugin] dynamicControls的值必须是一个对象',
    ...
    '86f056f1cd4e25d5bd2bebddc971032b': '默认表单是可以获取到完整数据链中的数据的，如果想使表单的数据域独立，请关闭此配置',
    '5cd08fe4cd86fffe7cd23d934d4d3b32': '提交设置',
    'e59e1cb3f366d6e7012fe64748355b0a': '如果底部按钮不是自定义按钮时，可以通过该配置可以快速修改按钮名称，如果设置成空，则可以把默认按钮去掉。',
    'd3458f4ee2c2203bb51f9d138dfd0c05': '提交后重置表单',
    'e89bb79f0a0cb4fa4693c4a5ace130f4': '表单提交后，让所有表单项的值还原成初始值',
    '59c1b37b7ff983385a2521541cbcccf8': '阻止回车提交',
    '794020840d754ea7fb58ea3bf4394e1a': '默认按回车键触发表单提交，开启后将阻止这一行为',
    ...
    'f9e5a5377c1f56f1d09ae2bc58bd2d5b': '开启后，滚动表单内容区时使底部操作区悬浮吸附',
    ...
    '9b1ddba55066e0f329ca3cca2e58909c': '可以通过接口获取检索结果，检索值可以通过变量\\${term}获取，如："https://xxx/search?name=\\${term}"',
    '14079611c014884bbdffce4d0e5f4d73': '可以通过接口获取动态选项，一次拉取全部',
    '1fd65acd90f99791d70ca70e046c9f05': '假数据图片',
    '5789be67da4a1dc0fd9600bd626776a1': '只在编辑区显示的模拟图片，运行时将显示图片实际内容',
    ...
    '087e631da111edc6db508289a7b5a95b': '分配不同的值段，用不同的颜色提示用户。若只配置一个颜色不配置value，默认value为100',
    ...
    'bfa178f875f63957378fc2d0bd8d0f59': '配置schemaApi后，可以实现动态渲染页面内容',
    'dd22d42f40442605fbe0c5da03203ffb': '是否Schema初始加载',
    'eb1d029d107422d00f55c8b76e66ec75': 'WebSocket接口',
    '470e0b39b2486883a10c1048f2df9f40': 'Service 支持通过WebSocket(ws)获取数据，用于获取实时更新的数据。',
    '3bfc17446f0456f9692f25fc90383ec1': '对于复杂的数据获取情况，可以使用外部函数获取数据',
    ...
    '413c6b52c23a1bf5cbc9fba1485f88ff': '[amis-editor][Table2Plugin] dynamicControls的值必须是一个对象',
    ...
    '1b4b8d809a7d253bb650d0f104d24ea2': '声明数据结构中作为子节点的字段名称，默认是<code>children</code>',
    'f53160d07e516a3b0d38d61822944b03': '行角标',
    '8952f4e24070a79741a505dc20bad8f0': '高度自适应',
    'dd7befc8e7c124f6f4ba9bbf3de9dc53': '缩进尺寸',
    'eedd7279409d000114e27194f3c8a5ea': '嵌套结构展示时，设置子节点的缩进值，单位为px',
    ...
    '44c9d7cb031327029dd0b1bc92689542': '[amis-editor][TableCell2Plugin] dynamicControls的值必须是一个对象',
    ...
    'a903e51cb1915b56f94bf54a81816cf5': '只在编辑区显示的假数据文本，运行时将显示文本实际内容',
    ...
    'aa70a469e4ceb0dede9d73cb8d8d953a': '序号「{{@1}}」的字段名称「{{@2}}」不唯一',
    ...
    '17817a4d2da41f4261f4155ada59e395': '<%= data.ignoreError === false ? "找不到组件和动作执行失败都中断" : typeof data.ignoreError === "undefined" ? "找不到组件容忍，动作执行失败才中断" : ""%>',
    ...
    'f16654604d6cb2f62469e5aa9db19871': '如果开启发送数据，会先发送配置数据到目标组件，然后重新请求数据。',
    'a0c117d927c6290bab55ae0e848a4d4b': '开启“发送数据”后，所配置的数据将发送给目标组件，这些数据将与目标组件数据域进行合并或覆盖',
    ...
    '0e2ba6becfa8760853cfa31c9e15a94b': '如需执行多次表单提交，可以修改此变量名用于区分不同的提交结果',
    ...
    'a422eb12ebbfdd3347c4deb5ec6b4b54': '如需执行多次表单校验，可以修改此变量名用于区分不同的校验结果',
    '0552d08957a270160d5203e0611661b2': '自定义样式仅对当前组件生效。示例：\n// 当前层级\nroot {\n  color: #000;\n}\n// 子层级\n.text-color: {\n  color: #fff;\n}\n',
    'aaf9656ba493b58fbab398d52efa9f7c': '编辑样式',
    '3ac7b489ba8cb811386c9f4fbfd1c6cc': '结尾字段名',
    '9da561f34a93e0275c56b84717ac9cf0': '配置了结尾字段名，该组件将开始和结尾存成两个字段',
    '475cdfcaf614f2b69d88e1e34ba76079': '主键',
    'c28f86f11fc814ea5696af5aa9464cbe': '每行记录的唯一标识符，通常用于行选择、批量操作等场景。',

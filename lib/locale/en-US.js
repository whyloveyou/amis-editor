...
i18nRuntime.extendLocale('en-US', {
    ...
    'f10b676db977ae808af8d96b327be7f3': 'Which secondary CSS class names are available? Go to<a href="https://baidu.gitee.io/amis/zh-CN/style/index" target="_blank">Style description</a>. In addition, you can add a custom class name, and then add a custom style in the system configuration.',
    '159dbc2fafd57b9d3652f16659b1b519': 'Triggering mode',
    '45a51525391d4a3771b22f2cf1aa96b3': 'The floating layer triggering mode defaults to the mouseover.',
    ...
    '852228c640b1daefe6b0853390e66791': 'The number of column lines is incorrect.',
    '26526c3354307798dfa84f17decf5140': 'The corresponding id is not found.',
    '38d2ccdde0ae0c2329defd3c75c59d8b': 'Due to the padding limit, the height setting that is too small is invalid. Thus, you can reduce the default padding.',
    'd59379f4227af3b2c60214e2f4f903ba': 'Merge cells',
    '02d9819ddaaaeb1b7b22b12608c7e5ca': 'Prompt',
    '4be3194e93cdd2899d06b499c184195b': 'The prompt is used for special text prompt, which includes four types: operation prompt, success prompt, warning prompt, and danger prompt. Combining the <code>visibleOn</code>, the prompt can be used to prompt the error information.',
    ...
    'f6da8aa86fa3e399da95dab399a67985': 'When multiple lines of content are displayed in the anchor navigation, the content can be displayed in the form of anchor navigation groups. Thus, you can locate the corresponding content area by clicking the nav menu.',
    ...
    'e7a707f9fc7da36828db940ca2960f4b': 'The audio control can be used to play various audio files.',
    '997c7a5d34f6fc628893f509d0df32e0': 'Feature',
    '22b777e6fcb613b8ba83ced9594cd07e': 'Properties',
    '37b12f2666b9e4e37f33eb5e83533d5e': '<p>Currently, this feature is configured for the field content node. If you select the upper layer, more configurations exist. </p>',
    'f8f176147db276063e7ec15f076e39e0': 'Audio address',
    '91d3cd46d6b6919749e56056d5acc9bc': 'Allows you to get variables, such as <code>\\${audioSrc}</code>.',
    ...
    'ad751bba0aed43a673c40b652a239fc3': 'After you choose the speed, you need to configure it in the ordinary selection bar.',
    ...
    'def423db04dd24b226911b9e4cf5dc9c': 'The image processing method that the image size is inconsistent with the control size.',
    ...
    '9854f491213784118614be4a1970bcf9': 'Stretch the image to occupy the space fully.',
    '3d2b60dda894eba9a042beddf7daf3cc': 'Crop the image in terms of its original size.',
    'c7fff1a6f585d7fb22c94bb1ef82707d': 'Border distance',
    'f1b4c635cdb39c91461f181d27d06f8c': 'The text is centered. When the text is too long, keep it at the minimum distance from the border.',
    ...
    '89de611b2d759a1802542b5d3a06829f': 'It is used to display a button. You can configure different display styles and different click behaviors.',
    '7af5e3ef39ff71d39fe3f645c8079124': 'Trigger this option when you click it',
    'f6d767f39ba3bf955077a3c0ce81e581': 'Mouse-over',
    'bcdd89d453da0dc0622a2f3189728357': 'Trigger this option when you move your mouse over it',
    'e272b0b8c7fedc670a87075514d9b49f': 'Mouse-out',
    '727309bc724ff237c5e2cdf7a90cf28e': 'Trigger this option when you move your mouse out of it',
    ...
    'd5bb99590ef447a1af8e9782786c751d': 'Close the current {{@1}} after you specify the operation',
    '1e7196ce05260faa55e5b7ea5a1667c2': 'Second confirmation',
    'ed2f135144b4e138cb29419c1f245f4b': 'After you click it, ask the user. You can perform the action to avoid false touch upon the manual confirmation. You can use <code>\\${xxx}</code> to take a value.',
    ...
    '2fd82aa9dd7fedea2c16b7dfe93b6d0e': 'Give the prompt content in the normal status. If you do not fill in it, no prompt pops out. You can use <code>\\${xxx}</code> to take a value.',
    'fb37b983a93aabdcdbbd59ae48c519fb': 'Disable prompt',
    'f4f168a3fec79443d2ca8fd1955edee8': 'Give the prompt content in the disabled status. If you do not fill in it, a normal prompt pops out. You can use <code>\\${xxx}</code> to take a value.',
    ...
    '66ae9ce23b0b2e243aff087d906a2489': 'It is used to display multiple buttons which appears as a whole visually.',
    ...
    '2e28645c67c5742e473888a27aab7bd6': 'Enable the button group to occupy the parent container. The width of individual buttons is adaptive.',
    ...
    '433e2e80ec74563daf4368e59b525e34': 'It can be used to put multiple buttons or button groups. A spacing exists between buttons.',
    '6651fec0511e3593d3438a113dff23d6': 'The buttons or button groups are sortable and removable. If you want to edit the buttons or button groups, edit them in the preview area.',
    'd7213304d1a8a02a73a2f4010839e061': 'CRUD',
    '7a9f1ec32752de8b69ef21138970f64d': 'This button is used to realize the addition, deletion, change, and view of data, and supports three display modes: table, cards, and list. This button is used for data fetching, paging, single operation, batch operation, sorting, quick edit, and other features. Integrate query conditions',
    '48c68eb5a42e2b3e679c53b00f6e203f': 'Rendering engine',
    '64ca9bab920a2983bcf270320d850d00': 'Reload',
    '9ef5597ac0b4da662bcd967da37eceb4': 'Trigger the component data refresh and render it again',
    ...
    '4a1e3c50547e61503a2d1c356005eb08': 'Add, delete, change, view, and quick start-CRUD',
    '85624c8e8b0fc98954eecbe508e8b59d': 'API address',
    '3dd674542204724eb5417efc7354ec73': 'Verify the format and automatically generate the column configuration.',
    '3266535dc49863d976b9960adad29fef': 'The API return format is incorrect. Click the question mark in the example on the right of the API address to view the example.',
    ...
    '46e6edaeb9968e7f7ab549d4f2f82d6d': 'You can manage the batch action buttons through this button. A selection box appears only when you set the batch action buttons. Also, you can configure the position of the batch action button in the appearance. ',
    '8347a927c09a4ec2fe473b0a93f667d0': 'Change',
    'f13a0697d58d975d14eb3f3c72c2cbf2': 'Single-entry action',
    '3674ea51498e7118732e5e1c53d4bc80': 'After you set this button, an action button appears when you hover your mouse over it. Meanwhile, this button appears in the top action bar. When you select a member, it can switch to the batch action button intelligently.',
    '4916771d080ddf6d0551de4d6d2f42a4': 'Hide mouseover',
    '569343b4fe5e48131b78611c11eadbeb': 'Synchronization address bar',
    '6dbee29a8c54eef9d042ef3280999ad9': 'After you open the synchronous address bar, the query condition data and paging information are synchronized to the address bar. When multiple synchronization address bars appear on the page, it is recommended to keep only one synchronization address bar. Otherwise, multiple synchronization address bars tend to affect each other.',
    '2171d1b07d045e796cba4a05bcf7d13f': 'Default parameters',
    '01e7eb2256821085a14708d6ddf36814': 'This button is used to set the default parameters, such as <code>perPage:20</code>.',
    '58ed0a7a5a91996dbb4c7d6dc7679364': 'Retain entry selection',
    '36ac0011faae6f88ee0ec3e642328327': 'After the default paging and search, the selected entries are cleared. After you enable this feature, the user’s selection is retained. Also, this feature allows you to achieve the cross-page batch actions. ',
    '2a0b47ba76e886070c3bd6abeae3d1c0': 'Single-entry description template',
    '6ab3e5b6c5d5d2cf621e911226495433': 'With the [Retain entry selection] enabled, all selected entries are listed. This option can be used to customize the entry display text.',
    '987b04af242bb2dafaf32d890ab952ff': 'Designate primary key',
    'a270e70be12fb13a24ca3e4ac70fa838': 'This option defaults to <code>id</code> and is used for batch action to get the data at the row level.',
    '54ea89b497ec3bb319c68844dfa3687f': 'API',
    'db7ee36de8063c2d5a6c123eac65641a': 'Data fetch API',
    '0951dad1723aa1191ce1a2e96db76051': 'Whether to perform the initial data fetching',
    '0a60ac8f02ccd2cf723f927284877851': 'Yes',
    'c9744f45e76d885ae1c74d4f4a934b2e': 'No',
    'a9400c408441f1f7f6d6954deb05ae9a': 'Expression',
    '55b22f5d136e73b26cef65aedd8ba86e': 'You can use the JS expression to determine it.',
    'bedc70d448b656d828bd3ed7926b3e4d': 'One-time data fetch',
    '559fa334442f0f75b0343bbf38b7ff05': 'With this option enabled, you can fetch the data only in the initial time. No request for subsequent paging and sorting is sent to the API. Instead, the subsequent paging and sorting are achieved by the front-end device.',
    '1af68c43e1780249f11b9de1eeaeb281': 'Enable timed refresh',
    '9800f1ce2f78a23b81c8d944ebf9cce9': 'After you set this option, the timed refresh takes place automatically. The unit is ms.',
    '19c5410b23fba4bbfd1a58bbd5268c9b': 'Silent refresh',
    '04f840b0772f4b5d59954a29a76f4e7b': 'Whether to display the loading after you set the automatic timed refresh.',
    '6037dae99e9446deaed45f7e408f47ab': 'Detection expression for stopping timed refresh',
    '32e3a79e80dcf7f7304e8092dd7acc6f': 'The refresh takes place constantly once you set the timed refresh. The refresh proceeds unless and until an expression is given and the conditions are satisfied.',
    '154ef40e477c031f6c1ec15caefb570a': 'Disable automatic refresh when a popout appears.',
    '50f7c85bf60a9f43522789644566c62b': 'The automatic refresh is disabled when a popout appears. The automatic refresh is recovered after you close the popout.',
    'd8905a70e93a33c7a86240f467c653d4': 'Whether you can drag and sort them or not.',
    '040a78b24eaff47d4fa7e266473635b4': 'API for sequential saving',
    'ee850a0e326b217bdeb61d936c521177': 'API for quick saving',
    '8343f619879fa79bc8ef1a35b2fc3e78': 'After you set the quick edit in the column, you can use this API to save the data in batch.',
    'd891e79d4a8718a7dbd47ac68aaaa5cb': 'API for quick saving of a single entry',
    '38db6e045e214ffcd03ede695002271c': 'This API is used to save the data when you set the quick edit and the immediate saving in the column.',
    '522110866c19dace2ce38336617405c2': 'Default message prompt',
    '3b69c2e540c05e9ca530ed30cf224472': 'It overwrites the default message prompt. However, if the API returns a msg, this msg is used preferentially.',
    ...
    'c62a1b7f314be10aead10475e7543f6a': 'Prompt for successful saving of the sequences',
    'c8035507b7a576d43e9f227c91c7a7b5': 'Prompt for failure to save the sequences',
    ...
    'e4fd8d64804a4f3d743eff384a6eb20a': 'You can select and edit the non-built content in the preview area.',
    ...
    '440a3a2d7f1b123718be75e2baee8391': 'You can select and edit the details in the preview area.',
    '34da7e4a0ecdb63967427f43adf2de3e': 'Whether to display and hide query conditions',
    '25c0db3ddce9bfffd497d0c824cf3c72': 'Whether the query conditions are visible by default',
    '259d11c300a365b6767228c12d29ce53': 'Hide top prompt for quick saving',
    'fa9417bacb7714e82663655345ca213d': 'Whether to display paging condition always',
    ...
    '62569fcb0fc8314daea97989bba3877c': 'This option is left blank. The properties of the items or rows returned from the API are read by default. If anything else exists, set it here, e.g.,  <code>\\${xxxx}</code>.',
    ...
    'dd8d217677e4c5df28b7f46aa99b22a8': 'It is a field name that is used to determine the position. The new sequence that you set is assigned to this field.',
    'e04e8f570e2fb43a533b224f3c48523d': 'Number of switch-overs on each page',
    '0fc1de8f71a7470213fc68f981abdbc2': 'Configure the expression that you can select for each item.',
    '7d5fefd589000879088063dceb4b2552': 'Use js expression. If failed to set it, you can select all items.',
    '614ec7801e03f7ee009e4448e6ed4001': 'Enable a single entry, and click and select the entire area.',
    '530ab79908eabe5b329ffe17695079e2': 'Automatic return to the top ',
    '9092afb1ccb692308ef06d8001da2208': 'Whether to return to the top during paging.',
    'c8cf39b24bb52d0562472c33b86824fe': 'Synchronize query conditions',
    'd3c172700af4f3f3afb028d6bb4a90a4': 'After the query, the returned data is synchronized to the query conditions. ',
    '5db6b2160b9169b9d89de247d14ab740': '“Add, delete, change, and view” edit area',
    'f49d40842a3c66c4de2e57a48157c707': 'Display a single card',
    '0212e8c9b113143a031d1f3e25167794': 'Click to add a button element in the left component panel.',
    '6312e80e416fa79ff3383e1577c243b8': 'Click to add a content element in the left component panel.',
    'a3cf7c9ee581ae71eb51d18b610b05b6': 'Add content',
    '00a1f644f34b9ee43adf82cb3449158c': 'It supports the following template syntax: <code>\\${xxx}</code>',
    ...
    'd4f223e0619836d03d488c89558f38e7': 'Maximum number of buttons put in each row of the card',
    ...
    '85c17b016309a3f867a1803049b3bcd8': 'This feature resembles the table, but it uses a small card to display the data. You need to configure a data source for the current component. This component does not have the data fetch feature. You need to take priority to use the “CRUD” component. ',
    ...
    '58e78d512d9ff40c73a263ab616cc652': 'Number of class names displayed in each row',
    '3cf0da9fe51f92842e0a6d375fa5c605': 'When this parameter is not set, it depends on the card CSS class name.',
    ...
    '1007c97dbf952e032ce13be3cb811f23': 'It is used to render the carousel image. It allows you to configure the content on each page (in addition to images) and the transition animation.',
    ...
    '793a763e73f1f742e3a16ddc2ed95ccb': 'This option allows you to set the field name and associate the data in the current data domain.',
    ...
    '10e14f791d73c7c0f4113787f36f1626': 'This option is used to render the chart. Based on the echarts library, it supports all echart types theoretically.',
    ...
    '03677b68a73eb59e5faf281f49f3c130': 'The API can return the configuration or data. Recommend that the return data could be mapped into the Echarts configuration.',
    '1396ebc166bd49c1e3b67549a1b4caa0': 'Whether to fetch API initially',
    '2af32ab13a9dece315cec2764d6aa7d4': 'Timed refresh interval',
    'bc827aaffaa35a95607346cc104c0785': 'After you set this option, the timed refresh takes place automatically. The minimum refresh interval is 3000 ms.',
    '57c7d1125d2803b946a5b25c3f80f249': 'Echarts configuration',
    '3d3fa75d8b345b22a5fbd14a65a0af71': 'This option supports the data mapping, which can fill in the data returned from the API.',
    ...
    'd98ef182637b4d10e16e8073c1101e51': 'The chart configuration is completely replaced.',
    'f1f13cb0ca4720a727cbfba4c82e5890': 'This option defaults to the append mode. The new configuration is merged with the old one. If selected, the configuration is entirely overwritten.',
    '40128a51e9667fe6a20a0454069368ba': '<p>Content<code>${value|json}</code></p>',
    ...
    '452b62e9b7e650fa163300da2893654a': 'The folder can unfold or fold the content area to keep the page clean.',
    '81d2b9f20fb2083c75a5b052b84e897a': 'Unfold title',
    '7349194c139069b32889101768aa7428': 'The title appeared when the folder is in the unfolded status.',
    ...
    '0d571a7ab19e098820e8cea4d5a80f7d': 'When the information volume is huge and there are many classes, you can use the fold panel to sort the classes.',
    ...
    'bb3548f0bb97ab11ee92284ecf37ec16': 'In the accordion mode, you can unfold a single panel only.',
    ...
    'ded228f9173b241dd8df2a4811ea0e98': 'A simple container allows you to put several renderers together.',
    'a823cfa70cfa46c788e1eedae043f6e5': 'Container label',
    'f7d64e5e79994c3c8853f2608d7b2d25': 'Because the HTML label is invalid, re-enter it again.',
    '473d2078518479669823205110842376': 'Custom Code',
    '8b9c77fa4e646b9cb270f833252e511b': 'This feature is implemented through the embedded code.',
    ...
    'e5b5798a8bab7dc8a578431991731040': 'The container component is implemented through the custom code.',
    ...
    '2bc6d101e5701a70f2fb9e0b67581594': 'It is mainly used to associate the field name for date display. It supports various formats, such as X (time stamp), YYYY-MM-DD HH:mm:ss.',
    'a2344febfc246ddc7281f62217ba42c0': 'Date value',
    '84ff80a2dc4717cc01acd486040a6763': 'Display date format',
    '6eea1b15be458a6999c9259aa2280a70': 'Refer to the format use method in the moment.',
    ...
    '773ddc154f1e9b80f04e8bc9d83d2caf': 'Trigger when you click the Confirm button in the popout.',
    '625fb26b4b3340f7872b411f401e754c': 'Cancel',
    '08ab4ffcd1bddd249a193e6353bb52bb': 'Trigger when you click the Cancel button in the popout.',
    ...
    'abf68809d31c8eabb3eb5ae9e00abfcd': '< p class = text SM text muted > when data mapping is not enabled, the pop-up box will have all the data of the environment where the pop-up box button is triggered by default</ p>',
    '1fab180b92bddf03ecf7da009f86d826': '<p>When data mapping is enabled, the data in the pop-up box will only contain the set part. Please bind the data. For example, < code > {A: \\ ${a}, B: 2} < / code > < / P > < p > if you want to customize on the basis of default, please first add a key of ` & ` and a value of ` \\ $` as the first line</ p> < div > when the value is < code >__ Undefined < / code > means to delete the corresponding field, which can be combined with < code > {&: \\ $} < / code > to achieve the blacklist effect</ div>',
    'd6f555510792c9f3cb9e8087af037898': 'There are errors in the data mapping, please check carefully',
    'c14ebcefcb02c97b925b762d8bacd1ee': 'Press ESC to close the pop-up box',
    '4cade75641878a17e2f1ff29ff0ac235': 'Click the area outside the pop-up box to close the pop-up box',
    ...
    'bc43ae8e61f1ad4be2b0a9e70501e490': 'This option is used to display a separator which is used for the visual separation.',
    '33f1fc330b325469b43614c9d96f590e': 'Drawer type popout',
    '0c5a0448b07419ad2900c36867e8e4e0': 'Trigger when you click the drawer confirmation button',
    '57f215184a2fb83541f7cfa22d039feb': 'Trigger when you click the drawer cancellation button',
    ...
    '399f43daffee1afae2a881027b6fb1f9': 'Click "external" to close the pop-up box',
    ...
    '0fad5a56c8b4643f24797eaa616bef6f': 'Define whether the pop-up box can be dragged and resized',
    '7fdaa90d63dd5163de1911264bc5c514': 'Bodyclassname class name',
    'cc70a816b7d61e7212d57335c0a15af5': 'Drop Down Button',
    '74bafe23b0be1a14aa218b396cb33bd0': 'More buttons are displayed after you click the drop-down button.',
    ...
    '697eb55e1c6cecf43e63a26232dda5b2': 'The drop-down menu defaults to unfold after you select this option.',
    'b2aa282e908597d1d700c1f4de17b8aa': 'Menu alignment method',
    'e57996d3d771141f1b3080bbd8ad605b': 'The button occupies the parent container width after you select this option.',
    ...
    'f34111ff3694a6c6de6e31bef8ebadcb': 'The feature renderer can be based on the current renderer for the loop output of variables.',
    '874268022baac239b06c40600d3ce080': '<%= data.index + 1 %>. Content: <%= data.item %>',
    '69bdc66bb88ac5b63053e2bb7db41801': 'Loop',
    'b7c16dedc4291d333fba7628ec9eb073': 'If the container has a value, you do not need to configure a variable name. If it has not any value, you need to configure a variable name. It supports multiple levels, e.g., a.b indicates that the b’s attributes under the object a are associated. The target variable may be an array and can also be an object.',
    '4726ff4e62d3fcfa4b090aaefc393229': 'No content is available temporarily.',
    '5d5f9d49fcb2109f94a43590ef796ca7': 'When no variable is associated or the target variable is not an array or object, it displays the placeholder information.',
    ...
    '2fdc3722b88a2ba5077e0d11156ede6a': 'Horizontal distribution method of child nodes',
    ...
    'd5a3cb1cc31a0469b011abdbd3e947f7': 'Even distribution (leave a blank at the starting and end points)',
    '85530444a72a840ee657e2df99970136': 'Even distribution (alignment at the starting and end points)',
    '9aad08fbd356fb4279f0efa81b3d016e': 'Even distribution (equal spacing between elements)',
    'ae558cbf4c35d381b6542f517f2e8dff': 'Even distribution (automatic stretch)',
    '70d39e84bc1ecefaf6e19cf78c9574fe': 'Position of child nodes at the vertical direction',
    ...
    '197af5d5971778e3b80deb25182d63e3': '<span class="label label-default">Child node${index | plus}</span>',
    ...
    '29513434492e5d19a9660e0a918befd1': 'This option is used to display multiple buttons which appear as a whole visually. Meanwhile, it can be used as an option selector for form items.',
    '6edda84461bf13d38328cb401c8c23db': 'Option 1',
    '39692081e75ef73c6479fc25f8f10dfc': 'Option 2',
    'a457872a51628ccadfb9bcfa23428a98': 'The button click and selection can be used as an option.',
    '755955372bcc0c7ebf161a656bc389b3': 'Value change',
    '2fc76872efce1eabd3b74a3e4fd5b976': 'Be triggered when the selected value changes.',
    ...
    '8db57ba01ffb9bf29c1656de5f0208f5': 'Reset the value to resetValue. If the resetValue is not configured, the value is cleared.',
    '8f40db3b25528063f1b6a59602a05cd5': 'Value assignment',
    '944908c981a86bfa0cfab9360ab38184': 'Allow the button to occupy the parent container fully. The width of individual buttons is adaptive.',
    ...
    'fdf1664c0790d25f236bd596aef1acef': 'Through the <code>source</code> fetch option, you can add the levels infinitely as long as there is a return result.',
    ...
    '2646ee1ebb6922a5c9359de6cd3b3639': 'After this option is enabled, concatenate the values of the selected options to get a value of the current form item. ',
    '1395eba8d9efe27aa1ecd1a45e3e5dcd': 'Get option API',
    '4ea50507bf8b9ceb908677f30fb20e68': 'Option label field',
    'fe4c9c2eed1ad213040d84036c675454': 'The default rendering option group gets the label variable in each item and uses it as the display text.',
    'be43687d4ed1d9e663c729e12618166d': 'Option value field',
    'f1e6b60c4b6df555a6b03f91033091f4': 'The default rendering option group gets the value variable in each item and uses it as the form item value.',
    ...
    'c75fde0e2d329ce62f55cb1a207181ae': 'Be triggered when the selection status changes.',
    ...
    '6d1383a2806f0516aac2c115f96799eb': 'You can configure multiple select boxes through <code>options</code> and can also fetch options through the <code>source</code>.',
    ...
    '08346c5bb99d8e3bfa406995b8c4f067': 'The code editor is a monaco-editor, which supports {{@1}} and so on.',
    'ab0710b367acefa1d6a78e2338291e86': 'Get focus',
    '4638e799b95e1b71edd55f278a6f707c': 'Be triggered when the input box gets a focus.',
    'efa3ddc1e26ed5d8cf7d9855cc7bd42e': 'Current code',
    'fc96a5f1b79cb734afe08e401b6ba5e7': 'Lose focus',
    'c776ab86eb24f6b3db35114e43026f75': 'Be triggered when the input box loses the focus.',
    ...
    '4db731c7d73988e40a01b4bf1a7f00d7': 'Through the combination of multiple form items, you can configure whether to add and delete the initially set template.',
    'b58c7549c0246c55b9cac96383200338': 'Add',
    '8575b828c7320de82b9f99058aa1f55f': 'Be triggered when you add a combination item',
    ...
    'ba2bd765f6c2e2b717139c5453884e14': 'Be triggered when you set tabsMode to true and change the tab.',
    ...
    '85485d70be6b380294428018e54fc9b9': 'Judge whether to use this branch according to the member’s data.',
    ...
    '28a59fee1a4714493a8d6cec05c1417b': 'The data structure in the default array is an object. If there is a form item only, you can configure the value. Thus, the value contained in the array is the value of the form item.  ',
    ...
    '91396e9bc25c9e8b63907fe22408e2bb': 'You can adjust the sequence by dragging the [Change] button in each line.',
    ...
    'b8ccbc166c72b2eb54aac1332c99fb49': 'A prompt appears in case of failure to limit the sub-form item.',
    'b34cbe877b2c8464c625858fcf19f4eb': 'A prompt appears in case of failure to verify the minimum length.',
    'ea2474ff679195d9b54bd5ff3384fdfd': 'A prompt appears in case of failure to verify the maximum length.',
    '1c5b9cb245f04413a2d888bd59442097': 'Whether to fill in the parent variable with the same name automatically.',
    ...
    '93dc24d4ad01981d5994ba7f8ffaf345': 'When a lag occurs if there are much data, you can enable this configuration item.',
    '98d52b737d6bc171b6d5bad9a42f6e23': 'Strict mode',
    'cb5ca128b6c78a90f26673e21b0b3f28': 'If you want to transit the value of the environment variable into Combo, disable this option.',
    'bc91f4844843d6c8ec1acb78a1f1aba4': 'Configure synchronization field',
    '07bf6c08bb5f0bdb32dbfecc7d3fe290': 'If the Combo level is deep, the data acquisition at the bottom level is out of synchronization with that at the external level. However, configuring this attribute of the combo can achieve the synchronization.',
    '3f2176cdae8a4ed6a4c4eaff002a3b24': 'Allow to leave this field blank',
    'ead7156521ca11acb7ca7bdf4c9c87f6': 'If the sub-form item is configured with a validator and is in the single-entry mode, the user can select to clear it (leave it blank).',
    ...
    'ab7f2096d3ea8aa85f453b204bfbc493': 'It is used to set the complicated combination condition. It allows you to add conditions and groups, set the combination method, and drag the sorting feature and other features.',
    'ae5e21c7b57aaaff2071b757f35dbb3e': 'It allows the user to enter the query conditions. Thus, the backend device can generate query where according to the data. ',
    ...
    'f20a86701d87369e5166c28a71b8b8cd': 'You can fetch the field option remotely. It supports the API or data mapping.',
    ...
    '7b4fe9415d80d3694d2f630411ac7e9c': 'Compare the codes on both sides. The supportive language includes {@1}} and so on.',
    '0517b74cbe247a903faf40991a5a335f': 'diff editor',
    '42f04184315801c372989820106cc4ee': 'Be triggered when the right input box gets a focus.',
    '58ec44a580ba7cdcdf65985f5c44940c': 'Be triggered when the right input box loses the focus.',
    'b42cb49fc7c4ec140697e6d78c39e585': 'Get the focus which lies on the right editor panel.',
    '2a69150aa382f6a309c03a96145d4266': 'Left default value',
    '04b8c503707c34f9c275d349275787f2': 'It allows you to use ${xxx} to get the variable.',
    'a71e655ab56c9962742f72623f67ca76': 'Right default value',
    '460bc46ffeb31b737669e2312c5bae72': 'Field Set',
    'a89cd8150a1dbc60ac7063580e0852e2': 'Through the combination of multiple form items, you can configure whether to fold',
    ...
    '12b54e3fdccdbb5588785fce5534edbd': 'Click to add a sub-form item in the left component panel',
    ...
    'f75e31cd2e3bfb79be420b0e61a533cc': 'Be triggered when the request to the remote initialization interface is sent successfully',
    '211f02318e3cceff5ee50d4949a5c8ed': 'initApi Initialization data returned from the remote request',
    'b2a5322c8dbc0d8343315cafbd39b7ce': 'Value change',
    'd6fc04abf4889a864bea240d6b67963a': 'Be triggered when the form value changes',
    '66f1115691b0a3e434dd3e8a6e733730': 'Current form data',
    '7233c9cadee5096097673c9590eae9b8': 'The form item is checked successfully',
    '6611594c527756e23d4044f908fedfa9': 'Be triggered after the form item check is successful',
    'e00a32d415785d5a5d43a593d26cbaa0': 'The form item check fails',
    'd4c12cea41e1595329358edb365c5f5b': 'Be triggered after the form item check fails',
    '368f9bab722b255f1fdb669a89f0c594': 'The form check is successful',
    '35e69ab84129d721229bc5b48afdedd2': 'Be triggered after the form check is successful',
    ...
    '8c9d9d2594b9cc39294c6939bd08a5d5': 'Be triggered after the form submission request is successful',
    ...
    '86555672b37841b639311e7d49f0f593': 'Be triggered after the form submission fails',
    '17aa713bc661f98e585ec3725d6d4f0d': 'Error information returned after the submission fails',
    ...
    'a834505b13627a2e9eb4e0a0c2746e5c': 'It is valid when no button is customized.',
    'cbef9ad64297efd7657d5b67b2112751': 'Automatic focus',
    'ded8caee55c05aa0f1a4e6a197c480bd': 'After the setting, the first form item that you can input in the form gets focused',
    'c8801f299681b3080968effcb13a57fe': 'Disable the “Enter” key to submit the form',
    '4fe8162504ae5fb955c30863d88834fa': 'After the setting, you cannot submit the form through the “Enter” key on the keyboard',
    '6232c762a93aeb3c89cc759c06802610': 'Reset form after the submission',
    '7d61784cd115d333f01a3c0c46408a1c': 'After the form submission, restore the value of all form items to the initial value',
    '49086a13c74f262de398e60f448ab056': 'Submit the form once after the initialization',
    '1babd035cabfeb997ac3eee3f938d794': 'With this option enabled, trigger the one-time submission after the form initialization is complete',
    '0d1fb15904862f5fd2d81d2fc8f371d6': 'Whether to close the dialog after the form submission ',
    'e91209a4a78c0b34c26b681b49e0681a': 'Submit the form to another component',
    '4133d2c3613ece9792c90d185ec32306': 'You can submit the value of the current form to the target component by setting the attribute. Instead, the value is not saved by the interface. Enter the <code>name</code>  attribute of the target component. Multiple components are separated with commas. When the <code>target</code> is <code>window</code>, the form data is attached to the address bar.',
    '7653297de32f34fdec0dd0653aebf358': 'Redirection',
    '6d00e21637c382cbd4d949b7735a2e41': 'When the value is set, redirect to the target address after the form submission.',
    '672b63d7523095b949f5fad233fa0cde': 'Whether to enable local cache',
    '8a0544ca2f7ddaf8768ab599858315a6': 'With this option enabled, the form data is cached in the browser. Changing the page or closing the popout does not clear the data in the current form.',
    'ce2457fe99197e0fe81b6fb08e3eaf0e': 'Clear local caching after the submission is successful',
    'bc01ee1a28f980c298679610fe4d2d66': 'After you enable the local cache and the configuration item and the form submission is successful, clear the cached data of the current form in the browser. ',
    ...
    'd2af24c0f76cf325f1c8fa939576c379': 'After this property is set and the form requests initApi, it continues to poll the request for this interface until the returned finished attribute is true.',
    'ab94e2c30b3cf0fd11eea477f70dcbaf': 'Initialization failed',
    'b64292a1903bd969d0e3a558c334f5bf': 'Default message information',
    '8a5e590f69e1ae52d86396410ceeee5a': 'You cannot set this option. The msg field returned from the interface has a higher priority.',
    ...
    '1cb01363e2463443bc8105f544ce2736': 'With this option disabled, the form can display the form item only. The title and action bar does not appear.',
    ...
    'f24b7483069b44490a6379be5b90f4e3': 'Indicate that the data of the current form is at the top of the form',
    'eb332076d766c2e817285f0a6d4860b9': 'Formula',
    '000cf7353ce03857c671e89c91b35464': 'Calculate the specified variable value through the formula and apply its result in the specified variable',
    '9da7578f9329ccaee1bbdf6a766744fd': 'Calculation formula',
    '77562ec3db28683ec71612a11e6b39ef': 'The formula calculation result is applied in the variable corresponding to this field name.',
    'c80c42a0be1b39ed899b1f5560875cf8': 'It supports the JS expression, such as: <code>data.var_a + 2</code>. That is, when the form item  <code>var_a</code> changes, it sets the current form item to a value of <code>var_a + 2</code> automatically. If it is set to a string, it should be placed inside quotation marks.',
    '89a8549c2ed7fc23a683599731d92b22': 'Application conditions',
    '8add6799ceff24eb041c5a6a92bb1694': 'It supports the following conditions. For example, the <code>\\${xxx}</code> or <code>data.xxx == "a"</code> expression is used to configure the application conditions. When the application conditions are satisfied, you can set the calculation result to the target variable.  ',
    '3df193f5d4f652a4bac331a69761041b': 'Whether to apply it initially',
    '86cebf86c66c6a4e6731b840c3967ab0': 'Whether to run the formula result during initialization and set it to the target variable.',
    'aaff9b44fa3c84058d6bec9888b7b39f': 'Whether to apply it automatically',
    '677568b4f6505bdd63387137bfcbf35a': 'Whether to automatically calculate the formula result. In case of any change, automatically set it to the target variable. <br />With this option disabled, you can press the button to trigger the operation.',
    '222c7bc60f06552b019d71bce57013ed': 'Feature component (formula)',
    'bb09a378529edac439abc2edf05c10d7': 'Form group',
    '39d36f049a794eb8df305b5ca7710c36': 'Display multiple form items horizontally',
    '32f6f7f8164c7f78e4b46eb50c158ab9': 'Sub-form',
    '400fbff5e744d3b7317dd130eaad723e': 'Click to add a form item in the left component panel',
    ...
    '6e43f86d0b2973c34078bc7c7bc02eb0': 'The array input box allows you to customize the member input type. In fact, it is a method of flatting the Combo flat value, which can be replaced by combo directly. ',
    ...
    '1362211a6bfc8cc4130d54643e8e9732': 'This option allows you to drag and sort the prompt text',
    'ba6a6f2cdb46e8f80fbfd4fed20eafac': 'Input City',
    '20700607ccdb7b6c83f3b5bc525e6975': 'This option allows you to select a region or city',
    ...
    '5a9e72d006165ae3dacdbd96f931f70e': 'It supports <code>hex, hls, rgb, and rgba</code> formats. It defaults to the <code>hex</code> format.',
    ...
    '9b161db0e2e749c1106c702c8097d380': 'With this option enabled, disable manual color input. Thus, you can select a color among alternative colors only.',
    '05a64e0df1490a5db391e7a43eced6e0': 'Alternative colors',
    '6cbabc9a4cc07c1e26bb131c02833f8d': 'Alternative colors at the bottom of the color picker',
    ...
    '4be42a8a2cbb9088b4d051cfd824d68c': 'It supports the use of relative values, such as <code>now, +1day, -2weeks, +1hours, and +2years</code>. Meanwhile, it supports such variables as <code>\\${start_date}</code>.',
    'be28cd64f978dd70c1cd345ebe751bca': 'Date box, input-datetime, date and time box, input-time, time box, input-month, month box, input-quarter, quarter box, input-year, and year box',
    '52ea2070560eb55083b64f5ba748697d': 'This option allows you to select year, month, and date. It supports the setting of relative values, e.g., <code>+2days</code> later.',
    'e54ca3223a36c6489de0fb8a39d4049f': 'Date configuration',
    '96f9d9fc9cef8b18e3cd1cf9077147d1': 'Be triggered when the time value changes',
    '0a72b3858efffaa1bab685fa840b701b': 'Time value',
    'f6db3514c72bdc34922f137a8a92b997': 'Be triggered when the input box gets a focus (non-embedded mode)',
    '0f5fc3b84cf9c24ff3acae45ae22fb57': 'Be triggered when the input box loses the focus (non-embedded mode)',
    'e02d111d524de97e8622121f7ce845cf': 'Before the data submission, format the data according to the setting. Refer to the format application in <a href="https://momentjs.com/" target="_blank">moment</a>.',
    'ecd1a3cadcf1d55250afafbbde767250': 'Display format',
    '182503224cfaf1f63c566f13da56a2a4': 'Refer to the format application in <a href=https://momentjs.com/ target=_blank>moment</a>.',
    'bf8f46b5c3b309f666965a74d57ac093': 'It supports the use of relative values, such as <code>now, +1day, -2weeks, +1hours, and +2years</code>.',
    ...
    '28de3d73d839b616bd617b3636669780': 'Date range box, input-datetime-range, date and time range, input-time-range, time range, input-month-range, month range, input-quarter-range, quarter range, input-year-range, year range',
    '9024ff398faf8340b92bf0208431973b': 'For the date range, you can set the minimum and maximum dates through <code>minDate</code> and <code>maxDate</code>.',
    ...
    '7f4466c0a16a1808b5ee398ce55997ab': 'For the date and time range, you can set the minimum and maximum dates through <code>minDate</code> and <code>maxDate</code>.',
    'ab37cc3baa3ec204bd7ebfa450568c40': 'Email box',
    'e3c0d799e8880a36edb07e34fd1bed67': 'Verify whether the input meets the Email format',
    ...
    '7caadb59b5892d107a909816b6571c66': 'excel Be triggered after the upload and parsing are complete',
    ...
    '50b10b178196378f4359ce11bbc31372': 'Whether to parse the sheet into a pure text',
    '1647e4bfb548f2e8468d10b4b3bfbe21': 'Whether to include empty content',
    'ec1f230a0181d79b37967a455b1f3515': 'You can upload several files. Also, you can configure whether to automatically upload files and to upload large files by dividing them into multiple parts ',
    '8dccb3d6633a85edb21fa52599211654': 'It is be triggered when the upload file value changes. It can also be triggered in case of failure to upload.',
    ...
    'e309c24c2b07e5970208a82388f1d88e': 'Be triggered when the file is uploaded successfully',
    'a27518f50ea00aaacb2c4e52f113eeb1': 'Result data returned after the remote upload request is successful',
    '54e5de428ca9d59119d4624706215a4d': 'The upload fails.',
    '4855bc3f3d06b9cf58d14b61839c5a51': 'Be triggered if the file upload fails',
    '236dc056d6800bf423df47520637c52d': 'Error information returned after the remote upload request fails',
    ...
    '5548252bd28fc1d217d13a9e5771ecb0': 'It is used for the block preparation. A file can be called once. If an error occurs, the subsequent block upload interrupts.',
    'd7832abe5b9ce8e41537b4964fd7cf70': 'Block upload interface',
    '14008d63c109cc0d0c4ba305671800d2': 'It is used to receive each uploaded block. A large file is divided into multiple blocks according to the chunkSize and then each block is uploaded by calling this interface.',
    '70c935fa7ae03aeb1ff87b878e16841f': 'Upload completion interface',
    'c88aaeddb5aa95c7627d84df33929e3f': 'After all blocks are uploaded, the `eTag` information collected for the uploaded files is merged. Then, you can request the backend to complete the file upload. ',
    '1e4dc4d5f4a3a95ddc349147d4d8cd39': 'File receiver',
    '258d9e27231b06769dd584a3365545ba': 'By default, this option is left blank. The files are uploaded to bos. You can set your bos address in the system configuration.',
    '28b988ce6ae6dd62d24bcb8a52119179': 'File type',
    'f0a37d6f810c73a2f936f33035d99056': 'Enter the file suffix. If there are several types, they are separated with <code>,</code>.',
    '58892b7a6a785706712761d5aebb4639': 'Template link',
    'af4b910df15b00ba7fb5163558389cfe': 'It applies to the scenarios that have upload format requirements, such as excel upload format. Also, it provides users with a template download entry.',
    ...
    '5b7363cba6bad37b6614809e9bd90746': 'The input combination supports several types of control combinations.',
    '13370c4a5c95eff126068be5cfd2a9df': 'input combination',
    'ff10d1d90be63fbcdc7377435bf18f96': 'Input combination',
    '0a7f8e17f8487c3715a154bea698778e': 'This option allows you to crop the image. Also, it can limit the width, height, and size of the image. It supports automatic upload and upload of multiple images.',
    '295afc11c5fad1a6d97ae174abfcc5bf': 'File value change',
    'd4633ba7a30303a59891d051a7715cc9': 'With this option enabled, you cannot enable the crop feature at the same time',
    '22616e32a895c56187921ac6cc673f51': 'Maximum image volume',
    '13446481eaf0a047d8fddf159d981a7c': 'The upload is rejected when the file exceeds the size limit. The size is expressed in bytes.',
    'aeae3dd09f5cc972944a892802244483': 'Maximum number of pictures',
    'eec48d0e729f7260544646c60ef6580d': 'Upload is not allowed when the number exceeds',
    'b582587147013afc52c58de5fe34d7d7': 'File reception interface',
    'd24bada35447c81d7d7ddec13c44b576': 'It is a file reception interface. If this option is left blank, the files are uploaded to hiphoto.',
    '7c5e7ad8954effd97cb78dcb0e8f99d9': 'Image type',
    'f816b3decb401dcd0c22db7f104beccc': 'Enter the image suffix or <code>MimeType</code>. If there are several types of images, they are separated with <code>,</code>.',
    ...
    '2c4a34adf66f12d0a08716383304a66e': 'It is implemented by hiphoto. For the custom interface, it is invalid.',
    ...
    '3d948d24bc4c29689c5a1d4bcb9f2b98': 'With this option enabled, you cannot enable the multi-select mode.',
    ...
    'a7b7da38fcb8e246e910e178c5fe4ebc': 'When the aspect ratio does not meet conditions, the description appears as the prompt information.',
    'ed55564c631322fa3042c77286d6562c': 'Input KV',
    '746dd83e6891ccc9a19804c23c2c4443': 'It is used to edit the data of the key-value pair type',
    'b3747d09769d3a2ea8aa664edc901212': 'Be triggered when you delete a combination item.',
    ...
    '5b4ad7ffa6eee985e72e002bf18ac09a': 'To select the month range, you can set the minimum and maximum dates through <code>minDate</code> and <code>maxDate</code>.',
    '1e65b8181e9a40e76b86e2c261cafbe0': 'Input Number',
    'c45782c425bfc31824af8129bd6e0282': 'It supports the setting of the maximum and minimum values and the step and precision.',
    ...
    '33bf23fcb86101a9994b7e4bfdc2b062': 'Enter a number or use the <code>\\${xxx}</code> to get a variable. Otherwise, the configuration does not come effect.',
    'e284e64008fd8b066da04bca335d032a': 'Number of decimal places',
    'b317cbf67c94f986fc44cf4cbc2280c6': 'Precisely retain the number of decimal places according to the rounding rules ',
    '4c9bb42608b11278a5d9a2471b74eb40': 'Prefix',
    '0c8fe8b3675b0c7f5a896a153461ea46': 'It appears before the input content. It is not contained in the data value.',
    ...
    'f34b1a3e26aadb6f60c546dbe9c62232': 'Be triggered when you set showInput to true and the input box gets a focus.',
    '404625f170839b2a24d7ab65304c2fe7': 'Current value of the sliding block',
    '7c9ec5db3bf23f367c1a905d356aab5c': 'It is triggered when you set showInput to true and the input box loses the focus.',
    ...
    'f11a0f49123c2099ca6c6162ca37f0ec': 'Support the read-only and half-star selection',
    'ce9201dd7d5816945fbedae79927518f': 'Be triggered when the score value changes',
    ...
    '5ea244a79d480632f635a254c95c38df': 'Whether to allow you to clear it after you click it again',
    ...
    '497562b3159756834c7adfe9525bd7b5': 'The default unselected color value is #e7e7e8.',
    ...
    'b3389af540d99fe9e51fb2995dbd6dff': 'Select the repeated frequency, e.g., hourly, daily, weekly, and so on.',
    '2d842318fbd931286be387aaf5b2a7c3': 'Cycle',
    'a2d92b5adb07a4bf8a45e55643bc39f8': 'Enable unit',
    '42c036311993897680ef37f11e4e20a8': 'You can customize the configuration bar of the rich text.',
    ...
    '39624e820b79bbd62561357f6179c8d7': 'Prompt language displayed when the mouse is over the configuration in the configuration bar',
    'a7bac2239fcdcb3a067903d8077c4a07': 'Chinese',
    'f9fb6a063d1856da86a06def2dc6b921': 'English',
    '81fafee54baebeb9591b5e7840d7e650': 'Configuration item displayed in the large-screen mode',
    '0b6eee152cb2553ed4298ca2fe82d3f8': 'Screen width ≥ 1200px',
    'd85a80d177db696b29b7338af1501055': 'The configuration is separated with a space. You can group the configuration bars using <code>|</code>. <a target="_blank" href="https://www.froala.com/wysiwyg-editor/docs/options">Reference documentation</a>',
    'f126c4368fbf51cfd470684e7c3d31c9': 'Configuration item displayed in the medium-screen mode',
    '3b8c320d14dba586c581ceb951917397': 'Screen width ≥ 992px',
    '89bc688b5b497e515ce3c026a1d92669': 'Configuration item displayed in the small-screen mode',
    ...
    '8cfcd52cebdc2555b202f4b03de93662': 'The configuration is separated with a space. <a target="_blank" href="https://www.tiny.cloud/docs/general-configuration-guide/basic-setup/">Reference documentation</a>',
    '1a920d9999206a9fa5f588c7405fe081': 'The SubForm allows you to configure a <code>subform</code> as the current form item.',
    '18c113b99afa964ee988f30e81baf12b': 'Name field description',
    '4d930a9c13fca9d74e1a77496abfaa58': 'The button description is displayed by using this field value when this field appears in the value.',
    '307ae20f587910da3e9bb4e885334b6a': 'Button label description',
    'e366ccf1556c0672dcecba135ed5472e': 'Setting',
    '70c04a0f4522e39fde5f18ebc85b6232': 'The minimum number of buttons is allowed. ',
    'f58ea00f6a84bcb1cac174d1f68c88bd': 'The maximum number of buttons is allowed.',
    'e41fd1934b82f93f5737827be7323119': 'Form edit box',
    '0fbb26a646da61d2123319b4d0144ba4': 'If it can be used to display the data, it can also be used to display the data of array type, e.g., <code>multiple</code> <code>sub-form</code>.',
    ...
    '1b4996b29c7b4d5fb45ca701e6438d14': 'Configure <code>options</code> to implement the selected option.',
    ...
    '6f6fa31a91b516b28ebee7a86a9b13e2': 'After you set the option, drop down these options for your reference when you enter it.',
    '379b5486e7860a9f38f37dddabbb094c': 'Text box, email box, input-email, URL box, input-url, password box, and input-password',
    'f222f5413d3854897741e0ec4b0d2c7b': 'Text input box. It supports the input of common text, password, URL, email, and other content.',
    '9306b956ca5950203ee49a2680cac63d': 'Additional widget on the left side or right side of the input box',
    'd548d3e938088d5d469a28c20e939750': 'Automatic complementation',
    '424cd425082360322678a5c8d6910b80': 'Call the interface provision option according to the input content. The current input value can use the ${term} variable.',
    '7e9c83e86beb612377a94e6e8d1fc644': 'Display field',
    '26ff46d82166741297ce666b2792af85': 'The data field corresponding to the option text. If multiple fields are merged, configure it through the template.',
    '6d4ce0631f37676a887c9599691fabec': 'It is the field that corresponds to the option text',
    '2e01f5f5889e33d003bec7857cd38445': 'Value field',
    '959c27193eb0a41d01f4b53dcc4b9245': 'It is the field that corresponds to the value.',
    '82a61b32c76fba3dc83e2611624e93ec': 'Time box',
    'c54993eb4c2a46263cca2e6bdebb051d': 'Hour, minute, and second input',
    'c166d8f9804ecef74b3b74190599a7b8': 'To select the date range, you can set the minimum and maximum dates through <code>minDate</code> and <code>maxDate</code>.',
    '479728c411bac59bc44d5ab8dc3cb4f0': 'Tree Select',
    '15ac5d800c0163b4b806622739478e9b': 'You can select it in the tree structure. You can configure the option through <code>options</code> and can also fetch options through the <code>source</code>.',
    ...
    'ec2fb7a5db150690b14b63f83d9d4b30': 'Be triggered when the remote request from the lazy loading interface is successful',
    'e6b94af26512b3f7ea8eb1433d4a2aaa': 'deferApi The data returned after the lazy loading remote request is successful',
    ...
    '210bc6834481c05ed90875d87a262ed5': 'Whether the child node is automatically selected when the parent is selected',
    'b39c6fb1cdf629d3f3032d6c7d4694a8': 'Whether the value contains a sub-node.',
    '1fa482fed3042cac9f96c6f43c13f84a': 'Whether the value contains a child node only.',
    ...
    '32a750b4fd61f1cfe37cac7147f05b3c': 'To select the year range, you can set the minimum and maximum dates through <code>minDate</code> and <code>maxDate</code>.',
    '973b69af999dbdf4fa124df8c928ca6e': 'Read-only mode',
    '710ad08b11419332713360d2750cd707': 'Disable',
    '7abf78a41095c6d21a1cc89b4a876233': 'Delete form item value when it is hidden',
    'cd8992b644e6c18367861a4d913fd116': 'Verify',
    '1040279cf7b8dbdb842f597c30095f62': 'Check API',
    '133886b10fd9721e6cf91b76f2df5b6e': 'Separately check the API of this form item',
    'b95c6e14a4d8f6a6c6d99d583916f327': 'Merged into one row',
    'd22dfe420e4b00e000b93f94db3c856e': 'Select List',
    '5e391af52da238f13c78b471a7cc54f3': 'You can select a single list of multiple lists. This feature allows you to fetch options by <code>source</code>. You can configure images for the options and also customize the <code>HTML</code> configuration.',
    ...
    'a269e7de6c7735290733eb3e574c2129': 'Get Baidu Map AK from the <a href="http://lbsyun.baidu.com/" target="_blank">Baidu Map Open Platform</a>',
    'b472ba224a7d132c487ee6ec4798f835': 'Coordinate format',
    '36443b53c845b197db8d39eeda433ab9': 'Baidu coordinate',
    'f58cb611aec0998a44ef104b5c950b40': 'Coordinate format by State Bureau of Surveying and Mapping',
    '076a041dcf45a36b29c5cdb8b8eca922': 'Rectangular Switch',
    '183aae5eec1ff547833dc338aaeffc9a': 'You can configure row single-select and column single-select, and single-select or multi-select for all options. ',
    ...
    '10d1cfb7219a5445ef1e70aa16e4451d': 'It applies to sub-items contained in the option. You can fetch options through <code>source</code>. It supports the selection of multiple options.',
    ...
    '601bb29fe72e56930dea03ae3e1aa555': 'The text appeared when no result exists during retrieval',
    'e3be7b8a459a08fec8f378a0660b642b': 'Multi-select',
    '6a7f7d89c8f1f3e6aab0962ff920b145': 'Parent option as a return value',
    'c23eb92d1f249452c3ff3ee13738b47a': 'With this feature enabled, you can select the parent option but cannot select all child options. Also, the parent option is used as the return value.',
    '8fcbfdc1a9403f6339d81911473806da': 'Picker',
    '819776e8d96b1438eca3594f47bdb1c6': 'Through the <code>pickerSchema</code>, you can configure the data source available to select the data you need. It supports the selection of multiple data sources.',
    ...
    '0861915dbac25ccb573b3bb72ffeebd7': 'It allows you to get the variable using <code>\\${xxx}</code> or write the template logic using lodash.template syntax. <a target="_blank" href="/amis/zh-CN/docs/concepts/template">Details</a>',
    'c2c23b4fc7f695c58e947ad413f2c5d8': 'Checkbox type',
    '33e6c41fed95c25e3b426d596d504579': 'Drawer type popout',
    '5a7af8d3e471d98339c84b07a844547b': 'You can configure the options through <code>options</code> and can fetch the options through the <code>source</code>.',
    '1e890599eec94efccec337cd474f7f1b': 'The first option is selected by default.',
    ...
    '8a0c1f35cff334fc105b6d52b195369d': 'It supports the selection of multiple options and can give an input prompt. You can get the options using the <code>source</code>. ',
    ...
    'e19c0792886a147d74fc662d7af138bb': 'Display the selected value in a single row',
    'b28aa9c36d0b506a71aa78b628e796c6': 'Number of labels displayed',
    '2b23767de575e27fc9e4e0949e885f81': 'Maximum number of labels displayed. The floating layers are folded in case of exceeding the maximum number. All labels are displayed by default.',
    'dfac151de712ab0b3618072c8a7f0a0f': 'Advanced',
    '406af2b98e6210cd42d7f824cb6dfd16': 'Option value check',
    'fa8d03e8b5458c1a1d742736bc26e25b': 'With this feature enabled, the option text becomes red when the option value does not match the option among the current options.',
    '33e7b7433fdbeafa1ef71105ee28c061': 'Static',
    'c99e0a675933de39693b7e80d5b70405': 'It is purely used to display data. Also, it can be used to display <code>json, date, image, and progress</code> data.',
    ...
    '2d2eb2ac28f074d1caef0d332d61cfb0': 'With this feature enabled, the modification is submitted immediately. Instead, the modifications cannot be submitted in batch after they are marked.',
    'eccba4475f3144e417e55fd96e831e09': 'API for immediate saving',
    'c8e5c062d5ad38e54413abd9c7cfb2f4': 'Whether to separately configure an API for immediate saving. If no API is configured for immediate saving, quickSaveItemApi is used by default. ',
    ...
    '622e14515c4fd5ca6fe6946e3a1bfb4a': 'It defaults to the current field value and can be customized.',
    ...
    'ddccb436305b0a984c77d4ffa0725375': 'Be triggered when the switch value changes',
    ...
    '48433deca382e67b26af31c6ff967d04': 'The default selected value is true and the default unselected value is false.',
    ...
    'd202bc660c4d2eeb58e194b6320bd235': 'Be triggered when the tab change-over takes place',
    ...
    '91f894b900f593c848e5b21f2b414b05': 'Modify currently selected tab and select other options',
    ...
    '2af7e3952d7430d1e4c86ea5aca4e4fa': 'It allows you to enter characters in a newline.',
    '5bc28acd4afb712dcbc234927357cd87': 'Be triggered when the input box value changes',
    'cd7f479dd052edc1261261c15fb0b50f': 'Remove blank space at start and end positions',
    'd3a8fe0d542476cf7989ef9e69cdd6f7': 'With this feature enabled, you cannot enter blank space at start and end positions.',
    ...
    '1b09b6621ebf0d10ce98f0178fa1bda1': 'Trigger the component data update. Several values are separated with “,”.',
    ...
    '26aa42c81825364d2d691261017b6797': 'Click the input box to pop out the tree select-box for your selection.',
    ...
    '8784005bbfb2b66592cc0c5cc0a62f2d': 'Be triggered when you submit the edit option',
    '25a4d7b5ce2585aada1205e1121e9967': 'Edited option information',
    '91a6d3a760184e581eccd52bfa3f7a18': 'Delete node',
    '3c72d934764bb7205f593903c63ac7ec': 'Be triggered when you submit the deletion option',
    '7768e7d47fa6e9b811d1a1f684703cfb': 'Deleted option information',
    'cfd5faa079bd9d7092e7cdc92f353c30': 'Autocomplete interface',
    'a9f97c7c1bec32a0912f1dd36b2c3b90': "After each new content is input, the interface will be called and the update options will be returned according to the interface. The current user input value is in ` \\ ${term} '< Code > please do not set it at the same time as the access option interface</ code>",
    ...
    '43e1548e15272e1007051d7c8b70adf6': 'Automatically generate UUID in the UUID v4 format without the need to configure it',
    ...
    '69a519f6b7fd6d0bebba72e7572ea1d6': 'It is used to implement the left and right typesetting layout. It defaults to even distribution. You can configure the width of a column through columnClassName.',
    'f9c91bffab8b1202cf32ab508879e805': 'Fixed width <br />w-xs',
    '8c187c1862900db487c8d47e19490fac': 'Automatic fill-up',
    'b6f2fcb279241fe5ff9a8052a444266a': '< span class = label label default > column ${index | plus}</span>',
    'cb2f68c9c24e85d21e6b090b6e5657d8': 'Column',
    '92e2c6523449dfad4350f58908260266': 'Press and hold the right block of the highlighted box and then drag it to adjust the width ',
    '129b16a89a82c6d5e03ab075633b3892': 'Column CSS class name',
    'd34cc10492e80595a901a292d0c16bb8': 'You can add a width class style to adjust the width. By default, the width is equally distributed.',
    ...
    '713315591970d7c8b49d1c732fe54fde': 'It can be used to embed the current page.',
    '8f1c078c6d42759e6ccb1a9bf35f1629': 'Page address',
    '51ad722113289f70b6d77c78ddf0c64a': 'The default width is the parent container width. The value is expressed in px by default or in percent, e.g., 100%.',
    'c78d9b9ab9db5951eb5526e8a46677d9': 'The default height is the container height. The value is expressed in px by default or in percent, e.g., 100%.',
    '9ef4425332e5f8bcad86de483b4faedf': 'IFrame page ({{@1}})',
    '67997ccf7ea846c3c2d278b01ed9600b': 'Image display',
    '6dcf991e992a0b765df0933411fe9bb2': 'It can be used to display an image. It supports the static setting of the image address. Also, you can configure the association of the <code>name</code> with the variable.',
    ...
    '1193e1aab7bea094279ae7b4288ba848': 'If a field name is bound, you do not need to set it. Also, it supports the variable.',
    'f5865bf2d791d293374af4aa76d27c4d': 'The image displayed when no data is available',
    'e1110b854bceeed0e887cb951bb3d2f3': 'Enable image enlargement feature',
    '7ffade593e390a2a2cc43e6663461b71': 'Original image address',
    '214953c5f7557b1a5f1310c87238ee03': 'If it is not configured, use the thumbnail address by default.',
    ...
    '2d4247be13246794180897b40fcdbcb1': 'e.g., \\${listVar}. It is used to associate the data existed in the application domain.',
    ...
    '6dfe63d8c039df37787c87afe4c68604': 'You can use it to display the text address.',
    '6ab20dc4b64021b85886ad9c12b6e0cc': 'Destination address',
    '78ce29fdc55e6d0980b591a264c537a8': 'It allows you to fetch the variable. If a field name is bound, you do not need to set it.',
    '5d809212900f3bc3ba122fe93638394d': 'When it is left blank, automatically use the destination address value.',
    ...
    'e35dbea2b0c097d7fb76173da0e0bba1': 'HTML &lt;a&gt; the target property of the element. This attribute specifies where to display the linked resource.',
    '9f556fb46ecef854282d17e631578b1c': 'It displays a list. It allows you to customize the title and sub-title, content, and button group. You need to configure a data source for the current component. This component does not have the data fetch feature. You need to take the priority to use the “CRUD” component.',
    ...
    '3ed7b428165499a1b91ed1eb287ba343': 'It supports the following template syntax: ${xxx}',
    '456d29ef8bafd5202547e50d3e64d4ea': 'Log',
    'd06f8476d115020496058363a32bc40b': 'It is used to display logs in real time.',
    'a2bc1edd7be9348e5a998feb0886c55d': 'Log data source',
    'ddeeaa33ae62ead1a77a859fb79b78d7': 'It displays the mapping of the current values. For example, if the original value is 1, 2, or 3..., it is required to display offline, online, expiration, and so on.',
    '844318bd1d58ba0bf7dabbb771174b12': '<span class="label label-info">I/span>',
    '2fccd71275cdf5d6c0c677ef79dd84a0': '<span class="label label-success">II</span>',
    '198a96c4cfc64d5feba81b3f931f8289': '<span class="label label-danger">III</span>',
    '626a0f2fdf13bcadf11581006ab9eba3': '<span class="label label-warning">IV</span>',
    'ce3fd44456123f571e9d083b98da9fcb': '<span class="label label-info"> V/span>',
    '8b139ce9fa196b602bb1ee3bd25b25df': 'Mapping table',
    'a9de5901385d644363cd056482be7517': '<p>When the value hits the left Key, it displays the right conent. When the value does not hit the key, the key is the content of <code>*</code> by default</div>. Ensure that the key value is unique.',
    ...
    'f6a5891819c67a80c1179c7cdaa00935': 'It is used to render the nav menu and supports the landscape and portrait modes.',
    ...
    'f7a63e1e77fac1bfa05a060d55e27692': 'A configuration error exists in the menu, so you need to check it carefully.',
    '7fa141f341e173e2339dcf0ce6869b5c': 'Redirection address',
    '720fc47e20be9b7a2e67a4ed808b3bf2': 'Whether to highlight',
    'a6ed2640c41d0e3df4acb4f15d37f6e3': 'You can configure whether to highlight the menu. ',
    'dc55fd2e990771fd670743ca5dd59275': 'Automatically analyze the menu address when you leave it blank',
    '78b7cf23a2b93db1ec36e6c6cfe170db': 'Include sub-menu',
    '710b20ff1d85f7965bfaac44ae26344e': 'A configuration error exists in the sub-menu, so you need to check it carefully.',
    ...
    '9fc8c79aac0302a60ebc0777183cd181': 'If you want to set the menu address dynamically, enter the API address here.',
    ...
    '975903dc39691813530e108986e49ac1': 'Click to add a button in the left component panel',
    ...
    'b680997c50ca749acd4e6075cdca244e': '<p>You are right! You click it just now</p>',
    'c3c8422fcecd8c1cc922cba15ab5cbc0': 'Configure popout content',
    '262c7c7b9874ae5607fb51da468d0e8c': 'Configure content of drawer type popout ',
    ...
    'dfa07586a471e24b23fe68e11f5dc41a': 'Use JS expression, e.g., `this.xxx == 1`.',
    '47186f00df86d3edad3b5595ba8c2a0a': 'Whether canceling the popout interrupts the subsequent operation?',
    '4f21e04fe35d39c79e7779cdf2f4e232': 'Whether confirming the popout interrupts the subsequent operation?',
    ...
    '06b13b11740f7663af325bf5426930ba': 'Click to pop up this content. You can perform the corresponding operation after you confirm it. ',
    'fa9a0a79f29fef72e3060ea1af93c305': 'Refresh target component',
    '437d629f00e62cf99b3ad288f84ade46': 'Specify target component you want to refresh after you complete the current action. Support data transfer, such as <code>xxx?a=\\${a}&b=\\${b}</code>. Multiple targets are separated with a comma.',
    'b01f08bf5b9f8e3ef9d49e31d89bf770': 'Specify response component',
    'f667748a8e9717498da714d4e5087af2': 'Specify action executor. It defaults to the functional component where the current component resides. The action executor is specified in terms of the target component.',
    '80ddab8a52f74d707765501b0caae21f': 'Customize click event',
    'babbd439bc04241ed3536f892668c250': 'Transfer two parameters, i.e, event and props.',
    '867ade50f0bbb10bac65a5c3bc7895e9': 'Keyboard shortcut key',
    '45882ddedb42c1a38462949750bc8a84': 'Display a prompt icon. When your mouse hovers over the icon, the icon prompts the content.',
    'ff88d5db9d61f14bce6e3397fd4652a5': 'When no value is available, this prompt is displayed in place of the value.',
    '348097cc50579e489f0bcb5433637d3a': 'With this option enabled, you can sort them according to the current column sequence (backend sequence).',
    ...
    'b198805e7a6b35830ba813f51db2fdc4': 'Fixed column width. Setting the fixed column width is not recommended.',
    ...
    '49400a573b9f7a7bd693f84ec59379d7': 'Initialization data returned from the remote request',
    '5d758dc5e33ba0122c256d80c1572e88': 'Drop-down refresh',
    'd6fdfa4f989be6586a7a29ea85522f24': 'With the drop-down refresh enabled, it is triggered after you stop the drop-down action.',
    ...
    '685fae7809f86f9edee4338daaa212a0': 'A prompt icon will appear near the title, and the mouse will prompt the content.',
    'ac82acdf2f38faaf293c8690b2ea627f': 'Data initialization interface',
    '9d191f6126f21da8222755c14f49707b': 'Set the default prompt information of ajax. It is useful when ajax does not return the msg information. If ajax returns a msg value, ajax returns the value predominately.',
    ...
    '7cfb5e222a5954e891fba6e3802c7ea6': 'The paging component can display the paging of the list to improve the page performance.',
    ...
    '7c94d517ef4d6633144d5c719d0019d0': 'Select to render this item. You can drag and drop the sorting to adjust the display order',
    ...
    '2ee8eb6b1a80a4b025f97fca6afb800d': 'Display the maximum number of paging buttons. The minimum value is 5 and the maximum value is 20. ',
    'cd6f79e7bff1337c12c86a15ceedd6da': 'Panel',
    'e04a2f1662121e5a3c397d496114185b': 'Display a panel. You can configure the title and content area.',
    ...
    '6c5b1f0e8e361a801fa75da070d1cba5': 'It is used to display the pure text. The html label is escaped.',
    '67e77a196826a8880e47ad949ce08ac0': 'This a pure text.',
    'f8fc21a9fd40881e8fd3d7f15919465c': 'If the current field has a value, do not set it any more. Otherwise, the new set value overwrites the old one. It allows you to get the variable using <code>\\${xxx}</code> or write the template logic using lodash.template syntax. <a target="_blank" href="/amis/zh-CN/docs/concepts/template">Details</a>',
    '83077805e05ac6bedad69b47fca4462b': 'Progress display',
    'c77048def6e8a2d6c556a3fcc9c66730': 'Progress bar, progress',
    'b1aefb18d4bf96dc283a26d67abc41a8': 'It is used to display the progress. You can configure this option to display the progresses in different color.',
    ...
    '9cf66e7783e4c9b1d74bcd411edb6950': 'The value existed when the data field is not defined. The value does not include 0.',
    ...
    'c035fb9e67c0b566fd5d35889035424e': 'Allocate different value segments. Give a prompt to the user in a different color.',
    ...
    '7fa5c95b26550753b0931fa21cea5d10': 'The property is taken from the variable.',
    ...
    '1857d9050ac0527374f4324c0a5ad910': 'This option can be used to generate a QR code.',
    'e71377bb59c70af683be127ec49d01c7': 'QR code value',
    '57eda9139c0b3bc0605ed4cf303ffbd2': 'It allows you to use <code>\\${xxx}</code> to get the variable.',
    ...
    'd5e6d5c44426a82e18e31eadf7f1e09b': 'It is usually used to reset the form data to the initial value.',
    '6a06f12bdf3fc96df6cb45467b9a7c2c': 'Service',
    '9cc50da6bb17ea7ecf44c254c9b37619': 'The functional container can be used to load the data or the renderer configuration. The loaded data can be used in the container.',
    'c5a33208cf3deab68cd9fe34679edff6': 'The functional component is used to fetch the data.',
    ...
    'c8f0e77a9eb5de26e6ab62695d8494b6': 'Trigger schemaApi refresh and re-build Schema',
    ...
    '54f876a529283de5668426b2dc8adb15': 'Set the default prompt information of the service. It is useful when the service does not return the msg information. If the service returns and carries a msg value, the service’s return result value dominates.',
    ...
    '71ae1c76cc4160f8fb76e404e35ca08f': 'Whether to display the loading animation after you set the automatic timed refresh.',
    ...
    'bfdee34e14602e3113c88a9145843e86': 'Transfer two parameters, e.g., data and setData',
    ...
    '270301455c3de762a7e2b145dac7a8b4': 'It is used to embed and display simple charts',
    '44e13bdad8c7eb6391e84d940513b927': 'Status display',
    '82a3047196be368be13dcdd2373520ff': 'Display the status by using icons to associate fields. For example, display √ for 1 and x for 0. You can customize this block.',
    '774b2bcaca8a64f46c84b510cec89109': 'Icon configuration',
    'b698a95f1e217e5465835ee0d23b1b1c': 'Configure different value segments. Give a prompt to the user in a different style.',
    ...
    '74f0f6730053049f4c9beca2ab00c193': 'It is used to submit a form. The form verification is required. If it is in the popup, the popup is closed automatically.',
    ...
    '70567329ee851a5ba7e7301bd8e9d9a1': 'Column configuration event displayed currently',
    ...
    '5dc3017c21ae2e31ab127dbde8ec80e9': 'Enable table dragging and sorting feature',
    '25915fb58615ba9a5e145efa252fec30': 'Automatically merge cells',
    'd7d0936858fcdf4ffdb2899451ec74fc': 'Set number of columns',
    '80174cabf025dfe269aee5390b813708': 'Set the number of columns from left to right within which you can enable the feature of automatically merging cells. Thus, you can decide whether to merge cells according to whether their field values are the same.',
    ...
    '6fe0b71c07a5ce5f7a09f7fdb1d63827': 'It is enabled automatically when there are more than 5 columns.',
    '2206c0e11aa5f4f154aa9e5dfffcb474': 'Whether to fix the table header',
    '5006fdc5659989e42c3855c17c57f878': 'Whether to enable the bottom display of a single entry',
    '9db359f376a1a588ef7dcbef53cc114a': 'If there are too many columns, some columns can be displayed at the footer of the current row.',
    ...
    '1fe38acb67e766f7767d9f8e88bfe990': "It supports the template syntax, such as <%= data.id % 2 ? 'bg-success' : '' %>.",
    ...
    'a8b1273cb2d53ad858906ff9744a9891': 'The content group can be displayed in the form of tab to reduce the user cost.',
    ...
    'fcd3abb110aab48ebd0ac2a1d7040d6d': 'Modify the key of currently activated tab item of key',
    ...
    'b744b72fd649d904e561358fc26c455f': 'Pop up the prompt when you move the mouse to the tab. It can give a complete prompt when the title is too long.',
    '6e7fe62a865cb9ae90e52f85f4c6b8a0': 'Default tab',
    'a8986713e2b83c9ecafe5b107c09b68e': 'Display a tab by default. When you configure hash, use hash. Otherwise, you need to use an index value. It can get variables, such as <code>tab\\${id}</code> and <code>\\${id}</code>.',
    'acb839aac679bb34be9b4b49806b74a8': 'You can use <code>\\${xxx}</code> value. You can re-render the configured tab dynamically according to the data.',
    '5b9af1bc3012bb3c8e07b983b423ec17': 'Render the content during the activation.',
    '4bcecc15d16e8c851dc3d155b8f30929': 'The content rendering can be conducted to improve the rendering performance only when you activate the tab.',
    '12c6a62683d63e404d71a31c9cb5209c': 'Destroy content after being hidden',
    '5b52bcb62a2e1dab99ef841b05395b6d': 'When you destroy other option cards, destroy the current content. Thus, you can re-render the content when you activate the tab again. This applies to the scenarios for getting the data when the data container should be rendered every time.',
    ...
    '996a919888ae86e842c76245daae2360': 'After you set it, update the Hash of the address bar synchronously.',
    'f3051dd9b3538e170322fd5224b28de0': 'It can be rendered only during activation.',
    'ee51f2d49fa12c730d2a0efef0d67e44': 'Its content area cannot be rendered until you select the tab. Thus, it is possible to improve the rendering performance.',
    '024f24defb08c5c9d463a2668cbb9802': 'Destroy upon being hidden',
    '370bb4d6806c88a7df2ac17ca2a7b6a6': 'Disabling the tab leads to the destruction of its content area. By configuring the “Render only during activation” tab, it is possible to realize the re-load effect every time when you select it.',
    'f6724322c613ca164ea9a9d03e9055c9': 'Card {{@1}}',
    '8a471486c6c7bbe43e14392c6b127aea': 'Asynchronous Task',
    '4f58f808d62c4e31c347e483898396d5': 'It is used to show or perform asynchronous tasks.',
    '9ee043b0a77a26d22eec0f4ea99afbd3': 'hive task',
    '2c8a99d35cb5704994cabcc61a4c3a4a': 'View details<a target="_blank" href="http://www.baidu.com">Log</a>.',
    ...
    '093bcd735847b8464d683464165adbb8': 'You do not have to set it if the detection interface returns this information.',
    ...
    'b091a100499d48dd4ccf0b982aa37d68': 'Configure CSS class name of status label ',
    ...
    '33813749a95477897085e2435acc16b6': 'It is similar to a container. Multiple renderers can be put together. When the user puts the mouse over or clicks on the container, a floating layer for the text prompt is displayed.',
    '9b14c9051067bef2dd9a15683201dd18': 'Prompt text',
    'ab97cef55407efa11f79211e17cb2b4b': 'The default configuration is “Mouseover”.',
    ...
    '4583d3453c31cd3ff068c1358d8e7f1c': 'Click the area outside the container to close the prompt',
    '8e290c31bc0b4f76edbd58c3575b8420': 'Floating layer offset',
    '03c87fc8d49f865f0c2895d9ef3fe352': 'Prompt the offset of the floating layer position from the “Horizontal” and “Vertical” position.',
    '4e3e1e12e701890f4461808cc8f9d407': 'Can enter the floating layer',
    '9d6246f57f6924410b0c68f2172420f9': 'With this option enabled, the floating layer is closed after your mouse is over the prompt floating layer.',
    '90919000a708f8d66b7591e21b8e33f1': 'Display floating layer arrow',
    'ed81f127f3b2aaff73a4f4dd5968fdcb': 'With this option enabled, a prompt floating layer does not display the direction arrow. ',
    ...
    '65862c97143c6c5479e0c623093a25d6': 'It is used to display a text or paragraph. Also, it supports the template syntax which can be used associate the dynamic data.',
    '38accbc34901ee6fd7bd7cd9f92f0a2a': 'This is the current time of the template content <%- new Date() %>.',
    '590e147e49735ebbfc51ae2175c36eb0': 'Edit content',
    '47ae015d04dda362d066e4f9ac09d647': 'In the inlink mode, the <code>span</code> label packaged content is adopted by default. In the non-inlink mode, the <code>div</code> label is used as a container by default.',
    '7fcf42edf5817042904f4a122ff77582': 'Video',
    '1d5bbe0ab0d90a223c162fb375997a98': 'The video control can be used to play various types of video files, including flv and hls formats.',
    'f50bc38cf567e68250a8d15edfd8eb27': 'Video address',
    '733dda7842619a437b2486f6f71b0c10': 'You can write a static value and can also use variables, such as <code>\\${videoSrc}</code>.',
    'fb103fc64a0caeec24c707b9e7b50870': 'Video cover image address',
    '828f83110677bab8ef940f79f77b9049': 'You can write a static value and can also use variables, such as <code>\\${videoPoster}</code>.',
    '351cb1f8ffbcc9d2d4c1f35505e15864': 'Mute',
    'c7638cec349cb86eaeaeb983909fae0e': 'Live stream',
    '82f5f7bf3fb529360947cbb3b988037f': 'If it is a live stream, select it. Otherwise, it may not play normally.',
    ...
    '1fc7d723b3a82ce32bfbbfa0a1761969': 'For example, enter <code>\\${videoFrames}</code>. You can search for the videoFrames in the current application domain. If it is an object, a video screen-shot list is generated. After you click the list, click the screen-shot to redirect to the corresponding frame.',
    ...
    'c8c0339a6f9e105cfef45b76b788b635': 'The form wizard can split multiple complex form items into multiple steps. Then, it can guide the user to fill the items  step by step.',
    ...
    '33c627bce8015c50152941a5b6fada32': 'Be triggered when the final submission is successful',
    '574f27f7223c86545a7724d18da96651': 'Be triggered when the final submission fails',
    ...
    '357954d848a9e2f12208673b3906a972': 'Error information returned after submitting a single step fails',
    ...
    '832efcc5c30746b84b910cde8630d491': 'Submit the data of the current step data',
    ...
    '1fd41e410930ac58e748f7704c3a05f3': 'If the API returns the  <code>step</code> variable and the value is of digit type, e.g., <code>3</code>, redirect to Step 3 after the submission.',
    '938b484df1447d8f01f96e45125eb031': 'Whether it is open or not',
    '20022725ac2c53869f7af6646ca4ba29': 'An expression is used to decide whether the current step can be open by clicking it. Additional available variable: currentStep represents the current step.',
    'd4b8306441c00f01d4f044b3802c4266': 'Default start value',
    '37c0c041a0ad487d23c9f42c29f6d5e1': 'Get started from Step N? It supports a template. However, you can render the template and set the current number of steps only during the component creation. Then, the current step cannot change according to the startStep when the component is refreshed.',
    '076bd7c0adfc4f5d2abde6b309d9f53b': 'It is used to initialize the wizard data. When the <code>step</code> field is returned from the interface, it is possible to control the default redirection to the Step N. Note that the value must be of number type. When <code>submiting</code> is returned and an asynchronous save interface exists in the current step, the wizard can initially enter the asynchronous submission status.',
    'dbb19fea1965f7ef88cf1d1e0450c0f4': 'It is used to save the form data. In the last step, click Finish to trigger the saving. <code>If the save interface is already set in the last step, the setting here is invalid. </code>',
    ...
    'de5e232d10e2fa6218259289d4de4835': 'Similar to the container, the only difference is that there is a layer of padding by default.',
    '3954d7a9c047b7522ef92ddd5fc35852': 'Padding',
    '315dcc9412a4499cf846736fdbaaa72a': 'Child node',
    '5db7ca044a5179bf05428b283ac0452c': 'After you set the style, the size setting is invalid.',
    ...
    '91ee84292a5bf5e59d3b6309f948f2f1': 'An expression is used to set the sending conditions for the request.',
    '55409342e28d37db86fb23efbd84a025': 'The sending entity format is ',
    'e06a14abe7ef66a8ead143db4ae9786e': 'When a file exists in the sending content, the form-data format is used automatically.',
    '773a0e8384fd6f784088b829d7cc2f68': 'Whether to set the cache',
    'c1b110f13431df9662299f26def71df1': 'Set the valid time of the request cache, which is in ms.',
    'a18ea11244325dd3d20c5988bc7f6e39': 'Download file',
    '68caa6082eda1745aa3f6b6d12efe423': 'When the interface is for the binary file download, select it. Otherwise, the file shows unrecognizable codes.',
    '91831507074270c0da8a31ad9ff87495': 'Data replacement',
    '42be3061671b38468cc6ac84f6a0dd77': 'The default data is the append method. After being enabled, the current data is replaced completely.',
    '4e7c006f535b13b9737ac310bc34193a': 'Initial loading',
    '3c743b8b2d662421117a2fb1c445425d': 'When you configure the initialization interface, the component fetches the interface data initially. It can be modified according to the following configuration.',
    '713ec76479b992652ed39364d3d03870': 'For example, this.id represents the initial loading when an id value exists.',
    ...
    '620f826a77f079c5683a9d3c59461ea1': 'The timed refresh is always triggered once you set the timed refresh successfully. The refresh proceeds unless and until an expression is given and the conditions are satisfied.',
    '90260d55567cfd97ec2f085963a60bcf': 'HTTP configuration',
    '9ae7a582479116d4cb41e828fbd59798': 'Send data mapping',
    '0fcbf036057c6dd88b7b809daa0c5eb7': 'When the data mapping is not enabled, it send as much data as possible when the API is sent. If you want to control the data sent by yourself, or need additional data processing, enable this option.',
    '5414824fb8efdb7d59beae4bf95fdefd': '<p>When the data mapping is not enabled, the sent data is automatically cut into the whitelist mode. Thus, what is sent is determined by the configuration. Bind the data, e.g., <code>{"a": "\\${a}", "b": 2}</code></p><p>If you want to customize (???) based on the default(?????), add a Key as `&`. The Value is `\\$$` in the first row. </p><div>When the value is <code>__undefined</code>, it indicates that you need to delete the corresponding field. You can combine the <code>{"&": "\\$$"}</code> to achieve the blacklist effect. </div>',
    '7dd590a9d9e783e980d318bd52891905': 'Return the result mapping',
    '7e295b6ff39ec7356e06c4534bfc4fb3': 'If required to process the additional data for the return result, enable this option.',
    '417125a06b1d2bfff025e83a4e067bf0': 'Sending adapter',
    '62efcb25e5b21da47c09780119da3458': 'Function signature: (api) => api, The data is in api.data. After being revised, return the api object.',
    '6eb8944029108ad3b6bb3572a648fafa': 'Receiving adapter',
    'e83cbec70e17988749c4a02a3b73f55c': 'Function signature: (payload, response, api) => payload',
    'be47bd270e7756d4233e59bbe4cd5b96': 'Request header',
    '9e8c8bc795ad25fc992cee9d81a8c46d': 'You can configure the headers object and add a custom request header.',
    ...
    '81cdf47e8d8adfc70faac2cbc55e4067': 'Offset of corner mark relative to the “horizontal” and “vertical” positions',
    '7ba3812c61e01b3049404a46fac8deda': 'Customize corner mark size',
    '29e13ada94b145a1359291d5e1564655': 'Capping number',
    '42becf09dfd209746b66726e7d21d014': 'It takes effect when it is a number in the text content.',
    ...
    '7d92f998d24da41b58db140b1864f773': 'The current expression becomes exceptional. The loop reference exists.',
    ...
    'f4ab507e2fa2d2bd66bcdeafd9fef797': 'Keep consistent with the text by default',
    ...
    'c130bd5b55edefdaf8923269e9a52439': 'Each option is listed in a separate row. All items with non-repeated values are added as new options. <br/>You can set the label and value for each row using a space, respectively, e.g., "张三 zhangsan"',
    ...
    '9046ad86a1a47f16e954f2ec38fb680a': 'Because the level is too deep, it is recommended to use the [Get API] management option.',
    ...
    '256dbc5161ae393ec8a0e83ae6cf9469': 'Open popout. The popup supports the complicated interaction design.',
    ...
    '4abbdba4b6b06ce00702a255bd89c92c': 'After being selected, the service request is sent in silent mode. That is, no success or error prompt pops up.',
    'e3b49b5bbbdea05598525e91dbdfa638': 'Storage result',
    '4dca05af026848011eedee1b53efa61c': 'Enter variable name of storage request result',
    '4da82260041107e5780bcbb3a14ef791': 'If you need to perform multiple sending requests, you can modify this variable name to distinguish the results returned by different requests.',
    ...
    '1bd4cfded5e11a7a8ea4dcfd2fa17e15': 'Control the display and hide of the selected component',
    ...
    '5e75800641ec5c1198092bcf9d34f180': 'Control the enabling and disabling of the selected component',
    ...
    'be4b778e7f5aa6aa5a811d7db4e1a8b3': 'Request and re-load the data of the selected component',
    '694fc5efa9e1d1c2c5eb6525e1c7fb29': 'Refresh',
    'ea4d3723b350b2cb8f4c1a615e1b7df1': 'Set component data',
    'cb7add16ba6f0cd65d5ddcad71359813': 'Set the data of the data container or form item',
    ...
    '98d130cb9a360df782f6510abacbc022': 'Trigger the feature action of the selected component',
    ...
    '1b5a6299ef404c1f7b4292c290b80f55': 'Customize action logic through JavaScript',
    ...
    '9654916723a8d1d82f5ab9d2911edf93': 'Tip: After you add the following event action, the following event action should be done earlier than the old version action. It is recommended to you migrate it to the event action mechanism, helping you achieve the more flexible interaction design.',
    ...
    '4db5110d41293fef57f5a1f364187896': 'Go to add an event quickly and start you product.',
    '5baa9ac58c00a7fb818d4a113d3f8cff': 'The image upload address is not configured.',
    ...
    'f4882cbf65b232af449d7289354b9a16': '* The angle ranges from 0 to 360 degrees. 0 degree indicates that the angle changes gradually from the bottom to the top.',
    ...
    'dfc71567fb75f5c73da377013a223168': 'Leave a blank at the starting and end points',
    'eb5ec10ef70689996dd5cd66e17a64aa': 'Alignment at the starting and end points',
    ...
    'a0472043a9598b1b19f1adcec1e1d75d': 'An error exists in the interface configuration, so you need to check it carefully.',
    '2816c3584802b2fc75db5bc3c6aa81e8': 'Set valid time of request cache',
    '6e889f0cc8c1d8f705edfd5d0bbdaaa0': 'Select it and set Content-Disposition when the interface is used to download binary files.',
    '508a38f518821a0f6bb2d15269b31ece': 'The default data is the append method. After you enable this option, it is replaced completely.',
    '5c131eb3bc61f6b0a26e20449ad7ce56': 'Customize adapter',
    'f514cabe63553a850063834c9d44a5ee': 'You can get dynamic options through the interface and fetch all options once.',
    '47d0a7caaa2baee8d38612a1c57421ef': 'Whether to perform initial load',
    '866a60d7fbdfeba6ae42c7e9c7b03059': 'When you configure the initialization interface, the component fetches the interface data initially. It can be modified according to the following configuration.',
    ...
    'e2773277c7765d4590f7128423c58cee': 'After the title is hidden, the title width is 0 in the horizontal layout.',
    'cc572c07586f4ea0c5b9b1060eb777f2': 'Placeholder for empty content prompt',
    '8528426e54902956723f322bdbbcfafc': 'Input box prompt',
    'dc5dbe7a1b1ff5cae22ffbb636bc6380': 'It appears when the input box gets the focus. It is used to prompt the user’s input content.',
    'ff255db9b108589abd5c649e2a02e3f1': 'Control prompt',
    '9e783b34207fe24bc488136faba65442': 'Display the prompt beside the input control. Note that you need to set the control width. Otherwise, the prompt to trigger the icon leads to the automatic wrapping.',
    ...
    'dc46b7f19799047a26fee668d49be0f3': 'The option rendering template supports JSX and uses the variable \\${xx}.',
    'b18ec08df2e47313bcc93430e7a25fd3': 'It supports the JS expression, such as `this.xxx == 1`.',
    'b7dee01f2d085d90c47bcb8b490d9055': 'Click to select icon',
    '689fad203a167d542c12bdc46f27e921': 'Name',
    '6c1e18fd4cb57288a9f43603d5167292': 'It is required when you need to link it. Other components can be linked with the current component through this name.',
    'ae344073ea6ca9ce742899cdf6d3e106': 'Enter a letter or figure',
    '1a1ff1e1149a0cd1b39c0b231a334d04': 'You can specify to refresh the target component after the operation is complete. Enter the <code>name</code> property of the target component. Multiple components should be separated with <code>,</code>. If the target component is a form item, first enter the form name, and then connect the form item name with <code>.</code>, such as <code>xxForm.xxControl</code>. Additionally, you can refresh the whole page if you set the refresh target object to <code>window</code>. ',
    '705b3b333576dbf6c063d7060a4cc509': 'After the name is set, the completion of the current component operation will trigger the refresh of the target component (according to the set name).',
    '7080fa6e0ca1d7e24f6f8cac05077a3a': 'Which secondary CSS class names are available? Go to <a href="https://baidu.github.io/amis/docs/concepts/style" target="_blank">Style instructions</a>. In addition, you can add a custom class name, and then add a custom style in the system configuration.',
    '3bce1a6217990c8dc087d254f1fe754a': 'Automatic fill',
    'f01553e415ca33cc89d0bca84023f4b5': 'Automatically fill the value in a field of the currently-selected option into a form item in the form. The data mapping is supportive.',
    '04d815a5d4b803d6bb956d2da5a82688': 'Required',
    'a1b6281dc554ac84a3e6062f812fe50d': 'Light text description below the form item control',
    ...
    '495333d64fc1efafd6c40bc9a3929fee': 'Get the value according to the name when it is not set',
    ...
    'a80c61384a8459ef7bfb5082a2b54b5f': 'You must select the end level, but cannot select the middle level.',
    ...
    'd52e57147787797ae0153d43bf8be298': 'After this feature is enabled, the submitted data and displayed data are UTC-converted. Recommend you enable the applications that have cross-region users.',
    ...
    '34598b2c71a8affb13da84ba39e905d5': '12 equally-divided parts. The title width occupies n/12.',
    ...
    '51c1e80408011ba118cdcc696f28283d': 'Left and right distribution adjustment (n/12)',
    'aa0ff71cb10c3e54d68874dc2b17acaf': 'There are 12 equally-divided parts in total. You can set the left width equivalent to n/12.',
    '1f08c91da33fc5f0616e8a85c0456a18': 'The static data do not support multiple levels temporarily. Thus, you can switch to the code mode or use the source interface to get the data.',
    'cf763c357566be6fdaee886a40ddcca7': 'Option text',
    '1ca0b9b486be3b766a92474189f11fc8': 'Concatenation symbol',
    'ab8e2e8cd076bd115cdd600d17ca5020': 'Concatenate multiple values to a connector that consists of a string.',
    '6df0630b4f00b6bd05de8af09c2f78ad': 'Extract value only',
    'd7d810ec89408c206a220f62edde737f': 'After this option is enabled, the value of the selected option is encapsulated to an array. After this option is disabled, the data of the whole option is encapsulated to an array.',
    '4cff56e2b9703018efc48218b83844b1': 'Can create',
    '457c4cf8e1e2e0daef8949085555563f': 'The configuration event action can be inserted or intercept the default interaction.',
    ...
    '63bbd68594c9a987d0ff41d645fafa16': 'Whether the first option is selected by default.',
    '0dd2e4469872c176ab1e85b66d99da98': 'Hide path',
    'b7e26fcff328b28b393ef2e57e96e258': 'Hide the text information about the ancestor node of the selected node',
    ...
    'c17d9577233793976d3902c117eed82b': 'It is identical to the specified field value.',
    ...
    'fb73d98245f558dbb2d6a0c8d2699780': 'You can input letters, figures, `-`, and `_` only.',
    '923a91fdc2c777f8443c85278060195a': 'The format is incorrect. Enter the content that meets the rule of `$1`.',
    'd87b1a3d180a1cc56bbd174d2860ca4c': 'Enter more content which includes at least $1 character.',
    '9b8d6abb2f03fbcbdb0e4d2b1970a751': 'Control the content length and do not enter more than $1 character.',
    '2a5d0be4d5cd088f0371ba6f8656fe7a': 'Check it when the current input value exceeds the maximum value $1 ',
    '8256618e16217325e6a1d880f8eb7adb': 'Check it when the current input value is less than minimum value $1',
    ...
    'd7772d568894afbb1c924bed7f7ddb32': 'When the prompt conditions are not satisfied, you can customize it.',
    '58c9592f818d706420236c6f9f595517': 'Add prompt',
    '171f7b825707ddd79175fed3f8def6cd': 'The submission is done once the modification is complete',
    '6ccb7091c39a5229f7e77eff4dd44a0e': 'After you enable this option, trigger the submission once you make a modification every time',
    '1a006028adf7167ae28cdf532bb75ef4': 'Trigger check action',
    '8d877748c3bc71b517e2d46344916b3f': 'Trigger the check action once you make a modification every time after the submission',
    '2c60032f2a57717e4f7c16ee185795d6': 'Trigger the check once you make a modification',
    ...
    'a85ce2404b26140080c929ad9c3ec305': 'Enter more content which includes at least $1 character',
    ...
    '60011314ed92794f3d4f3e874c359279': 'After the default switch-over to a page and the search, the items selected by the user are cleared. After you enable this feature, the user’s selection is retained. Also, this feature allows you to achieve the cross-page batch actions.',
    '949a8b7bd2c10070a2fae16f9c66afbb': 'Column setting',
    '2816cea6c4887a53c417831deb5fbe00': 'Custom display column',
    'd3c5079f7e26b1a7374ff76341376de4': 'It is enabled automatically when the number of columns exceeds 10.',
    ...
    'd2e20bb1e977f9571a9e2d1b39a7ff10': 'The data is loaded to the browser once, so you do not make a request to load the data on the current page that is requested by the backend user. It is not recommended to enable this option because it has significant influence on the performance.',
    ...
    'c6bd3393c21379d3f75d179abe36da3d': 'Use specified conditions to accomplish list data query',
    ...
    'a0c35361a003527d123cb581f5c68f4b': 'This option is to realize the addition, deletion, change, and view of the data in the card list. It is used for data fetch, paging, single-entry operation, batch operation, sorting, quick edit, and other features. Also, it is integrated with the query conditions.',
    '860827796ce2fa94e9ee39e53f011ec0': 'This option is to realize the addition, deletion, change, and view of the data in the list. It is used for data fetching, paging, single operation, batch operation, sorting, quick edit, and other features. Also, it is integrated with the query conditions.',
    '629645f147f378869fe9d7ee2bbc2857': 'Sub-title content',
    '97d03d4621f0024cf045afbd901197a5': 'Select area',
    '44705bb94d83e7bd6b3b6c1480ebfb38': 'Click to trigger selected area or cancel selected area',
    ...
    'aeca6900b9e45f7f235eb9d443f0dd61': 'This option is used to hide the select-box. It is possible to achieve the selection style by customizing the appearance of the selection status.',
    ...
    'a955021cdf0249de1f3818f83cf248b7': 'It is used to display the custom display column button in the table. You can configure different display styles.',
    ...
    '73ac822ddf4685dbfec661dec41a96b7': '<div>\r\n<h2>hello, world!</h2>\r\n<div id="customBox">Custom container area</div>\r\n</div>',
    'f29ab26877ed22ffa59636d747d824b9': 'You can press the Esc key to close the popout.',
    'dcba76890a534e1fe94421be2a17b484': 'Display the error message at the bottom left corner.',
    'af5876b89583552eef4c781718886dec': 'Display the loading animation at the bottom left corner.',
    'f19464cd1d7c55610b84b4972eaf506f': '<div> With the data mapping enabled, the data in the popout only contains the set part. Then, you need to bind the data. For example:{"a": "${a}", "b": 2}. </div>',
    '784cf5219012b5f16f2985b7f1fd52f5': '<div>When the value is __undefined, it indicates that the corresponding field is deleted. You can combine {"&": "$$"} to achieve the blacklist effect. </div>',
    'af9f27383daeec508815a33753247f42': '${data["&"] ? "The parameter customization feature is already enabled. Thus, you can click to disable this feature." : "If you need to customize the parameters based on the default data, enable the parameter customization feature and then define the key and value."}',
    '9567f8bbb315b1217b7b32be37f97792': '${data[&] ? Disable immediately:  disable immediately}',
    'bde8a41fc64bfe78d0c4951ac6f93718': 'Display mask',
    '874cf31274d782914c7833cc39836c4e': 'You can drag the drawer to change its size.',
    '94397b87ac63fe238c779120fadab024': "It takes effect when it is at the 'left' or 'right' position. The default width is the width configured in the 'size' field. The value unit defaults to px. It also supports such units as percentage, e.g., 100%.",
    'a6d91e801974dfa735a4ae0e098c522a': "It takes effect when it is at the 'upper' or 'bottom' position. The default width is the height configured in the 'size' field. The value unit defaults to px. It also supports such units as percentage, e.g., 100%.",
    '45ce37c24c6e7252d98c6d450e3ca4ad': 'Title area',
    '660553eee939d2bd8ea68172fa7216df': 'Footer area',
    '1495c26f33625552e4845630b6b7b44a': '<div>Description of available variables</div><ul>\r\n                      <li><code>value</code>Current value</li>\r\n                      <li><code>level</code>The fetch level starts from <code>1</code>. </li>\r\n                      <li><code>parentId</code><code>value</code> selected at the previous layer</li>\r\n                      <li><code>parent</code>The option selected at the previous layer includes a <code>label</code> and <code>value</code>. </li>\r\n                  </ul>',
    ...
    'be7d848c40dfdd3e20f233c373af00a5': 'Select child node in a cascaded manner when you select a parent node.',
    '4c3ed2fc7331db687fc0e8ffb8f672a7': 'The child node can be selected inversely.',
    '0ae8c01434dc2a38a90561fcbf5d79b5': 'The child node can be selected inversely. The value includes the parent and child nodes. ',
    '22c023bf51970a461cc164e711f3d3ff': 'The value includes parent nodes.',
    '6e19e48a52986659ae5ba1bfe612ba8a': 'When you select the parent node, its value includes the value of the parent and child nodes. Otherwise, only the value of the parent node is retained.',
    'cccb3595f8ff536e27d94ec91a49bfdf': 'The value contains the sub-nodes only.',
    '49ccf100ac35e1cc3d40b7222cdcd1a7': 'Through the ui behavior, you can select the child nodes in a cascaded manner. The child node can be selected reversely. The value contains the value of the child node only.',
    ...
    'bc560e477282dafc3c37b7a665af4f9c': 'You can add a child node at the top layer',
    ...
    '68c7da9593da32100cb82ef5106047e1': 'After being enabled, the corresponding node value contains parent nodes.',
    ...
    '4444d03faa51f8550a8a4547fb471ab7': 'In the single-select condition, it can display the tree node select-box.',
    'd7eae84550f9b9bc0c78a94e4072ad0d': 'Customize unfolding levels',
    '346f7e0c7ef27b6a83f3c9f8f406d737': 'By default, unfold all node levels. With this option enabled, you can customize the number of unfolding levels.',
    ...
    'b3a17ee1af382c467d857d33089fc0c7': 'The left option rendering template supports JSX and uses the variable \\${xx}.',
    'd5dbf5285b2dbe07b481fbd5d4536c60': 'Right result panel',
    'b720b2abd62161c3c99625c8160df987': 'It follows the left option panel.',
    'acef03eee638dc4239ee60f627f33d85': 'Currently, the query feature allows you to perform fuzzy match query according to the name or value.',
    'e3ed623b79100791f156d3586751c652': 'It supports the sorting.',
    'd4865602e26e9c985814380beae99b6d': 'The result option rendering template supports JSX and uses the variable \\${xx}.',
    '0aa73cfbe5a84cd34a212de5bab2058d': 'The option text only displays the selected node.',
    '4dabfefd787102b8159b5c4a221aa048': 'Hide the text information about the ancestor node of the selected node in the select-box.',
    '0f993a54d2c67716220632577d3b5b51': 'Display the unfolding line of the level',
    '846da282ebfa6dfe61deb1d58145158c': 'Display the unfolding line of the tree level',
    ...
    '36bded76593f98fab62453c7430b2918': 'Means whether the sidebar content is fixed. The sidebar content does not roll together the content area.',
    '4143d7418de740e8bc26ef4b27c63534': 'It is used to get the API for initial data. The returned data can be used at the whole page level.',
    ...
    '41ed1e238b846005dfb0f087cbec644b': 'Select this option to indicate that it is enabled. You can drag and drop the features to adjust their sequence.',
    ...
    '88a364068f684dc77aca5b6c006ef576': 'When there are too much column content and the content exceeds the width limit, you can view the data in the landscape mode.',
    ...
    'aa2bd9f54608c0c85d3ceecb707938c9': 'The user can drag the column to adjust its width.',
    ...
    'f35c90b504521a2da346960b9db23828': 'When no value is available, this prompt is displayed in place of the value.',
    'ac83dbca40c9d2151b5f7d81795535cc': 'With this option enabled, you can sort it according to the current column sequence. For the interface types, you can increase sorting parameters.',
    ...
    'c115f372bcdced1e70824bcbf42b5923': 'With this feature enabled, the modification is submitted immediately. Instead, the modifications cannot be submitted in batch.',
    ...
    'ad96280bb24a38f9a83051b16ebc9688': 'Default display during the customization of columns',
    'eb58b078f2f8560160ebf87bc7109de9': 'Content exceeding line break',
    'f1f4c88f30744f2365b65f1790c71da8': 'Wrong component merging object. The panel is too old, it cannot be handled unless you add a panel.',
    ...
    'f80cc88446cc10da4838556666f6b9f1': 'You can configure the <code>headers</code> object, add the custom request header.',
    '005c50d1af6e833d6991ab882653b7ae': 'Due to failure to load the available field, please contact the administrator! ',
    ...
    'b51796f5778fdc31bac73769a85f89c7': 'The corresponding component is not found.',
    ...
    '1bf14fd24efe68f62bbff0538dee238a': 'Each option is listed in a separate row. All items with non-repeated values are added as new options. <br/>You can set the time and title for each row using spaces, respectively, e.g., "End-of-term makeup examination on June 23, 2022"',
    ...
    'd3e329f73ae4b58d95cc7769eeca8370': 'It takes effect when it is at the left or right position.',
    'fd179c2844536ce198290441c38c814e': '<span class=label label-default><% if (data.type === button-group) { %> Button group <% } else { %><%= data.label %><% if (data.icon) { %><i class=<%= data.icon %>/><% }%><% } %></span>',
    ...
    '1d20d90b7c7301b7739900242d38544e': 'No configuration. The title appears by default.',
    ...
    'fcb9b16d5d056bfbf6b6cba9dcf61efa': 'Refer to the format application in <a href="https://momentjs.com/" target="_blank">moment</a>.',
    '17a689143f0c7003123bb3c947d35273': 'The verification priority is higher than the maximum width.',
    '2aa41edf8cfa79e7e5fcf38c9742b495': 'The verification priority is higher than the maximum height.',
    '37ad5d98b12853d786b08cb52b91a43a': 'After enabling it, you need to set its height and width through the CSS class.',
    '324d0ccd6fa9d976d2f17de3bf0b70bd': 'Control the display size according to this value when the fixed size is enabled.',
    '7a377ac3904628fd73e7d33ce6130ae1': 'Minimum number of nodes selected for form validation',
    '674ddb63a7cd9e14a49813d52cf7e25e': 'Maximum number of nodes selected for form validation',
    ...
    'ff0d36eac9b9c029d91c365cd2c7e6cf': '${data[&] ? Disable immediately:  disable immediately}',
    'a718dcd3a16bee2a4086244ef1eb0ab4': 'Enter the content with a length of $1',
    'c323e3527a805cfdd264700fdf013daf': 'Control the content length and do not enter more than $1 character.',
    'c762cefa0ff423010af0a943c04d603b': 'Enter more content which includes at least $1 character',
    'b95aed5c6f2c8e49e23b382ac3d593ba': 'Check it when the current input value exceeds the maximum value $1',
    'fd11733fbabaf2ae3cf1fcd3fe385cc5': 'Check it when the current input value is less than minimum value $1',
    ...
    'd01886eeef1de19f2e99617017f4def8': "'The format is incorrect. Enter the content that meets the rule of \\$1\\ .'",
    '5e568c42a5ecb74db2dc3d8531079dd6': '<a target="_blank" href="https://www.tiny.cloud/docs/general-configuration-guide/basic-setup/">Reference documentation</a>',
    ...
    'd7bf42dd6e66f2818f9a232603c4a53b': 'When "Yes" is selected, the crud component will request the first page of data',
    ...
    '506f28f48dbebd5d19e19dfc721e13be': 'Control the input state/static state of the selected component',
    '0e35b091e18032508758899735664df7': 'Components switch to static',
    '34d361256526b04909e064c29d9a9b76': 'The component switches to the input state',
    ...
    'b62ce3df3c0d5772006c525b60d5eeab': 'The data defaults to the data field where the source component is located, you can select "Custom" to customize the required data',
    '0f9803bd27434940d4017007c105a861': 'When "Yes" is selected, and the target component is CRUD, the request be send with this data. Other target components send with this data just when the request api is POST method.',
    '81e1ff0bb8917a9df99d737982ee24b7': 'SubForm, configure a subform as the current form item',
    'a5c2dba5ccf62851b24cfa12d4958ce2': 'It can be used to display data and array type data, such as multiform of multiple',
    '74104c62ed33836f0bc74297539dd7c9': 'Configure options to realize selection options',
    'b5ade3d97d5b11bc784786111e011571': 'Tree structure, options can be configured through options, or options can be pulled through source',
    '2c05e451a6f2b2fe1cf55f7afb8c8423': 'Single or multiple choices, support the source pull option, which can be configured with pictures or customized HTML configuration',
    'c65c9862813c7a66c0df52e301e0e1d1': 'Applicable to options that contain sub items. You can pull options from source and support multiple choices',
    '8f650b58c8421edecfb380d6f60ef40e': 'Configure the data sources available for selection through pickerSchema to select the required data. Multiple selections are supported',
    'b7a4abc1e4e975c9df5bb9d9cf4823ba': 'Configure options through options, and pull options through source',
    'f2fc416c7d95a93a8da621f760be8417': 'Support multiple choices, input prompts, and use source to obtain options',
    'b4482a3d9523f48e83a816fa85911185': 'It is purely used to display data, such as json, date, image, progress, etc',
    'ecfd82eb65102274188011a502913d3a': 'Drawer data',
    '951f802ebd0c0d795fbae6767a5ee9b3': 'Initialize interface request succeeded',
    'da0126992b4937a5fd847ef5366b02e6': 'Data returned by initialization interface request successfully',
    '70b8342d743374233bfee0f56c7f0fc7': 'Node Sample Data',
    '38f85482d657cd4db1280c5efa1950fd': '{{@1}} Alignment',
    '0a0574baedb8eb2abf7daf25159d8bb1': 'Set the alignment of sub elements on the spindle',
    '5ccc4c05cd41195f202f550a4c307a64': 'Set the alignment of child elements on the cross axis',
    'b1b98c19058af70d8bd499e1899e93bc': 'Layout Container',
    '03097563d201ad3a29c79165226764e5': 'The layout container is a layout effect based on CSS Flex. It is more controllable than Grid and HBox for the location of child nodes, and easier to use than CSS classes',
    ...
    'cbc1d00cc640b67ee34a29a694ef162a': 'Left (upper) insert column level container',
    'bb3cc092e17ff83e943554bde3d5771b': 'Insert column level container on the right (lower) side',
    'b19b454fe603e03e98ad9772615c7c32': 'Positioning mode',
    '8444f01399c0003fbb68eeff1310566c': 'Specifies the positioning type of the current container element',
    ...
    '6e72759ed1cbf9f9e8523197dd93888f': 'Specifies the location of the current container element, which is used to configure top, right, bottom, and left.',
    '6896da744f8ae9633263d55af0fceae1': 'Hierarchy',
    '6f649980c839dffca1506f20d534fe3d': 'Specifies the stacking order of elements. Elements at higher levels will always be above elements at lower levels.',
    'a8489cf57d7f44e889aff79434776f47': 'The default is block level, which can be set to elastic layout mode (flex layout container)',
    ...
    '3fa460b81736c0360f6f7571801935b1': 'If the direction is set to horizontal arrangement, children are placed from left to right; If it is set to the vertical arrangement direction, the sub items will be set from top to bottom',
    'fa228d6bec96d052de0ad369407f5241': 'Horizontal (starting point is at the right end)',
    ...
    '947c03e411c20563c7ac67d0a5ad741b': 'After the elastic mode is set, the current area is automatically adapted',
    'f92626f9e56b3e2d0c47495a446acf71': 'Elastic width',
    'cf8852316501c22ea19c4e432c59e7d7': 'Default Width',
    '9cc69c8469b23b77519065d3df381113': 'Define the main size occupied by the project before allocating extra space',
    '0ad8b3b736ae5b9e23cf16ac13e1e283': 'Proportion setting',
    'fa6bb048a2f73975a40789b30c5b8a06': 'Defines the magnification of the project, which is 0 by default, that is, if there is any remaining space, it will not be magnified.',
    'c19b79073b676b9bade80613aba2dbfa': 'Fixed height',
    'd1b91a1a24f0d4935c2dd13e6a22b6d4': 'The maximum width is the maximum horizontal display area of the current element',
    'c2ed47a1f0f45cf7e2d22bddffc8a732': 'Scroll mode for setting horizontal direction',
    ...
    'ede82efb4a69c35743185c6c73ab771e': 'The minimum width is the smallest horizontal display area of the current element',
    '6f420734edfaff00a8210a4c762a9207': 'The maximum height is the display height with the most current elements',
    '411f9d120093314cd38e6dd5cce398c6': 'The minimum height is the smallest vertical display area of the current element',
    'b31c6aaa78f8e24df665ce80ab5301e2': 'Scroll mode for setting the vertical direction',
    ...
    '41a7494315a528f0f9618646f7e0dddf': 'It can be set as upper left corner, upper right corner, lower right corner and lower left corner. The default is lower right corner',
    '845c61ac8f51c6702dd22e5657c07e8d': 'Lower right corner (default)',
    '2794fe303cf8ad4395fe93271fae7925': 'Layout containers are mainly used to design container components with complex layouts. The layout effect implemented based on CSS Flex is more controllable than Grid and HBox for the location of child nodes, and easier to use than using CSS classes',
    'abbd790f85282349e2004df9fd494e31': 'Main size occupied by default before allocating extra space',
    ...
    '230d65546ea0d299907943403608233c': 'Common layout: classic layout (layout container based on CSS Flex implementation).',
    '9bbb7cfaeb34a2b5c095ac253355f028': 'Levitation vessel',
    'a3e91631c1a3a43e09526ea7f6b8595c': 'Common layout: suspended container (layout container based on CSS Flex implementation).',
    'd423930b823fc45f08c18922b19e4e9e': 'Bottom suction vessel',
    'b8b4eb373d8ba6f98271b681fba2511d': 'Common layout: bottom suction container (a layout container based on CSS Flex implementation).',
    'faaa6444a709917ff33e0d58948504dc': 'Ceiling container',
    '1facf0bd0f56c66759857345e7434443': 'Common layout: ceiling container (a layout container based on CSS Flex implementation).',
    'f416a3a2566dda04bc0ef67027e6f460': 'X axis rolling container',
    'e3d9ad8453925764f2918dbfd6ff824e': 'Common layout: x-axis rolling container (based on the layout container implemented by CSS Flex).',
    '053e0cbf18c8fe59b928d52fcd556b88': 'Y-axis rolling container',
    'c9f089cefc06c217c6dddfe2fc772ea3': 'Common layout: y-axis rolling container (a layout container based on CSS Flex implementation).',
    '3587540660a01f8a8aff6a2c0409a404': 'After the elastic mode is turned on, the current area is automatically adapted',
    ...
    '262cd2f688751332c1907a659e686210': 'Triggered when the legend is switched to the selected state',
    ...
    '8572d14f815d840bd9e940cd8ee4e380': 'Add or subtract data values through up and down arrow keys on the keyboard',
    '925d31bb30d63576600299475a910c33': 'Displayed before entering content, not included in data value',
    '42677544e2cbee28f7e7df216e685543': 'Displayed after input, not included in data value',
    ...
    '76ddcc0ad85aa4be6875b73244a64faf': 'Triggered when a component instance is created and inserted into the DOM',
    '584e4b6108e132be92c9de09d7bbed72': 'Current Data Domain',
    '9328b90ded33d16a873db5c0dbd815b8': 'Initial data interface request successful',
    'f3b97bd71a77cca1e9288089a537cf3b': 'Triggered on successful remote initialization data interface request',
    '9787088794f42c7e476cf7580f81447e': 'Initialize the data returned by a successful data interface request',
    '029e280e119b028bffc51424d909c07d': 'SelectedItems',
    'a6eebb9b4fc7148e2dc41335c74e6393': 'Initialization of Schema interface request successful',
    '887954cd9bdb290003984fe9a6eb99e2': 'Triggered when remote initialization Schema interface request is successful',
    '8f0064a9cfd7dcbb3c729f1357f11772': 'Send data',
    '6d33298a54888a30753373ca5bfe3bc2': 'Return Data',
    '542e06175ff4f7407c467bbde90de56a': 'Turn on this option if you need to do additional data processing on the data in the returned results',
    ...
    'f3dc08e3617d1e19cf8135be4412a80b': 'After clicking, ask the user first, and then execute the action after manual confirmation to avoid accidental touch. Values can be taken from data field variables.',
    'faa29265819714253843e23437b9193e': 'The prompt content under normal status. If it is not filled, no prompt will pop up. Values can be taken from data field variables.',
    'f855f46ce6146aa17a9ed423da16bfa2': 'Prompt content in disabled status. If it is not filled in, a normal prompt will pop up. Values can be taken from data field variables.',
    '037becbe8bff2f8838d141cc7b6b2df7': 'Support such relative value usage as:<code>now,+3 days, - 2weeks,+1hour,+2years</code>, etc. (minute | min | hour | day | week | month | year | weekday | second | millisecond)',
    ...
    '6b3c2a07db1bb3c229bbc5df48068792': 'Support such relative value usage as:<code>now,+3 days, - 2weeks,+1 hour,+2 years</code>(minute | hour | day | week | month | year | weekday | second | millisecond)',
    'dcc94ea1715bd502c709c5d5092e9c82': 'Support such relative value usage as:<code>3days, 2weeks, 1hour, 2years</code>(minute | hour | day | week | month | year | weekday | second | millisecond)',
    '13ce82d026daa5a30e50105bd2a204a6': 'Please enter a relative value',
    '31c29c46536a5007522032d2a42db56a': 'Numerical template',
    'a6a41d1bfb5896210eb527d183a07958': 'Value rendering template, which supports the use of JSX and data field variables. The default is ${value}%',
    'eadd1d64cd6ceb2c50554281cd2d3be0': 'Dynamically re render the configured tabs based on this data',
    ...
    'd6ecb32a380c91887a9346653c2427e9': 'Customized option rendering template, supporting the use of JSX and data field variables',
    'cb048b2d8426afd464dc01b72c446342': 'Block level (default)',
    '3b6e8d54b7b2ae890d5357b7eaaeaaf2': 'No line breaks (default)',
    '0611733b53e0098e6fd880bd44b2806f': 'The minimum height is the smallest vertical display area of the current element',
    '03bfb834c8a5fef58d885e448a4e13b4': 'Virtual List Threshold',
    '50437e080edc71ab624c93d419472919': 'When the number of options exceeds the threshold, the virtual list is opened to optimize performance',
    '02b9880e1d2df8a07e90e9878080c739': 'Option Height',
    'a3f66655c3d2bcfecc6afba0e4424460': 'Height of each option when virtual list is turned on',
    ...
    'eb7366583485f478e3d8c2b105ea51ff': 'Defines the magnification of the item. If it is set to 0, it will not be magnified even if there is space left in the parent container.',
    '5d3d48de1ba22368eacdc1c69fb044ce': 'Component inner layer CSS class name',
    '72c32b47c5e4dcd58ddabdb8fde761a0': 'Suspended container: a special layout container based on CSS Flex implementation.',
    'a03384e93b62e3110aa92c9e345111ba': 'Bottom suction container: a layout container based on CSS Flex.',
    'f564e3e66dd2aca0e080cb6484c95a5e': 'Ceiling container: a layout container based on CSS Flex.',
    'db805d4e361ac2d3fc6047eaea1a7c69': 'Free container',
    '9ccbfde404798593fa6fdeac9dbef200': 'Free container: its direct child elements support dragging to adjust the position.',
    'f20ca09e513399510ce34ba2cb05b7d9': 'X axis rolling container: a layout container based on CSS Flex implementation.',
    '47ef0cec2c3436377a42390e10de4567': 'Y-axis rolling container: a layout container based on CSS Flex.',
    '8c2bb89f516205027b9ed6609fb17726': 'Blocking condition',
    '46a3c6ab94da0b16a707bdd3b74c9e09': 'When the conditions are met, the execution of subsequent actions of the current event will be blocked',
    '6e6d4269d0dc3324d551062350a2ae9f': 'Silent request',
    '56e13c39822a814ab39b0d5a0867d7dc': 'When enabled, the service request will be sent in a silent mode, that is, no success or error message will pop up.',
    ...
    '7fe94616be0e8fb5ef5ab40a7397f0aa': 'After event anti duplication is enabled, only the last event will be executed when triggered multiple times within the anti duplication time',
    '91b72e901f1663637157cda638ac4dcc': 'Anti gravity time',
    '969e9e56b3812abffa3994f35ea31835': 'Adsorption vessel',
    'bb0e1fea25aafbe731886295fcef9a2e': 'Adsorption container: It can be set as a ceiling or ceiling display.',
    ...
    '1c5ea0ffb2b15713cb22c41a02576924': 'When rolling adsorption is enabled, the adsorption mode will be automatically enabled when rolling to the upper and lower edges of the parent container.',
    '5f9be0002394f0b58952969d5952e24c': 'Used to set the position of rolling adsorption',
    ...
    'c6a65a86cd2bd74a6f72df0a7b81d3cb': 'After the event is configured, the default verification, submission to the api or target and other behaviors will not be triggered when the form is submitted. All behaviors need to be configured by yourself',
    ...
    '052f93928af33d4d7035e7c8e8a73f17': 'The alignment is set by the margin value, where margin: 0 auto is used to set the center alignment',
    ...
    'defe851634125bb16e762f26dbb6555f': 'see https://www.tiny.cloud/docs/general-configuration-guide/basic-setup/ file',
    'df025e01cbbae804f7d720e6b932e8e8': 'Show menu bar',
    'b74c3bbb8ec4f18896cd3b5a20ee9e2c': 'Toolbar - Large Screen',
    'e08c3505f9779bf919628166a77d0d77': 'Screen width ≥ 1200px, reference document: https://froala.com/wysiwyg-editor/docs/options/',
    '04f91b84d48285162d3e29205a194143': 'Toolbar - middle screen',
    '9ac0e46a361565f0b8be2228bef4b679': 'Screen width ≥ 992px, if not configured, it will be consistent with the toolbar set for the large screen. Refer to the document: https://froala.com/wysiwyg-editor/docs/options/',
    '70d3894aaed305d2fc67f91122d77759': 'Toolbar - small screen',
    'a3133ac3b34da77e612bcb1763adae1e': 'Screen width ≥ 768px, if not configured, it is consistent with the toolbar set for large screen. Refer to the document: https://froala.com/wysiwyg-editor/docs/options/',
    ...
    '555a9859e2c34b015438bdfb59a57c5b': '${vendor==="tinymce"? "Editor": "edit area"}',
    ...
    '383c125a11b0dd070b04194b9e2e78fb': 'It takes effect when a single line of data is added or edited. When opening, after entering the content, you need to click the "Save" button on the right side of the form before submitting to the data field. If it is not enabled, the data field can be submitted after the content is entered.',
    ...
    '078f9734eeef4ff8c06e0b639ce6bd8f': 'If it is empty, no paging will be performed',
    '52029187eaa09f55193b6a15387e45ca': 'Minimum number of rows',
    '3d99d1f17ebf865877e681397c61dc9d': 'Maximum number of rows',
    'aa8b2a821e8e32196a720eaaa41b64d3': 'For performance, the default change of other form item values will not update the current table. Sometimes, in order to obtain other form item fields synchronously, you need to enable this.',
    '2aa56a9b94ee3fde76a15711c94fdabc': 'Whether the parent data, that is, the peer data in the form, can be accessed, usually needs to be used with the "Strict Mode" attribute.',
    ...
    '391299a1c1722a777991a182a44bccbf': 'The following states are supported by default and can be used without configuration. The custom state is merged with the default state.',
    ...
    '2464e9d13bfc84169eb8333b6996203c': 'Update the data value of the target component or variable',
    ...
    '3d4d83f05a12364e2522fcfb265d8ce8': 'When it is enabled, you need to click the "Save" button on the right side of the table to add or edit component data. When not enabled, add, edit and delete operations directly change component data.',
    'c18169dd6fceab2f023216fa6f7d22c1': 'Confirm button icon',
    '5720057e62e80f7a04489dc4c035b4f1': 'Cancel button icon',
    '8985ea173dce8f9bee667b3cdf0b7bdf': 'This configuration item only applies to the "Add" button in the table operation bar',
    ...
    '522cddc343d72db3db80cf3d71f99210': 'The API return format is incorrect. Please click the example on the right side of the interface address to view the CRUD data interface structure requirements',
    ...
    'c13998e4c837dc40b8e90828d99561df': 'If it is blank, editing is not supported',
    '738b58219dda4a849e293c0f75d06438': 'New button in operation bar',
    '306abb77f96a1048cf6e61bfe6e7bae4': 'If it is empty, no paging will be performed',
    ...
    'ee621e1f1429f1150a69bd02eecf6964': 'Trigger the folding and expansion of components',
    'e0e2b0cf2a3c8379b1d9144b10b3824d': 'Horizontal placement',
    '8dd27bbe64ec245ce449caab5cf7f12b': 'The default is inline mode. After opening, the submenu will not expand below the parent level, but will be displayed on the side of the menu',
    '154a7ec36c43427f73705ae834967703': 'Submenu floating display',
    '9dcb6b749d6682f1ac51b2dcdefd3208': 'Click the menu to expand only the current parent menu and collapse other expanded menus',
    '49a84da9b39148af54903ba4c6ed257f': 'Default expansion level',
    'd4b70ea3a756ec4d06c8ecb2f27330ab': 'Expand the corresponding level of all menus by default',
    '96198d14846a941a60824bd6ebda4d9e': 'Maximum display level',
    'cac013d011fe1ac71c3b9f0bd0594d65': 'After configuration, menu items beyond this level will be hidden. For example, if the maximum display level is two, three levels and below of menu items will be hidden',
    '7419d6bab78d959d5c3b7a38f9888258': 'menu item',
    '1a9aaf05889002e65708c4950012a652': 'Yes, you just clicked',
    '243e91d5fbc5a03a5c54da6d8e662e4f': 'Page renderer, the top entry of the page. It contains multiple regions. You can choose to place different renderers in different regions.',
    'a7999d1390b7dc775e4287511c395d6c': 'Corner type',
    '31175366279c15232e27b6736ccb2fd4': 'Only valid if the text content is numeric',
    '58f966670529f4753fb3c5a0647606be': 'size',
    'b3c1b71ed42c7f2fe55f3c64346f1ae6': 'The corner marker style is configured here. The corner marker takes effect after the corner marker content is configured in the menu item at the same time',
    '515e8b11c3c24c6c3b03c6c76b1da496': 'Default selected menu',
    '4f80ea1e761598ba9fe393e7c745468d': 'Priority is given to matching according to the URL of the current browser address bar, and the menu item you configured will be selected in case of miss',
    ...
    '22b47452f52254ce07507287d137d167': '<div>When data mapping is enabled, the data in the pop-up box will only contain the set part. Please bind the data. For example: {"a": " ${a}", "b": 2}</ div>',
    '68419387f5bb8487a848b818d78424ae': '<div>When the value is__ When undefined, it means to delete the corresponding field. You can combine {"&": " $$"} to achieve the blacklist effect</ div>',
    'cb65841ea7dec5ae0af20b3f5e52abfc': 'Raw data leveling',
    '6922790f45faf064e063069816e4d2ec': 'After opening, all the original data will be flattened and set in the data, and customized on this basis',
    '9791b05a4df9d72f1a01b81fa695fbc6': 'When the grouping names of multiple columns are consistent, the table will display the super header on the upper layer of the display header.<a href=“ https://baidu.github.io/amis/zh-CN/components/table#%E8%B6%85%E7%BA%A7%E8%A1%A8%E5%A4%B4 " target="_ Blank ">Example</a>',
    ...
    'f1ee660e12ef0b76c10cccc3d923e605': 'AK cannot be empty, please visit http://lbsyun.baidu.com/ Obtain Key (AK)',
    '4d01bb9f50eb1480e0e9995a2a003181': 'Please select<a href=“ http://lbsyun.baidu.com/ " target="_ Blank "class=" text sm ">Baidu Maps open platform</a>Get',
    'f1f7a5f821ca0ee4caaa9324eda48d91': 'Static Form Item',
    '4602761ee85e2e6e5360cd13fe642a08': '<p>The current component has stopped maintenance. It is recommended that you use the new feature of<a="/amis/zh CN/components/form/formitem #% E9% 85% 8D% E7% BD% AE% E9% 9D% 99% E6% 80% 81% E5% B1% 95% E7% A4% BA" target="_blank">static display</a>to achieve static display of form items</ p>',
    '6ca92e3386f9e392584367df5054c27c': 'Used to display an icon, you can configure different icon styles.',
    '47fd366b711a0567646854f541449f8b': 'For example:  ${listVar}, used to associate existing data in the scope',
    ...
    '83fe6a5db780fcfa68f3336c7d86f25b': 'Used to display a simple search box, usually used in conjunction with other components. For example, after configuring initApi on the page, it can be used to achieve simple data filtering and lookup, and name keywords will be passed as parameters to initApi on the page.',
    'bb50b53491c2c43845c58b16e48c27f3': 'Search box content',
    '68a896ef9627fea8cd84f3fa4f7269aa': 'Click Search',
    'a7be3c702997f49cf9429240fbbc5e36': 'Triggered when clicking on the search icon',
    ...
    '6d8e3115be41a8a5690d6fefa637dac7': 'The data returned by the interface needs to conform to the following format, with status, msg, and data as necessary fields',
    '09212e946a4d9b0f775700c46ef0dcd5': 'Returning 0 indicates that the current interface is returning correctly, otherwise it will be processed as an error request',
    '7391774e57425e5d8e83de64100b5f2e': 'Returns interface processing information, mainly used for displaying the toast when a form submission or request fails',
    'fa385c23820ee9999c82035086baa772': 'Must return an object with a key value structure',
    '6494bc042d99f2f5de34a858b8a699c6': 'Verification interface return format field description:',
    'e6246c03148f553e5d6a66adbdabb9f8': 'Returning 0 indicates successful verification, 422 indicates failed verification',
    'b8079b9d1e6d3e8a457787910a75cce4': 'When the return status is 422, the displayed verification failure message',
    'a59c65bea7d5065f19eb9c918a716c33': 'The modified API object must be returned.',
    '05fb5edb84e41c19b0f5429fff20b834': 'Return adapter',
    '98498eb59e87ec9a0eaf98ac55628da9': "The current request's response payload, which is response.data",
    ...
    'bc3f5a690d8c3a47d27ef8a1b127bafc': 'Hidden options cannot be set as default values',
    ...
    'f36616e35765ac3d5c9c7646e50a305d': 'Initialize data interface request completed',
    '48c43999cf3908d9f5100a6d5f0b4404': 'Triggered when the remote initialization data interface request is completed',
    ...
    'a556b5535b6b0e5925d59bbc54b58946': 'Initialize Schema interface request completed',
    '2cfbb19c3e801c5f4a11dafa1ec7884d': 'Triggered when the remote initialization of the Schema interface request is completed',
    ...
    '90a5608bcd85a3cfcfbb5263a229915c': 'Triggered when moving into the entire row',
    ...
    '85f1708454f409855d552f702ac27b19': 'The current data field can be used to read the corresponding value through the field name',
    ...
    '1b5cf3e354142cc1cdd6f56b6afaba49': 'The current form data can be read from the corresponding value through the field name',
    ...
    'bd749c7a75af1236325d8d669e9bc5fc': 'The tab activated during component initialization has higher priority than the activated tab and cannot respond to contextual data. When configuring the hash for the tab, use hash, otherwise use index values, and support obtaining variables, such as<code>tab  ${id}</code>,<code> ${id}</code>',
    '8b4de52c23ad472b9ece9e30d8750c48': 'Initial default activated tab',
    '7806807651c37e4467f9d2fc1c18eb2a': 'Active Tabs',
    '8a59e0a5705fea1751d77a97b7bf5d8d': 'By default, a certain tab is displayed, which can respond to contextual data. When configuring a hash for a tab, use hash. Otherwise, use index values, and support obtaining variables, such as<code>tab  ${id}</code>,<code> ${id}</code>',

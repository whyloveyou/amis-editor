...
import { Html, buildApi } from 'amis';
...
setSchemaTpl('api', function (patch) {
  ...
  var name = patch.name,
    ...
    patch.apiDesc;
    var rest = __rest(patch, ["name", "label", "value", "description", "sampleBuilder", "apiDesc"]);
  return __assign({
    type: 'container',
    body: [{
      type: 'checkbox',
      ...
      labelRemark: sampleBuilder ? {
        label: false,
        title: i18n("226c06861b0605a3276311b1369204f2"),
        icon: 'fas fa-code',
        className: 'm-l-xs ae-ApiSample-icon',
        tooltipClassName: 'ae-ApiSample-tooltip',
        children: function (data) {
          return React__default.createElement(Html, {
      ...
      option: i18n("1f318234cab713b51b5172d91770bc11"),
      name: name || 'api',
      mode: 'inline',
      ...
      className: 'm-b-none',
      messages: {
        validateFailed: i18n("a0472043a9598b1b19f1adcec1e1d75d")
      },
      pipeIn: function (value) {
      ...
      items: [{
        ...
        type: 'switch',
        label: i18n("dd10fdec63a2224aa3d28b48d428cb98"),
        name: 'data',
        ...
        tpl: i18n("0fcbf036057c6dd88b7b809daa0c5eb7")
      }, {
      ...
      // },
      {
        ...
        type: 'switch',
        label: i18n("6e6d4269d0dc3324d551062350a2ae9f"),
        name: 'silent',
        mode: 'inline',
        description: i18n("ddca9c0f0e3d07c3341701b80f139cc0")
      }, {
        type: 'switch',
        label: i18n("773a0e8384fd6f784088b829d7cc2f68"),
        name: 'cache',
        className: 'w-full m-b-xs',
        description: i18n("2816c3584802b2fc75db5bc3c6aa81e8"),
        pipeIn: function (value) {
          return !!value;
        },
        pipeOut: function (value) {
        ...
        description: i18n("6e889f0cc8c1d8f705edfd5d0bbdaaa0")
      }, {
        ...
        name: 'replaceData',
        description: i18n("508a38f518821a0f6bb2d15269b31ece")
      }, {
        type: 'switch',
        label: i18n("7dd590a9d9e783e980d318bd52891905"),
        name: 'responseData',
        className: 'w-full m-b-xs',
        pipeIn: function (value) {
          return !!value;
        ...
        inline: false,
        className: 'text-sm text-muted m-b',
        tpl: i18n("7e295b6ff39ec7356e06c4534bfc4fb3")
      }, {
        type: 'input-kv',
        syncDefaultValue: false,
        name: 'responseData',
        ...
        title: i18n("5c131eb3bc61f6b0a26e20449ad7ce56"),
        type: 'fieldSet',
        className: 'm-b-none',
        size: 'sm',
        collapsable: false,
        ...
        body: [{
          ...
          label: i18n("417125a06b1d2bfff025e83a4e067bf0"),
...
setSchemaTpl('source', function (patch) {
  ...
  return getSchemaTpl('api', __assign({
    name: 'source',
    label: i18n("1395eba8d9efe27aa1ecd1a45e3e5dcd"),
    description: i18n("f514cabe63553a850063834c9d44a5ee"),
...
setSchemaTpl('initFetch', function (overrides) {
  ...
  var label = get(overrides, 'label', i18n("47d0a7caaa2baee8d38612a1c57421ef"));
  return {
    type: 'group',
    label: tipedLabel(label, i18n("866a60d7fbdfeba6ae42c7e9c7b03059")),
    visibleOn: visibleOn,
    direction: 'vertical',
    body: [{
      name: fieldName,
      ...
      placeholder: i18n("713ec76479b992652ed39364d3d03870"),
      className: 'm-t-n-sm'
    })
    // {
    //   name: `${fieldName}On`,
...
setSchemaTpl('proxy', {
  type: 'switch',
  label: i18n("3f4f3acd6968f38361dddc6612a0c54f"),
  name: 'proxy',
  mode: 'horizontal',
  horizontal: {
    justify: true,
...
setSchemaTpl('interval', function (config) {
  return __assign({
    type: 'ae-switch-more',
    label: i18n("e5e3131aaf96b6dd10574bc9beeaf934"),
    name: 'interval',
    formType: 'extend',
    bulk: true,
    mode: 'normal',
    form: {
      body: __spreadArray([getSchemaTpl('withUnit', __assign({
        label: i18n("8df0f3891f8a80a392816f6ca662a33d"),
        name: 'interval',
        control: {
          type: 'input-number',
          name: 'interval',
        ...
        unit: i18n("21157cbff85802e353409f647f1f1f91")
      }, config && config.intervalConfig || {}))], __read(config && config.formItems || []), false)
    }
  }, config && config.switchMoreConfig || {});
});
setSchemaTpl('silentPolling', function () {
  return getSchemaTpl('switch', {
    label: tipedLabel(i18n("19c5410b23fba4bbfd1a58bbd5268c9b"), i18n("04f840b0772f4b5d59954a29a76f4e7b")),
    name: 'silentPolling',
...
setSchemaTpl('stopAutoRefreshWhen', function (extra) {
  ...
  return getSchemaTpl('valueFormula', __assign({
...
setSchemaTpl('actionApiControl', function (patch) {
  ...
  var name = patch.name,
    ...
    var description = patch.description,
    sampleBuilder = patch.sampleBuilder,
    rest = __rest(patch, ["name", "label", "value", "description", "sampleBuilder"]);
  return __assign({
    ...
    labelRemark: sampleBuilder ? {
      icon: '',
      label: i18n("1a63ac23010e0573f7c0a8cd3314b8c6"),
      title: i18n("226c06861b0605a3276311b1369204f2"),
      tooltipClassName: 'ae-ApiSample-tooltip',
      children: function (data) {
        return React__default.createElement(Html, {
...
setSchemaTpl('loadingConfig', function (patch, _a) {
  ...
  return __assign(__assign({
    ...
    options: [{
      label: i18n("6ade3082696deb00357f5c0359093cd4"),
      value: 1 /* LoadingOption.MERGE */
    }, {
      label: i18n("b6ac896eff6a6502e4ae7079b3e507a5"),
      value: 0 /* LoadingOption.HIDDEN */
    }, {
      label: i18n("0e9ffe1f1cf3f7a620970ea75dba9f39"),

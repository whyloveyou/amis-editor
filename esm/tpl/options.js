...
import { setSchemaTpl, getI18nEnabled, getSchemaTpl, tipedLabel, defaultValue, JSONPipeOut } from 'amis-editor-core';
...
setSchemaTpl('strictMode', {
  type: 'switch',
  label: i18n("98d52b737d6bc171b6d5bad9a42f6e23"),
  name: 'strictMode',
  value: false,
  mode: 'horizontal',
  horizontal: {
  ...
  labelRemark: {
    ...
    setting: true,
    title: '',
    content: i18n("fa66d1acaef7cd181f21f5fc2895becc")
  }
});
...
setSchemaTpl('createBtnLabel', {
  label: i18n("9e3790244299ed296601d79e0bf43a5c"),
  name: 'createBtnLabel',
  type: 'input-text',
  placeholder: i18n("65d76d0590aa6e05d61fe8db4c6a11ca")
});
...
setSchemaTpl('selectFirst', {
  type: 'switch',
  label: i18n("553333a72dec41b54e8ed18d49453a76"),
  name: 'selectFirst',
  mode: 'horizontal',
  horizontal: {
    justify: true,
  ...
  body: [getSchemaTpl('switch', {
    ...
    body: [getSchemaTpl('switch', {
      ...
      onChange: function (value, origin, item, form) {
        ...
        form.setValues({
          data: value ? __assign(__assign({}, data), {
            '&': '$$'
          }) : data && data['&'] === '$$' ? omit(data, '&') : data
        });
      }
    }), {
      type: 'input-kv',
...
setSchemaTpl('optionAddControl', function (params) {
  ...
  return getSchemaTpl('creatable', __assign(__assign({
    formType: 'extend',
    autoFocus: false,
    hiddenOnDefault: false
  }, controlSchema), {
    form: {
      body: __spreadArray(__spreadArray([], __read(replace ? customFormItems : __spreadArray(__spreadArray([], __read(customFormItems), false), [getSchemaTpl('createBtnLabel')], false)), false), [getSchemaTpl('addApi'), /** 用于关闭开关后清空相关配置 */
      {
        type: 'hidden',
        name: 'addDialog'
      }, {
        ...
        children: function (props) {
          ...
          /** 新增表单弹窗 */
          var scaffold = __assign(__assign({
            type: 'dialog',
            title: createBtnLabel || i18n("66ab5e9f24c8f46012a25c89919fb191").concat(optionLabel || i18n("ea15ae2b7fba76c83eec6d0986d15197"))
          }, addDialog), {
            body: {
              ...
              'controls': __spreadArray([], __read(value ? Array.isArray(value) ? value : [value] : [/** FIXME: 这里是没做任何配置时的默认 scaffold */
              {
                type: 'input-text',
                name: 'label',
                label: false,
                required: true,
                placeholder: i18n("06e2f88f428b7e26f7da3cd4d40ec2ed")
              }]), false)
            }
          });
          return React__default.createElement(Button, {
            ...
            onClick: function () {
              manager.openSubEditor({
                title: i18n("c630aa278a251b72bebf09284095112a"),
                value: scaffold,
                onChange: function (value, diff) {
                  ...
                  var addDialog = omit(pureSchema, ['type', 'body', 'id']);
          ...
          }, i18n("c630aa278a251b72bebf09284095112a"));
        }
      }
      // {
      //   label: '按钮位置',
...
setSchemaTpl('optionEditControl', function (params) {
  var _a = params || {},
    ...
    replace = _a.replace;
  var customFormItems = Array.isArray(collections) ? collections : [collections];
  return getSchemaTpl('editable', __assign(__assign({
    formType: 'extend',
    autoFocus: false,
    hiddenOnDefault: false
  }, controlSchema), {
    form: {
      body: __spreadArray(__spreadArray([], __read(replace ? customFormItems : __spreadArray([], __read(customFormItems), false)), false), [getSchemaTpl('editInitApi'), getSchemaTpl('editApi'), /** 用于关闭开关后清空相关配置 */
      {
        type: 'hidden',
        name: 'editDialog'
      }, {
        ...
        children: function (props) {
          ...
          var scaffold = __assign(__assign({
            type: 'dialog',
            title: i18n("cd994c38456676f5a55c5593b6a652bf")
          }, editDialog), {
            body: {
              /** 标识符，用于 SubEditor 确认后找到对应的 Schema */
          ...
          return React__default.createElement(Button, {
            ...
            onClick: function () {
              manager.openSubEditor({
                title: i18n("fba91204d335ae6eda35809023a94f7f"),
                value: scaffold,
                onChange: function (value, diff) {
                  var _a, _b, _c, _d, _e;
                  var pureSchema = JSONPipeOut(value, function (key, propValue) {
                  ...
                  var editDialog = omit(pureSchema, ['type', 'body', 'id']);
...
setSchemaTpl('optionDeleteControl', function (params) {
  var _a = params || {};
    ...
    replace = _a.replace;
  var customFormItems = Array.isArray(collections) ? collections : [collections];
  return getSchemaTpl('removable', __assign(__assign({
    formType: 'extend',
    autoFocus: false,
    hiddenOnDefault: false
  }, controlSchema), {
    form: {
      body: __spreadArray(__spreadArray([], __read(replace ? customFormItems : __spreadArray([], __read(customFormItems), false)), false), [getSchemaTpl('deleteApi')], false)
    }
  }));
});

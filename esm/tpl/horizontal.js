...
import { setSchemaTpl, tipedLabel, getSchemaTpl, defaultValue } from 'amis-editor-core';
...
setSchemaTpl('leftRate', {
  ...
  max: 11,
  step: 1,
  label: tipedLabel(i18n("150075376834f1879d6ceb7c2d10ec67"), i18n("34598b2c71a8affb13da84ba39e905d5")),
  pipeIn: function (v) {
    return v.left || 3;
  },
  pipeOut: function (v) {
...
setSchemaTpl('horizontal', function (config) {
  return [__assign({
    type: 'select',
    label: i18n("60e237a1b5e9a4cc3633898d527d5a38"),
    name: 'horizontal',
    options: [{
      label: i18n("2dde3029c4170a1c8e961a90766e0194"),
      value: 'formHorizontal'
    }, {
      label: i18n("ae6fa9e75d38b9db24f78496b72bcc75"),
      value: 'leftFixed'
    }, {
      label: i18n("150075376834f1879d6ceb7c2d10ec67"),
      value: 'leftRate'
    }],
    pipeIn: function (v) {
      if (!v) {
  ...
  }, isObject(config) ? config : {}), getSchemaTpl('layout:wrapper-contanier', {
    visibleOn: 'this.mode == "horizontal" && this.horizontal && this.label !== false',
    body: [getSchemaTpl('leftFixed'), getSchemaTpl('leftRate'), getSchemaTpl('labelAlign')]
  })];
});
setSchemaTpl('subFormItemMode', {
  label: i18n("424f04d454332ddaff4daa0a365e9335"),
  name: 'subFormMode',
  type: 'button-group-select',
  size: 'sm',
...
setSchemaTpl('subFormHorizontalMode', {
  type: 'switch',
  label: i18n("b17754a193ac835bcae0bf960f3a3772"),
  name: 'subFormHorizontal',
  onText: i18n("2dde3029c4170a1c8e961a90766e0194"),
  offText: i18n("f1d4ff50f3828f9b73412e7d94e6dd6e"),
...
setSchemaTpl('subFormHorizontal', {
  ...
  items: [{
    name: 'leftFixed',
    type: 'button-group-select',
    label: i18n("2e282fb6405a60830112991f88e95753"),
    size: 'xs',
    options: [{
      label: i18n("c41b3271487a3cc63e79feeb11b11de0"),
      value: ''
    }, {
      label: i18n("0fcf69b5d0b44955fcbec9702f90b556"),
      value: 'sm',
      ...
      label: i18n("0fa590019ace86acee8d7655e5fb11b7"),
      value: 'lg',
      visibleOn: 'this.leftFixed'
    }]
  }, {
    ...
    max: 11,
    step: 1,
    label: i18n("51c1e80408011ba118cdcc696f28283d"),
    labelRemark: {
      trigger: 'click',
      className: 'm-l-xs',
      rootClose: true,
      content: i18n("aa0ff71cb10c3e54d68874dc2b17acaf"),
      placement: 'left'
    }
  }]
});

...
var directionText = {
  'row': [i18n("413f48cc71f71083ce532a86e3efdc21"), i18n("fd8e9572cc6bf87653c4d8f8b8dd0db9"), i18n("2a6ad292447e6354ca39ee7f40d2fcc8"), i18n("d68c21b6b65e7a2e361762b65b8a5032")],
  'column': [i18n("2a6ad292447e6354ca39ee7f40d2fcc8"), i18n("d68c21b6b65e7a2e361762b65b8a5032"), i18n("413f48cc71f71083ce532a86e3efdc21"), i18n("fd8e9572cc6bf87653c4d8f8b8dd0db9")],
  'row-reverse': [i18n("fd8e9572cc6bf87653c4d8f8b8dd0db9"), i18n("413f48cc71f71083ce532a86e3efdc21"), i18n("2a6ad292447e6354ca39ee7f40d2fcc8"), i18n("d68c21b6b65e7a2e361762b65b8a5032")],
  'column-reverse': [i18n("d68c21b6b65e7a2e361762b65b8a5032"), i18n("2a6ad292447e6354ca39ee7f40d2fcc8"), i18n("413f48cc71f71083ce532a86e3efdc21"), i18n("fd8e9572cc6bf87653c4d8f8b8dd0db9")]
};
var scaleX = {
  'row': '',
  'column': 'scaleX-90',
...
var getFlexItem = function (props) {
  ...
  var directionItemOptions = [{
    label: i18n("ed33c46d1d69336bb011813e8352fa01"),
    value: 'row',
    icon: 'drow'
  }, {
    label: i18n("963e9ff4252cdef288063c41eb6d4998"),
    value: 'column',
    icon: 'dcolumn'
  }, {
  ...
  var justifyItemsOptions = [{
    ...
    label: isColumn ? i18n("4117e80d2c2e52f795ec64160f399364") : i18n("d365d58d281508b9982f6a0370649ae2"),
    value: 'center',
    icon: 'jCenter',
    iconClassName: scaleX[curDirection]
  }, {
    ...
    label: i18n("21af94c1abc5891b2703c9321417a1a9"),
    value: 'space-around',
    icon: 'jSpaceAround',
    iconClassName: scaleX[curDirection]
  }];
  ...
  var alignItemsOptions = [{
    ...
    label: isColumn ? i18n("d365d58d281508b9982f6a0370649ae2") : i18n("4117e80d2c2e52f795ec64160f399364"),
    value: 'center',
    icon: 'aCenter',
    iconClassName: scaleY[curDirection]
  }, {
    ...
    label: isColumn ? i18n("849b9b944a65eb0685f3e6af60a0c523") : i18n("cbac406a3f51abad691702015b0784ba"),
    value: 'stretch',
    icon: 'aStretch',
...
var FlexSettingControl = /** @class */function (_super) {
  ...
  FlexSettingControl.prototype.render = function () {
    ...
    }, i18n("98204720c30a843a9234bdf22dc05d51")), flexItems.map(function (item) {
      return React__default.createElement("div", {
        className: "ap-Flex-item ap-Flex-".concat(item.field),
        key: item.field
      }, React__default.createElement(ButtonGroupControl, __assign({}, rest, {

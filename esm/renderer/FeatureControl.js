...
import { Icon, Button, autobind, FormItem } from 'amis';
import { Checkbox } from 'amis-ui';
import { evalExpression } from 'amis-core';
import { GoConfigControl } from './GoConfigControl.js';
...
var FeatureControl = /** @class */function (_super) {
  ...
  FeatureControl.prototype.renderItem = function (item, index, checkable) {
    ...
    if (goFeatureComp) {
      content =
      // @ts-ignore
      React__default.createElement(GoConfigControl, {
        className: cx("".concat(klass, "Item-go")),
        label: item.label,
        manager: manager,
        compId: function () {
      ...
      content = React__default.createElement("div", {
        className: cx("".concat(klass, "Item-label"))
      }, item.label);
    }
    return React__default.createElement("li", {
      className: klass + 'Item',
      key: index
    }, checkable && onItemCheck && React__default.createElement(Checkbox, {
    ...
    }, sortable && React__default.createElement("a", {
      className: klass + 'Item-dragBar'
    }, React__default.createElement(Icon, {
      icon: "drag-bar",
      className: "icon"
    })), content), React__default.createElement(Button, {
  ...
  FeatureControl.prototype.renderAction = function () {
    ...
    return render('action', {
      ...
      closeOnClick: true,
      label: i18n("b58c7549c0246c55b9cac96383200338") || addText,
  ...
  FeatureControl.prototype.render = function () {
    ...
    return React__default.createElement("div", {
      className: cx('ae-FeatureControl', className)
    }, React__default.createElement("ul", {
      className: cx('ae-FeatureControl-features'),
      ref: this.dragRef
    }, this.state.inUseFeat.map(function (item, index) {
      return _this.renderItem(item, index, isCheckable);
    })), this.renderAction());
  };
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object, Number]), __metadata("design:returntype", void 0)], FeatureControl.prototype, "handleRemove", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], FeatureControl.prototype, "handleAdd", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], FeatureControl.prototype, "dragRef", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Boolean, Number]), __metadata("design:returntype", void 0)], FeatureControl.prototype, "handleCheck", null);
...
/** @class */(function (_super) {
  ...
  FeatureControlRenderer = __decorate([FormItem({
    type: 'ae-feature-control'
  })], FeatureControlRenderer);
  return FeatureControlRenderer;
})(FeatureControl);

export { FeatureControl as default };

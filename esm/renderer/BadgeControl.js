...
import { isObject, anyChanged, getI18nEnabled, defaultValue, tipedLabel, autobind } from 'amis-editor-core';
...
var BadgeControl = /** @class */function (_super) {
  ...
  BadgeControl.prototype.componentDidUpdate = function (prevProps) {
    ...
    if (anyChanged(['mode', 'text', 'size', 'offset', 'position', 'overflowCount', 'visibleOn', 'animation', 'style', 'level'], (_a = prevProps === null || prevProps === void 0 ? void 0 : prevProps.value) !== null && _a !== void 0 ? _a : {}, (_b = props === null || props === void 0 ? void 0 : props.value) !== null && _b !== void 0 ? _b : {})) {
      this.setState({
        checked: !!isObject(props === null || props === void 0 ? void 0 : props.value)
      });
    }
  ...
  BadgeControl.prototype.renderBody = function () {
    ...
    return render('badge-form', {
      ...
      body: [{
        ...
        label: i18n("cbc608353218e1d63e6f47c9db1eae64"),
        name: 'text',
        ...
        label: i18n("7ba3812c61e01b3049404a46fac8deda"),
        name: 'size',
        type: 'switch',
        mode: 'row',
        ...
        label: tipedLabel(i18n("29e13ada94b145a1359291d5e1564655"), i18n("42becf09dfd209746b66726e7d21d014")),
        name: 'overflowCount',
        type: 'input-number',
        size: 'sm',
        mode: 'row',
        ...
        label: i18n("b599979e9a40823363451aeaadc0723f"),
        name: 'animation',
        type: 'switch',
        mode: 'row',
        inputClassName: 'inline-flex justify-between flex-row-reverse'
  ...
  BadgeControl.prototype.render = function () {
    ...
    return React__default.createElement("div", {
      ...
      className: cx('ae-BadgeControl-switch')
    }, React__default.createElement("label", {
      className: cx("".concat(classPrefix, "Form-label"), labelClassName)
    }, label || i18n("b8c467fce096a649583c0bc9d9281a5c")), React__default.createElement(Switch, {
      value: checked,

...
import { Icon, render, FormItem } from 'amis';
import { getI18nEnabled, getSchemaTpl, autobind } from 'amis-editor-core';
...
var TimelineItemControl = /** @class */function (_super) {
  ...
  TimelineItemControl.prototype.renderOption = function (props) {
    ...
    return React__default.createElement("li", {
      ...
      value: time,
      placeholder: i18n("72a3c1690dead6e24f7ac1abc90d5063"),
      clearable: false,
  ...
  TimelineItemControl.prototype.render = function () {
    ...
    }))) : null, source === 'variable' ? render$1('variable', getSchemaTpl('sourceBindControl', {
      label: false,
      className: 'ae-ExtendMore'
    }), {
      onChange: this.handleAPIChange
...
export { TimelineItemControl as default };

...
import { NumberInput, FormItem } from 'amis';
...
var PartsSourceOptions = [{
  label: i18n("5b4ffa2eadaf629b833b37a3e8742b2c"),
  value: PartsSourceEnum.NO_BLOCK
}, {
  label: i18n("3569877e498155b59ef5299870c43f80"),
  value: PartsSourceEnum.AVERAGE
}, {
  label: i18n("15e1fdd9d5cc4dc595fba0eee0719cba"),
...
var MarksSourceOptions = [{
  label: i18n("56d37871117270ce5d157a8de90dacd6"),
...
var PartsControl = /** @class */function (_super) {
  ...
  PartsControl.prototype.renderHeader = function () {
    ...
    }, i18n("6903085e7f31286560e4a2e160beac42")), React__default.createElement("div", {
  ...
  PartsControl.prototype.renderContent = function (source) {
    ...
    if (source === PartsSourceEnum.AVERAGE) {
      return React__default.createElement("div", {
        ...
        className: cx("".concat(classPrefix, "Form-label"), "".concat(classPrefix, "Form-itemColumn--4"))
      }, i18n("7145575ab9e3b4529eea61fe5fe76d0e")), React__default.createElement("div", {
        className: cx("".concat(classPrefix, "Form-value"))
...
var MarksControl = /** @class */function (_super) {
  ...
  MarksControl.prototype.renderHeader = function () {
    ...
    return React__default.createElement("div", {
      ...
      className: cx("".concat(classPrefix, "Form-label"), "".concat(classPrefix, "Form-itemColumn--4"))
    }, i18n("dc4c91dfaa3b760147bd92e648560af4")), React__default.createElement("div", {
      className: cx("".concat(classPrefix, "Form-value"))
    }, render('header', {
      type: 'select',
      name: 'optionSourceList',
...
export { MarksControl, PartsControl };

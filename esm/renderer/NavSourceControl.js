...
import { toast, Icon, Button, FormItem } from 'amis';
...
var NavSourceControl = /** @class */function (_super) {
  ...
  NavSourceControl.prototype.handleDelete = function (index) {
    ...
    return new Promise(function (resolve) {
      ...
      var deleteItemParent = parentPathArr.length > 0 ? get(links, "".concat(parentPath, ".children"), []) : links;
  ...
  NavSourceControl.prototype.handleSubmit = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        if (!modalName) {
          toast.error(i18n("404f38ae7ac36860c0b3af6f2f4a13f9"));
          return [2 /*return*/];
        }

        if (isEdit && currentIndex === modalParent) {
          toast.error(i18n("822be91778b5ac22d31681f7256b849b"));
          return [2 /*return*/];
        }
  ...
  NavSourceControl.prototype.renderHeader = function () {
    ...
    var optionSourceList = [{
      label: i18n("088b54ee8f10a43977afa9d16ea5350f"),
      value: 'custom'
    }, {
  ...
  NavSourceControl.prototype.renderNav = function (dataSource, index) {
    var _this = this;
    var render = this.props.render;
    return React__default.createElement(React__default.Fragment, null, dataSource.map(function (nav, i) {
      return React__default.createElement("div", {
      ...
      }, nav.label)), React__default.createElement("div", {
        className: "nav-links-item-actions"
      }, React__default.createElement(TooltipWrapper, {
        tooltip: i18n("95b351c86267f3aedf89520959bce689"),
        placement: "left"
      }, React__default.createElement(Icon, {
        icon: "edit",
        ...
        tooltip: i18n("2f4aaddde33c9b93c36fd2503f3d122b"),
        placement: "left"
      }, React__default.createElement(Icon, {
        icon: "delete-btn",
      ...
      })))), nav.children && nav.children.length > 0 && React__default.createElement("div", {
  ...
  NavSourceControl.prototype.renderDialog = function () {
    ...
    return render({
      type: 'dialog',
      title: isEdit ? i18n("cd1e63aed43df0827cc09fb26521936c") : i18n("648c5e847b923bdd51bf5c72436169ba"),
      ...
      body: {
        ...
        body: [{
          type: 'input-text',
          label: i18n("8ee9f276a6356aab65f8178c4f30fabd"),
          name: 'modalName',
          placeholder: i18n("4cd5629f32fc9710fbb0291b51adc34b"),
          mode: 'horizontal',
          required: true,
          horizontal: {
            justify: true,
          ...
          type: 'tree-select',
          label: i18n("e3cc5bd7fc92d7287a14bf5398c4ecc3"),
          name: 'modalParent',
          initiallyOpen: false,
          placeholder: i18n("24ceb2a06b1962b396b75286fc0960d1"),
          searchable: true,
          multiple: false,
          valueField: 'id',
          options: treeData,
          ...
          name: 'modalIcon',
          label: i18n("9483042d09dbad731addc1791b5d207d"),
          mode: 'horizontal',
          horizontal: {
            justify: true,
            left: 2
          ...
          placeholder: i18n("6107b3c4fd8587589210cb9fe2fcdad9"),
          mode: 'horizontal',
          name: 'modalUrl',
          horizontal: {
            justify: true,
          ...
          type: 'radios',
          name: 'modalTarget',
          label: i18n("76b5162d1b7a16b4b6adf1b79231c96a"),
          inline: true,
          options: [{
            label: i18n("b2d1bffc689e4478519d8a010450192c"),
            value: '_self'
          }, {
            label: i18n("80fb2db8d3f212b3dd130d24da1c970e"),
            value: '_blank'
          }],
          mode: 'horizontal',
          horizontal: {
          ...
          type: 'input-text',
          label: i18n("70b4d0676f9a9640c5a7b1d5f66faa64"),
          placeholder: i18n("9f3cdf6aa12759fab68a5a88179462c4"),
          mode: 'horizontal',
          name: 'modalBadge',
          horizontal: {
            justify: true,
  ...
  NavSourceControl.prototype.render = function () {
    ...
    return React__default.createElement("div", {
      ...
      ref: this.dragRef
    }, this.renderNav(links)) : React__default.createElement("div", {
    ...
    }, i18n("14794add5446201274dd148086bc0361")))) : this.renderApiPanel(), showDialog && this.renderDialog());
  };
  ...
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "dragRef", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "handleDragging", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [String]), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "getNodePath", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Boolean]), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "destroyDragging", null);
  ...
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [String]), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "handleUpdate", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", []), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "getChildren", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", []), __metadata("design:returntype", Promise)], NavSourceControl.prototype, "handleSubmit", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Array, String]), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "handleSetNavId", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "handleDeleteNavId", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Array]), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "handleFilterTreeData", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", []), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "openModal", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", []), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "closeModal", null);
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], NavSourceControl.prototype, "handleChange", null);

...
import { PickerContainer, Spinner, Input } from 'amis-ui';
import { getEnv } from 'mobx-state-tree';
import { isApiOutdated, normalizeApi, isEffectiveApi } from 'amis-core';
import { anyChanged, createObject, tipedLabel, isObject, getSchemaTpl, autobind } from 'amis-editor-core';
...
var APIControl = /** @class */function (_super) {
      ...
      body: [{
        ...
        tabs: [{
          ...
          tab: [{
            ...
            body: [{
              type: 'switch',
              label: tipedLabel(i18n("6e6d4269d0dc3324d551062350a2ae9f"), i18n("ddca9c0f0e3d07c3341701b80f139cc0")),
              name: 'silent',
              mode: 'horizontal'
            }]
          }, {
  ...
  APIControl.prototype.render = function () {
    ...
    }) : React__default.createElement(React__default.Fragment, null, !renderLabel && this.renderHeader(), React__default.createElement("div", {

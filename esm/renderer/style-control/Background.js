...
var Background = function (props) {
  ...
  function onChange(key) {
    return function (e) {
      ...
      onChange(__assign(__assign({}, omit(value, ['backgroundColor', 'backgroundImage', 'backgroundPosition', 'backgroundSize', 'backgroundRepeat', 'angle', 'gradientNext', 'gradientPrev'])), result));
    };
  }
  // 获取渐变颜色
  ...
  function clearValues() {
    var value = props.value,
      onChange = props.onChange;
    var result = __assign(__assign({}, value), {
      backgroundSize: '',
      backgroundPosition: '',
      backgroundColor: '',
      backgroundImage: ''
  ...
  function handleChange(key, keyValue) {
    ...
    if (key === 'backgroundColor') {
      result = __assign(__assign({}, omit(value, ['backgroundImage', 'backgroundPosition', 'backgroundSize', 'backgroundRepeat', 'angle'])), (_a = {}, _a[key] = keyValue, _a));
    } else if (key === 'angle') {
      keyValue = keyValue || 0;
      ...
      result = __assign(__assign({}, value), {
        backgroundImage: backgroundImage
      });
    } else {
      result = __assign(__assign({}, value), (_b = {}, _b[key] = keyValue, _b));
    }
    onChange(result);
  }
  ...
  return React__default.createElement("div", {
  ...
  }, currentItem === 'pure' && React__default.createElement("div", {
  ...
  })), currentItem === 'gradient' && React__default.createElement("div", {
    className: "ae-Background_setting"
  }, React__default.createElement("div", {
    ...
    type: 'input-color',
    label: i18n("7241f67ee4fa8e0adb5d602b5f9516df"),
    clearable: false,
    placeholder: i18n("9f1b854df133912bb46203e84f0594ee"),
    ...
    type: 'input-color',
    label: i18n("8ea65e3d4e52c871d1c58b1926380ab0"),
    clearable: false,
    placeholder: i18n("0c46a7f77a7247a9cc6d6e995c0ea8cb"),
    inputClassName: 'ae-Background-colorpicker',
    ...
    type: 'input-number',
    label: i18n("c7706039e8ad85969df13ce3458d199a"),
    mode: 'row',
    step: 10,
    min: 0,
    max: 360,
    value: getGradientAngle(),
    description: i18n("f4882cbf65b232af449d7289354b9a16")
  }, {
    onChange: function (value) {
      return handleChange('angle', value);
    }
  }))), currentItem === 'image' && React__default.createElement("div", {
    className: "ae-Background_setting"
  }, render('image', {
    type: 'group',
    mode: 'horizontal',
    body: [getSchemaTpl('backgroundImageUrl', {
      name: 'backgroundImage',
      placeholder: i18n("5b9ea77bb6ce2d6c82e97b120d757201"),
      fixedSize: true,
      value: getbgValue(),
      ...
      type: '',
      label: i18n("61a87a021904dc65995e99d4c476cb21"),
    ...
    type: 'select',
    label: i18n("737391648d1216a1f84ac9ff52da5aa2"),
    name: 'backgroundSize',
    mode: 'horizontal',
    placeholder: i18n("737391648d1216a1f84ac9ff52da5aa2"),
    value: getbsValue(),
    options: [{
      label: i18n("18c63459a2c069022c7790430f761214"),
      value: 'auto'
    }, {
      label: i18n("0f1fd39145bad43e18f81337e0144c8c"),
      value: 'cover'
    }, {
      label: i18n("e0d76824dfe5e09c7068b44f605266d2"),
      value: 'contain'
    }, {
      label: i18n("e39d3b7a3600d9327221a637f910fc0b"),
      value: '100%'
    }, {
      label: i18n("e1ff2c83c09f2dc6cc74ae02ab6b8222"),
      value: 'auto repeat'
    }, {
      label: i18n("7ddd9dbf373f760acfd63778469b5c4b"),
      value: 'auto repeat-x'
    }, {
      label: i18n("4ab931e0f709f9b493e660156925a113"),
      value: 'auto repeat-y'
    }, {
      label: i18n("21f3929a4484e6e992af64ec1dd3a576"),
  ...
  })), currentItem === 'noset' && React__default.createElement("div", {
...
/** @class */(function (_super) {
  ...
  BackgroundRenderer.prototype.render = function () {
    return React__default.createElement(Background, __assign({}, this.props));
  };
  BackgroundRenderer = __decorate([FormItem({

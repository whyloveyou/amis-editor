...
import { isExpression, FormulaExec, InputBox, TooltipWrapper, ResultBox, Icon, Button, FormItem } from 'amis';
import { FormulaEditor } from 'amis-ui';
import FormulaPicker from './textarea-formula/FormulaPicker.js';
import { getVariables, JSONPipeOut, translateSchema, autobind } from 'amis-editor-core';
...
var FormulaControl = /** @class */function (_super) {
  ...
  FormulaControl.prototype.render = function () {
    ...
    var _c = this.props,
      ...
      rest = __rest(_c, ["className", "label", "value", "header", "placeholder", "simple", "rendererWrapper", "manager", "useExternalFormData", "customFormulaPicker", "clearable", "render"]);
    var _f = this.state,
    ...
    var highlightValue = isExpression(value) ? FormulaEditor.highlightValue(exprValue, variables) || {
      html: exprValue
    } : value;
    // 公式表达式弹窗内容过滤
    ...
    }, isLoop ? i18n("7d92f998d24da41b58db140b1864f773") : i18n("b5cc1cd60cd694f45142dc52a5bf53fc")), formulaPickerOpen ? React__default.createElement(FormulaPickerCmp, __assign({}, this.props, {
      value: filterValue,
      initable: true,
      header: header,
      variables: variables,
  ...
  __decorate([autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], FormulaControl.prototype, "getRendererSchemaFromProps", null);
...
export { FormulaDateType, FormulaControl as default, renderFormulaValue };

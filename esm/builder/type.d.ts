...
export interface FormScaffoldConfig<Fields extends Record<string, any> = ScaffoldField, API extends any = ApiConfig> extends ScaffoldConfigBase {
    /** Form功能场景 */
    feat?: DSFeatureType;
    /** 表单初始化接口 */
    initApi?: API;
...
export interface CRUDScaffoldConfig<Fields extends Record<string, any> = ScaffoldField, API extends any = ApiConfig> extends ScaffoldConfigBase {
    /** 工具栏 */
    tools?: Extract<DSFeatureType, 'Insert' | 'BulkDelete' | 'BulkEdit'>[];
    /** 数据操作 */
    operators?: Extract<DSFeatureType, 'View' | 'Edit' | 'Delete'>[];
    /** 条件查询 */
    filters?: Extract<DSFeatureType, 'FuzzyQuery' | 'SimpleQuery' | 'AdvancedQuery'>[];
    /** 表格 list 接口 */
    listApi?: API;
    viewApi?: API;
    editApi?: API;
...
export type ScaffoldConfig<Fields extends Record<string, any> = ScaffoldField, API extends any = ApiConfig> = FormScaffoldConfig<Fields, API> | CRUDScaffoldConfig<Fields, API>;

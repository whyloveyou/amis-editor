...
import { getSchemaTpl, LayoutBasePlugin } from 'amis-editor-core';
...
var defaultFlexContainerSchema = {
  type: 'flex',
  className: 'p-1',
  items: [defaultFlexColumnSchema(i18n("ef5abdfc944546ddcbe10e9884cf5832")), defaultFlexColumnSchema(i18n("874fdb7b3a5730910a4de1c58220c337")), defaultFlexColumnSchema(i18n("3a76596e73fa265257ce90b7bed684c7"))],
  style: {
    position: 'relative'
  }
};
var FlexPluginBase = /** @class */function (_super) {
  ...
  function FlexPluginBase() {
    ...
    _this.description = i18n("03097563d201ad3a29c79165226764e5");
    ...
    _this.panelTitle = i18n("b1b98c19058af70d8bd499e1899e93bc");
    ...
    _this.panelBodyCreator = function (context) {
      ...
      var positionTpl = [getSchemaTpl('layout:position', {
      ...
      return [getSchemaTpl('tabs', [{
        ...
        body: [getSchemaTpl('collapseGroup', [{
          ...
          body: __spreadArray(__spreadArray(__spreadArray(__spreadArray([isSorptionContainer ? getSchemaTpl('layout:sorption') : null], __read(isSorptionContainer ? [] : positionTpl), false), [getSchemaTpl('layout:flex-setting', {
            label: i18n("98204720c30a843a9234bdf22dc05d51"),
            direction: curRendererSchema.direction,
            justify: curRendererSchema.justify,
            alignItems: curRendererSchema.alignItems
          }), getSchemaTpl('layout:flex-wrap')], false), __read(isFlexItem ? [getSchemaTpl('layout:flex', {
          ...
          }), !isFlexItem ? getSchemaTpl('layout:margin-center') : null, getSchemaTpl('layout:z-index'), !isSorptionContainer && getSchemaTpl('layout:sticky', {
    ...
    _this.regions = [{
      key: 'items',
      label: i18n("a4611da51ffee9140976d01668e45d45")
    }];
    return _this;
  }
  FlexPluginBase.prototype.buildEditorToolbar = function (_a, toolbars) {
    ...
    var newColumnSchema = defaultFlexColumnSchema(i18n("e151c86d57096bb74dcd390ade29362b"));
    ...
    if (parent && (((_e = info.renderer) === null || _e === void 0 ? void 0 : _e.name) === 'flex' || ((_f = info.renderer) === null || _f === void 0 ? void 0 : _f.name) === 'container') && !draggableContainer && !(schema === null || schema === void 0 ? void 0 : schema.isFreeContainer)) {
      ...
      // 备注：如果是列级元素不需要显示
      if (!toolbarsTooltips[i18n("dbb93e8f413074ead24b6ed822247d98")] && !isFlexItem && canAppendSiblings) {
        toolbars.push({
          iconSvg: 'add-btn',
          tooltip: i18n("dbb93e8f413074ead24b6ed822247d98"),
          level: 'special',
          placement: 'right',
          ...
          iconSvg: 'add-btn',
          tooltip: i18n("5b5765b3fd7e72e04a5cd3e2ef6218a4"),
          level: 'special',
          placement: 'right',
      ...
      if (((_g = info.renderer) === null || _g === void 0 ? void 0 : _g.name) === 'flex') {
        if (!toolbarsTooltips[i18n("31f84d1bc6175fd0828a81b5bfd98736")]) {
          toolbars.push({
            iconSvg: 'add-btn',
            tooltip: i18n("31f84d1bc6175fd0828a81b5bfd98736"),
            level: 'special',
            placement: 'bottom',
    ...
    if (parent && (parent.type === 'flex' || parent.type === 'container') && isFlexItem && !draggableContainer && canAppendSiblings) {
      if (!toolbarsTooltips["".concat(isFlexColumnItem ? i18n("14c495b1248756310c75396cd41f4fe9") : i18n("39a2cb79c6d9762783e20522ea86dcff"), "\u63D2\u5165\u5217\u7EA7\u5BB9\u5668")]) {
        // 布局容器的列级元素 增加左右插入icon
        toolbars.push({
          iconSvg: 'add-btn',
          tooltip: "".concat(isFlexColumnItem ? i18n("14c495b1248756310c75396cd41f4fe9") : i18n("39a2cb79c6d9762783e20522ea86dcff"), "\u63D2\u5165\u5217\u7EA7\u5BB9\u5668"),
          level: 'special',
          placement: 'right',
          ...
          iconSvg: 'add-btn',
          tooltip: "".concat(isFlexColumnItem ? i18n("e33ac3a4c1a95a02a18f1555038804da") : i18n("de2a774bf98944b8f0ec8755d5f59d64"), "\u63D2\u5165\u5217\u7EA7\u5BB9\u5668"),
          level: 'special',

...
var StepsPlugin = /** @class */function (_super) {
  ...
  function StepsPlugin() {
    ...
    // 组件名称
    _this.name = i18n("87d88a457161f2a09f95f6aa29b38051");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-forward';
    _this.pluginIcon = 'steps-plugin';
    _this.description = i18n("aacb2b36c47395e4b4b409e351eb4279");
    ...
    _this.scaffold = {
      ...
      steps: [{
        ...
        description: i18n("3bdd08adab6ea90b9164b20a0e4151ac")
      }, {
        title: i18n("9757f2c59c17e9aea46e0c8adb69597e")
      }, {
        title: i18n("207e30c0e7318027d521dd7c6fab6a99")
      }]
    };
    ...
    _this.panelBody = [getSchemaTpl('tabs', [{
      ...
      body: [getSchemaTpl('layout:originPosition', {
        ...
        name: 'steps',
        label: i18n("b8a2d347bdb22fde367a851df8335771"),
        type: 'combo',
        scaffold: {
          type: 'wrapper',
          body: i18n("bc78248b34b7bf18691e6d385e0f544b")
        },
        minLength: 2,
        multiple: true,
        draggable: true,
        ...
        }), getSchemaTpl('stepSubTitle'), getSchemaTpl('stepDescription')]
      }), {
        name: 'value',
        type: 'input-text',
        label: i18n("59cecbff0cc77511590d2161cc3058e9"),
        description: i18n("c207ba29769aca6ffd45db9f80bcb29e")
      }, {
        name: 'status',
        type: 'select',
        label: i18n("6bf1f392c0a404d1f7558e6dcdd6c2e6"),
        creatable: true,
        value: 'finish',
        options: [{
          label: i18n("fb852fc6cce168301447d1baff276dc5"),
          value: 'process'
        }, {
          label: i18n("8797922788916874c39ee1524bbc3638"),
          value: 'wait'
        }, {
          label: i18n("769d88e425e03120b83ee4ed6b9d588e"),
          value: 'finish'
        }, {
          label: i18n("ad8e01fe719bf1a5af82ee0d100d246b"),
          value: 'error'
        }]
      }, getSchemaTpl('api', {
        name: 'source',
        label: i18n("d1f03ea8d9d3c3a241e8a340b8a384d3")
      })]
    }, {
      ...
      body: [{
        ...
        options: [{
          ...
          label: i18n("2a9a1329b191c2787b1a70c289e3bbe0"),
          value: 'vertical'
        }, {
          label: i18n("d517acb68fbed2331b57d1a11ca21dcc"),
          value: 'simple'
        }]

...
var LinkPlugin = /** @class */function (_super) {
  ...
  function LinkPlugin() {
    ...
    // 组件名称
    _this.name = i18n("bfe68d5844f8e54602760e18f45954f7");
    _this.isBaseComponent = true;
    _this.description = i18n("6dfe63d8c039df37787c87afe4c68604");
    ...
    _this.panelTitle = i18n("bfe68d5844f8e54602760e18f45954f7");
    ...
    _this.panelBody = [getSchemaTpl('tabs', [{
      ...
      body: getSchemaTpl('collapseGroup', [{
        ...
        body: [getSchemaTpl('layout:originPosition', {
          ...
          name: 'href',
          label: tipedLabel(i18n("6ab20dc4b64021b85886ad9c12b6e0cc"), i18n("78ce29fdc55e6d0980b591a264c537a8")),
          rendererSchema: {
            type: 'input-text'
          }
        }), {
          ...
          name: 'blank',
          label: i18n("88a5126f6a1463fc9986b590ee4ab99f")
        ...
        body: [{
          name: 'htmlTarget',
          type: 'input-text',
          label: tipedLabel(i18n("6be15e9949e4be7fc485e1eaae472942"), i18n("e35dbea2b0c097d7fb76173da0e0bba1"))
        }]
      }])])
    }, {

...
import { getSchemaTpl, getI18nEnabled, mapReactElement, VRenderer, RegionWrapper, jsonToJsonSchema, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var WizardPlugin = /** @class */function (_super) {
  ...
  function WizardPlugin() {
    ...
    _this.name = i18n("5acec91385a3b9093e3c803f6b0d869a");
    _this.isBaseComponent = true;
    _this.description = i18n("c8c0339a6f9e105cfef45b76b788b635");
    ...
    _this.actions = [{
      ...
      descDetail: function (info) {
        ...
        }, info === null || info === void 0 ? void 0 : info.__rendererLabel), i18n("832efcc5c30746b84b910cde8630d491"));
      }
    }, {
      actionType: 'prev',
      ...
      descDetail: function (info) {
        ...
        return React__default.createElement("div", null, React__default.createElement("span", {
          className: "variable-right"
        }, info === null || info === void 0 ? void 0 : info.__rendererLabel), i18n("d529f7d5ed8956cd890173b4b5045a67"), React__default.createElement("span", {
        ...
        return mapReactElement(dom, function (child) {
          if (/Wizard-step\b/.test(child.props.className)) {
            return React__default.createElement(VRenderer, {
              ...
              hostId: info.id,
              memberIndex: index,
              name: step.title || i18n("52b36576f88c31ed3971ca4d1fccd46f").concat(index + 1),
              id: id,
              draggable: false,

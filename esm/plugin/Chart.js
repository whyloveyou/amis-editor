...
import { getSchemaTpl, tipedLabel, defaultValue, diff, BasePlugin, registerEditorPlugin, CodeEditor } from 'amis-editor-core';
    ...
    _this.panelBodyCreator = function (context) {
      return [getSchemaTpl('tabs', [{
        ...
        body: [getSchemaTpl('collapseGroup', [{
          ...
          title: i18n("e7af71fb102cc86ab3be6a2fb32b5e3f"),
          body: [
          /*
          {
            type: 'select',
          ...
          */
          getSchemaTpl('apiControl', {
            label: tipedLabel(i18n("31f8a7a967286a16eb404e3ba237619e"), i18n("eabda74dd2ac5b4e6eab9229e0e63f79")),
            mode: 'normal'
            ...
            name: 'interval',
            label: tipedLabel(i18n("2af32ab13a9dece315cec2764d6aa7d4"), i18n("bc827aaffaa35a95607346cc104c0785")),
            type: 'input-number',
            step: 500,
            // visibleOn: 'chartDataType === "dataApi" && data.api',
            visibleOn: 'data.api.url',
            ...
            evalMode: false,
            label: tipedLabel(i18n("59688d1a484179aef8edc0ccbabb9fc1"), i18n("3fd81a573ea309b203ab019c1aa95a2c")),
          ...
          title: i18n("e732f4c0d8075670b6c75cc52bd1f7d5"),
          body: [{
            name: 'clickAction',
            asFormItem: true,
            label: false,
            children: function (_a) {
              ...
              }, i18n("43ddd80698198791d4a738bb20a2d7f4")), value ? React__default.createElement(Button, {
                size: "sm",
                level: "link",
                className: "m-l",
                onClick: function () {
              ...
              }, i18n("c8da43fe6ad1c537f86cecb353250145")) : null);
            }
          }]
        }, getSchemaTpl('status')])]
      }, {
        ...
        body: getSchemaTpl('collapseGroup', __spreadArray([{
          ...
          body: [getSchemaTpl('style:widthHeight', {
            ...
            heightSchema: {
              label: tipedLabel(i18n("c1df04eec5fa0857bc0df2d68d8e953c"), i18n("b3e991d11b9f0ee04f55627c62d4fcba")),

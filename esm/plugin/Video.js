...
import { mockValue, getSchemaTpl, JSONPipeOut, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var VideoPlugin = /** @class */function (_super) {
  ...
  function VideoPlugin() {
    ...
    // 组件名称
    _this.name = i18n("7fcf42edf5817042904f4a122ff77582");
    _this.isBaseComponent = true;
    _this.description = i18n("1d5bbe0ab0d90a223c162fb375997a98");
    ...
    _this.panelTitle = i18n("7fcf42edf5817042904f4a122ff77582");
    _this.panelBody = [getSchemaTpl('tabs', [{
      ...
      body: [getSchemaTpl('layout:originPosition', {
        ...
        description: i18n("733dda7842619a437b2486f6f71b0c10")
      }, {
        name: 'poster',
        type: 'input-text',
        label: i18n("fb103fc64a0caeec24c707b9e7b50870"),
        description: i18n("828f83110677bab8ef940f79f77b9049")
      }, getSchemaTpl('switch', {
        name: 'autoPlay',
        label: i18n("54c6bb48170611ec995f634319312156")
      }), getSchemaTpl('switch', {
        name: 'muted',
        label: i18n("351cb1f8ffbcc9d2d4c1f35505e15864")
      }), getSchemaTpl('switch', {
        name: 'isLive',
        label: i18n("c7638cec349cb86eaeaeb983909fae0e"),
        labelRemark: {
          className: 'm-l-xs',
          trigger: 'click',
          rootClose: true,
          placement: 'left',
          content: i18n("82f5f7bf3fb529360947cbb3b988037f")
        }
      })]
    }, {
      ...
      body: [{
        ...
        name: 'splitPoster',
        label: i18n("0d682d277649d8c7952d36f836619a44")
      ...
      body: [getSchemaTpl('ref'), {
        type: 'input-text',
        name: 'rates',
        label: i18n("ee1600dfbd6f9e86ca8761cf3fcf6a17"),
        multiple: true,
        joinValues: false,
        extractValue: true,
        ...
        name: 'frames',
        type: 'input-text',
        label: i18n("8e7124c3069460d4a8a04c3e3d9ce752"),
        description: i18n("1fc7d723b3a82ce32bfbbfa0a1761969")
      }]
    }])];
    return _this;
  }

...
import { getSchemaTpl, defaultValue, VRenderer, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
  ...
  function CardPlugin() {
    ...
    _this.panelBodyCreator = function (context) {
      return [getSchemaTpl('tabs', [{
        ...
        body: flatten([getSchemaTpl('layout:originPosition', {
          value: 'left-top'
        }), {
          children: React__default.createElement(Button, {
            ...
            onClick: function () {
              ...
              return _this.manager.showRendererPanel(i18n("fa966345577ba81af19408f203db968f"), i18n("0212e8c9b113143a031d1f3e25167794"));
            }
          }, i18n("f9f2b9cc91cd332db6b2b732c3869233"))
        }, {
          children: React__default.createElement("div", null, React__default.createElement(Button, {
            ...
            onClick: function () {
              ...
              return _this.manager.showRendererPanel(i18n("027446c2f9070b0f5b16a18208bf5fc7"), i18n("6312e80e416fa79ff3383e1577c243b8"));
            }
          }, i18n("a3cf7c9ee581ae71eb51d18b610b05b6")))
        }, {
          type: 'divider'
        }, getSchemaTpl('cardTitle'), getSchemaTpl('cardSubTitle'), {
          name: 'header.avatar',
          type: 'input-text',
          ...
          type: 'input-text',
          label: i18n("d85562778760b00b1372af642c4630e6"),
          description: i18n("4011e5fb23b422f755d81269a5242d22")
        }])
      }, {
        ...
        body: [{
          ...
          max: 10,
          step: 1,
          label: i18n("d4f223e0619836d03d488c89558f38e7")
        }, getSchemaTpl('className', {
          name: 'titleClassName',
          label: i18n("620868e5e60e5c22249c3277c971bb13")
        }), getSchemaTpl('className', {
          name: 'highlightClassName',
          label: i18n("1fee6fa022c97f5dd7f48e362cea5acf")
        }), getSchemaTpl('className', {
          name: 'subTitleClassName',
          label: i18n("2a3c7d647a29fb7dc5aedabac216575e")
        }), getSchemaTpl('className', {
          name: 'descClassName',
          label: i18n("0e627e6a0ff773ee76bc4cc0871cb48d")
        }), getSchemaTpl('className', {
          name: 'avatarClassName',
          label: i18n("a5680444d449b2099b067e9963fe43aa")
        }), getSchemaTpl('className', {
          name: 'imageClassName',
          label: i18n("b8e1e46cbdea20de4e5fc130d31b7bcc")
        }), getSchemaTpl('className', {
          name: 'bodyClassName',
          label: i18n("a31119cb2fddee3366163a311f317cf7")
        }), getSchemaTpl('className')]
      }, {

...
import { ContainerWrapper, getSchemaTpl, defaultValue, tipedLabel, jsonToJsonSchema, JSONPipeOut, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
    ...
    _this.panelBodyCreator = function (context) {
      return [getSchemaTpl('tabs', [{
        ...
        body: [getSchemaTpl('collapseGroup', __spreadArray([], __read(getSchemaTpl('theme:common', {
          ...
          baseTitle: i18n("6f99b6eed37795cb97d5f6370c32113b"),
          extra: [getSchemaTpl('theme:base', {
            classname: 'bodyControlClassName',
            title: i18n("4e74ff55b36a0f35d511a761c264fce3"),
            hiddenOn: 'data.regions && !data.regions.includes("body")'
          }), getSchemaTpl('theme:base', {
            classname: 'headerControlClassName',
            title: i18n("a67496c9ef1b1951fb9f104d1ef17997"),
            extra: [getSchemaTpl('theme:font', {
            ...
            title: i18n("af608093f1d3c25e85bdb4ed17f8b947"),
            hiddenOn: 'data.regions && !data.regions.includes("toolbar")'
          }), getSchemaTpl('theme:base', {
            classname: 'asideControlClassName',
            title: i18n("fa898e5ae4c0315061129c6cef47c326"),
            hiddenOn: 'data.regions && !data.regions.includes("aside")'
          })]
        })), false))]
      }, {

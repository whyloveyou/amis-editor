...
import { getEventControlConfig, getOldActionSchema } from '../renderer/event-control/helper.js';
...
var ButtonPlugin = /** @class */function (_super) {
  ...
  function ButtonPlugin() {
    ...
    _this.order = -400;
    // 组件名称
    _this.name = i18n("fa966345577ba81af19408f203db968f");
    _this.isBaseComponent = true;
    _this.description = i18n("89de611b2d759a1802542b5d3a06829f");
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('layout:originPosition', {
            ...
            name: 'close',
            label: i18n("5e64227f46b221001e3b151d72fa6412"),
            ...
            mode: 'normal',
            formType: 'extend',
            label: tipedLabel(i18n("1e7196ce05260faa55e5b7ea5a1667c2"), i18n("f3dc08e3617d1e19cf8135be4412a80b")),
            form: {
              body: [getSchemaTpl('textareaFormulaControl', {
                label: i18n("0d0c6ff7b65e62eba3ddd523e2976389"),
                mode: 'normal',
                name: 'confirmText'
              })]
            }
            ...
            formType: 'extend',
            mode: 'normal',
            label: i18n("7e9646e2db5ce66dc2b4b922ece483ba"),
            hidden: isInDropdown,
            form: {
              body: [getSchemaTpl('textareaFormulaControl', {
                name: 'tooltip',
                mode: 'normal',
                label: tipedLabel(i18n("5daaffe964aee9d884e0a681b2818a17"), i18n("faa29265819714253843e23437b9193e"))
              }), getSchemaTpl('textareaFormulaControl', {
                name: 'disabledTip',
                mode: 'normal',
                label: tipedLabel(i18n("fb37b983a93aabdcdbbd59ae48c519fb"), i18n("f855f46ce6146aa17a9ed423da16bfa2")),
                clearValueOnHidden: true,
                ...
                size: 'sm',
                options: [{
                  label: i18n("d420160a9e04c481e55a9686ab158caa"),
                  value: 'hover'
                }, {
                  label: i18n("d6763cb7640bed39caa058f156007a86"),
                  value: 'focus'
                }],
                ...
                // visibleOn: 'data.tooltip || data.disabledTip',
                label: i18n("d586324c6d6b45cb78a4172d836dab3e"),
                size: 'sm',
                options: [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('buttonLevel', {
            ...
            label: i18n("c12ba7b658a9fccf0815f3951bc759b6"),
            name: 'activeLevel',
            hidden: isInDropdown,
            visibleOn: 'data.active'
          }), getSchemaTpl('switch', {
            name: 'block',
            label: i18n("6aa6b9e2dca63d27dc74eb155020271d"),
            hidden: isInDropdown
          }), getSchemaTpl('size', {
        ...
        className: 'p-none',
        body: !!context.schema.actionType || ['submit', 'reset'].includes(context.schema.type) ? [getSchemaTpl('eventControl', __assign({
          name: 'onEvent'
        }, getEventControlConfig(_this.manager, context))), getOldActionSchema(_this.manager, context)] : [getSchemaTpl('eventControl', __assign({
          name: 'onEvent'

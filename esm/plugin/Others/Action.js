...
import { defaultValue, getSchemaTpl, diff, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var ActionPlugin = /** @class */function (_super) {
  ...
  function ActionPlugin() {
    ...
    _this.name = i18n("b7dd79307fb7bcc921aa1b94ef904fe9");
    ...
    _this.panelBodyCreator = function (context) {
      ...
      var schema = [{
        ...
        options: [{
          ...
          label: i18n("a56c9f13b1566009fdc7640bc551709e"),
          value: 'reset-and-submit'
        }, {
          label: i18n("30313d6fa06603604db18086bbcad9d3"),
  ...
  ActionPlugin.prototype.buildEditorToolbar = function (_a, toolbars) {
    ...
    if (~['action', 'button', 'submit', 'reset'].indexOf(info.renderer.name) && schema.actionType === 'dialog') {
      toolbars.push({
        iconSvg: 'dialog',
        tooltip: i18n("c3c8422fcecd8c1cc922cba15ab5cbc0"),
        placement: 'bottom',
        onClick: function () {

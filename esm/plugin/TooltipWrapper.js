...
var TooltipWrapperPlugin = /** @class */function (_super) {
  ...
  function TooltipWrapperPlugin() {
    ...
    _this.name = i18n("b624985146c759cfeb1be80325eccd65");
    _this.description = i18n("33813749a95477897085e2435acc16b6");
    ...
    _this.scaffold = {
      ...
      tooltip: i18n("9b14c9051067bef2dd9a15683201dd18"),
      body: [{
        type: 'tpl',
        wrapperComponent: '',
      ...
      return [getSchemaTpl('tabs', [{
        ...
        body: [getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('layout:originPosition', {
            ...
            type: 'button-group-select',
            name: 'tooltipTheme',
            label: i18n("b47707f0e916e3e3f4ba885bc2cf2c11"),
            size: 'sm',
            className: 'ae-buttonGroupSelect--justify',
            options: [{
              label: i18n("a32b3b848eee6929634dfc9a9d8bcdb1"),
              value: 'light',
              icon: 'far fa-sun'
            }, {
              label: i18n("adb7e5312abdb9a44297e48d63815fa3"),
              value: 'dark',
              icon: 'far fa-moon'
            }],
            ...
            name: 'inline',
            label: i18n("0de826c66ae3fe8043e9a39b35616ee6"),
            type: 'switch',
            mode: 'row',
            ...
            label: i18n("4583d3453c31cd3ff068c1358d8e7f1c"),
            type: 'switch',
            mode: 'row',
            inputClassName: 'inline-flex justify-between flex-row-reverse'
          }]
          ...
          body: [{
            ...
            type: 'input-group',
            label: tipedLabel(i18n("8e290c31bc0b4f76edbd58c3575b8420"), i18n("03c87fc8d49f865f0c2895d9ef3fe352")),
            body: [{
              type: 'input-number',
              name: 'offset',
              suffix: 'px',
            ...
            type: 'switch',
            label: tipedLabel(i18n("4e3e1e12e701890f4461808cc8f9d407"), i18n("9d6246f57f6924410b0c68f2172420f9")),
            name: 'enterable',
            inputClassName: 'is-inline'
          }, {
            type: 'switch',
            label: tipedLabel(i18n("90919000a708f8d66b7591e21b8e33f1"), i18n("ed81f127f3b2aaff73a4f4dd5968fdcb")),
            name: 'showArrow',
            inputClassName: 'is-inline'
          }, {
            label: i18n("b60e5222037939812dabb7da9979c27d"),
            type: 'input-number',
            min: 0,
            step: 100,
            ...
            label: i18n("82bb338503938f2da52e91f7244a34a2"),
            type: 'input-number',
            min: 0,
            step: 100,

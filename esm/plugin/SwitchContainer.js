...
import { getSchemaTpl, VRenderer, RegionWrapper, LayoutBasePlugin, registerEditorPlugin } from 'amis-editor-core';
    ...
    _this.vRendererConfig = {
      regions: {
        body: {
          key: 'body',
          label: i18n("132a78bdf68d6d17bde00aa807bbf032"),
          placeholder: i18n("3fea7ca76cdece641436d7ab0d02ab1b"),
          wrapperResolve: function (dom) {
            return dom;
          }
        }
      },
      panelTitle: i18n("3fea7ca76cdece641436d7ab0d02ab1b"),
      panelJustify: true,
    ...
    _this.overrides = {
      renderBody: function (item) {
        ...
        return React__default.createElement(VRenderer, {
          ...
          hostId: info.id,
          memberIndex: index,
          name: "".concat(item.title || i18n("3fea7ca76cdece641436d7ab0d02ab1b").concat(index + 1)),
          id: id,
          draggable: false,
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', __spreadArray([{
          ...
          body: __spreadArray(__spreadArray(__spreadArray([getSchemaTpl('layout:originPosition'), getSchemaTpl('layout:inset', {
            mode: 'vertical'
          })], __read(!isFreeContainer ? displayTpl : []), false), __read(isFlexItem ? [getSchemaTpl('layout:flex', {

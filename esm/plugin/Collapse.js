...
var CollapsePlugin = /** @class */function (_super) {
  ...
  function CollapsePlugin() {
    ...
    // 组件名称
    _this.name = i18n("e90e6ff080f179215c3566a61ca62367");
    _this.isBaseComponent = true;
    _this.description = i18n("452b62e9b7e650fa163300da2893654a");
    ...
    _this.panelTitle = i18n("e90e6ff080f179215c3566a61ca62367");
    _this.panelJustify = true;
    _this.events = [{
      eventName: 'change',
      eventLabel: i18n("8e5ff4f20463c03f7935e0627888c03c"),
      description: i18n("bcfcd9d31a7a469fa1f3a2ea9e3e3f89"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('layout:originPosition', {
            ...
            name: 'collapsable',
            label: i18n("96c0cc844a06e0850c04f7c44b6475fb"),
            pipeIn: defaultValue(true)
          })]
        }, getSchemaTpl('status', {
          disabled: true
        ...
        body: getSchemaTpl('collapseGroup', [getSchemaTpl('style:classNames', {
          ...
          schema: [getSchemaTpl('className', {
            ...
            label: i18n("63b67eead04256e42ea9f6f7218731ee")
          }), getSchemaTpl('className', {
            name: 'bodyClassName',
            label: i18n("66d88b3e01aff17c7973181e53fc8c0c")
          })]
        })])
      }, {

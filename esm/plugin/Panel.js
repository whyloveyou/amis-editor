...
var PanelPlugin = /** @class */function (_super) {
  ...
  function PanelPlugin() {
    ...
    _this.name = i18n("cd6f79e7bff1337c12c86a15ceedd6da");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-window-maximize';
    _this.pluginIcon = 'panel-plugin';
    _this.description = i18n("e04a2f1662121e5a3c397d496114185b");
    ...
    _this.previewSchema = {
      type: 'panel',
      title: i18n("4e9bb0326ab4d3a2af94d901c7f1b6a7"),
      body: i18n("5bf5f1fd54476671bd6fd9d97e3e6b6b"),
    ...
    _this.panelTitle = i18n("cd6f79e7bff1337c12c86a15ceedd6da");
      ...
      return [getSchemaTpl('tabs', [{
        ...
        body: [getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('layout:originPosition', {
            value: 'left-top'
          }), getSchemaTpl('title'), isForm ? null : {
            children: React__default.createElement(Button, {
              ...
              block: true
            }, i18n("cac3ba71180c97b1b6432833b3417d2c"))
          }]
        }, getSchemaTpl('status')])]
      }, {
        ...
        body: [getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('switch', {
            name: 'affixFooter',
            label: i18n("1fae678397df046c1754092f15a71d98"),
            value: false
          ...
          className: 'p-none',
          title: i18n("68744acedf015b8cfc445af30583815e"),
          body: [getSchemaTpl('subFormItemMode', {
            label: i18n("5a0fbcaaeb439684bb4ae5be579e4cd4")
          }), getSchemaTpl('subFormHorizontalMode', {
            label: i18n("f99d7e5f15906ca78c45753ee3b04a8b")
          ...
          body: [{
            ...
            label: i18n("65810a32a98f09be550b0c421df6c540")
          }), getSchemaTpl('className', {
            name: 'bodyClassName',
            label: i18n("33be689a0f0de129ce37f7a96052002e")
          }), getSchemaTpl('className', {
            name: 'footerClassName',
            label: i18n("f3b9889baa6d17ec63f05ea7d326bcfa")
          }), getSchemaTpl('className', {
            name: 'actionsClassName',
            label: i18n("da71dcbb13405815476cef28a8b9c4f6")
          })]
        }])]
      }])];
    };

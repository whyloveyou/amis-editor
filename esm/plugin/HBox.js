...
import { getSchemaTpl, Icon, repeatArray, defaultValue, VRenderer, RegionWrapper, JSONChangeInArray, JSONPipeIn, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var HBoxPlugin = /** @class */function (_super) {
  ...
  function HBoxPlugin() {
    ...
    _this.description = i18n("69a519f6b7fd6d0bebba72e7572ea1d6");
    ...
    _this.previewSchema = {
      ...
      columns: [{
        type: 'tpl',
        tpl: i18n("f9c91bffab8b1202cf32ab508879e805"),
        columnClassName: 'bg-primary w-xs'
      }, {
        type: 'tpl',
        tpl: i18n("8c187c1862900db487c8d47e19490fac"),
    ...
    _this.panelBodyCreator = function (context) {
      return [getSchemaTpl('tabs', [{
        ...
        body: [getSchemaTpl('layout:originPosition', {
          ...
          items: [{
            type: 'tpl',
            tpl: "<span class=\"label label-default\">".concat(i18n("cb2f68c9c24e85d21e6b090b6e5657d8"), "${index | plus}</span>"),
          ...
          title: i18n("98d695d6a6a48cfb4bc2f6396ee64787"),
          collapsable: false,
          body: [{
          ...
          title: i18n("11b7fc50778c89572391ec4c6c4b55e1"),
          collapsable: false,
          body: [{
            type: 'button-group-select',
            name: 'valign',
    ...
    _this.vRendererConfig = {
      regions: {
        body: {
          ...
          placeholder: i18n("cb2f68c9c24e85d21e6b090b6e5657d8"),
          wrapperResolve: function (dom) {
            return dom;
          }
        }
      },
      panelTitle: i18n("cb2f68c9c24e85d21e6b090b6e5657d8"),
      panelBodyCreator: function (context) {
        return [getSchemaTpl('tabs', [{
          title: i18n("22b777e6fcb613b8ba83ced9594cd07e"),
          body: [getSchemaTpl('fieldSet', {
            title: i18n("9bdb07e72d3a9a6084201a7398523f5a"),
            collapsable: false,
            body: [{
              type: 'wrapper',
            ...
            title: i18n("a170a375b264f7fe0c02a7ca8c268784"),
            collapsable: false,
            body: [{
              type: 'button-group-select',
              name: 'width',
              ...
              description: "<% if (this.width && this.width !== \"auto\") {%>".concat(i18n("92e2c6523449dfad4350f58908260266"), "<%}%>")
            }]
          }), getSchemaTpl('fieldSet', {
            title: i18n("11b7fc50778c89572391ec4c6c4b55e1"),
            collapsable: false,
          ...
          body: [getSchemaTpl('className', {
            name: 'columnClassName',
            label: i18n("129b16a89a82c6d5e03ab075633b3892"),
            description: i18n("d34cc10492e80595a901a292d0c16bb8")
          })]
        }])];
      }
    };
      ...
      renderColumn: function (node, index) {
        ...
        if (info && node.$$id) {
          ...
          return React__default.createElement(VRenderer, {
            ...
            hostId: info.id,
            memberIndex: index,
            name: "\u7B2C".concat(index + 1, i18n("cb2f68c9c24e85d21e6b090b6e5657d8")),
            id: node.$$id,
            draggable: false,
  ...
  HBoxPlugin.prototype.buildEditorContextMenu = function (context, menus) {
    ...
    if (context.node.isVitualRenderer) {
      menus.push('|');
      menus.push({
        label: i18n("4bfd6e7e1ec0fe485aa0e7741d1670db"),
        onSelect: function () {
          return _this.insertColumnBefore(context);
        }
      });
      menus.push({
        label: i18n("9d75cc0b193601391a139285d55a3493"),
        onSelect: function () {
          return _this.insertColumnAfter(context);
        }
      });

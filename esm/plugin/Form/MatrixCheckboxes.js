...
var MatrixControlPlugin = /** @class */function (_super) {
  ...
  function MatrixControlPlugin() {
    ...
    // 组件名称
    _this.name = i18n("076a041dcf45a36b29c5cdb8b8eca922");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-th-large';
    _this.pluginIcon = 'matrix-checkboxes-plugin';
    _this.description = i18n("183aae5eec1ff547833dc338aaeffc9a");
    _this.docLink = '/amis/zh-CN/components/form/matrix-checkboxes';
    _this.tags = [i18n("55b45c73ae417c4dead67905b1550e85")];
    _this.scaffold = {
      type: 'matrix-checkboxes',
      name: 'matrix',
      label: i18n("076a041dcf45a36b29c5cdb8b8eca922"),
      rowLabel: i18n("7583b85ff3579d60a9f9d323c2f6674a"),
      columns: [{
        label: i18n("3fc35bb610852289cf718f07a5b79369")
      }, {
        label: i18n("50987924540e6e35c78246031499e75b")
      }],
      rows: [{
        label: i18n("08a6996be7a86af5692cbca41922a5d1")
      }, {
        label: i18n("ce31d858c63395098c5e4cd892bd473b")
      }]
    };
    _this.previewSchema = {
      type: 'form',
    ...
    _this.panelTitle = i18n("076a041dcf45a36b29c5cdb8b8eca922");
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('layout:originPosition', {
            ...
            label: tipedLabel(i18n("f0789e79d48f135e5d870753f7a85d05"), i18n("e9b376d39966c8182683019f95ff8cf3")),
            name: 'singleSelectMode',
            type: 'button-group-select',
            size: 'sm',
            option: i18n("0f244785fd9f555aae9797db4d14fb09"),
            horizontal: {
              left: 2,
              justify: true
            },
            ...
            options: [{
              label: i18n("5a57bd526cc3170b6c86f920fc24cdee"),
              value: 'row'
            }, {
              label: i18n("0f244785fd9f555aae9797db4d14fb09"),
              value: 'column'
            }, {
              label: i18n("45dde5879e77d7f7a15d04b8fed26ec8"),
              value: 'cell'
            }],
            pipeIn: defaultValue('column')
          }, getSchemaTpl('switch', {
            name: 'yCheckAll',
            label: tipedLabel(i18n("542241c52bd2efb24dc37b32cab2329c"), i18n("d94ec7663ac9ad2d09fca5c86928b434"))
          }), getSchemaTpl('switch', {
            name: 'xCheckAll',
            label: tipedLabel(i18n("7020fa7949a5ae24cc8eb696772d97fc"), i18n("227c24282ff52f3f6f52dfdb853cc1ad"))
          }), getSchemaTpl('autoFillApi')]
        }, {
          title: i18n("ea15ae2b7fba76c83eec6d0986d15197"),
          body: [[getSchemaTpl('combo-container', {
            label: i18n("dc7558211f2990370954c2e7ca498ee9"),
            mode: 'normal',
            name: 'columns',
            type: 'combo',
            multiple: true,
            addButtonText: i18n("f4c807fd8453f4b3fdaab02fb9c21ba7"),
            scaffold: {
              label: i18n("39886861ea5d8b526e0ac5ecc78d110c")
            },
            items: [getSchemaTpl('matrixColumnLabel')]
          }), getSchemaTpl('matrixRowTitle'), getSchemaTpl('combo-container', {
            label: i18n("48baa62373a2f90d6aa743d7821be956"),
            name: 'rows',
            type: 'combo',
            mode: 'normal',
            multiple: true,
            scaffold: {
              label: i18n("854af3c2cd9c275ac70fc5121ea4fb2e")
            },
            addButtonText: i18n("bf306308e467aeb7b00df0e2dd127d06"),
            items: [getSchemaTpl('matrixRowLabel')]
          })], getSchemaTpl('apiControl', {
            label: tipedLabel(i18n("54ea89b497ec3bb319c68844dfa3687f"), i18n("75bf5fd49520bce97de632700fc8a129")),
            name: 'source',
            mode: 'normal'
        ...
        body: [getSchemaTpl('collapseGroup', [getSchemaTpl('style:formItem', {
          ...
          label: tipedLabel(i18n("d5bc35360607472de4525358af126de4"), i18n("83a60f8b752a1ef3ce6a240388d635aa")),
          name: 'textAlign',
          type: 'select',
          options: [{

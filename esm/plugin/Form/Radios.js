...
var RadiosControlPlugin = /** @class */function (_super) {
  ...
  function RadiosControlPlugin() {
    ...
    // 组件名称
    _this.name = i18n("9913107b19cb6012250134ff91377430");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-dot-circle-o';
    _this.pluginIcon = 'radios-plugin';
    _this.description = i18n("b7a4abc1e4e975c9df5bb9d9cf4823ba");
    ...
    _this.panelTitle = i18n("9913107b19cb6012250134ff91377430");
    // 事件定义
    _this.events = [{
      eventName: 'change',
    ...
    _this.panelBodyCreator = function (context) {
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          getSchemaTpl('labelRemark'), getSchemaTpl('remark'), getSchemaTpl('autoFillApi', {
            trigger: 'change'
          })]
        }, {

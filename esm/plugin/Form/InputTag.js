...
var TagControlPlugin = /** @class */function (_super) {
  ...
  function TagControlPlugin() {
    ...
    // 组件名称
    _this.name = i18n("fb7b49ff7f85f6e3f995b5eaae42d084");
    ...
    _this.scaffold = {
      ...
      name: 'tag',
      options: [{
        label: i18n("52636511861a0e08cbe6a0eb1c27d816"),
        value: 'red'
      }, {
        label: i18n("b2c712c788d3a143206eee22fe24d9f1"),
        value: 'green'
      }, {
        label: i18n("9c9aabab3f7627ff4bb224b2738b26ea"),
        value: 'blue'
      }]
    };
    _this.previewSchema = {
        ...
        properties: {
          data: {
            ...
            properties: {
              value: {
                type: 'array',
                title: i18n("9d776ddd9dd2d8d85ea225df9c27e929")
              }
            }
          }
        }
        ...
        properties: {
          data: {
            ...
            properties: {
              ...
              selectedItems: {
                type: 'array',
                title: i18n("4ed30a5be1b6680e6cc9fec0965d0f4f")
              },
              items: {
                type: 'array',
                title: i18n("e01315f74dee36831d93a117cbc47c8f")
              }
            }
          }
        }

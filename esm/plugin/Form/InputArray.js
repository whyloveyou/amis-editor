...
import { getSchemaTpl, valuePipeOut, defaultValue, JSONPipeOut, diff, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var ArrayControlPlugin = /** @class */function (_super) {
  ...
  function ArrayControlPlugin() {
    ...
    _this.panelTitle = i18n("a4b72cd5d7c953c57b00e3597b9ef666");
    _this.panelBodyCreator = function (context) {
      return [getSchemaTpl('layout:originPosition', {
        ...
        }, i18n("50bfed6ada3e7d0ef4d20eb727b3d7df"))
      }, getSchemaTpl('switch', {
        label: i18n("7f2579cabd4d654458a720eed517a37d"),
        name: 'addable',
        pipeIn: defaultValue(true)
      }), {
        label: i18n("ea1e5695bf682ea3b31aba0c35198ae3"),
        name: 'addButtonText',
        type: 'input-text',
        visibleOn: 'data.addable',
        pipeIn: defaultValue(i18n("66ab5e9f24c8f46012a25c89919fb191"))
      }, {
        type: 'textarea',
        name: 'scaffold',
        label: i18n("aab09f676645f2651655a711d5e3327c"),
        visibleOn: 'this.addable !== false',
        pipeOut: valuePipeOut,
        pipeIn: defaultValue('')
      }, getSchemaTpl('switch', {
        label: i18n("1ab31449faaaeeeb7200d724eab9a7ab"),
        name: 'removable',
        pipeIn: defaultValue(true)
      }), getSchemaTpl('api', {
        name: 'deleteApi',
        label: i18n("fa3e9f9e49f5a81c998f949155f86b50"),
        visibleOn: 'data.removable'
      }), {
        label: i18n("f962922d46ef18e68127642e5c00165a"),
        name: 'deleteConfirmText',
        type: 'input-text',
        visibleOn: 'data.deleteApi',
        pipeIn: defaultValue(i18n("fc763fd5ddf637fe4ba1ac59e10b8d3a"))
      }, getSchemaTpl('switch', {
        name: 'draggable',
        label: i18n("89e34c77922f9362fc8f4033e7f6bdf4")
      }), {
        name: 'draggableTip',
        visibleOn: 'data.draggable',
        type: 'input-text',
        label: i18n("1362211a6bfc8cc4130d54643e8e9732"),
        pipeIn: defaultValue(i18n("91396e9bc25c9e8b63907fe22408e2bb"))
      }, {
        name: 'addButtonText',
        type: 'input-text',
        label: i18n("ea1e5695bf682ea3b31aba0c35198ae3"),
        pipeIn: defaultValue(i18n("66ab5e9f24c8f46012a25c89919fb191"))
      }, getSchemaTpl('minLength'), getSchemaTpl('maxLength')];
    };
    return _this;
  }
  ...
  ArrayControlPlugin.prototype.buildEditorToolbar = function (_a, toolbars) {
    ...
    if (info.renderer.name === 'input-array') {
      toolbars.push({
        icon: 'fa fa-expand',
        order: 100,
        tooltip: i18n("50bfed6ada3e7d0ef4d20eb727b3d7df"),
  ...
  ArrayControlPlugin.prototype.editDetail = function (id) {
    ...
    node && value && this.manager.openSubEditor({
      title: i18n("50bfed6ada3e7d0ef4d20eb727b3d7df"),
      value: value.items,
      slot: {
        type: 'form',
        mode: 'normal',

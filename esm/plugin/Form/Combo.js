...
var ComboControlPlugin = /** @class */function (_super) {
  ...
  function ComboControlPlugin(manager) {
    ...
    // 组件名称
    _this.name = i18n("254bb8aa6b92d588d957a383df24db1e");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-group';
    _this.pluginIcon = 'combo-plugin';
    _this.description = i18n("4db731c7d73988e40a01b4bf1a7f00d7");
    ...
    _this.scaffold = {
      ...
      items: [{
        ...
        type: 'select',
        name: 'select',
        placeholder: i18n("ea15ae2b7fba76c83eec6d0986d15197"),
        options: [{
          label: 'A',
          value: 'a'
        }, {
    ...
    _this.events = [{
      ...
      eventLabel: i18n("95e09290c4e0f01323bb5abf301c950b"),
      description: i18n("ba2bd765f6c2e2b717139c5453884e14"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
            ...
            properties: {
              ...
              item: {
                type: 'object',
                title: i18n("046de1a6cb21ff83af74958342c0db64")
              }
            }
          }
        }
    ...
    _this.actions = [{
      ...
      actionType: 'addItem',
      actionLabel: i18n("00d1a6230e9a31664c895e95fde707d3"),
      description: i18n("cf3f7c0c1e6c77197bb0b6508a9173aa"),
      innerArgs: ['item'],
      schema: getArgsWrapper({
        type: 'combo',
        label: i18n("00d1a6230e9a31664c895e95fde707d3"),
        name: 'item',
        draggable: false,
        multiple: true,
        removable: true,
    ...
    _this.panelTitle = i18n("254bb8aa6b92d588d957a383df24db1e");
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: [getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('formItemName', {
            ...
            label: tipedLabel(i18n("225f3ed00750ae78ad1e6ea42c8f5087"), i18n("bf8f46b5c3b309f666965a74d57ac093")),
          ...
          getSchemaTpl('switch', {
            ...
            body: [{
              label: i18n("3a553b1123f403cf1f81eb28b3e4b814"),
              name: 'maxLength',
              type: 'input-number'
            }, {
              label: i18n("93bc4888bc13bb6e6c49b34b54077438"),
              name: 'minLength',
              type: 'input-number'
            }]
          }, getSchemaTpl('switch', {
            name: 'flat',
            label: tipedLabel(i18n("e61c32382d879b867938086a50ef094e"), i18n("28a59fee1a4714493a8d6cec05c1417b")),
          ...
          getSchemaTpl('switch', {
            name: 'addable',
            label: tipedLabel(i18n("8865c6822a31e0da6bc7eece8677d8f0"), i18n("30d4e9f1c60f2d5851f77463476d568b")),
            visibleOn: 'data.multiple',
            pipeIn: defaultValue(false),
            onChange: function (value, oldValue, model, form) {
              if (value) {
          ...
          getSchemaTpl('switch', {
            ...
            // 自定义删除按钮开关
            {
              ...
              name: 'removableMode',
              label: i18n("405a48545938c075e62eafb80b732769"),
              options: [{
            ...
            // }),
            {
              label: i18n("f4b06bd9e4f5ceaac7fbb0e17fffc518"),
          ...
          body: [getSchemaTpl('switch', {
            ...
            label: i18n("f7894f17d0eba299011d856ce3efea73"),
            pipeIn: defaultValue(false)
          }), getSchemaTpl('switch', {
            name: 'strictMode',
            label: tipedLabel(i18n("98d52b737d6bc171b6d5bad9a42f6e23"), i18n("cb5ca128b6c78a90f26673e21b0b3f28")),
            value: true
          }), getSchemaTpl('combo-container', {
            name: 'syncFields',
            visibleOn: '!data.strictMode',
            label: tipedLabel(i18n("7fc8dab2069004acb8f5c98c27ee0883"), i18n("07bf6c08bb5f0bdb32dbfecc7d3fe290")),
            type: 'combo',
            mode: 'normal',
            multiple: true,
            canAccessSuperData: true,
            ...
            name: 'lazyLoad',
            label: tipedLabel(i18n("9ff4713f6b17e96e9cd76650fd5892be"), i18n("93dc24d4ad01981d5994ba7f8ffaf345")),
            pipeIn: defaultValue(false),
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [{
            name: 'tabsMode',
            label: i18n("1e409f26f9c1d58ce0c47a68104d45f0"),
            type: 'button-group-select',
            inputClassName: 'items-center',
            size: 'sm',
            options: [{
              label: i18n("eee1e2258d7ea163fec625ee44be9637"),
              value: false
            }, {
            ...
            body: [{
              ...
              label: i18n("8e32c9ffc35059f8ac5254ffaf3c99b0"),
              name: 'tabsLabelTpl'
            })]
          },
          // 表单多行展示
          getSchemaTpl('switch', {
            name: 'multiLine',
            label: i18n("21766034147682a2435ecc766de5ea22"),
            pipeIn: defaultValue(false),
            visibleOn: '!data.tabsMode',
            onChange: function (value, oldValue, model, form) {
              if (!value) {
            ...
            name: 'noBorder',
            label: i18n("8ee004bdd55b578acdb10b1bcd3fa4f7"),
            pipeIn: defaultValue(false)
          })]
        }, getSchemaTpl('style:formItem', {
          renderer: context.info.renderer,
          schema: [getSchemaTpl('subFormItemMode', {
    ...
    if (props.multiple && !props.value && !props.$schema.value && !props.$ref) {
      ...
      if (Array.isArray(props.items) && props.items.length === 0) {
        props.items.forEach(function (control) {
          control.name && setVariable(mockedData_1, control.name, mockValue(control));
        });
      }

...
var TransferPlugin = /** @class */function (_super) {
  ...
  function TransferPlugin() {
    ...
    // 组件名称
    _this.name = i18n("685e5f4815e87c4690dda7d7aa163904");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-th-list';
    _this.pluginIcon = 'transfer-plugin';
    _this.description = i18n("26b4a55f458275a108c1ef213a354ced");
    ...
    _this.panelTitle = i18n("685e5f4815e87c4690dda7d7aa163904");
    _this.events = [{
      eventName: 'change',
      ...
      eventName: 'selectAll',
      eventLabel: i18n("66eeacd93a7c1bda93906fe908ad11a0"),
      description: i18n("8b3a9a5c912610c384bc8dc2c8514386"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
    ...
    _this.actions = [{
      ...
      actionLabel: i18n("66eeacd93a7c1bda93906fe908ad11a0"),
      description: i18n("8b3a9a5c912610c384bc8dc2c8514386")
    }, {
      actionType: 'setValue',
      actionLabel: i18n("8f40db3b25528063f1b6a59602a05cd5"),
      description: i18n("1b09b6621ebf0d10ce98f0178fa1bda1")
    }];
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          }), getSchemaTpl('labelRemark'), getSchemaTpl('remark'), getSchemaTpl('description'), getSchemaTpl('switch', {
            label: i18n("439a19857be1fb8d3e6017258e32c486"),
            name: 'statistics'
          })]
        }, {
          title: i18n("a2888bca5f435690ff9f5a5d615a968a"),
          body: [{
            ...
            options: [{
              ...
              label: i18n("eebda442c4bff2aaaf8274383d0ed12f"),
              value: 'tree'
            }],
          ...
          title: i18n("d5dbf5285b2dbe07b481fbd5d4536c60"),
          body: [{
            ...
            options: [{
              ...
              label: i18n("b720b2abd62161c3c99625c8160df987"),
              value: true
            }],
            onChange: function (value, origin, item, form) {
            ...
            label: tipedLabel(i18n("dbdae74eb12668e2b9568b013bf27d45"), i18n("acef03eee638dc4239ee60f627f33d85")),
            name: 'resultSearchable'
          }), getSchemaTpl('sortable', {
            label: i18n("e3ed623b79100791f156d3586751c652"),
            mode: 'horizontal',
            horizontal: {
              justify: true,
              left: 8

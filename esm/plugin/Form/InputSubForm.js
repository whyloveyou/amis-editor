...
import { getSchemaTpl, JSONPipeOut, diff, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var SubFormControlPlugin = /** @class */function (_super) {
  ...
  function SubFormControlPlugin() {
    ...
    // 组件名称
    _this.name = i18n("d6c40a2ee219c010edbcdaa2eeb94ddd");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-window-restore';
    _this.pluginIcon = 'sub-form-plugin';
    _this.description = i18n("81e1ff0bb8917a9df99d737982ee24b7");
    ...
    _this.panelTitle = i18n("d6c40a2ee219c010edbcdaa2eeb94ddd");
    _this.panelBodyCreator = function (context) {
      return [getSchemaTpl('layout:originPosition', {
        ...
        children: function (_a) {
          ...
          }, i18n("39a6853b109ae98f1aabca90283d7edc"));
        }
      }, {
        name: 'labelField',
        type: 'input-text',
        value: 'label',
        label: i18n("18c113b99afa964ee988f30e81baf12b"),
        description: i18n("4d930a9c13fca9d74e1a77496abfaa58")
      }, getSchemaTpl('btnLabel', {
        label: i18n("307ae20f587910da3e9bb4e885334b6a"),
        value: i18n("e366ccf1556c0672dcecba135ed5472e")
      }), {
        name: 'minLength',
        visibleOn: 'data.multiple',
        label: i18n("70c04a0f4522e39fde5f18ebc85b6232"),
        type: 'input-number'
      }, {
        name: 'maxLength',
        visibleOn: 'data.multiple',
        label: i18n("f58ea00f6a84bcb1cac174d1f68c88bd"),
        type: 'input-number'
      }];
    };
    return _this;
  ...
  SubFormControlPlugin.prototype.editDetail = function (id) {
    ...
    var _a = value.form,
      ...
      _a.type;
      var rest = __rest(_a, ["title", "actions", "name", "size", "closeOnEsc", "showCloseButton", "bodyClassName", "type"]);
    var schema = {
      title: title,
      actions: actions,
      name: name,

...
import { getSchemaTpl, getI18nEnabled, tipedLabel, defaultValue, mockValue, repeatArray, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var TableControlPlugin = /** @class */function (_super) {
  ...
  function TableControlPlugin(manager) {
    ...
    _this.scaffold = {
      ...
      columns: [{
        ...
        label: i18n("b34422e637c90181d3fca4485a97c712"),
        name: 'score',
        ...
        label: i18n("95e0d70d1809d5267c2419eda58e78ca"),
        name: 'level',
    ...
    _this.previewSchema = {
      ...
      body: __assign(__assign({}, _this.scaffold), {
        value: [{
          color: 'green',
          name: i18n("b2c712c788d3a143206eee22fe24d9f1")
        }]
      })
    };
    _this.notRenderFormZone = true;
    _this.panelJustify = true;
    _this.panelTitle = i18n("13c250c68608118463871ce7cd8b292c");
    _this.events = [{
      eventName: 'add',
    ...
    _this.actions = [{
      ...
      actionType: 'addItem',
      actionLabel: i18n("58477471b3bb8ad53fe9ab18a244868b"),
      description: i18n("f8692d409bb7f122a374872e01efd03a"),
      ...
      schema: getArgsWrapper({
        ...
        body: [{
          ...
          label: i18n("459fd144ee129b501545d19c169269e9"),
          size: 'lg',
          placeholder: i18n("cfe5917c83c8c31d5e57ddeb1f3460a5")
        }, {
          type: 'combo',
          name: 'value',
          ...
          mode: 'horizontal',
          size: 'lg',
          addButtonText: i18n("a26858cccbc451fd53515416a5968550"),
          items: [{
            type: 'combo',
            name: 'item',
            label: false,
            ...
            size: 'lg',
            mode: 'horizontal',
            addButtonText: i18n("c520ed9911d349c7974116d3d1e1423e"),
            items: [{
              name: 'key',
              type: 'input-text',
              source: '${__setValueDs}',
      ...
      actionLabel: i18n("947fa341a6d676d7f25bae6bef8342cd"),
      description: i18n("344c1c96f9cb3275f972929755b4e238"),
      ...
      schema: getArgsWrapper({
        ...
        body: [{
          ...
          mode: 'horizontal',
          label: i18n("8910acd418e45a30f01e7e531b90b61b"),
          ...
          options: [{
            label: i18n("ebf62450c3fb11c0b7e06da2d7535d6c"),
            value: 'rowIndex'
          }, {
            label: i18n("4bf7636a84714fac140e42b4cee242d4"),
          ...
          required: true,
          label: i18n("7708fb1394ce722ee73326437a66c77a"),
          size: 'lg',
          placeholder: i18n("015f108b96c70bba6511091e159db0ac"),
          hiddenOn: 'data.__deleteType !== "rowIndex"'
        }, getSchemaTpl('formulaControl', {
          name: 'condition',
          variables: '${variables}',
          label: i18n("63aeb2082d7cc0a316fc1e44913d7749"),
    ...
    // },
    {
      ...
      description: i18n("4622a4ce221f9b79aa3396cc461adc75")
    }];
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('layout:originPosition', {
            ...
            type: 'ae-switch-more',
            name: 'needConfirm',
            label: tipedLabel(i18n("1205e138ba64dddf61c1f8e6eb3a1aa7"), i18n("3d4d83f05a12364e2522fcfb265d8ce8")),
            mode: 'normal',
            formType: 'extend',
            ...
            form: {
              body: [{
                ...
                label: i18n("1d96dc9b36793e242322dd1e092a010c"),
                placeholder: i18n("1d96dc9b36793e242322dd1e092a010c")
              }, getSchemaTpl('icon', {
                name: 'confirmBtnIcon',
                label: i18n("c18169dd6fceab2f023216fa6f7d22c1"),
                pipeIn: defaultValue('check')
              }), {
                type: i18nEnabled ? 'input-text-i18n' : 'input-text',
                name: 'cancelBtnLabel',
                label: i18n("e0698c2a2d5c568edfc5a0b1a1d298eb"),
                placeholder: i18n("e0698c2a2d5c568edfc5a0b1a1d298eb")
              }, getSchemaTpl('icon', {
                name: 'cancelBtnIcon',
                label: i18n("5720057e62e80f7a04489dc4c035b4f1"),
            ...
            form: {
              body: [getSchemaTpl('apiControl', {
                ...
                label: i18n("738b58219dda4a849e293c0f75d06438"),
                value: true
              }), {
            ...
            type: 'ae-switch-more',
            name: 'editable',
            label: i18n("a32b3bf74850faad3a9ae6a0a5dac781"),
            mode: 'normal',
            formType: 'extend',
            hiddenOnDefault: true,
            form: {
            ...
            type: 'ae-switch-more',
            name: 'removable',
            label: i18n("3c87af7c432e6b1f59e4f415fd5060cf"),
            mode: 'normal',
            formType: 'extend',
            hiddenOnDefault: true,
            form: {
            ...
            name: 'showIndex',
            label: i18n("d173fb23320acba326a4424133969256"),
            pipeIn: defaultValue(false)
          }), {
            type: 'input-number',
            name: 'perPage',
            label: i18n("26eb498526ba909386befc43466db79d"),
            placeholder: i18n("306abb77f96a1048cf6e61bfe6e7bae4")
          }, {
            type: 'input-number',
            name: 'minLength',
            label: i18n("52029187eaa09f55193b6a15387e45ca"),
            pipeIn: defaultValue(0)
          }, {
            type: 'input-number',
            name: 'maxLength',
            label: i18n("3d99d1f17ebf865877e681397c61dc9d")
          }, getSchemaTpl('description'), getSchemaTpl('placeholder'), getSchemaTpl('labelRemark'), {
          ...
          body: [getSchemaTpl('switch', {
            name: 'strictMode',
            label: tipedLabel(i18n("98d52b737d6bc171b6d5bad9a42f6e23"), i18n("aa8b2a821e8e32196a720eaaa41b64d3")),
            pipeIn: defaultValue(false)
          }), getSchemaTpl('switch', {
            name: 'canAccessSuperData',
            label: tipedLabel(i18n("1c1618f67cfea6fefb5f287932be2c27"), i18n("2aa56a9b94ee3fde76a15711c94fdabc")),
            pipeIn: defaultValue(false)
          })]
        }, getSchemaTpl('status', {
          isFormItem: true
        ...
        body: getSchemaTpl('collapseGroup', [getSchemaTpl('style:formItem', {
          ...
          schema: [getSchemaTpl('className', {
            name: 'rowClassName',
            label: i18n("53a9db06d0b7e3482dc21e53f150e257")
          })]
        })])
      }, {
  ...
  Object.defineProperty(TableControlPlugin.prototype, "scaffoldForm", {
    get: function () {
      var i18nEnabled = getI18nEnabled();
      return {
        title: i18n("afccc17d5d672b10a1292dcd671ef534"),
        body: [{
          name: 'columns',
          type: 'input-table',
          label: false,
          ...
          columns: [{
            ...
            type: 'text',
            name: 'quickEditType',
            label: i18n("63bb911d6392cb2740140d406ab83d37"),
            quickEdit: {
              type: 'select',
              clearable: true,
              placeholder: i18n("c13998e4c837dc40b8e90828d99561df"),
              options: [{
                value: 'input-text',
                label: i18n("5ac57ce6df8c2a19668b7429aebd9f33")
              }, {
                value: 'input-number',
                label: i18n("1e65b8181e9a40e76b86e2c261cafbe0")
              }, {
                value: 'select',
                label: i18n("6530334ebf5ca810e576858eba168685")
              }, {
                value: 'input-color',
                label: i18n("f25cb224e4543c1dc0228fca8dbfaf1c")
              }, {
                value: 'checkboxes',
                label: i18n("1145703a07e11b6e680ee2ec8afae0b4")
              }, {
                value: 'radios',
                ...
                value: 'input-city',
                label: i18n("a877779dc422c5321057b638d6d520e5")
              }, {
                value: 'input-tree',
        ...
        pipeOut: function (schema) {
          ...
          columns.forEach(function (column) {
            var _a;
            var rawColumn = __assign(__assign({}, column), {
              type: column.type,

...
var UUIDControlPlugin = /** @class */function (_super) {
  ...
  function UUIDControlPlugin() {
    ...
    _this.description = i18n("43474db97aff2ed0a876a47b6f4cdc7d");
    ...
    _this.panelBody = [getSchemaTpl('layout:originPosition', {
      ...
      type: 'static',
      value: i18n("43e1548e15272e1007051d7c8b70adf6")
    }];
    return _this;
  }
  UUIDControlPlugin.prototype.renderRenderer = function (props) {
    return this.renderPlaceholder(i18n("844d72db7e57be4d77881ee9b4294e75"), props.key, props.style);
  };

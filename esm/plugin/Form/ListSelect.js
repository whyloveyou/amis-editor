...
import { getSchemaTpl, JSONPipeOut, JSONPipeIn, diff, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
import { formItemControl } from '../../component/BaseControl.js';
import { resolveOptionType, schemaArrayFormat } from '../../util.js';
...
var ListControlPlugin = /** @class */function (_super) {
  ...
  function ListControlPlugin() {
    ...
    // 组件名称
    _this.name = i18n("d22dfe420e4b00e000b93f94db3c856e");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-ellipsis-h';
    _this.pluginIcon = 'list-select-plugin';
    _this.description = i18n("2c05e451a6f2b2fe1cf55f7afb8c8423");
    ...
    _this.panelTitle = i18n("d22dfe420e4b00e000b93f94db3c856e");
    // 事件定义
    _this.events = [{
      eventName: 'change',
    ...
    _this.subEditorVariable = [{
      label: '当前选项',
      children: [{
        label: i18n("f69608e93e9728f4fbef583bfa1326c1"),
        value: 'label'
      }, {
        label: i18n("684a0d1aeca4e9acff89221b57826d4d"),
        value: 'value'
      }]
    }];
      ...
      return formItemControl({
        common: {
          ...
          body: [getSchemaTpl('layout:originPosition', {
            ...
            required: true
          }), getSchemaTpl('label'), getSchemaTpl('multiple'), getSchemaTpl('extractValue'), getSchemaTpl('valueFormula', {
  ...
  ListControlPlugin.prototype.editDetail = function (id, field) {
    ...
    node && value && this.manager.openSubEditor({
      ...
      data: (_a = {}, _a[value.labelField || 'label'] = '选项名', _a[value.valueField || 'value'] = i18n("684a0d1aeca4e9acff89221b57826d4d"), _a.item = i18n("6cb01692eea2fa7066d20fe2b6ccaea3"), _a)
    });
  };

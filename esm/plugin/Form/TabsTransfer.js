  ...
  function TabsTransferPlugin() {
        ...
        properties: {
          data: {
            ...
            properties: {
              key: {
                type: 'string',
                title: i18n("c46f27dcf45a345993f1cbb63380fa98")
              }
            }
          }
        }
    ...
    _this.actions = [{
      ...
      descDetail: function (info) {
        ...
        }, info === null || info === void 0 ? void 0 : info.__rendererLabel), i18n("2ac24a383a1faae33f81772b757b2817"));
      }
    }, {
      actionType: 'setValue',
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('layout:originPosition', {
            ...
            label: i18n("b7fc7efe26efb867838223936b7fc467"),
            name: 'selectMode',
            type: 'select',
            value: 'tree',
            options: [{
            ...
            placeholder: i18n("505e204cdd98afd08c174d6dcec0dc09")
          }, getSchemaTpl('sortable'), getSchemaTpl('searchable', {
            ...
            label: tipedLabel(i18n("791959f9b90734dce08da79f4ac27a41"), i18n("9b1ddba55066e0f329ca3cca2e58909c")),
            mode: 'normal',
            name: 'searchApi',
          ...
          body: [{
            ...
            label: tipedLabel(i18n("1395eba8d9efe27aa1ecd1a45e3e5dcd"), i18n("14079611c014884bbdffce4d0e5f4d73")),
            mode: 'normal',
            name: 'source'
            ...
            context: context
          }), getSchemaTpl('joinValues'), getSchemaTpl('delimiter'), getSchemaTpl('extractValue')

...
var SwitchControlPlugin = /** @class */function (_super) {
  ...
  function SwitchControlPlugin() {
    ...
    // 组件名称
    _this.name = i18n("a6beb974cc0b50eebd18120b8110a88b");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-toggle-on';
    _this.pluginIcon = 'switch-plugin';
    _this.description = i18n("d38b7fc2d31e0ae21cb4bc7d7df14e92");
    ...
    _this.scaffold = {
      ...
      option: i18n("f411d0f1f925d9b48d8c1d451bd809b1"),
      name: 'switch',
      falseValue: false,
      trueValue: true
    };
    _this.previewSchema = {
      ...
      body: [__assign(__assign({}, _this.scaffold), {
        label: i18n("6e17d8bb70df1c1e379fa86cb235ac82")
      })]
    };
    _this.notRenderFormZone = true;
    _this.panelTitle = i18n("a6beb974cc0b50eebd18120b8110a88b");
    _this.events = [{
      eventName: 'change',
      eventLabel: i18n("755955372bcc0c7ebf161a656bc389b3"),
      description: i18n("ddccb436305b0a984c77d4ffa0725375"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
            ...
            properties: {
              value: {
                type: 'string',
                title: i18n("a75c768fda740b2c8f6e2dcc76400f23")
              }
            }
          }
        }
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('layout:originPosition', {
            ...
            required: true
          }), getSchemaTpl('label'), getSchemaTpl('switchOption'), {
            type: 'ae-switch-more',
            bulk: true,
            mode: 'normal',
            label: i18n("7e1eec8349c4998d142960009305f27a"),
            formType: 'extend',
            form: {
            ...
            bulk: true,
            mode: 'normal',
            label: tipedLabel(i18n("db0258df1ddbd88749b335aecdc8425e"), i18n("48433deca382e67b26af31c6ff967d04")),
            formType: 'extend',
            form: {
              body: [{
                type: 'input-text',
                label: i18n("cadd676e2710e50ac149211078f8a306"),
                name: 'trueValue',
                value: true,
                ...
                type: 'input-text',
                label: i18n("13f19e1d0dd528aafd6263fafdc35e82"),
                name: 'falseValue',
                value: false,
                pipeOut: valuePipeOut,
                onChange: function (value, oldValue, model, form) {
        ...
        body: getSchemaTpl('collapseGroup', [getSchemaTpl('style:formItem', {
          ...
          title: i18n("f411d0f1f925d9b48d8c1d451bd809b1"),

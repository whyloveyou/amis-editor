...
import { getSchemaTpl, tipedLabel, defaultValue, getI18nEnabled, mapReactElement, VRenderer, RegionWrapper, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var TabsPlugin = /** @class */function (_super) {
  ...
  function TabsPlugin() {
    ...
    // 组件名称
    _this.name = i18n("9377e388f7189d6103a3985a321115c8");
    _this.isBaseComponent = true;
    _this.description = i18n("a8b1273cb2d53ad858906ff9744a9891");
    ...
    _this.scaffold = {
      type: 'tabs',
      tabs: [{
        title: i18n("f78416dbd6c6a40a3ecd1c1f2b0672c8"),
        body: i18n("9769ee568100b0c530a06ec3f0c0044d")
      }, {
        title: i18n("4be268145385303e8ebeb480458a380e"),
        body: i18n("c50159e2acff0f4ffdce4c67ec3513a3")
      }]
    };
    ...
    _this.panelTitle = i18n("9377e388f7189d6103a3985a321115c8");
    _this.events = [{
      eventName: 'change',
      eventLabel: i18n("e1112a529dc969a03bbbb409905ff2ec"),
      description: i18n("e1112a529dc969a03bbbb409905ff2ec"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
            ...
            properties: {
              value: {
                type: 'string',
                title: i18n("b04c6cf9cb1212b9c173ddfeec129028")
              }
            }
          }
        }
    ...
    _this.actions = [{
      ...
      actionLabel: i18n("7bb3e24cc54f4b8ee0a65d14fa4c067c"),
      description: i18n("fcd3abb110aab48ebd0ac2a1d7040d6d"),
      config: ['activeKey'],
      descDetail: function (info) {
        var _a;
        return React__default.createElement("div", null, i18n("9d000284174ff09642502803887f28ed"), React__default.createElement("span", {
          className: "variable-left variable-right"
        }, (_a = info === null || info === void 0 ? void 0 : info.args) === null || _a === void 0 ? void 0 : _a.activeKey), i18n("29645b509093191cad34c673c1b3efb7"));
      },
      schema: getArgsWrapper(getSchemaTpl('formulaControl', {
        name: 'activeKey',
        label: i18n("9578012b7d75a3a47c76acc176caf403"),
        variables: '${variables}',
        size: 'lg',
        mode: 'horizontal'
      }))
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [getSchemaTpl('layout:originPosition', {
            ...
            type: 'combo',
            label: i18n("9377e388f7189d6103a3985a321115c8"),
            mode: 'normal',
            name: 'tabs',
            draggableTip: '',
            draggable: true,
            ...
            minLength: 1,
            scaffold: {
              title: i18n("9377e388f7189d6103a3985a321115c8"),
              body: {
                type: 'tpl',
            ...
            items: [getSchemaTpl('title', {
              label: false,
              required: true
            })]
          }), getSchemaTpl('switch', {
            name: 'showTip',
            label: tipedLabel(i18n("3ba265c6b63bde0319822afd6b9a649d"), i18n("b744b72fd649d904e561358fc26c455f")),
            visibleOn: isNewTabMode,
            clearValueOnHidden: true
          }), {
            label: tipedLabel(i18n("6c200daeb748ecce2c730d01837d3508"), i18n("bd749c7a75af1236325d8d669e9bc5fc")),
            type: 'input-text',
            name: 'defaultKey',
            placeholder: i18n("8b4de52c23ad472b9ece9e30d8750c48"),
            pipeOut: function (data) {
              return data === '' || isNaN(Number(data)) ? data : Number(data);
            }
          }, {
            label: tipedLabel(i18n("7806807651c37e4467f9d2fc1c18eb2a"), i18n("8a59e0a5705fea1751d77a97b7bf5d8d")),
            type: 'input-text',
            name: 'activeKey',
            placeholder: i18n("27e0d57c4412bcb89e6aaeeb1e5935fe"),
            pipeOut: function (data) {
              return data === '' || isNaN(Number(data)) ? data : Number(data);
            }
          }]
          ...
          body: [getSchemaTpl('sourceBindControl', {
            label: tipedLabel(i18n("45a4922d3f42d0b137c6845c4c77031f"), i18n("eadd1d64cd6ceb2c50554281cd2d3be0"))
          }), getSchemaTpl('switch', {
            name: 'mountOnEnter',
            label: tipedLabel(i18n("5b9af1bc3012bb3c8e07b983b423ec17"), i18n("4bcecc15d16e8c851dc3d155b8f30929"))
          }), getSchemaTpl('switch', {
            name: 'unmountOnExit',
            label: tipedLabel(i18n("12c6a62683d63e404d71a31c9cb5209c"), i18n("5b52bcb62a2e1dab99ef841b05395b6d"))
          })]
        }])
      }, {
        ...
        body: [getSchemaTpl('collapseGroup', [{
          ...
          body: [{
            ...
            options: [{
              ...
              label: i18n("ecfcea4b381d761fecd512761bc07954"),
              value: 'line'
            }, {
              label: i18n("b30f254eccefa14c9980235bcbec74f9"),
              value: 'simple'
            }, {
              ...
              label: i18n("ee5e5a588705699a51eb3c5778c3020a"),
              value: 'chrome'
            }, {
              label: i18n("c5b8044dacf2e63931d85e5e307a9168"),
              value: 'tiled'
            }, {
              label: i18n("22d18bf0c476ebe7aa9303108677ff2e"),
              value: 'radio'
            }, {
              label: i18n("75ac842f8e77305846f1d776f97dfaf8"),
              value: 'vertical'
            }, {
              label: i18n("5bff38cb05e3710a0c0cb16ed3ced78f"),
              value: 'sidebar'
            }],
            pipeIn: defaultValue('')
          }, getSchemaTpl('horizontal-align', {
            label: i18n("593c1c61592f80831f58b2e44cfe63fa"),
            name: 'sidePosition',
    ...
    _this.vRendererConfig = {
      ...
      panelTitle: i18n("d87f215d9ac688b1d3399bf575a0ef6f"),
      panelJustify: true,
        ...
        return getSchemaTpl('tabs', [{
          ...
          body: getSchemaTpl('collapseGroup', [{
            ...
            body: [{
              ...
              formType: 'extend',
              mode: 'normal',
              label: i18n("32b4bc87bf7f95cd6094992f0135ff7f"),
              form: {
                body: [getSchemaTpl('icon'), getSchemaTpl('horizontal-align', {
              ...
              label: tipedLabel('Hash', i18n("996a919888ae86e842c76245daae2360")),
              name: 'hash',
              type: 'input-text'
            }]
          }, getSchemaTpl('status', {
            ...
            body: [getSchemaTpl('switch', {
              name: 'mountOnEnter',
              label: tipedLabel(i18n("f3051dd9b3538e170322fd5224b28de0"), i18n("ee51f2d49fa12c730d2a0efef0d67e44")),
              visibleOn: '!this.reload',
              clearValueOnHidden: true
            }), getSchemaTpl('switch', {
              name: 'unmountOnExit',
              label: tipedLabel(i18n("024f24defb08c5c9d463a2668cbb9802"), i18n("370bb4d6806c88a7df2ac17ca2a7b6a6")),
              visibleOn: '!this.reload',
              clearValueOnHidden: true
            })]
          }])
        ...
        if (!this.renderTab && this.props.$$editor && dom) {
          ...
          return mapReactElement(dom, function (item) {
            ...
            if (item.type === Tab && item.props.$$id) {
              ...
              var index = findIndex(tabs_1, function (tab) {
                return tab.$$id === id_1;
              });
              ...
              if (~index) {
                ...
                return React__default.cloneElement(item, {
                  children: React__default.createElement(VRenderer, {
                    ...
                    hostId: info.id,
                    memberIndex: index,
                    name: "".concat(item.props.title || i18n("d87f215d9ac688b1d3399bf575a0ef6f").concat(index + 1)),
                    id: id_1,
                    draggable: false,

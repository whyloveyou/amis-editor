...
var CollapseGroupPlugin = /** @class */function (_super) {
  ...
  function CollapseGroupPlugin() {
    ...
    _this.events = [{
      ...
      description: i18n("d2fa917958506736ea39edbef5e1cea5"),
      dataSchema: [{
        type: 'object',
        properties: {
          data: {
            ...
            properties: {
              activeKeys: {
                type: 'array',
                title: i18n("58164864ad00f5d134f304d309055eda")
              },
              collapseId: {
                type: 'string',
                title: i18n("44732aa2566399b71483e63252d3dbc7")
              },
              collapsed: {
                type: 'boolean',
            ...
            pipeOut: function (value, oldValue, data) {
              ...
              value.forEach(function (item) {
                if (!item.key) {
                  ...
                  item.key = key;
                  item.header = i18n("32c65d8d7431e76029678ec7bb73a5ab").concat(key);
                }
              });
              return value;
            },

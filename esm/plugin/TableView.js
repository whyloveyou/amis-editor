...
import { __extends, __assign, __spreadArray, __read, __values } from 'tslib';
import React__default from 'react';
import { getSchemaTpl, defaultValue, VRenderer, JSONGetById, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
import { TableViewEditor } from '../component/TableViewEditor.js';
...
function getCellRealPosition(table) {
  ...
  try {
    for (var trs_1 = __values(trs), trs_1_1 = trs_1.next(); !trs_1_1.done; trs_1_1 = trs_1.next()) {
      ...
      try {
        for (var tds_1 = (e_2 = void 0, __values(tds)), tds_1_1 = tds_1.next(); !tds_1_1.done; tds_1_1 = tds_1.next()) {
...
var TableViewPlugin = /** @class */function (_super) {
  ...
  function TableViewPlugin() {
    ...
    // 组件名称
    _this.name = i18n("175e01917d9d4891a40eab43f4487030");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-columns';
    _this.pluginIcon = 'table-view-plugin';
    _this.description = i18n("9fe8304dade75a37bc04f45515688325");
    ...
    _this.panelTitle = i18n("175e01917d9d4891a40eab43f4487030");
    _this.panelBody = [getSchemaTpl('tabs', [{
      ...
      className: 'p-none',
      body: getSchemaTpl('collapseGroup', __spreadArray([], __read(getSchemaTpl('theme:common')), false))
    }, {
  ...
  TableViewPlugin.prototype.insertRow = function (tdId, position) {
    ...
    for (var trIndex = 0; trIndex < table.trs.length; trIndex++) {
      try {
        for (var _b = (e_3 = void 0, __values(table.trs[trIndex].tds || [])), _c = _b.next(); !_c.done; _c = _b.next()) {
          var td_1 = _c.value;
          var tdRow = td_1.$$row;
  ...
  TableViewPlugin.prototype.insertCol = function (tdId, position) {
    ...
    try {
      for (var _b = __values(table.trs || []), _c = _b.next(); !_c.done; _c = _b.next()) {
        var tr = _c.value;
        var tds = tr.tds || [];

...
var AvatarPlugin = /** @class */function (_super) {
  ...
  function AvatarPlugin() {
    ...
    // 组件名称
    _this.name = i18n("4c50eef3bdaf0b4164ce179e576f2b2d");
    _this.isBaseComponent = true;
    _this.icon = 'fa fa-user';
    _this.pluginIcon = 'avatar-plugin';
    _this.description = i18n("18dc831ec12d358d05902bef1f00e1f1");
    ...
    _this.panelTitle = i18n("4c50eef3bdaf0b4164ce179e576f2b2d");
        ...
        body: [getSchemaTpl('collapseGroup', [{
          ...
          // 如果同时存在 src、text 和 icon，会优先用 src、接着 text、最后 icon
          {
            ...
            getSchemaTpl('valueFormula', {
              ...
              label: tipedLabel(i18n("b54f4a65cd257c87db32ee1023e1daa1"), i18n("def423db04dd24b226911b9e4cf5dc9c")),
              name: 'fit',
              type: 'select',
              pipeIn: defaultValue('cover'),
              options: [{
                label: i18n("74735df86a8e1c15bce50e2c1dd42e98"),
                value: 'cover'
              }, {
                label: i18n("9d7f3e170404f211a4f95c214f044b05"),
                value: 'contain'
              }, {
                label: i18n("9854f491213784118614be4a1970bcf9"),
                value: 'fill'
              }, {
                label: i18n("3d2b60dda894eba9a042beddf7daf3cc"),
                value: 'none'
              }],
              visibleOn: 'data.showtype === "image"'
            },
            ...
            getSchemaTpl('avatarText'), {
              ...
              name: 'gap',
              value: 4,
              label: tipedLabel(i18n("c7fff1a6f585d7fb22c94bb1ef82707d"), i18n("f1b4c635cdb39c91461f181d27d06f8c")),
              body: [{
                type: 'input-number',
                name: 'gap',
                min: 0
